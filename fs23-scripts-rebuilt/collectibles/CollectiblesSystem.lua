...
function CollectiblesSystem:onTriggerCollectible(collectible)
	...
	if numLeftInGroup == 0 then
		g_gui.hud:showInGameMessage(group.dialogTitle or g_i18n:getText("ui_collectibleMessageTitle"), prefixText .. group.dialogText, -1)
	elseif info.dialogText ~= nil then
		g_gui.hud:showInGameMessage(string.format(info.dialogTitle or g_i18n:getText("ui_collectibleMessageTitle"), numLeftInGroup), prefixText .. string.format(info.dialogText, numLeftInGroup), -1)
	end
