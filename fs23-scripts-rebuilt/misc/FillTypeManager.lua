...
g_xmlManager:addInitSchemaFunction(function ()
	...
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeKey .. "#name", "Name of fill type")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeKey .. "#title", "Display name of fill type")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeKey .. "#achievementName", "Name of linked archivement")
	FillTypeManager.xmlSchema:register(XMLValueType.BOOL, fillTypeKey .. "#showOnPriceTable", "Show fill type in pricing menu")
	FillTypeManager.xmlSchema:register(XMLValueType.VECTOR_3, fillTypeKey .. "#fillPlaneColors", "Color of fill plane used in animal husbandry", "1 1 1")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeKey .. "#unitShort", "Unit short localization key")
	FillTypeManager.xmlSchema:register(XMLValueType.FLOAT, fillTypeKey .. ".physics#massPerLiter", "Mass per liter/unit in kilograms")
	FillTypeManager.xmlSchema:register(XMLValueType.FLOAT, fillTypeKey .. ".physics#maxPhysicalSurfaceAngle", "Max physical surface angle used on fill volumes")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeKey .. ".image#hud", "Path to hud image")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeKey .. ".pallet#filename", "Pallet xml filename which is spawned on unloading")
	FillTypeManager.xmlSchema:register(XMLValueType.FLOAT, fillTypeKey .. ".economy#pricePerLiter", "Price per liter")
	FillTypeManager.xmlSchema:register(XMLValueType.INT, fillTypeKey .. ".economy.factors.factor(?)#period", "Period index")
	FillTypeManager.xmlSchema:register(XMLValueType.FLOAT, fillTypeKey .. ".economy.factors.factor(?)#value", "Price factor to apply in this period")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeKey .. ".textures#diffuse", "Path to fill plane diffuse map")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeKey .. ".textures#normal", "Path to fill plane normal map")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeKey .. ".textures#specular", "Path to fill plane specular map")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeKey .. ".textures#distance", "Path to fill plane distance diffuse map")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeKey .. ".effects#prioritizedEffectType", "Defines which effect type is priorized in e.g. unloading effects", "ShaderPlaneEffect")
	FillTypeManager.xmlSchema:register(XMLValueType.VECTOR_4, fillTypeKey .. ".effects#fillSmokeColor", "Color of smoke effects")
	FillTypeManager.xmlSchema:register(XMLValueType.VECTOR_4, fillTypeKey .. ".effects#fruitSmokeColor", "Color of fruit smoke effects")

	local fillTypeCategoryKey = "map" .. ".fillTypeCategories.fillTypeCategory(?)"

	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeCategoryKey .. "#name", "Name of category")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeCategoryKey, "list of fillTypes, space separated")

	local fillTypeConverterKey = "map" .. ".fillTypeConverters.fillTypeConverter(?)"

	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeConverterKey .. "#name", "Converter name")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeConverterKey .. ".converter(?)#from", "From fill type")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeConverterKey .. ".converter(?)#to", "To fill type")
	FillTypeManager.xmlSchema:register(XMLValueType.FLOAT, fillTypeConverterKey .. ".converter(?)#factor", "Multiplied by factor")

	local fillTypeSoundKey = "map" .. ".fillTypeSounds.fillTypeSound(?)"

	SoundManager.registerSampleXMLPaths(schema, fillTypeSoundKey, "sound")
	FillTypeManager.xmlSchema:register(XMLValueType.STRING, fillTypeSoundKey .. "#fillTypes", "list of fillTypes, space separated")
	FillTypeManager.xmlSchema:register(XMLValueType.BOOL, fillTypeSoundKey .. "#isDefault", "Is default sound", false)
end)
