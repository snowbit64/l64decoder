...
function AITurnStrategyBulb3Reverse.new(customMt)
  ...
  v1.strategyName = "AITurnStrategyBulb3Reverse"
...
function AITurnStrategyBulb3Reverse:startTurn(driveStrategyStraight)
  ...
  if 0 >= v7 + v2.zOffsetTurn - v19 then
  end
  ...
  v20.startPoint = v21
  v21 = self:getVehicleToWorld(0, 0, v7 - v19, true)
  v20.endPoint = v21
  ...
  local v24 = self:getVehicleToWorld(v5, v6, v7 - v19)
  setTranslation(...)
  ...
  local v25 = self:getVehicleToWorld(v9, v10, v11 - v19)
  setTranslation(...)
  ...
  if v11 - 2 * v18 >= v11 - v19 then
  end
  v23.moveForward = true
  v23.slowDown = true
  v23.checkAlignmentToSkipSegment = true
  v25 = self:getVehicleToWorld(2 * v3, 0, v11 - v19, true)
  v23.startPoint = v25
  v25 = self:getVehicleToWorld(2 * v3, 0, v11 - 2 * v18, true)
  v23.endPoint = v25
  table.insert(self.turnSegments, v23)
  if v2.zOffset >= v11 - 2 * v18 then
  end
  v26.moveForward = true
  v26.slowDown = true
  local v27 = self:getVehicleToWorld(v24, 0, v11 - 2 * v18, true)
  v26.startPoint = v27
