...
function AITurnStrategyBulb3.new(customMt)
  ...
  v1.strategyName = "AITurnStrategyBulb3"
  return v1
end
...
function AITurnStrategyBulb3:startTurn(driveStrategyStraight)
  ...
  v15 = self:getVehicleToWorld(0, 0, v6 + v2.zOffsetTurn, true)
  ...
  local v18 = self:getVehicleToWorld(v4, v5, v6 + v2.zOffsetTurn)
  setTranslation(...)
  ...
  local v19 = self:getVehicleToWorld(v8, v9, v10)
  setTranslation(...)
  ...
  v19 = self:getVehicleToWorld(2 * v3, 0, v10, true)
  local v23 = math.min(v2.zOffset, v10 - 0.1)
