...
// Function: addDensityMasked2Parallelogram
// Entry Point: 00b8ba08
// Size: 756 bytes
// Signature: undefined __thiscall addDensityMasked2Parallelogram(DensityMapOldOperations * this, Parallelogram * param_1, uint param_2, uint param_3, int param_4, OPERATION param_5, uint param_6, int param_7, int param_8, uint param_9, uint param_10, DensityMap * param_11, uint param_12, uint param_13, OPERATION param_14, uint param_15, int param_16, int param_17, uint param_18, uint param_19, DensityMap * param_20, uint param_21, uint param_22, OPERATION param_23, uint param_24, int param_25, int param_26, uint param_27, uint param_28, int param_29, uint param_30, uint * param_31, uint * param_32, int * param_33)


/* DensityMapOldOperations::addDensityMasked2Parallelogram(DensityMapOperationShapes::Parallelogram
   ...
   DensityMapFilter::OPERATION, unsigned int, int, int, unsigned int, unsigned int, int, unsigned
   int, unsigned int&, unsigned int&, int&) */

void __thiscall
DensityMapOldOperations::addDensityMasked2Parallelogram
          ...
          uint param_27,uint param_28,int param_29,uint param_30,uint *param_31,uint *param_32,
          int *param_33)
