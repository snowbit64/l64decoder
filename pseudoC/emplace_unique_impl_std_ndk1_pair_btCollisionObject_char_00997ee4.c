...
// Function: __emplace_unique_impl<std::__ndk1::pair<btCollisionObject*,char*>>
// Entry Point: 00997ee4
// Size: 308 bytes
// Signature: pair __cdecl __emplace_unique_impl<std::__ndk1::pair<btCollisionObject*,char*>>(pair * param_1)
...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<btCollisionObject
   ...
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > >
   > >::__emplace_unique_impl<std::__ndk1::pair<btCollisionObject*, char*>
...
pair std::__ndk1::
     ...
     ::__emplace_unique_impl<std::__ndk1::pair<btCollisionObject*,char*>>(pair *param_1)

{
  ...
  __construct_node<std::__ndk1::pair<btCollisionObject*,char*>>(param_1);
