...

{
  ...
  if (param_3 != 0) {
    ...
    (**(code **)(*(long *)(*(long *)(this + 0x10) + 8) + 0x58))
              ((long *)(*(long *)(this + 0x10) + 8),param_2,*(undefined8 *)(this + 0x30),param_1,__n
               ,4);
    if (__n < param_3) {
      lVar1 = param_3 - __n;
      (**(code **)(*(long *)(*(long *)(this + 0x10) + 8) + 0x58))
                ((long *)(*(long *)(this + 0x10) + 8),param_2 + __n,param_1,param_1 + __n,lVar1,4);
    }
    else {
      lVar1 = param_3 - __n;
    }
    memcpy(*(void **)(this + 0x30),param_1 + lVar1,__n);
    return;
  }
  return;
}
