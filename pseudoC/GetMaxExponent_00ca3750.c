...
// Entry Point: 00ca3750
// Size: 180 bytes
// Signature: undefined GetMaxExponent(void)


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>::GetMaxExponent() const */

void CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>::GetMaxExponent(void)

{
  ...
  Integer::Integer((Integer *)local_68,1);
                    /* try { // try from 00ca3790 to 00ca379f has its CatchHandler @ 00ca3808 */
  ...
  for (; local_58 != 0; local_58 = local_58 - 1) {
    *(undefined4 *)((long)local_48 + local_58 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00ca37d8 to 00ca37db has its CatchHandler @ 00ca3804 */
