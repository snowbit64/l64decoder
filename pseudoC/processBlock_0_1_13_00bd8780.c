...
// Function: processBlock_0_1_13
// Entry Point: 00bd8780
// Size: 3116 bytes
// Signature: undefined __cdecl processBlock_0_1_13(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_0_1_13(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_0_1_13(CustomCipher *param_1,uchar *param_2)

{
  ...
  uVar14 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar4 >> 8 ^ uVar2 >> 0x10) & 0x3f) * 4) |
            (&s_wPS)[(uVar4 >> 0xc ^ uVar2 >> 0x18) & 0x3f] |
            *(uint *)(&DAT_0211ea98 + (ulong)((uVar4 >> 4 ^ uVar2 >> 8) & 0x3f) * 4) |
           *(uint *)(&DAT_0211eb98 + (ulong)((uVar4 ^ uVar2) & 0x3f) * 4)) ^ uVar14 ^
           (*(uint *)(&DAT_0211ed98 + (ulong)((uVar3 >> 0x10 ^ uVar1 >> 7) & 0x3f) * 4) |
            *(uint *)(&DAT_0211ec98 + (ulong)((uVar3 >> 0x18 ^ uVar1 >> 0xb) & 0x3f) * 4) |
            *(uint *)(&DAT_0211ee98 + (ulong)((uVar3 >> 8 ^ uVar1 >> 3) & 0x3f) * 4) |
