...
// Function: applyModuleToShapeWithMask<ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
// Entry Point: 00819054
// Size: 2556 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask<ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>(IDensityPixelSource * param_1, ChunkedBitSquare * param_2, ProceduralDensityPixelSource * param_3, ParallelogramHelper * param_4, SetTypeProcessor * param_5, DensityMapFilter * param_6)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask<ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
    ...
    if ((uVar13 < uVar11) || (uVar14 < uVar12)) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar19 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar19 != 0
                    ...
                    /* try { // try from 00819a04 to 00819a0f has its CatchHandler @ 00819a60 */
        this = (Logger *)operator_new(0x38);
                    /* try { // try from 00819a14 to 00819a17 has its CatchHandler @ 00819a50 */
        Logger::Logger(this);
...
LAB_008196c4:
  ...
  if (param_5[0x5c] != (SetTypeProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_4 + 0x54),uVar13,*(uint *)(param_5 + 0x14),*(uint *)(param_5 + 0x18),
...
LAB_00819780:
  uVar22 = uVar22 + 1;
  if (uVar22 == uVar16) goto LAB_00819758;
  goto LAB_0081978c;
LAB_00819758:
  uVar14 = uVar14 + 1;
  if (uVar14 == uVar11) goto LAB_00819710;
  goto LAB_00819768;
LAB_00819710:
  *(int *)param_5 = *(int *)param_5 + 1;
LAB_0081971c:
  uVar13 = uVar13 + 1;
  if (*(uint *)(param_4 + 0x5c) <= uVar13) goto LAB_008196c4;
  goto LAB_0081973c;
}
