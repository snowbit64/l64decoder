...
// Function: FUN_00974324
// Entry Point: 00974324
// Size: 800 bytes
// Signature: undefined FUN_00974324(void)


void FUN_00974324(undefined8 *param_1,undefined8 *param_2)

{
  ...
  if (uVar6 < 6) {
    ...
    switch(uVar6) {
    default:
      goto switchD_00974384_caseD_0;
    case 2:
      puVar13 = param_2 + -3;
      if ((*(int *)puVar13 < *(int *)param_1) ||
      ...
      break;
    case 3:
      FUN_00973ee8(param_1,param_1 + 3,param_2 + -3);
      break;
    case 4:
      puVar13 = param_1 + 3;
      puVar11 = param_1 + 6;
      FUN_00973ee8(param_1,puVar13,puVar11);
      puVar8 = param_2 + -3;
      ...
      break;
    case 5:
      FUN_00974090(param_1,param_1 + 3,param_1 + 6,param_1 + 9,param_2 + -3);
    }
  }
  else {
          ...
          *(int *)((long)puVar13 + 4) = iVar2;
          ...
          if (iVar9 == 8) {
            ...
            goto switchD_00974384_caseD_0;
                ...
                (dVar18 = (double)puVar8[1], dVar18 < (double)puVar11[1])) goto LAB_00974460;
        lVar7 = lVar7 + 0x18;
        puVar13 = puVar8 + 3;
        puVar11 = puVar8;
