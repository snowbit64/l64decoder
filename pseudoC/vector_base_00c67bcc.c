...
// Entry Point: 00c67bcc
// Size: 156 bytes
// Signature: undefined __thiscall ~__vector_base(__vector_base<UserBlockManager::UserDetails,std::__ndk1::allocator<UserBlockManager::UserDetails>> * this)


/* std::__ndk1::__vector_base<UserBlockManager::UserDetails,
   std::__ndk1::allocator<UserBlockManager::UserDetails> >::~__vector_base() */
