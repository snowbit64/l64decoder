...
// Function: __append
// Entry Point: 00727660
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<DynamicAvoidance::ObstacleWrapper,std::__ndk1::allocator<DynamicAvoidance::ObstacleWrapper>> * this, ulong param_1)


/* std::__ndk1::vector<DynamicAvoidance::ObstacleWrapper,
   std::__ndk1::allocator<DynamicAvoidance::ObstacleWrapper> >::__append(unsigned long) */
