...
// Function: placeType
// Entry Point: 009c3630
// Size: 92 bytes
// Signature: undefined __thiscall placeType(ProceduralPlacementCacheManager * this, basic_string * param_1, uint param_2, uint param_3)


/* ProceduralPlacementCacheManager::placeType(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, unsigned int, unsigned
   int) */

void __thiscall
ProceduralPlacementCacheManager::placeType
...

{
  ...
  if (this + 0x10 != (ProceduralPlacementCacheManager *)(ulong)_Var1) {
    DistanceMatrixTypeField::addPoint
