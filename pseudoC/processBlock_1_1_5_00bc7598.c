...
// Function: processBlock_1_1_5
// Entry Point: 00bc7598
// Size: 1756 bytes
// Signature: undefined __cdecl processBlock_1_1_5(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_1_1_5(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_1_1_5(CustomCipher *param_1,uchar *param_2)

{
  ...
  uVar2 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar16 >> 8 ^ uVar3 >> 0x10) & 0x3f) * 4) |
           (&s_wPS)[(uVar16 >> 0xc ^ uVar3 >> 0x18) & 0x3f] |
           *(uint *)(&DAT_0211ea98 + (ulong)((uVar16 >> 4 ^ uVar3 >> 8) & 0x3f) * 4) |
          *(uint *)(&DAT_0211eb98 + (ulong)((uVar16 ^ uVar3) & 0x3f) * 4)) ^ uVar14 ^
  ...
  uVar1 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar16 >> 8 ^ uVar4 >> 0x10) & 0x3f) * 4) |
          ...
          *(uint *)(&DAT_0211eb98 + (ulong)((uVar16 ^ uVar4) & 0x3f) * 4)) ^ uVar1 ^
          (*(uint *)(&DAT_0211ed98 + (ulong)((uVar15 >> 0x10 ^ uVar2 >> 7) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ec98 + (ulong)((uVar15 >> 0x18 ^ uVar2 >> 0xb) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ee98 + (ulong)((uVar15 >> 8 ^ uVar2 >> 3) & 0x3f) * 4) |
          *(uint *)(&DAT_0211ef98 + (ulong)((uVar15 ^ uVar16 >> 0x10) & 0x3f) * 4));
  uVar4 = uVar1 >> 0xf | uVar1 << 0x11;
  uVar15 = *(uint *)(param_1 + 0x224);
  uVar2 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar4 >> 8 ^ uVar14 >> 0x10) & 0x3f) * 4) |
           (&s_wPS)[(uVar4 >> 0xc ^ uVar14 >> 0x18) & 0x3f] |
           *(uint *)(&DAT_0211ea98 + (ulong)((uVar4 >> 4 ^ uVar14 >> 8) & 0x3f) * 4) |
          *(uint *)(&DAT_0211eb98 + (ulong)((uVar4 ^ uVar14) & 0x3f) * 4)) ^ uVar2 ^
  ...
  uVar4 = (&s_wPS)[(uVar17 >> 0xc ^ uVar3 >> 0x18) & 0x3f];
  uVar14 = *(uint *)(&DAT_0211ea98 + (ulong)((uVar17 >> 4 ^ uVar3 >> 8) & 0x3f) * 4);
  uVar16 = *(uint *)(&DAT_0211e998 + (ulong)((uVar17 >> 8 ^ uVar3 >> 0x10) & 0x3f) * 4);
  uVar3 = *(uint *)(&DAT_0211eb98 + (ulong)((uVar17 ^ uVar3) & 0x3f) * 4);
  CVar8 = param_1[0x2b1];
  uVar18 = (ulong)(byte)CVar8;
  uVar5 = *(uint *)(&DAT_0211ec98 + (ulong)((uVar15 >> 0x18 ^ uVar2 >> 0xb) & 0x3f) * 4);
  uVar6 = *(uint *)(&DAT_0211ee98 + (ulong)((uVar15 >> 8 ^ uVar2 >> 3) & 0x3f) * 4);
  uVar7 = *(uint *)(&DAT_0211ed98 + (ulong)((uVar15 >> 0x10 ^ uVar2 >> 7) & 0x3f) * 4);
  uVar15 = *(uint *)(&DAT_0211ef98 + (ulong)((uVar15 ^ uVar17 >> 0x10) & 0x3f) * 4);
  ...
  CVar9 = param_1[0x2b2];
  uVar19 = uVar18 + (byte)CVar9 & 0xff;
  uVar1 = (uVar16 | uVar4 | uVar14 | uVar3) ^ uVar1 ^ (uVar7 | uVar5 | uVar6 | uVar15) ^
