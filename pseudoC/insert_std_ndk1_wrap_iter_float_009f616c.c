...
// Function: insert<std::__ndk1::__wrap_iter<float*>>
// Entry Point: 009f616c
// Size: 1012 bytes
// Signature: type __thiscall insert<std::__ndk1::__wrap_iter<float*>>(vector<float,std::__ndk1::allocator<float>> * this, __wrap_iter param_1, __wrap_iter param_2, __wrap_iter param_3)


/* std::__ndk1::enable_if<__is_cpp17_forward_iterator<std::__ndk1::__wrap_iter<float*>
   >::value&&is_constructible<float, std::__ndk1::iterator_traits<std::__ndk1::__wrap_iter<float*>
   >::reference>::value, std::__ndk1::__wrap_iter<float*> >::type std::__ndk1::vector<float,
   std::__ndk1::allocator<float> >::insert<std::__ndk1::__wrap_iter<float*>
   >(std::__ndk1::__wrap_iter<float const*>, std::__ndk1::__wrap_iter<float*>,
   std::__ndk1::__wrap_iter<float*>) */

type __thiscall
std::__ndk1::vector<float,std::__ndk1::allocator<float>>::insert<std::__ndk1::__wrap_iter<float*>>
          (vector<float,std::__ndk1::allocator<float>> *this,__wrap_iter param_1,__wrap_iter param_2
          ,__wrap_iter param_3)
    ...
    if (lVar16 < lVar18) {
      ...
      if (puVar5 != puVar3) {
        ...
        if ((0x1b < uVar4) &&
          ...
          if (uVar4 == uVar12) goto LAB_009f63f4;
        }
        do {
          puVar11 = puVar10 + 1;
          *puVar6 = *puVar10;
...
LAB_009f63f4:
      *(undefined4 **)(this + 8) = puVar7;
      puVar3 = puVar5;
      if ((long)uVar8 < 1) goto LAB_009f6528;
    }
    ...
    if (puVar5 < puVar1) {
      ...
      if (0x1b < uVar4) {
        ...
        if (((undefined4 *)((long)__src_00 + (lVar15 + (uVar17 >> 2)) * 4 + 4) <= puVar7) ||
          ...
          puVar10 = puVar6;
          if (uVar17 == uVar9) goto LAB_009f6500;
        }
      }
      do {
        puVar11 = puVar5 + 1;
...
LAB_009f6300:
    ...
    __src = __src + uVar12;
    if (uVar4 != uVar12) goto LAB_009f6300;
  }
  if (0 < (long)uVar17) {
