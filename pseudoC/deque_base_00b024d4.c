...
// Entry Point: 00b024d4
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<Streamable*,std::__ndk1::allocator<Streamable*>> * this)
...
void __thiscall
std::__ndk1::__deque_base<Streamable*,std::__ndk1::allocator<Streamable*>>::~__deque_base
          (__deque_base<Streamable*,std::__ndk1::allocator<Streamable*>> *this)

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_00b02540;
    uVar4 = 0x200;
  }
