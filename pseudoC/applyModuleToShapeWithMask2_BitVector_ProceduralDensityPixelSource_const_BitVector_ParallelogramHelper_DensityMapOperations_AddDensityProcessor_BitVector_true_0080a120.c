...
// Function: applyModuleToShapeWithMask2<BitVector,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
// Entry Point: 0080a120
// Size: 3508 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, ProceduralDensityPixelSource * param_3, BitVector * param_4, ParallelogramHelper * param_5, AddDensityProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)


/* bool DensityMapModifier::applyModuleToShapeWithMask2<BitVector, ProceduralDensityPixelSource
   const, BitVector, ParallelogramHelper, DensityMapOperations::AddDensityProcessor<BitVector, true>
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
    ...
    if (((uVar20 < local_98) || (uVar24 < local_94)) || ((uVar21 < local_94 || (uVar23 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar29 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar29 != 0
                    ...
                    /* try { // try from 0080ae98 to 0080aea3 has its CatchHandler @ 0080aed4 */
            ...
            do {
              ...
              if ((iVar29 == 2) || ((iVar29 == 0) != ((uVar28 & uVar15) != uVar4))) {
                ...
                if (((int)uVar28 < iVar5) || (iVar6 < (int)uVar28)) {
                  if (DVar12 != (DensityMapFilter)0x0) goto LAB_0080ac18;
                }
    ...
    do {
      ...
      if ((iVar8 == 2) || ((iVar8 == 0) != ((uVar35 & uVar17) != uVar9))) {
        ...
        if (((int)uVar35 < iVar10) || (iVar11 < (int)uVar35)) {
          if (DVar13 != (DensityMapFilter)0x0) goto LAB_0080ad48;
        }
...
LAB_0080ab50:
  uVar32 = uVar32 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar32) goto LAB_0080aae8;
  goto LAB_0080ab64;
}
