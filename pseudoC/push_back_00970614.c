...
/* std::__ndk1::__split_buffer<TextureStreamingManager::UpgradePipeline::ReallocateRequest*,
   std::__ndk1::allocator<TextureStreamingManager::UpgradePipeline::ReallocateRequest*>&>::push_back(TextureStreamingManager::UpgradePipeline::ReallocateRequest*&&)
    */
...

{
  ...
  if (ppRVar12 != *(ReallocateRequest ***)(this + 0x18)) goto LAB_00970794;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_0097077c;
      }
    }
    do {
      ppRVar11 = ppRVar8 + 1;
