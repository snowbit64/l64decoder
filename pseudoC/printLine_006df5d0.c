...
// Function: printLine
// Entry Point: 006df5d0
// Size: 248 bytes
// Signature: undefined __cdecl printLine(char * param_1, ...)


/* TextureStreamingStats::Printer::printLine(char const*, ...) */

void TextureStreamingStats::Printer::printLine(char *param_1,...)

{
  ...
  vsnprintf(acStack_838,0x800,in_x1,&local_860);
  local_39 = 0;
