...

{
  ...
  *pIVar2;
  ...
  if (pIVar2 == this + 0x70) {
    this[0xb1] = (IteratedHashWithStaticTransform<unsigned_int,CryptoPP::EnumToType<CryptoPP::ByteOrder,1>,64u,20u,CryptoPP::SHA1,0u,false>
                  )0x0;
  ...
  *(undefined ***)this = &PTR__IteratedHash_00fe9de8;
  ...
  if (pIVar2 == this + 0x10) {
    this[0x51] = (IteratedHashWithStaticTransform<unsigned_int,CryptoPP::EnumToType<CryptoPP::ByteOrder,1>,64u,20u,CryptoPP::SHA1,0u,false>
                  )0x0;
    for (; uVar1 != 0; uVar1 = uVar1 - 1) {
      *(undefined4 *)(pIVar2 + uVar1 * 4 + -4) = 0;
    }
