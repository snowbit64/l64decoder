...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 007e2d08
// Size: 4312 bytes
...
/* bool DensityMapModifier::applyModuleToShapeWithMask2<ChunkedBitSquare, ChunkedBitSquare,
   BitVector, ParallelogramHelper, DensityMapOperations::SetDensityProcessor<ChunkedBitSquare, true>
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
    ...
    if (((uVar19 < local_98) || (uVar23 < local_94)) || ((uVar20 < local_94 || (uVar22 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar33 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar33 != 0
                    ...
                    /* try { // try from 007e3da4 to 007e3daf has its CatchHandler @ 007e3de0 */
            ...
            do {
              ...
              do {
                ...
                if (*(uint *)(param_3 + 0x34) < 2) {
                  uVar46 = (ulong)*(uint *)(param_3 + 0x34);
                  if (iVar33 != 2) goto LAB_007e3a10;
LAB_007e3a30:
                  puVar1 = local_88;
                  uVar3 = uVar29 >> (ulong)(uVar5 & 0x1f) & uVar13;
                  if (((int)uVar3 < iVar28) || (iVar27 < (int)uVar3)) {
                    if (DVar10 != (DensityMapFilter)0x0) goto LAB_007e3a5c;
                  }
...
LAB_007e3a5c:
                  ...
                  if (iVar33 == 2) goto LAB_007e3a30;
LAB_007e3a10:
                  if ((iVar33 == 0) != ((uVar29 & uVar14) != uVar6)) goto LAB_007e3a30;
                }
                uVar31 = uVar31 + 1;
                uVar4 = uVar4 + 1;
              } while (uVar31 != uVar35);
...
LAB_007e3ae4:
  uVar31 = uVar31 + 1;
  uVar4 = uVar4 + uVar24;
  if (uVar31 == uVar20) goto LAB_007e3a9c;
  goto LAB_007e3af4;
LAB_007e3a9c:
  uVar38 = uVar38 + 1;
  uVar39 = uVar39 + uVar22 * uVar24;
  if (uVar38 == uVar37) goto LAB_007e38a8;
  goto LAB_007e3ab4;
}
