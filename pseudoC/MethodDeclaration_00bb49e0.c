...
// Entry Point: 00bb49e0
// Size: 120 bytes
// Signature: undefined __thiscall MethodDeclaration(MethodDeclaration * this, Type param_1, Type param_2, Type param_3, Type param_4, void * param_5, Type param_6, Type param_7, Type param_8, Type param_9, Type param_10, Type param_11, Type param_12, Type param_13, Type param_14, Type param_15, Type param_16, Type param_17)
...

{
  ...
  *(Type *)(this + 0x18) = param_10;
  *(Type *)(this + 0x24) = param_13;
  ...
  *(Type *)(this + 0x28) = param_14;
  *(Type *)(this + 0x2c) = param_15;
  *(Type *)(this + 0x1c) = param_11;
  *(Type *)(this + 0x20) = param_12;
  *(Type *)(this + 0x30) = param_16;
  *(Type *)(this + 0x34) = param_17;
  *(undefined8 *)(this + 0x60) = 0x40000000c;
  return;
}
