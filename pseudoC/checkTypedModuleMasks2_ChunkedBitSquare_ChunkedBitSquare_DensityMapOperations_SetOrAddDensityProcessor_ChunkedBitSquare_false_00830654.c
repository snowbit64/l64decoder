...
// Function: checkTypedModuleMasks2<ChunkedBitSquare,ChunkedBitSquare,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
// Entry Point: 00830654
// Size: 1508 bytes
...
bool DensityMapModifier::
     checkTypedModuleMasks2<ChunkedBitSquare,ChunkedBitSquare,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
...
joined_r0x00830770:
      ...
      TVar5 = param_1[0x98];
      if (*(int *)(param_1 + 0x94) < (int)uVar14) goto joined_r0x00830770;
      if (TVar5 != (TypedModuleWithMasks)0x0) {
        return false;
      }
    }
    ...
    pIVar15 = *(IDensityPixelSource **)(param_1 + 0xa8);
    if (pIVar15 == param_2) goto LAB_008307a4;
  }
...
joined_r0x00830758:
    ...
    TVar5 = param_1[200];
    if (*(int *)(param_1 + 0xc4) < (int)uVar14) goto joined_r0x00830758;
    if (TVar5 != (TypedModuleWithMasks)0x0) {
      return false;
    }
  }
...
LAB_008307f0:
          ...
          if ((*(IDensityPixelSource **)(param_1 + 0x78) == param_6) &&
            ...
            if ((int)uVar3 < *(int *)(param_1 + 0x90)) {
              TVar5 = param_1[0x98];
joined_r0x008309ac:
              if (TVar5 == (TypedModuleWithMasks)0x0) goto LAB_00830844;
            }
            else {
              TVar5 = param_1[0x98];
              if (*(int *)(param_1 + 0x94) < (int)uVar3) goto joined_r0x008309ac;
              if (TVar5 != (TypedModuleWithMasks)0x0) goto LAB_00830844;
            }
...
LAB_00830bd4:
          ...
          if ((*(IDensityPixelSource **)(param_1 + 0x78) == param_13) &&
            ...
            if ((int)uVar3 < *(int *)(param_1 + 0x90)) {
              TVar5 = param_1[0x98];
joined_r0x00830bc0:
              if (TVar5 == (TypedModuleWithMasks)0x0) goto LAB_00830a58;
            }
            else {
              TVar5 = param_1[0x98];
              if (*(int *)(param_1 + 0x94) < (int)uVar3) goto joined_r0x00830bc0;
              if (TVar5 != (TypedModuleWithMasks)0x0) goto LAB_00830a58;
            }
            if ((*(uint *)(param_1 + 0x9c) == 0) || ((*(uint *)(param_1 + 0x9c) & uVar3) != 0))
            goto LAB_00830bd4;
