...
// Function: FUN_0078f484
// Entry Point: 0078f484
// Size: 172 bytes
// Signature: undefined FUN_0078f484(void)


void FUN_0078f484(char **param_1)

{
  ...
  if (((UserBlockManager::getInstance()::instance & 1) == 0) &&
     (iVar2 = __cxa_guard_acquire(&UserBlockManager::getInstance()::instance), iVar2 != 0)) {
                    /* try { // try from 0078f4f8 to 0078f503 has its CatchHandler @ 0078f530 */
  ...
  uVar1 = UserBlockManager::getAllowVoiceCommunicationWithUser
