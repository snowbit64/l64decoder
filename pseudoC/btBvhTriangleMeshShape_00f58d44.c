...
// Entry Point: 00f58d44
// Size: 304 bytes
// Signature: undefined __thiscall btBvhTriangleMeshShape(btBvhTriangleMeshShape * this, btStridingMeshInterface * param_1, bool param_2, btVector3 * param_3, btVector3 * param_4, bool param_5)
  ...
  *(undefined ***)this = &PTR__btBvhTriangleMeshShape_01019ef0;
  if (param_5) {
    ...
    *(undefined8 **)(this + 0x48) = this_00;
    btOptimizedBvh::build((btOptimizedBvh *)this_00,param_1,(bool)bVar1,param_3,param_4);
