...
// Function: applyModuleToShapeWithMask2<BitVector,BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
// Entry Point: 0081ea08
// Size: 3564 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>(IDensityPixelSource * param_1, BitVector * param_2, BitVector * param_3, ProceduralDensityPixelSource * param_4, ParallelogramHelper * param_5, SetTypeProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
    ...
    if (((uVar20 < local_98) || (uVar25 < local_94)) || ((uVar21 < local_94 || (uVar24 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar29 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar29 != 0
                    ...
                    /* try { // try from 0081f7b8 to 0081f7c3 has its CatchHandler @ 0081f7f4 */
            ...
            do {
              ...
              if ((iVar29 == 2) || ((iVar29 == 0) != ((uVar35 & uVar15) != uVar4))) {
                ...
                if (((int)uVar35 < iVar5) || (iVar6 < (int)uVar35)) {
                  if (DVar12 != (DensityMapFilter)0x0) goto LAB_0081f58c;
                }
    ...
    do {
      ...
      if ((iVar10 == 2) || ((iVar10 == 0) != ((uVar28 & uVar17) != uVar26))) {
        ...
        if (((int)uVar28 < iVar8) || (iVar9 < (int)uVar28)) {
          if (DVar13 != (DensityMapFilter)0x0) goto LAB_0081f658;
        }
...
LAB_0081f46c:
  uVar32 = uVar32 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar32) goto LAB_0081f404;
  goto LAB_0081f480;
}
