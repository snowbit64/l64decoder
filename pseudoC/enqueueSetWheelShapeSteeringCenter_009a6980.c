...
// Function: enqueueSetWheelShapeSteeringCenter
// Entry Point: 009a6980
// Size: 200 bytes
// Signature: undefined __thiscall enqueueSetWheelShapeSteeringCenter(Bt2ScenegraphPhysicsContext * this, TransformGroup * param_1, uint param_2, Vector3 * param_3)


/* Bt2ScenegraphPhysicsContext::enqueueSetWheelShapeSteeringCenter(TransformGroup*, unsigned int,
   Vector3 const&) */
  ...
  if (param_1 != (TransformGroup *)0x0) {
    ...
    if ((*(uint *)(lVar2 + 8) & 3) != 0) {
      ...
      if ((this[0x488] == (Bt2ScenegraphPhysicsContext)0x0) && ((*(uint *)(lVar2 + 8) & 1) != 0)) {
        setWheelShapeSteeringCenter(this,param_1,(SetWheelSteeringCenter *)&local_88);
      }
      else {
