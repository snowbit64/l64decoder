...
// Entry Point: 009309d0
// Size: 252 bytes
// Signature: undefined __thiscall cookConvexMesh(PhysicsCookingInterface * this, IndexedTriangleSet * param_1, bool param_2, Vector3 * param_3, uchar * * param_4, uint * param_5)


/* I3DSaveUtil::PhysicsCookingInterface::cookConvexMesh(IndexedTriangleSet*, bool, Vector3 const&,
   unsigned char*&, unsigned int&) */

uint __thiscall
I3DSaveUtil::PhysicsCookingInterface::cookConvexMesh
