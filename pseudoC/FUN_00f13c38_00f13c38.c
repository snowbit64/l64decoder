...
// Function: FUN_00f13c38
// Entry Point: 00f13c38
// Size: 200 bytes
// Signature: undefined FUN_00f13c38(void)


undefined8 FUN_00f13c38(lua_State *param_1)

{
  ...
  if (local_260 == 0) {
    ...
    if (*(long *)(lVar3 + 0x28) != local_38) goto LAB_00f13cfc;
  }
  else {
    uVar6 = 0;
    do {
