...
// Function: construct<FoliageSystemDesc::MultiLayer,FoliageSystemDesc::MultiLayer_const&>
// Entry Point: 00a68c8c
// Size: 124 bytes
// Signature: void __thiscall construct<FoliageSystemDesc::MultiLayer,FoliageSystemDesc::MultiLayer_const&>(allocator<FoliageSystemDesc::MultiLayer> * this, MultiLayer * param_1, MultiLayer * param_2)


/* void 
   std::__ndk1::allocator<FoliageSystemDesc::MultiLayer>::construct<FoliageSystemDesc::MultiLayer,
   FoliageSystemDesc::MultiLayer const&>(FoliageSystemDesc::MultiLayer*,
   FoliageSystemDesc::MultiLayer const&) */
  ...
  *(undefined8 *)(param_1 + 0x10) = 0;
  ...
  if (lVar2 != 0) {
    FUN_00f276d0(1,lVar2 + 8);
                    ...
                    /* try { // try from 00a68cc8 to 00a68cf3 has its CatchHandler @ 00a68d08 */
