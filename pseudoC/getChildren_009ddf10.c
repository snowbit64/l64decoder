...
// Entry Point: 009ddf10
// Size: 380 bytes
// Signature: undefined __thiscall getChildren(ProceduralPlacementRaycastObjectsMask * this, vector * param_1, TransformGroup * param_2)


/* ProceduralPlacementRaycastObjectsMask::getChildren(std::__ndk1::vector<TransformGroup*,
   std::__ndk1::allocator<TransformGroup*> >&, TransformGroup*) */

void __thiscall
ProceduralPlacementRaycastObjectsMask::getChildren
          (ProceduralPlacementRaycastObjectsMask *this,vector *param_1,TransformGroup *param_2)
