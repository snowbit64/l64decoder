...
// Function: FUN_00d0f76c
// Entry Point: 00d0f76c
// Size: 440 bytes
// Signature: undefined FUN_00d0f76c(void)


void FUN_00d0f76c(void **param_1,undefined8 *param_2)

{
  ...
  if (puVar12 != (undefined8 *)param_1[3]) goto LAB_00d0f8ec;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00d0f8d4;
      }
    }
    do {
      puVar11 = puVar8 + 1;
