...
// Function: infof
// Entry Point: 00b2a9c4
// Size: 188 bytes
// Signature: undefined __thiscall infof(Logger * this, char * param_1, __va_list param_2)


/* Logger::infof(char const*, std::__va_list) */

Logger * __thiscall Logger::infof(Logger *this,char *param_1,__va_list param_2)

{
  ...
  if (uVar1 != 0) {
    pplVar6 = (long **)(this + 8);
    do {
      (**(code **)(**pplVar6 + 0x10))(*pplVar6,acStack_4048,uVar3);
      uVar5 = uVar5 - 1;
      pplVar6 = pplVar6 + 1;
    } while (uVar5 != 0);
  }
