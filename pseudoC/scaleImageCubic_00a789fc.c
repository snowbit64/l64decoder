...
// Entry Point: 00a789fc
// Size: 204 bytes
// Signature: undefined __thiscall scaleImageCubic(BitmapImage * this, uint param_1, uint param_2, CubicType param_3)


/* BitmapImage::scaleImageCubic(unsigned int, unsigned int, ImageScale::CubicType) */

undefined8 __thiscall
BitmapImage::scaleImageCubic(BitmapImage *this,uint param_1,uint param_2,CubicType param_3)
