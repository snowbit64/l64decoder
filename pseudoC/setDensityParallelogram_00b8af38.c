...
// Function: setDensityParallelogram
// Entry Point: 00b8af38
// Size: 416 bytes
// Signature: undefined __thiscall setDensityParallelogram(DensityMapOldOperations * this, Parallelogram * param_1, uint param_2, uint param_3, int param_4, OPERATION param_5, uint param_6, int param_7, int param_8, uint param_9, uint param_10, uint param_11, uint param_12, uint * param_13, uint * param_14)


/* DensityMapOldOperations::setDensityParallelogram(DensityMapOperationShapes::Parallelogram const&,
...
void __thiscall
DensityMapOldOperations::setDensityParallelogram
          ...
          uint param_10,uint param_11,uint param_12,uint *param_13,uint *param_14)

{
  ...
  uVar3 = DensityMapOperations::setDensity<ParallelogramHelper>
                    (aPStack_d0,(DensityMapFilter *)&local_100,(DensityMapFilter *)0x0,
                     (DensityMapFilter *)0x0,param_11,param_12,param_4,param_13,param_14);
