...
// Entry Point: 00cb2658
// Size: 156 bytes
// Signature: undefined __cdecl CascadeExponentiateBaseAndPublicElement(Integer * param_1, Integer * param_2)


/* CryptoPP::DL_PublicKey<CryptoPP::ECPPoint>::CascadeExponentiateBaseAndPublicElement(CryptoPP::Integer
   const&, CryptoPP::Integer const&) const */

void CryptoPP::DL_PublicKey<CryptoPP::ECPPoint>::CascadeExponentiateBaseAndPublicElement
...

{
  ...
  uVar4 = (**(code **)(*(long *)param_1 + 0x40))(param_1);
                    /* WARNING: Could not recover jumptable at 0x00cb26f0. Too many branches */
