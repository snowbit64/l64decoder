...
// Function: callStringFromIntrefInt
// Entry Point: 00c6c1a8
// Size: 264 bytes
// Signature: undefined __thiscall callStringFromIntrefInt(AndroidJNICall * this, char * param_1, char * param_2, uint * param_3, uint * param_4, uint param_5)


/* AndroidJNICall::callStringFromIntrefInt(char const*, char*, unsigned int&, unsigned int&,
   unsigned int) */

void __thiscall
AndroidJNICall::callStringFromIntrefInt
...

{
  ...
  p_Var4 = (_jstring *)
           _JNIEnv::CallObjectMethod
                     ((_jobject *)plVar1,*(_jmethodID **)(this + 0x48),uVar2,uVar3,(ulong)param_5);
