...
// Entry Point: 00ccc060
// Size: 364 bytes
// Signature: undefined __thiscall GetValueHelperClass(GetValueHelperClass<CryptoPP::DL_GroupParameters<CryptoPP::EC2NPoint>,CryptoPP::DL_GroupParameters<CryptoPP::EC2NPoint>> * this, DL_GroupParameters * param_1, char * param_2, type_info * param_3, void * param_4, NameValuePairs * param_5)


/* CryptoPP::GetValueHelperClass<CryptoPP::DL_GroupParameters<CryptoPP::EC2NPoint>,
   CryptoPP::DL_GroupParameters<CryptoPP::EC2NPoint>
   >::GetValueHelperClass(CryptoPP::DL_GroupParameters<CryptoPP::EC2NPoint> const*, char const*,
...

{
  ...
  *(undefined2 *)(this + 0x20) = 0;
  ...
  if ((iVar3 == 0) &&
     (iVar3 = strcmp(param_2 + 0xc,"N8CryptoPP18DL_GroupParametersINS_9EC2NPointEEE"), iVar3 == 0))
  {
    NameValuePairs::ThrowIfTypeMismatch
              (param_2,(type_info *)&DL_GroupParameters<CryptoPP::EC2NPoint>*::typeinfo,
               *(type_info **)(this + 0x10));
    GVar5 = (GetValueHelperClass<CryptoPP::DL_GroupParameters<CryptoPP::EC2NPoint>,CryptoPP::DL_GroupParameters<CryptoPP::EC2NPoint>>
             )0x1;
