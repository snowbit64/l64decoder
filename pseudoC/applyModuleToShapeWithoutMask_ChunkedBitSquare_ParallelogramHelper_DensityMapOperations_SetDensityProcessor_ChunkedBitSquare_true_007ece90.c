...
// Function: applyModuleToShapeWithoutMask<ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 007ece90
// Size: 708 bytes
// Signature: bool __cdecl applyModuleToShapeWithoutMask<ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>(IDensityPixelSource * param_1, ChunkedBitSquare * param_2, ParallelogramHelper * param_3, SetDensityProcessor * param_4)
...
/* bool DensityMapModifier::applyModuleToShapeWithoutMask<ChunkedBitSquare, ParallelogramHelper,
   ...
   DensityMapOperations::SetDensityProcessor<ChunkedBitSquare, true>&) */

bool DensityMapModifier::
     applyModuleToShapeWithoutMask<ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
...

{
      ...
      if (uVar12 < *(uint *)(param_3 + 0x5c)) {
        do {
          ...
          DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>::process
                    ((SetDensityProcessor<ChunkedBitSquare,true> *)param_4,(HelperSource *)&local_90
                    );
          uVar3 = local_70;
          puVar6 = local_80;
          if (uVar7 != local_70) {
  ...
  if (param_4[100] != (SetDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_3 + 0x54),uVar12,*(uint *)(param_4 + 0x1c),*(uint *)(param_4 + 0x20),
