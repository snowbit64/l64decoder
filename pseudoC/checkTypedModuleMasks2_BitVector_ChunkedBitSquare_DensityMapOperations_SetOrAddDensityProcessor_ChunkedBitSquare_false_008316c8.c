...
// Function: checkTypedModuleMasks2<BitVector,ChunkedBitSquare,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
// Entry Point: 008316c8
// Size: 1448 bytes
// Signature: bool __cdecl checkTypedModuleMasks2<BitVector,ChunkedBitSquare,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>(TypedModuleWithMasks * param_1, IDensityPixelSource * param_2, uint param_3, uint param_4, HelperSource * param_5, IDensityPixelSource * param_6, uint param_7, uint param_8, uint param_9, uint param_10, uint param_11, HelperSource * param_12, IDensityPixelSource * param_13, uint param_14, uint param_15, uint param_16, uint param_17, uint param_18)
...
bool DensityMapModifier::
     checkTypedModuleMasks2<BitVector,ChunkedBitSquare,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
...
joined_r0x008317e8:
      ...
      TVar9 = param_1[0x98];
      if (*(int *)(param_1 + 0x94) < (int)uVar27) goto joined_r0x008317e8;
      if (TVar9 != (TypedModuleWithMasks)0x0) {
        return false;
      }
    }
    ...
    local_80 = *(IDensityPixelSource **)(param_1 + 0xa8);
    if (local_80 == param_2) goto LAB_0083181c;
  }
...
joined_r0x008317d0:
    ...
    TVar9 = param_1[200];
    if (*(int *)(param_1 + 0xc4) < (int)uVar27) goto joined_r0x008317d0;
    if (TVar9 != (TypedModuleWithMasks)0x0) {
      return false;
    }
  }
          ...
          *(uint *)(param_5 + 0x20) = uVar16;
          if ((bool)(bVar11 | pIVar19 != param_6)) {
            ...
            if (((int)uVar16 < iVar15) || (iVar6 < (int)uVar16)) {
              if (TVar9 != (TypedModuleWithMasks)0x0) goto LAB_00831bfc;
            }
...
LAB_00831a5c:
        ...
        if ((*(IDensityPixelSource **)(param_1 + 0x78) == param_13) &&
          ...
          if ((int)uVar25 < *(int *)(param_1 + 0x90)) {
            TVar9 = param_1[0x98];
joined_r0x00831a48:
            if (TVar9 == (TypedModuleWithMasks)0x0) goto LAB_008318e0;
          }
          else {
            TVar9 = param_1[0x98];
            if (*(int *)(param_1 + 0x94) < (int)uVar25) goto joined_r0x00831a48;
            if (TVar9 != (TypedModuleWithMasks)0x0) goto LAB_008318e0;
          }
