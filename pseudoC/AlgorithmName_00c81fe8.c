...
void CryptoPP::CipherModeFinalTemplate_ExternalCipher<CryptoPP::CBC_Decryption>::AlgorithmName(void)

{
  ...
  if (lVar5 == 0) {
    ...
    (**(code **)(*(long *)(lVar5 + 8) + 0x18))(local_68);
                    /* try { // try from 00c82028 to 00c82037 has its CatchHandler @ 00c820cc */
    ...
    *puVar2 = 0;
                    ...
                    /* try { // try from 00c82058 to 00c82067 has its CatchHandler @ 00c820d4 */
  puVar3 = (undefined8 *)
           std::__ndk1::
