...
// Entry Point: 00f0389c
// Size: 248 bytes
// Signature: undefined __cdecl lua_rawequal(lua_State * param_1, int param_2, int param_3)


/* lua_rawequal(lua_State*, int, int) */

undefined8 lua_rawequal(lua_State *param_1,int param_2,int param_3)
