...
// Entry Point: 00bb3b88
// Size: 44 bytes
// Signature: undefined __thiscall MethodDeclaration(MethodDeclaration * this, Type param_1, void * param_2, Type param_3, Type param_4, Type param_5, Type param_6)
...

{
  ...
  *(undefined8 *)(this + 0x60) = 0x100000004;
