...
// Function: getAabb
// Entry Point: 00f61a3c
// Size: 300 bytes
// Signature: undefined __thiscall getAabb(btConvexInternalAabbCachingShape * this, btTransform * param_1, btVector3 * param_2, btVector3 * param_3)


/* btConvexInternalAabbCachingShape::getAabb(btTransform const&, btVector3&, btVector3&) const */

void __thiscall
btConvexInternalAabbCachingShape::getAabb
          (btConvexInternalAabbCachingShape *this,btTransform *param_1,btVector3 *param_2,
          btVector3 *param_3)

{
  ...
  fVar3 = (*(float *)(this + 0x44) + *(float *)(this + 0x54)) * 0.5;
  fVar9 = *(float *)(param_1 + 0x10);
  fVar12 = (float)NEON_fmadd(*(float *)(this + 0x54) - *(float *)(this + 0x44),0x3f000000,uVar1);
  fVar6 = (*(float *)(this + 0x48) + *(float *)(this + 0x58)) * 0.5;
  uVar17 = *(undefined8 *)(param_1 + 8);
  fVar11 = *(float *)(param_1 + 0x14);
  fVar16 = (float)NEON_fmadd(*(float *)(this + 0x58) - *(float *)(this + 0x48),0x3f000000,uVar1);
  fVar14 = (*(float *)(this + 0x4c) + *(float *)(this + 0x5c)) * 0.5;
  fVar19 = *(float *)(param_1 + 0x28);
  fVar18 = *(float *)(param_1 + 0x18);
  uVar4 = NEON_fmadd(*(float *)(param_1 + 0x24),fVar6,*(float *)(param_1 + 0x20) * fVar3);
  fVar2 = (float)NEON_fmadd(*(float *)(this + 0x5c) - *(float *)(this + 0x4c),0x3f000000,uVar1);
