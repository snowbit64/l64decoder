...
// Entry Point: 00addab8
// Size: 264 bytes
// Signature: undefined spvReflectGetEntryPointOutputVariableBySemantic(void)
...
LAB_00addb84:
      ...
      if ((param_2 != (char *)0x0) &&
        ...
        pplVar6 = (long **)(*(long *)(param_1 + 0x18) + 0x28);
        do {
          iVar1 = strcmp((char *)pplVar6[-5],param_2);
          if (iVar1 == 0) {
            uVar5 = (ulong)*(uint *)(pplVar6 + -1);
            if (*(uint *)(pplVar6 + -1) != 0) {
              plVar7 = *pplVar6;
              lVar4 = 0;
              do {
