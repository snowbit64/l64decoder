...
/* PriorityQueue<GeometryUtil::_optimiseTriangles<unsigned short>(unsigned int, unsigned int,
   ...
   short*)::TriangleScore, unsigned int*> > > >::updateKey(unsigned int,
   GeometryUtil::_optimiseTriangles<unsigned short>(unsigned int, unsigned int, unsigned int,
   unsigned short const*, unsigned short*)::TriangleScore const&) */
