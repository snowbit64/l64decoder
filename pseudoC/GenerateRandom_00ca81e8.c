...

{
  ...
  bVar2 = NameValuePairs::GetThisObject<CryptoPP::DL_GroupParameters_EC<CryptoPP::ECP>>
  ...
  (**(code **)(*plVar4 + 0xa8))(local_a8);
                    /* try { // try from 00ca826c to 00ca8297 has its CatchHandler @ 00ca835c */
  ...
  for (; local_98 != 0; local_98 = local_98 - 1) {
    *(undefined4 *)((long)local_88 + local_98 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00ca82d0 to 00ca82d3 has its CatchHandler @ 00ca8358 */
  UnalignedDeallocate(local_88);
                    /* try { // try from 00ca82dc to 00ca82e7 has its CatchHandler @ 00ca834c */
  ...
  for (; local_68 != 0; local_68 = local_68 - 1) {
    *(undefined4 *)((long)local_58 + local_68 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00ca8318 to 00ca831b has its CatchHandler @ 00ca8348 */
