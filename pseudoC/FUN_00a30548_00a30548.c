...
// Function: FUN_00a30548
// Entry Point: 00a30548
// Size: 788 bytes
// Signature: undefined FUN_00a30548(void)


uint FUN_00a30548(ulong *param_1,ulong *param_2,ulong *param_3,ulong *param_4,ulong *param_5,
...

{
  ...
  uVar6 = uVar5;
  if (*(float *)(param_5 + 4) == *(float *)(param_4 + 4)) {
    ...
    if ((((uVar1 == uVar2) && (bVar4 = param_4[1] <= param_5[1], param_5[1] == param_4[1])) &&
      ...
      if (*(uint *)((long)param_4 + 0x24) >> 0x1f <= *(uint *)((long)param_5 + 0x24) >> 0x1f)
      goto LAB_00a307bc;
    }
    else if (bVar4) goto LAB_00a307bc;
  }
  else if (*(float *)(param_5 + 4) <= *(float *)(param_4 + 4)) goto LAB_00a307bc;
  uVar11 = *param_5;
  uVar10 = param_5[3];
  uVar9 = param_5[2];
  uVar13 = param_4[1];
  ...
  *param_5 = uVar12;
  param_5[3] = uVar15;
  param_5[2] = uVar14;
  if (*(float *)(param_4 + 4) == *(float *)(param_3 + 4)) {
    ...
    if (((uVar1 == uVar2) && (bVar4 = param_3[1] <= param_4[1], param_4[1] == param_3[1])) &&
      ...
      if (*(uint *)((long)param_3 + 0x24) >> 0x1f <= *(uint *)((long)param_4 + 0x24) >> 0x1f)
      goto LAB_00a307bc;
    }
    else if (bVar4) goto LAB_00a307bc;
  }
  else if (*(float *)(param_4 + 4) <= *(float *)(param_3 + 4)) goto LAB_00a307bc;
  uVar11 = *param_4;
  uVar10 = param_4[3];
  uVar9 = param_4[2];
  uVar13 = param_3[1];
  ...
  *param_4 = uVar12;
  ...
  if (*(float *)(param_3 + 4) == *(float *)(param_2 + 4)) {
    ...
    if ((((uVar1 == uVar2) && (bVar4 = param_2[1] <= param_3[1], param_3[1] == param_2[1])) &&
      ...
      if (*(uint *)((long)param_2 + 0x24) >> 0x1f <= *(uint *)((long)param_3 + 0x24) >> 0x1f)
      goto LAB_00a307bc;
    }
    else if (bVar4) goto LAB_00a307bc;
  }
  else if (*(float *)(param_3 + 4) <= *(float *)(param_2 + 4)) goto LAB_00a307bc;
  uVar11 = *param_3;
  uVar10 = param_3[3];
  uVar9 = param_3[2];
  uVar13 = param_2[1];
  ...
  *param_3 = uVar12;
  ...
  if (*(float *)(param_2 + 4) == *(float *)(param_1 + 4)) {
    ...
    if (((uVar1 == uVar2) && (bVar4 = param_1[1] <= param_2[1], param_2[1] == param_1[1])) &&
      ...
      if (*(uint *)((long)param_1 + 0x24) >> 0x1f <= *(uint *)((long)param_2 + 0x24) >> 0x1f)
      goto LAB_00a307bc;
    }
    else if (bVar4) goto LAB_00a307bc;
  }
  else if (*(float *)(param_2 + 4) <= *(float *)(param_1 + 4)) goto LAB_00a307bc;
  uVar11 = *param_2;
  uVar10 = param_2[3];
  uVar9 = param_2[2];
  uVar13 = param_1[1];
