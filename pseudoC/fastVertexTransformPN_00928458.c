...
// Function: fastVertexTransformPN
// Entry Point: 00928458
// Size: 280 bytes
// Signature: undefined __cdecl fastVertexTransformPN(float * param_1, uchar * param_2, uchar * param_3, uint param_4, uint param_5)


/* fastVertexTransformPN(float*, unsigned char*, unsigned char*, unsigned int, unsigned int) */

void fastVertexTransformPN(float *param_1,uchar *param_2,uchar *param_3,uint param_4,uint param_5)
