...
// Function: FUN_00ec8c24
// Entry Point: 00ec8c24
// Size: 684 bytes
// Signature: undefined FUN_00ec8c24(void)


ulong FUN_00ec8c24(uint *param_1,uint *param_2,uint *param_3,uint *param_4,long *param_5)

{
  ...
  lVar2 = param_5[1];
  uVar6 = uVar3 * 3;
  lVar10 = (ulong)*(uint *)((long)param_5 + 0x14) * 8;
  uVar4 = *param_3;
  uVar7 = uVar4 * 3;
