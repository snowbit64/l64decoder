...
// Function: applyModuleToShapeWithMask<BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
// Entry Point: 0080bbc4
// Size: 2464 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask<BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, ChunkedBitSquare * param_3, ParallelogramHelper * param_4, AddDensityProcessor * param_5, DensityMapFilter * param_6)
...
/* bool DensityMapModifier::applyModuleToShapeWithMask<BitVector, ChunkedBitSquare,
   ...
   >(IDensityPixelSource*, BitVector*, ChunkedBitSquare*, ParallelogramHelper&,
   DensityMapOperations::AddDensityProcessor<BitVector, true>&, DensityMapFilter const&) */

bool DensityMapModifier::
     applyModuleToShapeWithMask<BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
    ...
    if ((uVar16 < uVar14) || (uVar17 < uVar15)) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar23 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar23 != 0
                    ...
                    /* try { // try from 0080c520 to 0080c527 has its CatchHandler @ 0080c574 */
        this = (Logger *)operator_new(0x38);
                    /* try { // try from 0080c52c to 0080c52f has its CatchHandler @ 0080c564 */
        Logger::Logger(this);
            ...
            do {
              ...
              do {
                ...
                if (*(uint *)(param_3 + 0x34) < 2) {
                  uVar31 = (ulong)*(uint *)(param_3 + 0x34);
                  if (iVar23 != 2) goto LAB_0080c37c;
LAB_0080c39c:
                  uVar4 = uVar21 >> (ulong)(uVar5 & 0x1f) & uVar10;
                  if (((int)uVar4 < iVar20) || (iVar7 < (int)uVar4)) {
                    if (DVar8 != (DensityMapFilter)0x0) goto LAB_0080c3c8;
                  }
...
LAB_0080c3c8:
                    if ((uVar18 == 0) || ((uVar4 & uVar18) != 0)) {
                      ...
                      DensityMapOperations::AddDensityProcessor<BitVector,true>::process
                                ((AddDensityProcessor<BitVector,true> *)param_5,
                  ...
                  if (iVar23 == 2) goto LAB_0080c39c;
LAB_0080c37c:
                  if ((iVar23 == 0) != ((uVar21 & uVar11) != uVar6)) goto LAB_0080c39c;
                }
                uVar28 = uVar28 + 1;
                uVar2 = uVar2 + 1;
              } while (uVar28 != uVar26);
        ...
        if (uVar15 < *(uint *)(param_4 + 0x5c)) {
          ...
          do {
            ...
            if ((((iVar23 == 2) || ((iVar23 == 0) != ((uVar19 & uVar11) != uVar6))) &&
              ...
              local_78 = uVar17;
              DensityMapOperations::AddDensityProcessor<BitVector,true>::process
                        ((AddDensityProcessor<BitVector,true> *)param_5,(HelperSource *)&local_98);
              if (uVar17 != local_78) {
                DensityMapAccessUtil::writeValue
