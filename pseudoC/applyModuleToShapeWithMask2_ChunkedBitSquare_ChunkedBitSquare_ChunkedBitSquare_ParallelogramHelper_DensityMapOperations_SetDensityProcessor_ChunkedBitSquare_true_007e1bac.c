...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 007e1bac
// Size: 4420 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
    ...
    if (((uVar20 < local_98) || (uVar24 < local_94)) || ((uVar21 < local_94 || (uVar23 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar33 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar33 != 0
                    ...
                    /* try { // try from 007e2ca4 to 007e2cb7 has its CatchHandler @ 007e2cf0 */
          ...
          do {
            ...
            do {
              ...
              if (*(uint *)(param_3 + 0x34) < 2) {
                uVar41 = (ulong)*(uint *)(param_3 + 0x34);
                if (iVar33 != 2) goto LAB_007e28a0;
LAB_007e28c0:
                uVar5 = uVar29 >> (ulong)(uVar6 & 0x1f) & uVar14;
                if (((int)uVar5 < iVar27) || (iVar28 < (int)uVar5)) {
                  if (DVar11 != (DensityMapFilter)0x0) goto LAB_007e28ec;
                }
...
LAB_007e28ec:
                ...
                if (iVar33 == 2) goto LAB_007e28c0;
LAB_007e28a0:
                if ((iVar33 == 0) != ((uVar29 & uVar15) != uVar7)) goto LAB_007e28c0;
              }
              uVar31 = uVar31 + 1;
              uVar3 = uVar3 + 1;
            } while (uVar31 != uVar36);
...
LAB_007e2a58:
      ...
      if (iVar9 == 2) goto LAB_007e2a58;
LAB_007e2a38:
      if ((iVar9 == 0) != ((uVar29 & uVar17) != uVar10)) goto LAB_007e2a58;
LAB_007e2964:
      uVar31 = uVar31 + 1;
      uVar3 = uVar3 + 1;
    } while (uVar31 != uVar21);
...
LAB_007e2750:
  uVar37 = uVar37 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar37) goto LAB_007e26ec;
  goto LAB_007e2768;
}
