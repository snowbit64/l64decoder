...
// Entry Point: 00971f94
// Size: 268 bytes
// Signature: ulong __thiscall __erase_unique<unsigned_long_long>(__hash_table<unsigned_long_long,std::__ndk1::hash<unsigned_long_long>,std::__ndk1::equal_to<unsigned_long_long>,std::__ndk1::allocator<unsigned_long_long>> * this, ulonglong * param_1)


/* unsigned long std::__ndk1::__hash_table<unsigned long long, std::__ndk1::hash<unsigned long
