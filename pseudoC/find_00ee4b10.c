...
// Function: find
// Entry Point: 00ee4b10
// Size: 112 bytes
// Signature: undefined __thiscall find(DenseHashMap<Luau::AstLocal*,Luau::Compile::Constant,Luau::DenseHashPointer,std::__ndk1::equal_to<Luau::AstLocal*>> * this, AstLocal * * param_1)


/* Luau::DenseHashMap<Luau::AstLocal*, Luau::Compile::Constant, Luau::DenseHashPointer,
  ...
  if (*(long *)(this + 0x10) != 0) {
    ...
    if (pAVar2 != *(AstLocal **)(this + 0x18)) {
      ...
      do {
        ...
        ppAVar5 = (AstLocal **)(*(long *)this + uVar4 * 0x18);
        if (*ppAVar5 == pAVar2) goto LAB_00ee4b70;
