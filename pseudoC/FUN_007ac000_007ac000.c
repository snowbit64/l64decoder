...
// Function: FUN_007ac000
// Entry Point: 007ac000
// Size: 1108 bytes
// Signature: undefined FUN_007ac000(void)


void FUN_007ac000(GsMaterial *param_1,char **param_2)

{
  ...
  FUN_007aacb0(param_1,uVar6,pRVar5,"gloss map",0);
  if (*(char *)(param_2 + 6) == '\0') {
    local_2a8 = 1;
    ...
    uStack_290 = SUB84(pRVar5,0);
    uStack_28c = (undefined4)((ulong)pRVar5 >> 0x20);
    ...
    GsMaterial::setGlossMap(param_1,(Texture *)pRVar5);
