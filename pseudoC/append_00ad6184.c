...
// Function: __append
// Entry Point: 00ad6184
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<VkSurfaceFormatKHR,std::__ndk1::allocator<VkSurfaceFormatKHR>> * this, ulong param_1)


/* std::__ndk1::vector<VkSurfaceFormatKHR, std::__ndk1::allocator<VkSurfaceFormatKHR>
   >::__append(unsigned long) */

void __thiscall
std::__ndk1::vector<VkSurfaceFormatKHR,std::__ndk1::allocator<VkSurfaceFormatKHR>>::__append
          (vector<VkSurfaceFormatKHR,std::__ndk1::allocator<VkSurfaceFormatKHR>> *this,ulong param_1
          )
