...
// Entry Point: 00a4eeb4
// Size: 64 bytes
// Signature: undefined __cdecl setVolumeImpl(float param_1)


/* AudioSourceSample::setVolumeImpl(float) */

void AudioSourceSample::setVolumeImpl(float param_1)

{
  ...
  if (*(long **)(puVar1 + 0xc) != (long *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00a4eeec. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(**(long **)(puVar1 + 0xc) + 0x50))();
    return;
  }
  return;
}
