...
// Entry Point: 00f61efc
// Size: 228 bytes
// Signature: undefined __cdecl localGetSupportingVertex(btVector3 * param_1)


/* btConvexPointCloudShape::localGetSupportingVertex(btVector3 const&) const */

undefined4 btConvexPointCloudShape::localGetSupportingVertex(btVector3 *param_1)
