...
// Function: applyModuleToShapeWithMask<ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 007eae04
// Size: 2904 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask<ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>(IDensityPixelSource * param_1, ChunkedBitSquare * param_2, ChunkedBitSquare * param_3, ParallelogramHelper * param_4, SetDensityProcessor * param_5, DensityMapFilter * param_6)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask<ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
    ...
    if ((uVar15 < uVar13) || (uVar16 < uVar14)) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar24 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar24 != 0
                    ...
                    /* try { // try from 007eb918 to 007eb91f has its CatchHandler @ 007eb96c */
        this = (Logger *)operator_new(0x38);
                    /* try { // try from 007eb924 to 007eb927 has its CatchHandler @ 007eb95c */
        Logger::Logger(this);
...
LAB_007eb6d0:
                ...
                if (iVar24 == 2) goto LAB_007eb6d0;
LAB_007eb6b0:
                if ((iVar24 == 0) != ((uVar21 & uVar10) != uVar7)) goto LAB_007eb6d0;
LAB_007eb5d8:
                uVar23 = uVar23 + 1;
                uVar3 = uVar3 + 1;
              } while (uVar23 != uVar27);
...
LAB_007eb55c:
  ...
  if (param_5[100] != (SetDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_4 + 0x54),uVar15,*(uint *)(param_5 + 0x1c),*(uint *)(param_5 + 0x20),
