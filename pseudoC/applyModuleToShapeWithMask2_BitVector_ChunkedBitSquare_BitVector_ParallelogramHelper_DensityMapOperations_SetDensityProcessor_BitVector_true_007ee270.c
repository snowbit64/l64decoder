...
// Function: applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
// Entry Point: 007ee270
// Size: 3896 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, ChunkedBitSquare * param_3, BitVector * param_4, ParallelogramHelper * param_5, SetDensityProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
    ...
    if (((uVar21 < local_98) || (uVar25 < local_94)) || ((uVar22 < local_94 || (uVar24 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar32 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar32 != 0
                    ...
                    /* try { // try from 007ef16c to 007ef177 has its CatchHandler @ 007ef1a8 */
          ...
          do {
            ...
            do {
              ...
              if (*(uint *)(param_3 + 0x34) < 2) {
                uVar46 = (ulong)*(uint *)(param_3 + 0x34);
                if (iVar32 != 2) goto LAB_007eee94;
LAB_007eeeb4:
                uVar2 = uVar30 >> (ulong)(uVar4 & 0x1f) & uVar15;
                if (((int)uVar2 < iVar6) || (iVar29 < (int)uVar2)) {
                  if (DVar12 != (DensityMapFilter)0x0) goto LAB_007eeee0;
                }
...
LAB_007eeee0:
                ...
                if (iVar32 == 2) goto LAB_007eeeb4;
LAB_007eee94:
                if ((iVar32 == 0) != ((uVar30 & uVar16) != uVar5)) goto LAB_007eeeb4;
              }
              uVar41 = uVar41 + 1;
              uVar3 = uVar3 + 1;
            } while (uVar41 != uVar34);
    ...
    do {
      ...
      if ((iVar8 == 2) || ((iVar8 == 0) != ((uVar39 & uVar18) != uVar10))) {
        ...
        if (((int)uVar39 < iVar11) || (iVar9 < (int)uVar39)) {
          if (DVar13 != (DensityMapFilter)0x0) goto LAB_007ef018;
        }
...
LAB_007eed4c:
  uVar28 = uVar28 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar28) goto LAB_007eece4;
  goto LAB_007eed60;
}
