...
// Function: FUN_007aa84c
// Entry Point: 007aa84c
// Size: 1124 bytes
// Signature: undefined FUN_007aa84c(void)


void FUN_007aa84c(GsMaterial *param_1,uint *param_2)

{
  ...
  if ((lVar5 != 0) && ((*(byte *)(lVar5 + 0x15) >> 4 & 1) != 0)) {
    ...
    FUN_007aacb0(param_1,uVar6,*(undefined8 *)(lVar5 + 0x20),"albedo map",1);
    lVar9 = *(long *)(lVar5 + 0x20);
    lVar7 = GsMaterial::getAlbedoMap();
    if (lVar9 != lVar7) {
      if (*(char *)(param_2 + 4) == '\0') {
        ...
        uStack_2a0 = (undefined4)*(undefined8 *)(lVar5 + 0x20);
        uStack_29c = (undefined4)((ulong)*(undefined8 *)(lVar5 + 0x20) >> 0x20);
        ...
        GsMaterial::setAlbedoMap(param_1,*(Texture **)(lVar5 + 0x20));
