...
/* std::__ndk1::__split_buffer<TextureStreamingManager::UpgradePipeline::WorkerResult*,
   ...
   >::push_back(TextureStreamingManager::UpgradePipeline::WorkerResult*&&) */
...

{
  ...
  if (ppWVar12 != *(WorkerResult ***)(this + 0x18)) goto LAB_00978ca0;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
         ...
         ((WorkerResult **)((long)pvVar5 + uVar13 * 8 + (uVar9 & 0xfffffffffffffff8) + 8) <= __src))
      {
        ...
        if (uVar9 == uVar10) goto LAB_00978c88;
      }
    }
    do {
      ppWVar11 = ppWVar8 + 1;
