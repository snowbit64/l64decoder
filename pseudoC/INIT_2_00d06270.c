...
// Function: _INIT_2
// Entry Point: 00d06270
// Size: 324 bytes
// Signature: undefined _INIT_2(void)
...

{
  ...
  DAT_02120840 = &PTR__Integer_0100c890;
  uRam0000000002120858 = 2;
  _DAT_02120850 = 0x3fffffffffffffff;
  DAT_02120860 = (undefined8 *)CryptoPP::UnalignedAllocate(8);
  DAT_02120868 = 0;
  *DAT_02120860 = 1;
  __cxa_atexit(CryptoPP::Integer::~Integer,&DAT_02120840,&PTR_LOOP_00fd8de0);
  return;
}
