...
// Function: checkTypedModuleMasks2<ProceduralDensityPixelSource_const,BitVector,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>
// Entry Point: 00841980
// Size: 1184 bytes
// Signature: bool __cdecl checkTypedModuleMasks2<ProceduralDensityPixelSource_const,BitVector,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>(TypedModuleWithMasks * param_1, IDensityPixelSource * param_2, uint param_3, uint param_4, HelperSource * param_5, IDensityPixelSource * param_6, uint param_7, uint param_8, uint param_9, uint param_10, uint param_11, HelperSource * param_12, IDensityPixelSource * param_13, uint param_14, uint param_15, uint param_16, uint param_17, uint param_18)
...
bool DensityMapModifier::
     checkTypedModuleMasks2<ProceduralDensityPixelSource_const,BitVector,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>
...
joined_r0x00841aa4:
      ...
      TVar10 = param_1[0x98];
      if (*(int *)(param_1 + 0x94) < (int)uVar22) goto joined_r0x00841aa4;
      if (TVar10 != (TypedModuleWithMasks)0x0) {
        return false;
      }
    }
    ...
    pIVar18 = *(IDensityPixelSource **)(param_1 + 0xa8);
    if (pIVar18 == param_2) goto LAB_00841ad8;
  }
...
joined_r0x00841a8c:
    ...
    TVar10 = param_1[200];
    if (*(int *)(param_1 + 0xc4) < (int)uVar22) goto joined_r0x00841a8c;
    if (TVar10 != (TypedModuleWithMasks)0x0) {
      return false;
    }
  }
          ...
          *(uint *)(param_5 + 0x20) = uVar14;
          ...
          if ((*(IDensityPixelSource **)(param_1 + 0x78) == param_6) &&
            ...
            if ((int)uVar14 < *(int *)(param_1 + 0x90)) {
              TVar10 = param_1[0x98];
joined_r0x00841be4:
              if (TVar10 == (TypedModuleWithMasks)0x0) goto LAB_00841b38;
            }
            else {
              TVar10 = param_1[0x98];
              if (*(int *)(param_1 + 0x94) < (int)uVar14) goto joined_r0x00841be4;
              if (TVar10 != (TypedModuleWithMasks)0x0) goto LAB_00841b38;
            }
        ...
        *(uint *)(param_12 + 0x20) = uVar15;
        if ((bool)(bVar12 | pIVar17 != param_13)) {
          ...
          if (((int)uVar15 < iVar5) || (iVar8 < (int)uVar15)) {
            if (TVar10 != (TypedModuleWithMasks)0x0) goto LAB_00841e04;
          }
