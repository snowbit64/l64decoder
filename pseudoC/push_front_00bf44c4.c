...
// Function: push_front
// Entry Point: 00bf44c4
// Size: 448 bytes
// Signature: undefined __thiscall push_front(__split_buffer<ShaderManager::AsyncCompileRequest**,std::__ndk1::allocator<ShaderManager::AsyncCompileRequest**>&> * this, AsyncCompileRequest * * * param_1)


/* std::__ndk1::__split_buffer<ShaderManager::AsyncCompileRequest**,
   std::__ndk1::allocator<ShaderManager::AsyncCompileRequest**>&>::push_front(ShaderManager::AsyncCompileRequest**
   const&) */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00bf464c;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00bf4634;
      }
    }
    do {
      puVar7 = puVar6 + 1;
