...
// Function: setBloomQuality
// Entry Point: 00759248
// Size: 220 bytes
// Signature: undefined __thiscall setBloomQuality(HardwareScalability * this, uint param_1)


/* HardwareScalability::setBloomQuality(unsigned int) */

void __thiscall HardwareScalability::setBloomQuality(HardwareScalability *this,uint param_1)

{
  ...
  if (*(uint *)(this + 0xac) != param_1) {
    *(uint *)(this + 0xac) = param_1;
