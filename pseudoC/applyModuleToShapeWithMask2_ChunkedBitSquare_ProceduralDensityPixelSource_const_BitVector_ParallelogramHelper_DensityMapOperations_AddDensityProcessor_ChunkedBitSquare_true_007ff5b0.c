...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 007ff5b0
// Size: 3968 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
    ...
    if (((uVar20 < local_98) || (uVar24 < local_94)) || ((uVar21 < local_94 || (uVar23 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar31 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar31 != 0
                    ...
                    /* try { // try from 008004f4 to 008004ff has its CatchHandler @ 00800530 */
              ...
              do {
                ...
                if ((iVar6 == 2) || ((iVar6 == 0) != ((uVar29 & uVar14) != uVar5))) {
                  ...
                  if (((int)uVar29 < iVar31) || (iVar28 < (int)uVar29)) {
                    if (DVar10 != (DensityMapFilter)0x0) goto LAB_008001a8;
                  }
...
LAB_0080022c:
  uVar29 = uVar29 + 1;
  uVar3 = uVar3 + uVar25;
  if (uVar29 == uVar21) goto LAB_008001e8;
  goto LAB_0080023c;
LAB_008001e8:
  uVar36 = uVar36 + 1;
  uVar37 = uVar37 + uVar23 * uVar25;
  if (uVar36 == uVar27) goto LAB_008000bc;
  goto LAB_00800200;
}
