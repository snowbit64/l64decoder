...
/* CryptoPP::GetValueHelperClass<CryptoPP::DL_PublicKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>
   >, CryptoPP::DL_PublicKey<CryptoPP::EC2NPoint> >::Assignable() */
    ...
    if ((iVar2 == 0) &&
      ...
      NameValuePairs::ThrowIfTypeMismatch
                ((char *)__s1,
                 ...
                 (type_info *)in_x0[2]);
      DL_PublicKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>>::operator=
                ((DL_PublicKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>> *)in_x0[3],
                 *in_x0);
      *(undefined *)(in_x0 + 4) = 1;
      return;
    }
