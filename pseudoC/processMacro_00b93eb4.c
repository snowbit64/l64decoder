...
/* PreprocessorMetaMacroIfndef::processMacro(Preprocessor*, unsigned int, unsigned int, unsigned
   int, unsigned int, unsigned int, unsigned int, unsigned int*, unsigned int*) */

void PreprocessorMetaMacroIfndef::processMacro
  ...
  *(int *)(this + (ulong)uVar3 * 4 + 100) = iVar1;
  if (iVar1 == 0) {
    if ((param_7 == 2) && (this[0x60] != (Preprocessor)0x0)) {
      Preprocessor::printWarning(this,"extra argument to #ifndef ignored");
    }
    ...
    if ((local_5c == local_60) ||
      ...
      Preprocessor::printError(this,"#ifndef requires an identififier");
      uVar4 = 0;
      goto LAB_00b93fc8;
    }
...
LAB_00b94014:
    ...
    *(undefined *)((long)__dest + __n) = 0;
                    /* try { // try from 00b94028 to 00b94033 has its CatchHandler @ 00b94060 */
