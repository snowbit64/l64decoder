...
// Function: __push_back_slow_path<TerrainTransformGroupDesc::LayerGroupDesc>
// Entry Point: 0093f3e0
// Size: 512 bytes
// Signature: void __thiscall __push_back_slow_path<TerrainTransformGroupDesc::LayerGroupDesc>(vector<TerrainTransformGroupDesc::LayerGroupDesc,std::__ndk1::allocator<TerrainTransformGroupDesc::LayerGroupDesc>> * this, LayerGroupDesc * param_1)


/* void std::__ndk1::vector<TerrainTransformGroupDesc::LayerGroupDesc,
   std::__ndk1::allocator<TerrainTransformGroupDesc::LayerGroupDesc>
   >::__push_back_slow_path<TerrainTransformGroupDesc::LayerGroupDesc>(TerrainTransformGroupDesc::LayerGroupDesc&&)
    */
...

{
  ...
  *puVar2 = uVar14;
  ...
  if (lVar8 == 0) {
    ...
    *(LayerGroupDesc **)(param_1 + 0x28) = param_1 + 0x30;
