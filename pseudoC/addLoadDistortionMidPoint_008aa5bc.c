...
// Function: addLoadDistortionMidPoint
// Entry Point: 008aa5bc
// Size: 364 bytes
// Signature: undefined __thiscall addLoadDistortionMidPoint(LoadSimulationRuntimeSettings * this, float param_1, float param_2)


/* LoadSimulationRuntimeSettings::addLoadDistortionMidPoint(float, float) */

void __thiscall
LoadSimulationRuntimeSettings::addLoadDistortionMidPoint
...
LAB_008aa65c:
    ...
    local_64 = 0x3f800000;
    uStack_60 = 0;
    uStack_70 = (ulong)(uint)param_2 << 0x20;
    local_98 = param_1;
    if (puVar6 == *(ulong **)(this + 0x58)) {
                    /* try { // try from 008aa6cc to 008aa6d7 has its CatchHandler @ 008aa728 */
      std::__ndk1::
      ...
      *puVar6 = (ulong)(uint)param_1;
                    /* try { // try from 008aa6ac to 008aa6af has its CatchHandler @ 008aa730 */
      std::__ndk1::
    ...
    if (*pfVar2 != param_1) {
      ...
      do {
        pfVar5 = pfVar5 + 0x10;
        if (uVar4 - 1 == uVar3) goto LAB_008aa65c;
        uVar3 = uVar3 + 1;
      } while (*pfVar5 != param_1);
      if (uVar4 <= uVar3) goto LAB_008aa65c;
    }
    pfVar2[uVar3 * 0x10 + 0xb] = param_2;
  }
  std::__ndk1::
  __sort<std::__ndk1::__less<LoadSimulationRuntimeSettings::LoadPoint,LoadSimulationRuntimeSettings::LoadPoint>&,LoadSimulationRuntimeSettings::LoadPoint*>
