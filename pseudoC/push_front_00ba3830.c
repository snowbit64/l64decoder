...
/* std::__ndk1::__split_buffer<ThreadPool::TaskAndMgr*,
   std::__ndk1::allocator<ThreadPool::TaskAndMgr*> >::push_front(ThreadPool::TaskAndMgr*&&) */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00ba39b8;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00ba39a0;
      }
    }
    do {
      puVar7 = puVar6 + 1;
