...
// Function: processBlock_0_1_16
// Entry Point: 00be1b10
// Size: 3608 bytes
// Signature: undefined __cdecl processBlock_0_1_16(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_0_1_16(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_0_1_16(CustomCipher *param_1,uchar *param_2)

{
  ...
  uVar1 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar6 >> 8 ^ uVar3 >> 0x10) & 0x3f) * 4) |
           (&s_wPS)[(uVar6 >> 0xc ^ uVar3 >> 0x18) & 0x3f] |
           *(uint *)(&DAT_0211ea98 + (ulong)((uVar6 >> 4 ^ uVar3 >> 8) & 0x3f) * 4) |
          *(uint *)(&DAT_0211eb98 + (ulong)((uVar6 ^ uVar3) & 0x3f) * 4)) ^ uVar1 ^
          (*(uint *)(&DAT_0211ed98 + (ulong)((uVar2 >> 0x10 ^ uVar14 >> 7) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ec98 + (ulong)((uVar2 >> 0x18 ^ uVar14 >> 0xb) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ee98 + (ulong)((uVar2 >> 8 ^ uVar14 >> 3) & 0x3f) * 4) |
          *(uint *)(&DAT_0211ef98 + (ulong)((uVar2 ^ uVar6 >> 0x10) & 0x3f) * 4));
  ...
  uVar6 = *(uint *)(param_1 + 0x290);
  uVar14 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar10 >> 8 ^ uVar4 >> 0x10) & 0x3f) * 4) |
            (&s_wPS)[(uVar10 >> 0xc ^ uVar4 >> 0x18) & 0x3f] |
            *(uint *)(&DAT_0211ea98 + (ulong)((uVar10 >> 4 ^ uVar4 >> 8) & 0x3f) * 4) |
           *(uint *)(&DAT_0211eb98 + (ulong)((uVar10 ^ uVar4) & 0x3f) * 4)) ^ uVar14 ^
           (*(uint *)(&DAT_0211ed98 + (ulong)((uVar2 >> 0x10 ^ uVar1 >> 7) & 0x3f) * 4) |
            *(uint *)(&DAT_0211ec98 + (ulong)((uVar2 >> 0x18 ^ uVar1 >> 0xb) & 0x3f) * 4) |
            *(uint *)(&DAT_0211ee98 + (ulong)((uVar2 >> 8 ^ uVar1 >> 3) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ef98 + (ulong)((uVar2 ^ uVar10 >> 0x10) & 0x3f) * 4));
  uVar10 = uVar14 >> 0xf | uVar14 << 0x11;
  uVar2 = *(uint *)(param_1 + 0x298);
  uVar4 = *(uint *)(param_1 + 0x29c);
  uVar1 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar10 >> 8 ^ uVar6 >> 0x10) & 0x3f) * 4) |
           (&s_wPS)[(uVar10 >> 0xc ^ uVar6 >> 0x18) & 0x3f] |
           *(uint *)(&DAT_0211ea98 + (ulong)((uVar10 >> 4 ^ uVar6 >> 8) & 0x3f) * 4) |
          *(uint *)(&DAT_0211eb98 + (ulong)((uVar10 ^ uVar6) & 0x3f) * 4)) ^ uVar1 ^
          (*(uint *)(&DAT_0211ed98 + (ulong)((uVar3 >> 0x10 ^ uVar14 >> 7) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ec98 + (ulong)((uVar3 >> 0x18 ^ uVar14 >> 0xb) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ee98 + (ulong)((uVar3 >> 8 ^ uVar14 >> 3) & 0x3f) * 4) |
          *(uint *)(&DAT_0211ef98 + (ulong)((uVar3 ^ uVar10 >> 0x10) & 0x3f) * 4));
  uVar3 = uVar1 >> 0xf | uVar1 << 0x11;
  uVar14 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar3 >> 8 ^ uVar2 >> 0x10) & 0x3f) * 4) |
            (&s_wPS)[(uVar3 >> 0xc ^ uVar2 >> 0x18) & 0x3f] |
            *(uint *)(&DAT_0211ea98 + (ulong)((uVar3 >> 4 ^ uVar2 >> 8) & 0x3f) * 4) |
           *(uint *)(&DAT_0211eb98 + (ulong)((uVar3 ^ uVar2) & 0x3f) * 4)) ^ uVar14 ^
           ...
           *(uint *)(&DAT_0211ef98 + (ulong)((uVar4 ^ uVar3 >> 0x10) & 0x3f) * 4));
