...
// Entry Point: 00a785cc
// Size: 248 bytes
// Signature: undefined __thiscall BitmapImage(BitmapImage * this, char * param_1, uchar * param_2, uint param_3, ORIGIN param_4, uint param_5)


/* BitmapImage::BitmapImage(char const*, unsigned char*, unsigned int, ImageDesc::ORIGIN, unsigned
   int) */

void __thiscall
BitmapImage::BitmapImage
          (BitmapImage *this,char *param_1,uchar *param_2,uint param_3,ORIGIN param_4,uint param_5)

{
  ...
  *(undefined8 *)(this + 0x20) = 0;
  ...
  uStack_48 = 0;
  local_58 = 0;
  uVar2 = ImageLoadUtil::loadImage(param_1,param_2,param_3,param_4,(ImageDesc *)&local_80,param_5);
  if ((uVar2 & 1) != 0) {
