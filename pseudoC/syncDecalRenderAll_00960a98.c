...
// Function: syncDecalRenderAll
// Entry Point: 00960a98
// Size: 532 bytes
// Signature: undefined __thiscall syncDecalRenderAll(MultiresTextureGpuUpdater * this, ICommandBuffer * param_1)


/* MultiresTextureGpuUpdater::syncDecalRenderAll(ICommandBuffer*) */

void __thiscall
MultiresTextureGpuUpdater::syncDecalRenderAll
  ...
  if (lVar5 == lVar6) {
    ...
    do {
      if (*(int *)(lVar6 + uVar7 * 0xf8 + 0x48) == 1 && uVar9 != 0) {
        ...
        do {
          if (local_78 == local_70) {
            ...
            uVar1 = ((long)__n >> 3) + 1;
            if (uVar1 >> 0x3d != 0) {
                    /* try { // try from 00960c94 to 00960ca7 has its CatchHandler @ 00960cb4 */
            ...
            if (uVar1 == 0) {
              ...
              if (uVar1 >> 0x3d != 0) {
                ...
                FUN_006d1f18("allocator<T>::allocate(size_t n) \'n\' exceeds maximum supported size"
                    ...
                    /* try { // try from 00960bc4 to 00960bc7 has its CatchHandler @ 00960cb0 */
      ...
      uVar8 = (lVar5 - lVar6 >> 3) * -0x1084210842108421;
                    ...
                    /* try { // try from 00960c3c to 00960c57 has its CatchHandler @ 00960cac */
