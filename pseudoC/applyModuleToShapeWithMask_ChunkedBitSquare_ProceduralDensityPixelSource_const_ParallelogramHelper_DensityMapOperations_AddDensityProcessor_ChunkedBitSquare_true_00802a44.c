...
// Function: applyModuleToShapeWithMask<ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 00802a44
// Size: 2556 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask<ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>(IDensityPixelSource * param_1, ChunkedBitSquare * param_2, ProceduralDensityPixelSource * param_3, ParallelogramHelper * param_4, AddDensityProcessor * param_5, DensityMapFilter * param_6)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask<ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
    ...
    if ((uVar13 < uVar11) || (uVar14 < uVar12)) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar19 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar19 != 0
                    ...
                    /* try { // try from 008033f4 to 008033ff has its CatchHandler @ 00803450 */
        this = (Logger *)operator_new(0x38);
                    /* try { // try from 00803404 to 00803407 has its CatchHandler @ 00803440 */
        Logger::Logger(this);
...
LAB_008030b4:
  ...
  if (param_5[0x6c] != (AddDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_4 + 0x54),uVar13,*(uint *)(param_5 + 0x24),*(uint *)(param_5 + 0x28),
...
LAB_00803170:
  uVar22 = uVar22 + 1;
  if (uVar22 == uVar16) goto LAB_00803148;
  goto LAB_0080317c;
LAB_00803148:
  uVar14 = uVar14 + 1;
  if (uVar14 == uVar11) goto LAB_00803100;
  goto LAB_00803158;
LAB_00803100:
  *(int *)(param_5 + 4) = *(int *)(param_5 + 4) + 1;
LAB_0080310c:
  uVar13 = uVar13 + 1;
  if (*(uint *)(param_4 + 0x5c) <= uVar13) goto LAB_008030b4;
  goto LAB_0080312c;
}
