...
// Function: __append
// Entry Point: 0071c410
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<Spline*,std::__ndk1::allocator<Spline*>> * this, ulong param_1)


/* std::__ndk1::vector<Spline*, std::__ndk1::allocator<Spline*> >::__append(unsigned long) */

void __thiscall
std::__ndk1::vector<Spline*,std::__ndk1::allocator<Spline*>>::__append
          (vector<Spline*,std::__ndk1::allocator<Spline*>> *this,ulong param_1)
