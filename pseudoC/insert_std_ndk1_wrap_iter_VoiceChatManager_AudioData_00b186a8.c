...
// Function: insert<std::__ndk1::__wrap_iter<VoiceChatManager::AudioData**>>
// Entry Point: 00b186a8
// Size: 1004 bytes
// Signature: type __thiscall insert<std::__ndk1::__wrap_iter<VoiceChatManager::AudioData**>>(vector<VoiceChatManager::AudioData*,std::__ndk1::allocator<VoiceChatManager::AudioData*>> * this, __wrap_iter param_1, __wrap_iter param_2, __wrap_iter param_3)


/* std::__ndk1::enable_if<__is_cpp17_forward_iterator<std::__ndk1::__wrap_iter<VoiceChatManager::AudioData**>
   >::value&&is_constructible<VoiceChatManager::AudioData*,
   std::__ndk1::iterator_traits<std::__ndk1::__wrap_iter<VoiceChatManager::AudioData**>
   >::reference>::value, std::__ndk1::__wrap_iter<VoiceChatManager::AudioData**> >::type
   std::__ndk1::vector<VoiceChatManager::AudioData*,
   std::__ndk1::allocator<VoiceChatManager::AudioData*>
   >::insert<std::__ndk1::__wrap_iter<VoiceChatManager::AudioData**>
   >(std::__ndk1::__wrap_iter<VoiceChatManager::AudioData* const*>,
   std::__ndk1::__wrap_iter<VoiceChatManager::AudioData**>,
   std::__ndk1::__wrap_iter<VoiceChatManager::AudioData**>) */
    ...
    if (lVar19 < lVar20) {
      ...
      if (puVar15 != puVar6) {
        ...
        if ((0x17 < uVar13) &&
          ...
          if (uVar13 == uVar16) goto LAB_00b1892c;
        }
        do {
          puVar9 = puVar14 + 1;
          *puVar11 = *puVar14;
...
LAB_00b1892c:
      *(undefined8 **)(this + 8) = puVar8;
      puVar6 = puVar15;
      if ((long)uVar10 < 1) goto LAB_00b18a60;
    }
    ...
    if (puVar15 < puVar1) {
      ...
      if (0x17 < uVar13) {
        ...
        if (((undefined8 *)(uVar7 + (lVar3 + (uVar12 >> 3)) * 8 + 8) <= puVar8) ||
          ...
          puVar14 = puVar11;
          if (uVar12 == uVar13) goto LAB_00b18a38;
        }
      }
      do {
        puVar9 = puVar15 + 1;
...
LAB_00b18834:
    ...
    if (uVar7 != uVar13) goto LAB_00b18834;
  }
