...
// Function: processBlock_1_1_9
// Entry Point: 00bcf02c
// Size: 2412 bytes
// Signature: undefined __cdecl processBlock_1_1_9(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_1_1_9(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_1_1_9(CustomCipher *param_1,uchar *param_2)

{
  ...
  uVar6 = *(uint *)(&DAT_0211ee98 + (ulong)((uVar3 >> 8 ^ uVar2 >> 3) & 0x3f) * 4);
  uVar7 = *(uint *)(&DAT_0211ed98 + (ulong)((uVar3 >> 0x10 ^ uVar2 >> 7) & 0x3f) * 4);
  ...
  CVar9 = param_1[0x2b2];
  uVar19 = uVar18 + (byte)CVar9 & 0xff;
  uVar1 = (uVar16 | uVar4 | uVar14 | uVar15) ^ uVar1 ^ (uVar7 | uVar5 | uVar6 | uVar3) ^
