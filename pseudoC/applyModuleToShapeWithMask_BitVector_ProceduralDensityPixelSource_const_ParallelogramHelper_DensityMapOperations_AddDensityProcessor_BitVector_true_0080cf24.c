...
// Function: applyModuleToShapeWithMask<BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
// Entry Point: 0080cf24
// Size: 2068 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask<BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, ProceduralDensityPixelSource * param_3, ParallelogramHelper * param_4, AddDensityProcessor * param_5, DensityMapFilter * param_6)


/* bool DensityMapModifier::applyModuleToShapeWithMask<BitVector, ProceduralDensityPixelSource
   const, ParallelogramHelper, DensityMapOperations::AddDensityProcessor<BitVector, true>
...
bool DensityMapModifier::
     applyModuleToShapeWithMask<BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
               (IDensityPixelSource *param_1,BitVector *param_2,
               ProceduralDensityPixelSource *param_3,ParallelogramHelper *param_4,
               AddDensityProcessor *param_5,DensityMapFilter *param_6)
    ...
    if ((uVar12 < uVar10) || (uVar13 < uVar11)) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar16 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar16 != 0
                    ...
                    /* try { // try from 0080d6f4 to 0080d6fb has its CatchHandler @ 0080d748 */
        this = (Logger *)operator_new(0x38);
                    /* try { // try from 0080d700 to 0080d703 has its CatchHandler @ 0080d738 */
        Logger::Logger(this);
              ...
              do {
                ...
                if ((iVar2 == 2) || ((iVar2 == 0) != ((uVar15 & uVar14) != uVar4))) {
                  ...
                  if (((int)uVar15 < iVar16) || (iVar3 < (int)uVar15)) {
                    if (DVar6 != (DensityMapFilter)0x0) goto LAB_0080d5a0;
                  }
...
LAB_0080d4e4:
        ...
        if (uVar11 < *(uint *)(param_4 + 0x5c)) {
          do {
            ...
            if ((((iVar2 == 2) || ((iVar2 == 0) != ((uVar12 & uVar14) != uVar4))) &&
              ...
              local_70 = uVar12;
              DensityMapOperations::AddDensityProcessor<BitVector,true>::process
                        ((AddDensityProcessor<BitVector,true> *)param_5,(HelperSource *)&local_90);
              if (uVar12 != local_70) {
                DensityMapAccessUtil::writeValue
  ...
  if (param_5[0x6c] != (AddDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_4 + 0x54),uVar12,*(uint *)(param_5 + 0x24),*(uint *)(param_5 + 0x28),
