...
// Function: FUN_00794cf4
// Entry Point: 00794cf4
// Size: 76 bytes
// Signature: undefined FUN_00794cf4(void)


void FUN_00794cf4(uint *param_1)

{
  ...
  if ((pTVar1 != (TransformGroup *)0x0) && (((byte)pTVar1[0x10] >> 5 & 1) != 0)) {
    ...
    EngineManager::removeScriptWakeUpCallback(this_00,pTVar1);
    return;
  }
  return;
}
