...
// Function: applyModuleToShapeWithMask2<BitVector,ProceduralDensityPixelSource_const,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
// Entry Point: 00821468
// Size: 3264 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,ProceduralDensityPixelSource_const,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>(IDensityPixelSource * param_1, BitVector * param_2, ProceduralDensityPixelSource * param_3, ProceduralDensityPixelSource * param_4, ParallelogramHelper * param_5, SetTypeProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,ProceduralDensityPixelSource_const,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
    ...
    if (((uVar18 < local_98) || (uVar22 < local_94)) || ((uVar19 < local_94 || (uVar21 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar25 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar25 != 0
                    ...
                    /* try { // try from 008220ec to 008220f7 has its CatchHandler @ 00822128 */
            ...
            do {
              ...
              if ((iVar25 == 2) || ((iVar25 == 0) != ((uVar24 & uVar13) != uVar3))) {
                ...
                if (((int)uVar24 < iVar6) || (iVar7 < (int)uVar24)) {
                  if (DVar10 != (DensityMapFilter)0x0) goto LAB_00821ec0;
                }
...
LAB_00821d98:
  ...
  if (param_6[0x5c] != (SetTypeProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar29,*(uint *)(param_6 + 0x14),*(uint *)(param_6 + 0x18),
    ...
    do {
      ...
      if ((iVar2 == 2) || ((iVar2 == 0) != ((uVar24 & uVar15) != uVar4))) {
        ...
        if (((int)uVar24 < iVar8) || (iVar9 < (int)uVar24)) {
          if (DVar11 != (DensityMapFilter)0x0) goto LAB_00821f8c;
        }
...
LAB_00821df8:
  uVar29 = uVar29 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar29) goto LAB_00821d98;
  goto LAB_00821e0c;
}
