...
// Function: processBlock_0_1_15
// Entry Point: 00bde750
// Size: 3444 bytes
// Signature: undefined __cdecl processBlock_0_1_15(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_0_1_15(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_0_1_15(CustomCipher *param_1,uchar *param_2)

{
  ...
  uVar14 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar6 >> 8 ^ uVar4 >> 0x10) & 0x3f) * 4) |
            (&s_wPS)[(uVar6 >> 0xc ^ uVar4 >> 0x18) & 0x3f] |
            *(uint *)(&DAT_0211ea98 + (ulong)((uVar6 >> 4 ^ uVar4 >> 8) & 0x3f) * 4) |
           *(uint *)(&DAT_0211eb98 + (ulong)((uVar6 ^ uVar4) & 0x3f) * 4)) ^ uVar14 ^
           (*(uint *)(&DAT_0211ed98 + (ulong)((uVar2 >> 0x10 ^ uVar1 >> 7) & 0x3f) * 4) |
            *(uint *)(&DAT_0211ec98 + (ulong)((uVar2 >> 0x18 ^ uVar1 >> 0xb) & 0x3f) * 4) |
            *(uint *)(&DAT_0211ee98 + (ulong)((uVar2 >> 8 ^ uVar1 >> 3) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ef98 + (ulong)((uVar2 ^ uVar6 >> 0x10) & 0x3f) * 4));
  ...
  uVar14 = *(uint *)(s_wO_L4 + (ulong)(uVar1 & 0xf) * 4) |
