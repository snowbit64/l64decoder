...
// Function: FUN_00d0dd84
// Entry Point: 00d0dd84
// Size: 440 bytes
// Signature: undefined FUN_00d0dd84(void)


void FUN_00d0dd84(void **param_1,undefined8 *param_2)

{
  ...
  if (puVar12 != (undefined8 *)param_1[3]) goto LAB_00d0df04;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00d0deec;
      }
    }
    do {
      puVar11 = puVar8 + 1;
