...
// Entry Point: 00b560dc
// Size: 216 bytes
// Signature: undefined __thiscall aabbInFrustum(Frustum * this, Vector3 * param_1, Vector3 * param_2)


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Frustum::aabbInFrustum(Vector3 const&, Vector3 const&) const */

bool __thiscall Frustum::aabbInFrustum(Frustum *this,Vector3 *param_1,Vector3 *param_2)
