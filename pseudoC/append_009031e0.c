...
// Function: __append
// Entry Point: 009031e0
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<MeshSplitAttachmentGeometry::ShapeAttachment,std::__ndk1::allocator<MeshSplitAttachmentGeometry::ShapeAttachment>> * this, ulong param_1)


/* std::__ndk1::vector<MeshSplitAttachmentGeometry::ShapeAttachment,
   std::__ndk1::allocator<MeshSplitAttachmentGeometry::ShapeAttachment> >::__append(unsigned long)
    */
