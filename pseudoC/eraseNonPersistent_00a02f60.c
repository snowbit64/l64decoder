...
// Function: eraseNonPersistent
// Entry Point: 00a02f60
// Size: 376 bytes
// Signature: undefined eraseNonPersistent(void)


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* PersistentShadowMap::DividedMap::eraseNonPersistent() */

void PersistentShadowMap::DividedMap::eraseNonPersistent(void)
  ...
  if (*(int *)(in_x0 + 0xc) != 0) {
    ...
    do {
      ...
      if (*ppvVar16 == (void *)0x0) {
        ...
        if (*plVar6 != 0) {
          if (*(char *)(lVar3 + uVar15 * 0x88 + 0x24) == '\0') {
            *plVar6 = 0;
          }
          else {
            *(undefined *)(lVar3 + uVar15 * 0x88 + 0x30) = 0;
          }
        }
      }
      else {
...
LAB_00a03070:
            ...
            iVar7 = iVar7 + iVar8;
            if (uVar5 != uVar4) goto LAB_00a03070;
          }
          if (iVar7 != 0) goto LAB_00a02f90;
          if (pvVar14 != (void *)0x0) goto LAB_00a030a8;
        }
        *ppvVar16 = (void *)0x0;
      }
LAB_00a02f90:
