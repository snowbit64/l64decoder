...
// Function: emplace_back<Vector2&,unsigned_char&>
// Entry Point: 0073e73c
// Size: 328 bytes
// Signature: void __thiscall emplace_back<Vector2&,unsigned_char&>(vector<std::__ndk1::pair<Vector2,unsigned_char>,std::__ndk1::allocator<std::__ndk1::pair<Vector2,unsigned_char>>> * this, Vector2 * param_1, uchar * param_2)
...
/* void std::__ndk1::vector<std::__ndk1::pair<Vector2, unsigned char>,
   ...
   unsigned char&>(Vector2&, unsigned char&) */
