  ...
  if (in_x0[4] < (pair *)0x400) {
    ...
    if ((ulong)(lVar6 >> 3) <= uVar8) {
      ...
      pppStack_50 = local_58;
                    /* try { // try from 0072fd58 to 0072fd5f has its CatchHandler @ 0072fe58 */
      local_68 = (pair *)operator_new(0x1000);
                    /* try { // try from 0072fd68 to 0072fd73 has its CatchHandler @ 0072fe48 */
      ...
      while (pppVar7 != (pair **)in_x0[1]) {
        pppVar7 = pppVar7 + -1;
        pppVar9 = pppVar9 + -1;
                    /* try { // try from 0072fd90 to 0072fd9b has its CatchHandler @ 0072fe5c */
        __split_buffer<std::__ndk1::pair<unsigned_short,unsigned_short>*,std::__ndk1::allocator<std::__ndk1::pair<unsigned_short,unsigned_short>*>&>
