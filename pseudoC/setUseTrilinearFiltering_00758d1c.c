...
// Function: setUseTrilinearFiltering
// Entry Point: 00758d1c
// Size: 224 bytes
// Signature: undefined __thiscall setUseTrilinearFiltering(HardwareScalability * this, bool param_1)


/* HardwareScalability::setUseTrilinearFiltering(bool) */

void __thiscall
HardwareScalability::setUseTrilinearFiltering(HardwareScalability *this,bool param_1)

{
  ...
  if (this[0x68] != (HardwareScalability)param_1) {
    this[0x68] = (HardwareScalability)param_1;
