...
// Function: move<BTBehavior*,BTBehavior**,BTBehavior*&,BTBehavior***,long,512l,BTBehavior*,BTBehavior**,BTBehavior*&,BTBehavior***,long,512l>
// Entry Point: 00713664
// Size: 408 bytes
// Signature: __deque_iterator __cdecl move<BTBehavior*,BTBehavior**,BTBehavior*&,BTBehavior***,long,512l,BTBehavior*,BTBehavior**,BTBehavior*&,BTBehavior***,long,512l>(__deque_iterator param_1, __deque_iterator param_2, __deque_iterator param_3)


/* std::__ndk1::__deque_iterator<BTBehavior*, BTBehavior**, BTBehavior*&, BTBehavior***, long, 512l>
   std::__ndk1::move<BTBehavior*, BTBehavior**, BTBehavior*&, BTBehavior***, long, 512l,
