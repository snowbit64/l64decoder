...
// Function: setLODDistanceCoeff
// Entry Point: 007574c4
// Size: 220 bytes
// Signature: undefined __thiscall setLODDistanceCoeff(HardwareScalability * this, float param_1)


/* HardwareScalability::setLODDistanceCoeff(float) */

void __thiscall HardwareScalability::setLODDistanceCoeff(HardwareScalability *this,float param_1)
