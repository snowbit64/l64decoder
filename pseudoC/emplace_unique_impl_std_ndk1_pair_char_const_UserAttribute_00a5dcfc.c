...
// Function: __emplace_unique_impl<std::__ndk1::pair<char_const*,UserAttribute*>>
// Entry Point: 00a5dcfc
// Size: 232 bytes
// Signature: pair __cdecl __emplace_unique_impl<std::__ndk1::pair<char_const*,UserAttribute*>>(pair * param_1)
...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, UserAttribute*>, void*>*, long>,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, UserAttribute*> >
   >::__emplace_unique_impl<std::__ndk1::pair<char const*, UserAttribute*> >(std::__ndk1::pair<char
   const*, UserAttribute*>&&) */
...
pair std::__ndk1::
     ...
     ::__emplace_unique_impl<std::__ndk1::pair<char_const*,UserAttribute*>>(pair *param_1)

{
  ...
  __construct_node<std::__ndk1::pair<char_const*,UserAttribute*>>(param_1);
                    /* try { // try from 00a5dd30 to 00a5dd3b has its CatchHandler @ 00a5dde4 */
  pp_Var2 = __find_equal<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,UserAttribute*>>
                      ((__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,UserAttribute*>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,UserAttribute*>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,UserAttribute*>>>
