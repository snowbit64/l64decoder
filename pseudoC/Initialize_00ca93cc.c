...
// Function: Initialize
// Entry Point: 00ca93cc
// Size: 124 bytes
// Signature: undefined __thiscall Initialize(DL_PrivateKey_EC<CryptoPP::ECP> * this, DL_GroupParameters_EC * param_1, Integer * param_2)


/* CryptoPP::DL_PrivateKey_EC<CryptoPP::ECP>::Initialize(CryptoPP::DL_GroupParameters_EC<CryptoPP::ECP>
   const&, CryptoPP::Integer const&) */

void __thiscall
CryptoPP::DL_PrivateKey_EC<CryptoPP::ECP>::Initialize
          (DL_PrivateKey_EC<CryptoPP::ECP> *this,DL_GroupParameters_EC *param_1,Integer *param_2)

{
  ...
  *(undefined2 *)(this + 0x1d0) = *(undefined2 *)(param_1 + 0x170);
                    /* WARNING: Could not recover jumptable at 0x00ca9444. Too many branches */
