...
// Entry Point: 00c80c4c
// Size: 224 bytes
// Signature: undefined __thiscall Resynchronize(AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,CryptoPP::CTR_ModePolicy>> * this, uchar * param_1, int param_2)


/* CryptoPP::AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,
   CryptoPP::CTR_ModePolicy> >::Resynchronize(unsigned char const*, int) */
...

{
  ...
  plVar4 = (long *)(**(code **)(*(long *)this + 0x100))();
  lVar7 = *plVar4;
  ...
  *(undefined8 *)(this + 0x70) = 0xffffffffffffffff;
  uVar6 = SimpleKeyingInterface::ThrowIfInvalidIVLength((SimpleKeyingInterface *)this,param_2);
                    /* WARNING: Could not recover jumptable at 0x00c80d28. Too many branches */
