...
// Entry Point: 00711ef4
// Size: 128 bytes
// Signature: undefined onInitialize(void)


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* AnimalRestingAction::onInitialize() */

undefined8 AnimalRestingAction::onInitialize(void)

{
  ...
  local_4c = MathUtil::getRandomMinMax
                       (*(float *)(*(long *)(in_x0 + 0x30) + 0x564),
                        *(float *)(*(long *)(in_x0 + 0x30) + 0x568));
  local_30 = 0;
