...
// Function: move<ThreadPool::Task*,ThreadPool::Task**,ThreadPool::Task*&,ThreadPool::Task***,long,512l,ThreadPool::Task*,ThreadPool::Task**,ThreadPool::Task*&,ThreadPool::Task***,long,512l>
// Entry Point: 00ba4d0c
// Size: 408 bytes
// Signature: __deque_iterator __cdecl move<ThreadPool::Task*,ThreadPool::Task**,ThreadPool::Task*&,ThreadPool::Task***,long,512l,ThreadPool::Task*,ThreadPool::Task**,ThreadPool::Task*&,ThreadPool::Task***,long,512l>(__deque_iterator param_1, __deque_iterator param_2, __deque_iterator param_3)


/* std::__ndk1::__deque_iterator<ThreadPool::Task*, ThreadPool::Task**, ThreadPool::Task*&,
   ThreadPool::Task***, long, 512l> std::__ndk1::move<ThreadPool::Task*, ThreadPool::Task**,
   ThreadPool::Task*&, ThreadPool::Task***, long, 512l, ThreadPool::Task*, ThreadPool::Task**,
   ThreadPool::Task*&, ThreadPool::Task***, long,
...
__deque_iterator
std::__ndk1::
move<ThreadPool::Task*,ThreadPool::Task**,ThreadPool::Task*&,ThreadPool::Task***,long,512l,ThreadPool::Task*,ThreadPool::Task**,ThreadPool::Task*&,ThreadPool::Task***,long,512l>
