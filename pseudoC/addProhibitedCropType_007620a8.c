...
// Function: addProhibitedCropType
// Entry Point: 007620a8
// Size: 1024 bytes
// Signature: undefined __thiscall addProhibitedCropType(FieldCropsQuery * this, MethodInvocation * param_1)


/* FieldCropsQuery::addProhibitedCropType(MethodInvocation*) */

void __thiscall
FieldCropsQuery::addProhibitedCropType(FieldCropsQuery *this,MethodInvocation *param_1)
  ...
  if ((lVar6 == 0) || ((*(byte *)(lVar6 + 0x16) >> 1 & 1) == 0)) {
    if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
       (iVar5 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar5 != 0)) {
                    /* try { // try from 007623e0 to 007623eb has its CatchHandler @ 007624b0 */
      LogManager::LogManager((LogManager *)&LogManager::getInstance()::singletonLogManager);
      __cxa_atexit(LogManager::~LogManager,&LogManager::getInstance()::singletonLogManager,
                   &PTR_LOOP_00fd8de0);
      __cxa_guard_release(&LogManager::getInstance()::singletonLogManager);
    }
    pcVar8 = "Error: addProhibitedCropType has invalid foliage with id %u.\n";
  }
  else {
    ...
    if (iVar5 == iVar2) {
      ...
      if (iVar5 == iVar2) {
        ...
        if (uVar3 == 0) {
          uVar16 = 0;
LAB_007621e0:
          if ((uint)uVar16 == uVar3) goto LAB_007621e8;
        }
        else {
          uVar16 = 0;
          plVar10 = (long *)(this + 0x48);
          do {
            if (*(long **)(*plVar10 + 8) == plVar15) goto LAB_007621e0;
            uVar16 = uVar16 + 1;
            plVar10 = plVar10 + 5;
          } while (uVar9 != uVar16);
          uVar16 = (ulong)uVar3;
LAB_007621e8:
        ...
        if (uVar3 < uVar4) {
          ...
          puVar11 = (ushort *)(lVar13 + uVar17 * 0x84 + 2);
          uVar1 = *puVar11;
          if (uVar1 < 4) {
            lVar14 = *(long *)(this + 8);
            uVar3 = *(int *)(lVar6 + 0x7c) + *(int *)(param_1 + 0x30);
            lVar6 = lVar13 + uVar17 * 0x84 + (ulong)uVar1 * 0x10;
            *(int *)(lVar6 + 0x48) = *(int *)(param_1 + 0x10) << (ulong)(uVar3 & 0x1f);
            *(int *)(lVar6 + 0x4c) = *(int *)(param_1 + 0x20) << (ulong)(uVar3 & 0x1f);
            ...
            *puVar11 = uVar1 + 1;
            *(int *)(lVar6 + 0x50) = ~(-1 << (ulong)(uVar3 & 0x1f)) << (ulong)(iVar5 + iVar2 & 0x1f)
            ;
            return;
          }
          puVar7 = (undefined8 *)LogManager::getInstance();
          uVar9 = 4;
          pcVar8 = 
          "Error: Trying to set too many prohibited crop types for the same type index. Maximum allowed is \'%u\'.\n"
          ;
          goto LAB_007621c4;
        }
        if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
           (iVar5 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar5 != 0
                    ...
                    /* try { // try from 00762470 to 0076247b has its CatchHandler @ 007624a8 */
          LogManager::LogManager((LogManager *)&LogManager::getInstance()::singletonLogManager);
          __cxa_atexit(LogManager::~LogManager,&LogManager::getInstance()::singletonLogManager,
                       &PTR_LOOP_00fd8de0);
          __cxa_guard_release(&LogManager::getInstance()::singletonLogManager);
    ...
    if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
       (iVar5 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar5 != 0)) {
                    /* try { // try from 00762428 to 00762433 has its CatchHandler @ 007624ac */
      LogManager::LogManager((LogManager *)&LogManager::getInstance()::singletonLogManager);
      __cxa_atexit(LogManager::~LogManager,&LogManager::getInstance()::singletonLogManager,
                   &PTR_LOOP_00fd8de0);
      __cxa_guard_release(&LogManager::getInstance()::singletonLogManager);
    ...
    pcVar8 = 
    "Error: addProhibitedCropType foliage %u must match the size of the ground terrain detail.\n";
  }
LAB_007621bc:
