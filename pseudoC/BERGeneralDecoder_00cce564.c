...
// Entry Point: 00cce564
// Size: 100 bytes
// Signature: undefined __thiscall BERGeneralDecoder(BERGeneralDecoder * this, BufferedTransformation * param_1, uchar param_2)
...
CryptoPP::BERGeneralDecoder::BERGeneralDecoder
          (BERGeneralDecoder *this,BufferedTransformation *param_1,uchar param_2)

{
  Algorithm::Algorithm((Algorithm *)this,false);
  *(BufferedTransformation **)(this + 0x20) = param_1;
