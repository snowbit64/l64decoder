...
// Function: Or
// Entry Point: 00cfcdb4
// Size: 448 bytes
// Signature: undefined __cdecl Or(Integer * param_1)


/* CryptoPP::Integer::Or(CryptoPP::Integer const&) const */

void CryptoPP::Integer::Or(Integer *param_1)
  ...
  if (*(ulong *)(param_1 + 0x18) < *(ulong *)(in_x1 + 0x18)) {
    ...
    if (uVar3 != 0) {
      ...
      if ((uVar3 < 8) || ((uVar5 < uVar1 + uVar3 * 4 && (uVar1 < uVar5 + uVar3 * 4)))) {
        ...
        if (uVar3 == uVar7) goto LAB_00cfce54;
      }
      lVar4 = uVar3 - uVar7;
