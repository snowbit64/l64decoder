...
// Function: checkTypedModuleMasks2<ChunkedBitSquare,ProceduralDensityPixelSource_const,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
// Entry Point: 008311c8
// Size: 1280 bytes
// Signature: bool __cdecl checkTypedModuleMasks2<ChunkedBitSquare,ProceduralDensityPixelSource_const,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>(TypedModuleWithMasks * param_1, IDensityPixelSource * param_2, uint param_3, uint param_4, HelperSource * param_5, IDensityPixelSource * param_6, uint param_7, uint param_8, uint param_9, uint param_10, uint param_11, HelperSource * param_12, IDensityPixelSource * param_13, uint param_14, uint param_15, uint param_16, uint param_17, uint param_18)


/* bool DensityMapModifier::checkTypedModuleMasks2<ChunkedBitSquare, ProceduralDensityPixelSource
   const, DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare, false>
...
bool DensityMapModifier::
     checkTypedModuleMasks2<ChunkedBitSquare,ProceduralDensityPixelSource_const,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
...
joined_r0x008312e4:
      ...
      TVar4 = param_1[0x98];
      if (*(int *)(param_1 + 0x94) < (int)uVar14) goto joined_r0x008312e4;
      if (TVar4 != (TypedModuleWithMasks)0x0) {
        return false;
      }
    }
    ...
    pIVar15 = *(IDensityPixelSource **)(param_1 + 0xa8);
    if (pIVar15 == param_2) goto LAB_00831318;
  }
...
joined_r0x008312cc:
    ...
    TVar4 = param_1[200];
    if (*(int *)(param_1 + 0xc4) < (int)uVar14) goto joined_r0x008312cc;
    if (TVar4 != (TypedModuleWithMasks)0x0) {
      return false;
    }
  }
...
LAB_00831364:
          ...
          if ((*(IDensityPixelSource **)(param_1 + 0x78) == param_6) &&
            ...
            if ((int)uVar2 < *(int *)(param_1 + 0x90)) {
              TVar4 = param_1[0x98];
joined_r0x00831520:
              if (TVar4 == (TypedModuleWithMasks)0x0) goto LAB_008313b8;
            }
            else {
              TVar4 = param_1[0x98];
              if (*(int *)(param_1 + 0x94) < (int)uVar2) goto joined_r0x00831520;
              if (TVar4 != (TypedModuleWithMasks)0x0) goto LAB_008313b8;
            }
        ...
        *(uint *)(param_12 + 0x20) = uVar10;
        ...
        if ((*(IDensityPixelSource **)(param_1 + 0x78) == param_13) &&
          ...
          if ((int)uVar10 < *(int *)(param_1 + 0x90)) {
            TVar4 = param_1[0x98];
joined_r0x00831638:
            if (TVar4 == (TypedModuleWithMasks)0x0) goto LAB_0083158c;
          }
          else {
            TVar4 = param_1[0x98];
            if (*(int *)(param_1 + 0x94) < (int)uVar10) goto joined_r0x00831638;
            if (TVar4 != (TypedModuleWithMasks)0x0) goto LAB_0083158c;
          }
