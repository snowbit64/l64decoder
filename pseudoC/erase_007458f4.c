...
/* std::__ndk1::deque<VehicleNavigationAgent*, std::__ndk1::allocator<VehicleNavigationAgent*>
   >::erase(std::__ndk1::__deque_iterator<VehicleNavigationAgent*, VehicleNavigationAgent* const*,
   VehicleNavigationAgent* const&, VehicleNavigationAgent* const* const*, long, 512l>) */
...

{
  ...
  if (*(long *)(uVar5 + 0x10) == lVar3) {
    lVar9 = 0;
    if (in_x2 == 0) goto LAB_007459f8;
  }
  else {
    lVar9 = *plVar2 + (uVar8 & 0x1ff) * 8;
    if (in_x2 == lVar9) goto LAB_007459f8;
  }
