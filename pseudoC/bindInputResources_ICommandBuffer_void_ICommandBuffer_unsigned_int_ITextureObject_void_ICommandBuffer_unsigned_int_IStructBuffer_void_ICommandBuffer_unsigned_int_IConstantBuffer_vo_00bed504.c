...
// Function: bindInputResources<ICommandBuffer,void(ICommandBuffer::*)(unsigned_int,ITextureObject*),void(ICommandBuffer::*)(unsigned_int,IStructBuffer*),void(ICommandBuffer::*)(unsigned_int,IConstantBuffer*),void(ICommandBuffer::*)(unsigned_int,ISamplerObject*)>
// Entry Point: 00bed504
// Size: 944 bytes
// Signature: void __cdecl bindInputResources<ICommandBuffer,void(ICommandBuffer::*)(unsigned_int,ITextureObject*),void(ICommandBuffer::*)(unsigned_int,IStructBuffer*),void(ICommandBuffer::*)(unsigned_int,IConstantBuffer*),void(ICommandBuffer::*)(unsigned_int,ISamplerObject*)>(ICommandBuffer * param_1, ShaderTexture * param_2, uint param_3, ShaderStructBuffer * param_4, uint param_5, ShaderConstantBuffer * param_6, uint param_7, ShaderSampler * param_8, uint param_9, TransitionsDesc * param_10, SHADER_STAGE param_11, _func_void_uint_ITextureObject_ptr * param_12, _func_void_uint_IStructBuffer_ptr * param_13, _func_void_uint_IConstantBuffer_ptr * param_14, _func_void_uint_ISamplerObject_ptr * param_15)


/* void AdhocShader::bindInputResources<ICommandBuffer, void (ICommandBuffer::*)(unsigned int,
   ...
   unsigned int, AdhocShader::ShaderSampler const*, unsigned int, AdhocShader::TransitionsDesc&,
   IProgramObject::SHADER_STAGE, void (ICommandBuffer::*)(unsigned int, ITextureObject*), void
   (ICommandBuffer::*)(unsigned int, IStructBuffer*), void (ICommandBuffer::*)(unsigned int,
   IConstantBuffer*), void (ICommandBuffer::*)(unsigned int, ISamplerObject*)) const */
...
void AdhocShader::
     bindInputResources<ICommandBuffer,void(ICommandBuffer::*)(unsigned_int,ITextureObject*),void(ICommandBuffer::*)(unsigned_int,IStructBuffer*),void(ICommandBuffer::*)(unsigned_int,IConstantBuffer*),void(ICommandBuffer::*)(unsigned_int,ISamplerObject*)>
               ...
               _func_void_uint_ITextureObject_ptr *param_12,
