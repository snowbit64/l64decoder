...
// Function: __append
// Entry Point: 0070e530
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<Vector2,std::__ndk1::allocator<Vector2>> * this, ulong param_1)


/* std::__ndk1::vector<Vector2, std::__ndk1::allocator<Vector2> >::__append(unsigned long) */

void __thiscall
std::__ndk1::vector<Vector2,std::__ndk1::allocator<Vector2>>::__append
          (vector<Vector2,std::__ndk1::allocator<Vector2>> *this,ulong param_1)
