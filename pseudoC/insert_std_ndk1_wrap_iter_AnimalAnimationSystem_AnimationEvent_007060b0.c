...
// Function: insert<std::__ndk1::__wrap_iter<AnimalAnimationSystem::AnimationEvent*>>
// Entry Point: 007060b0
// Size: 1004 bytes
// Signature: type __thiscall insert<std::__ndk1::__wrap_iter<AnimalAnimationSystem::AnimationEvent*>>(vector<AnimalAnimationSystem::AnimationEvent,std::__ndk1::allocator<AnimalAnimationSystem::AnimationEvent>> * this, __wrap_iter param_1, __wrap_iter param_2, __wrap_iter param_3)


/* std::__ndk1::enable_if<__is_cpp17_forward_iterator<std::__ndk1::__wrap_iter<AnimalAnimationSystem::AnimationEvent*>
   >::value&&is_constructible<AnimalAnimationSystem::AnimationEvent,
   std::__ndk1::iterator_traits<std::__ndk1::__wrap_iter<AnimalAnimationSystem::AnimationEvent*>
   >::reference>::value, std::__ndk1::__wrap_iter<AnimalAnimationSystem::AnimationEvent*> >::type
   std::__ndk1::vector<AnimalAnimationSystem::AnimationEvent,
   ...
   >(std::__ndk1::__wrap_iter<AnimalAnimationSystem::AnimationEvent const*>,
   std::__ndk1::__wrap_iter<AnimalAnimationSystem::AnimationEvent*>,
   std::__ndk1::__wrap_iter<AnimalAnimationSystem::AnimationEvent*>) */
    ...
    if (lVar19 < lVar20) {
      ...
      if (puVar15 != puVar6) {
        ...
        if ((0x17 < uVar13) &&
          ...
          if (uVar13 == uVar16) goto LAB_00706334;
        }
        do {
          puVar9 = puVar14 + 1;
          *puVar11 = *puVar14;
...
LAB_00706334:
      *(undefined8 **)(this + 8) = puVar8;
      puVar6 = puVar15;
      if ((long)uVar10 < 1) goto LAB_00706468;
    }
    ...
    if (puVar15 < puVar1) {
      ...
      if (0x17 < uVar13) {
        ...
        if (((undefined8 *)(uVar7 + (lVar3 + (uVar12 >> 3)) * 8 + 8) <= puVar8) ||
          ...
          puVar14 = puVar11;
          if (uVar12 == uVar13) goto LAB_00706440;
        }
      }
      do {
        puVar9 = puVar15 + 1;
...
LAB_0070623c:
    ...
    if (uVar7 != uVar13) goto LAB_0070623c;
  }
