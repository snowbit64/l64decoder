...
// Entry Point: 00bb41c8
// Size: 96 bytes
// Signature: undefined __thiscall MethodDeclaration(MethodDeclaration * this, Type param_1, Type param_2, void * param_3, Type param_4, Type param_5, Type param_6, Type param_7, Type param_8, Type param_9, Type param_10, Type param_11, Type param_12, Type param_13, Type param_14)
...

{
  ...
  *(undefined8 *)(this + 0x60) = 0x20000000b;
  return;
}
