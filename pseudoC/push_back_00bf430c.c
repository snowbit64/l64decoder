...
// Function: push_back
// Entry Point: 00bf430c
// Size: 440 bytes
// Signature: undefined __thiscall push_back(__split_buffer<ShaderManager::AsyncCompileRequest**,std::__ndk1::allocator<ShaderManager::AsyncCompileRequest**>&> * this, AsyncCompileRequest * * * param_1)


/* std::__ndk1::__split_buffer<ShaderManager::AsyncCompileRequest**,
   std::__ndk1::allocator<ShaderManager::AsyncCompileRequest**>&>::push_back(ShaderManager::AsyncCompileRequest**&&)
    */
...

{
  ...
  if (puVar12 != *(undefined8 **)(this + 0x18)) goto LAB_00bf448c;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00bf4474;
      }
    }
    do {
      puVar11 = puVar8 + 1;
