...
// Function: __append
// Entry Point: 0074e34c
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<char_const*,std::__ndk1::allocator<char_const*>> * this, ulong param_1)


/* std::__ndk1::vector<char const*, std::__ndk1::allocator<char const*> >::__append(unsigned long)
    */

void __thiscall
std::__ndk1::vector<char_const*,std::__ndk1::allocator<char_const*>>::__append
          (vector<char_const*,std::__ndk1::allocator<char_const*>> *this,ulong param_1)
