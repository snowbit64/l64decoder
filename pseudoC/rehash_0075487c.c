...
// Function: __rehash
// Entry Point: 0075487c
// Size: 384 bytes
// Signature: undefined __thiscall __rehash(__hash_table<LanguageUtil::LANGUAGE_TYPE,LocalizationManager::EnumClassHash,std::__ndk1::equal_to<LanguageUtil::LANGUAGE_TYPE>,std::__ndk1::allocator<LanguageUtil::LANGUAGE_TYPE>> * this, ulong param_1)
...
/* std::__ndk1::__hash_table<LanguageUtil::LANGUAGE_TYPE, LocalizationManager::EnumClassHash,
   ...
   std::__ndk1::allocator<LanguageUtil::LANGUAGE_TYPE> >::__rehash(unsigned long) */
...
::__rehash(__hash_table<LanguageUtil::LANGUAGE_TYPE,LocalizationManager::EnumClassHash,std::__ndk1::equal_to<LanguageUtil::LANGUAGE_TYPE>,std::__ndk1::allocator<LanguageUtil::LANGUAGE_TYPE>>
           *this,ulong param_1)
