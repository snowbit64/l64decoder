...
// Entry Point: 00758370
// Size: 220 bytes
// Signature: undefined __thiscall setAnisotropy(HardwareScalability * this, uint param_1)


/* HardwareScalability::setAnisotropy(unsigned int) */

void __thiscall HardwareScalability::setAnisotropy(HardwareScalability *this,uint param_1)

{
  ...
  if (*(uint *)(this + 0x6c) != param_1) {
    *(uint *)(this + 0x6c) = param_1;
