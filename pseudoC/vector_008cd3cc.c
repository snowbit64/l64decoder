...
// Function: vector
// Entry Point: 008cd3cc
// Size: 164 bytes
// Signature: undefined __thiscall vector(vector<std::__ndk1::vector<unsigned_short,std::__ndk1::allocator<unsigned_short>>,std::__ndk1::allocator<std::__ndk1::vector<unsigned_short,std::__ndk1::allocator<unsigned_short>>>> * this, ulong param_1)
  ...
  *(undefined8 *)(this + 0x10) = 0;
  if (param_1 != 0) {
    if (0xaaaaaaaaaaaaaaa < param_1) {
                    /* try { // try from 008cd468 to 008cd46f has its CatchHandler @ 008cd470 */
                    /* WARNING: Subroutine does not return */
      std::__ndk1::__vector_base_common<true>::__throw_length_error();
    }
                    /* try { // try from 008cd40c to 008cd413 has its CatchHandler @ 008cd470 */
