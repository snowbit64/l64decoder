...
// Function: destroy
// Entry Point: 009d76ac
// Size: 80 bytes
// Signature: undefined __thiscall destroy(__tree<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::allocator<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>> * this, __tree_node * param_1)
...
/* std::__ndk1::__tree<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   ...
   >::destroy(std::__ndk1::__tree_node<std::__ndk1::basic_string<char,
