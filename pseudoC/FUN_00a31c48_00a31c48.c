...
// Function: FUN_00a31c48
// Entry Point: 00a31c48
// Size: 772 bytes
// Signature: undefined FUN_00a31c48(void)


uint FUN_00a31c48(ulong *param_1,ulong *param_2,ulong *param_3,ulong *param_4,ulong *param_5,
...

{
  ...
  if ((((uVar1 == uVar2) && (bVar4 = param_4[1] <= param_5[1], param_5[1] == param_4[1])) &&
     ...
     (((bVar4 = param_4[2] <= param_5[2], param_5[2] == param_4[2] &&
      ...
      uVar1 == uVar2)))) {
    if (*(float *)(param_4 + 4) <= *(float *)(param_5 + 4)) goto LAB_00a31f1c;
  }
  else if (bVar4) goto LAB_00a31f1c;
  uVar11 = *param_5;
  uVar10 = param_5[3];
  uVar9 = param_5[2];
  uVar13 = param_4[1];
  ...
  if (((uVar1 == uVar2) && (bVar4 = param_3[1] <= param_4[1], param_4[1] == param_3[1])) &&
     ((bVar4 = *param_3 <= *param_4, *param_4 == *param_3 &&
      (((bVar4 = param_3[2] <= param_4[2], param_4[2] == param_3[2] &&
       ...
       uVar1 == uVar2)))))) {
    if (*(float *)(param_3 + 4) <= *(float *)(param_4 + 4)) goto LAB_00a31f1c;
  }
  else if (bVar4) goto LAB_00a31f1c;
  uVar11 = *param_4;
  uVar10 = param_4[3];
  ...
  *param_4 = uVar12;
  ...
  if (((uVar1 == uVar2) && (bVar4 = param_2[1] <= param_3[1], param_3[1] == param_2[1])) &&
     (((bVar4 = *param_2 <= *param_3, *param_3 == *param_2 &&
      ...
      uVar1 == uVar2)))) {
    if (*(float *)(param_2 + 4) <= *(float *)(param_3 + 4)) goto LAB_00a31f1c;
  }
  else if (bVar4) goto LAB_00a31f1c;
  uVar11 = *param_3;
  uVar10 = param_3[3];
  ...
  *param_3 = uVar12;
  ...
  if (((((uVar1 == uVar2) && (bVar4 = param_1[1] <= param_2[1], param_2[1] == param_1[1])) &&
    ...
    if (*(float *)(param_1 + 4) <= *(float *)(param_2 + 4)) goto LAB_00a31f1c;
  }
  else if (bVar4) goto LAB_00a31f1c;
  uVar11 = *param_2;
  uVar10 = param_2[3];
