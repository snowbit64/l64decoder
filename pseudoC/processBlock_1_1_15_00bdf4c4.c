...
// Function: processBlock_1_1_15
// Entry Point: 00bdf4c4
// Size: 3396 bytes
// Signature: undefined __cdecl processBlock_1_1_15(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_1_1_15(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_1_1_15(CustomCipher *param_1,uchar *param_2)

{
  ...
  uVar15 = *(uint *)(param_1 + 0x28c);
  uVar16 = uVar1 >> 0xf | uVar1 << 0x11;
  uVar3 = *(uint *)(param_1 + 0x284);
  ...
  uVar2 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar16 >> 8 ^ uVar14 >> 0x10) & 0x3f) * 4) |
          ...
          *(uint *)(&DAT_0211ef98 + (ulong)((uVar15 ^ uVar16 >> 0x10) & 0x3f) * 4));
  uVar16 = uVar2 >> 0xf | uVar2 << 0x11;
  uVar15 = *(uint *)(param_1 + 0x26c);
  uVar14 = *(uint *)(param_1 + 0x268);
  uVar1 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar16 >> 8 ^ uVar4 >> 0x10) & 0x3f) * 4) |
           (&s_wPS)[(uVar16 >> 0xc ^ uVar4 >> 0x18) & 0x3f] |
           *(uint *)(&DAT_0211ea98 + (ulong)((uVar16 >> 4 ^ uVar4 >> 8) & 0x3f) * 4) |
          *(uint *)(&DAT_0211eb98 + (ulong)((uVar16 ^ uVar4) & 0x3f) * 4)) ^ uVar1 ^
  ...
  uVar2 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar4 >> 8 ^ uVar14 >> 0x10) & 0x3f) * 4) |
          ...
          *(uint *)(&DAT_0211eb98 + (ulong)((uVar4 ^ uVar14) & 0x3f) * 4)) ^ uVar2 ^
           ...
           *(uint *)(&DAT_0211ec98 + (ulong)((uVar15 >> 0x18 ^ uVar1 >> 0xb) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ee98 + (ulong)((uVar15 >> 8 ^ uVar1 >> 3) & 0x3f) * 4) |
          *(uint *)(&DAT_0211ef98 + (ulong)((uVar15 ^ uVar4 >> 0x10) & 0x3f) * 4));
  uVar15 = *(uint *)(param_1 + 0x220);
  uVar17 = uVar2 >> 0xf | uVar2 << 0x11;
  uVar4 = (&s_wPS)[(uVar17 >> 0xc ^ uVar15 >> 0x18) & 0x3f];
  uVar14 = *(uint *)(&DAT_0211ea98 + (ulong)((uVar17 >> 4 ^ uVar15 >> 8) & 0x3f) * 4);
  uVar16 = *(uint *)(&DAT_0211e998 + (ulong)((uVar17 >> 8 ^ uVar15 >> 0x10) & 0x3f) * 4);
  uVar15 = *(uint *)(&DAT_0211eb98 + (ulong)((uVar17 ^ uVar15) & 0x3f) * 4);
  CVar8 = param_1[0x2b1];
  uVar18 = (ulong)(byte)CVar8;
  uVar5 = *(uint *)(&DAT_0211ec98 + (ulong)((uVar3 >> 0x18 ^ uVar2 >> 0xb) & 0x3f) * 4);
  uVar6 = *(uint *)(&DAT_0211ed98 + (ulong)((uVar3 >> 0x10 ^ uVar2 >> 7) & 0x3f) * 4);
  uVar7 = *(uint *)(&DAT_0211ee98 + (ulong)((uVar3 >> 8 ^ uVar2 >> 3) & 0x3f) * 4);
  uVar3 = *(uint *)(&DAT_0211ef98 + (ulong)((uVar3 ^ uVar17 >> 0x10) & 0x3f) * 4);
  ...
  CVar9 = param_1[0x2b2];
  uVar19 = uVar18 + (byte)CVar9 & 0xff;
  uVar1 = (uVar16 | uVar4 | uVar14 | uVar15) ^ uVar1 ^ (uVar6 | uVar5 | uVar7 | uVar3) ^
  ...
  uVar2 = ((uint)(byte)CVar8 << 0x10 |
          ...
          uVar2;
  uVar15 = *(uint *)(s_wO_L4 + (ulong)(uVar1 >> 4 & 0xf) * 4) |
  ...
  *(uint *)(param_2 + 4) = uVar15 >> 0x10 | uVar15 << 0x10;
