...
/* std::__ndk1::__tree<std::__ndk1::__value_type<FileHashManager::FilenameHash,
   ...
   >::destroy(std::__ndk1::__tree_node<std::__ndk1::__value_type<FileHashManager::FilenameHash,
   FileHashManager::FileHash>, void*>*) */
