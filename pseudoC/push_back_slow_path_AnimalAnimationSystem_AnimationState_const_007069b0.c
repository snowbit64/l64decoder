...
// Function: __push_back_slow_path<AnimalAnimationSystem::AnimationState_const&>
// Entry Point: 007069b0
// Size: 464 bytes
// Signature: void __thiscall __push_back_slow_path<AnimalAnimationSystem::AnimationState_const&>(vector<AnimalAnimationSystem::AnimationState,std::__ndk1::allocator<AnimalAnimationSystem::AnimationState>> * this, AnimationState * param_1)


/* void std::__ndk1::vector<AnimalAnimationSystem::AnimationState,
   std::__ndk1::allocator<AnimalAnimationSystem::AnimationState>
   >::__push_back_slow_path<AnimalAnimationSystem::AnimationState
   const&>(AnimalAnimationSystem::AnimationState const&) */
...

{
  ...
  *puVar12 = *(undefined8 *)param_1;
                    /* try { // try from 00706a88 to 00706a8b has its CatchHandler @ 00706b80 */
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string((basic_string *)(puVar12 + 1));
  puVar2 = puVar12 + 5;
  puVar7 = *(undefined8 **)this;
  puVar8 = *(undefined8 **)(this + 8);
  *(undefined2 *)((long)pvVar4 + lVar6 * 8 + 0x20) = *(undefined2 *)(param_1 + 0x20);
  puVar11 = puVar7;
  if (puVar8 != puVar7) {
    do {
      puVar11 = puVar8 + -5;
      ...
      puVar8[-2] = 0;
      puVar8[-4] = 0;
      *(undefined2 *)(puVar12 + -1) = *(undefined2 *)(puVar8 + -1);
      puVar12 = puVar12 + -5;
      puVar8 = puVar11;
