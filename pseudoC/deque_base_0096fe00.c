...
// Entry Point: 0096fe00
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<TextureStreamingManager::DowngradePipeline::ReallocateRequest,std::__ndk1::allocator<TextureStreamingManager::DowngradePipeline::ReallocateRequest>> * this)


/* std::__ndk1::__deque_base<TextureStreamingManager::DowngradePipeline::ReallocateRequest,
...

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_0096fe6c;
    uVar4 = 0x80;
  }
