...
// Function: FUN_0074612c
// Entry Point: 0074612c
// Size: 440 bytes
// Signature: undefined FUN_0074612c(void)


void FUN_0074612c(void **param_1,undefined8 *param_2)

{
  ...
  if (puVar12 != (undefined8 *)param_1[3]) goto LAB_007462ac;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00746294;
      }
    }
    do {
      puVar11 = puVar8 + 1;
