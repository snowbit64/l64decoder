...
/* CryptoPP::DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,
   CryptoPP::SHA1>::bits2octets(CryptoPP::SecBlock<unsigned char,
   CryptoPP::AllocatorWithCleanup<unsigned char, false> > const&, CryptoPP::Integer const&) const */

void CryptoPP::DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA1>::bits2octets
...

{
  ...
  if ((uVar4 & 0xffffffff) <= (ulong)(*(long *)(param_2 + 0x10) * 8) && uVar2 != 0) {
                    /* try { // try from 00c89090 to 00c89097 has its CatchHandler @ 00c89170 */
    Integer::operator>>=((Integer *)local_78,uVar2);
  }
                    /* try { // try from 00c89098 to 00c890a7 has its CatchHandler @ 00c89180 */
  Integer::Minus((Integer *)local_78);
                    /* try { // try from 00c890ac to 00c890d3 has its CatchHandler @ 00c89188 */
  Integer::ByteCount();
  pppuVar1 = local_78;
  if (local_80 != 1) {
    pppuVar1 = local_a8;
  ...
  for (; local_98 != 0; local_98 = local_98 - 1) {
    *(undefined4 *)((long)local_88 + local_98 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00c8910c to 00c8910f has its CatchHandler @ 00c8917c */
  ...
  for (; local_68 != 0; local_68 = local_68 - 1) {
    *(undefined4 *)((long)local_58 + local_68 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00c89140 to 00c89143 has its CatchHandler @ 00c89178 */
