...
// Function: addTypeForBulkAdd
// Entry Point: 009c30a8
// Size: 92 bytes
// Signature: undefined __thiscall addTypeForBulkAdd(ProceduralPlacementCacheManager * this, basic_string * param_1, uint param_2, uint param_3)


/* ProceduralPlacementCacheManager::addTypeForBulkAdd(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, unsigned int, unsigned
   int) */

void __thiscall
ProceduralPlacementCacheManager::addTypeForBulkAdd
