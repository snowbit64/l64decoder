...
/* std::__ndk1::__split_buffer<VulkanRenderWindow::ReleasedSwapChain*,
   std::__ndk1::allocator<VulkanRenderWindow::ReleasedSwapChain*>
   >::push_front(VulkanRenderWindow::ReleasedSwapChain*&&) */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00ad6c50;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00ad6c38;
      }
    }
    do {
      puVar7 = puVar6 + 1;
