...
// Function: insert<std::__ndk1::__wrap_iter<unsigned_long_long*>>
// Entry Point: 00969e24
// Size: 1012 bytes
// Signature: type __thiscall insert<std::__ndk1::__wrap_iter<unsigned_long_long*>>(vector<unsigned_long_long,std::__ndk1::allocator<unsigned_long_long>> * this, __wrap_iter param_1, __wrap_iter param_2, __wrap_iter param_3)


/* std::__ndk1::enable_if<__is_cpp17_forward_iterator<std::__ndk1::__wrap_iter<unsigned long long*>
   >::value&&is_constructible<unsigned long long,
   std::__ndk1::iterator_traits<std::__ndk1::__wrap_iter<unsigned long long*> >::reference>::value,
   std::__ndk1::__wrap_iter<unsigned long long*> >::type std::__ndk1::vector<unsigned long long,
   std::__ndk1::allocator<unsigned long long> >::insert<std::__ndk1::__wrap_iter<unsigned long
   long*> >(std::__ndk1::__wrap_iter<unsigned long long const*>, std::__ndk1::__wrap_iter<unsigned
   long long*>, std::__ndk1::__wrap_iter<unsigned long long*>) */
...
insert<std::__ndk1::__wrap_iter<unsigned_long_long*>>
          (vector<unsigned_long_long,std::__ndk1::allocator<unsigned_long_long>> *this,
    ...
    if (lVar14 < lVar16) {
      ...
      if (puVar5 != puVar3) {
        ...
        if ((0x17 < uVar4) &&
          ...
          if (uVar4 == uVar11) goto LAB_0096a0ac;
        }
        do {
          puVar12 = puVar10 + 1;
          *puVar6 = *puVar10;
...
LAB_0096a0ac:
      *(undefined8 **)(this + 8) = puVar7;
      puVar3 = puVar5;
      if ((long)uVar8 < 1) goto LAB_0096a1e0;
    }
    ...
    if (puVar5 < puVar1) {
      ...
      if (0x17 < uVar4) {
        ...
        if (((undefined8 *)((long)__src_00 + (lVar13 + (uVar15 >> 3)) * 8 + 8) <= puVar7) ||
          ...
          puVar10 = puVar6;
          if (uVar15 == uVar9) goto LAB_0096a1b8;
        }
      }
      do {
        puVar12 = puVar5 + 1;
...
LAB_00969fb8:
    ...
    __src = __src + uVar11;
    if (uVar4 != uVar11) goto LAB_00969fb8;
  }
  if (0 < (long)uVar15) {
