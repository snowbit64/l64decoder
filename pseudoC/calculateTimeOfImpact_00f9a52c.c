...
/* btSoftBodyConcaveCollisionAlgorithm::calculateTimeOfImpact(btCollisionObject*,
   btCollisionObject*, btDispatcherInfo const&, btManifoldResult*) */

void btSoftBodyConcaveCollisionAlgorithm::calculateTimeOfImpact
...

{
  ...
  if ((*(float *)(param_2 + 0x11c) * *(float *)(param_2 + 0x11c) <= fVar6 + fVar5 * fVar5) &&
    ...
    local_148 = &PTR__btTriangleCallback_0101c5a0;
    local_124 = 0;
    local_114 = 0;
    local_104 = 0;
    local_f4 = 0;
