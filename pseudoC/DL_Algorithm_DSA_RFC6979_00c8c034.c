...

{
  ...
  *(undefined ***)this = &PTR__DL_Algorithm_DSA_RFC6979_00ff2898;
  ...
  if (this + 0xc0 + ((ulong)(uint)-(int)(this + 0xc0) & 8) == pDVar2) {
    this[0x149] = (DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA512>)0x0;
  ...
  *(undefined ***)(this + 8) = &PTR__IteratedHash_01000e98;
  ...
  if (pDVar2 == this + 0x20) {
    this[0xa1] = (DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA512>)0x0;
    for (; uVar1 != 0; uVar1 = uVar1 - 1) {
      *(undefined8 *)(pDVar2 + uVar1 * 8 + -8) = 0;
    }
  }
