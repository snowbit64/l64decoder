...
// Function: __append_forward_unsafe<char_const*>
// Entry Point: 00c35668
// Size: 600 bytes
// Signature: basic_string * __thiscall __append_forward_unsafe<char_const*>(basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> * this, char * param_1, char * param_2)


/* std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >&
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char>
   >::__append_forward_unsafe<char const*>(char const*, char const*) */
...

{
    ...
    *puVar13 = 0;
    ...
    if ((local_70 & 1) != 0) {
      puVar13 = local_60;
                    ...
                    /* try { // try from 00c357d8 to 00c357df has its CatchHandler @ 00c358c0 */
    std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  ...
  if (param_1 != param_2) {
    ...
    if ((0x1f < __n) &&
      ...
      if (__n == uVar9) goto LAB_00c35864;
    }
    do {
