...
// Entry Point: 008fddd0
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<TransformGroup*,std::__ndk1::allocator<TransformGroup*>> * this)


/* std::__ndk1::__deque_base<TransformGroup*, std::__ndk1::allocator<TransformGroup*>
   >::~__deque_base() */

void __thiscall
std::__ndk1::__deque_base<TransformGroup*,std::__ndk1::allocator<TransformGroup*>>::~__deque_base
          (__deque_base<TransformGroup*,std::__ndk1::allocator<TransformGroup*>> *this)

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_008fde3c;
    uVar4 = 0x200;
  }
