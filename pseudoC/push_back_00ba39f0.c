...
void __thiscall
std::__ndk1::
__split_buffer<ThreadPool::TaskAndMgr*,std::__ndk1::allocator<ThreadPool::TaskAndMgr*>&>::push_back
...

{
  ...
  if (ppTVar12 != *(TaskAndMgr ***)(this + 0x18)) goto LAB_00ba3b70;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00ba3b58;
      }
    }
    do {
      ppTVar11 = ppTVar8 + 1;
