...
/* std::__ndk1::__split_buffer<TextureStreamingManager::UpgradePipeline::WorkerResult*,
   ...
   >::push_front(TextureStreamingManager::UpgradePipeline::WorkerResult*&&) */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00978e60;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00978e48;
      }
    }
    do {
      puVar7 = puVar6 + 1;
