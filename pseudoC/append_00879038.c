...
// Function: __append
// Entry Point: 00879038
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<BehaviorContext*,std::__ndk1::allocator<BehaviorContext*>> * this, ulong param_1)


/* std::__ndk1::vector<BehaviorContext*, std::__ndk1::allocator<BehaviorContext*>
   >::__append(unsigned long) */

void __thiscall
std::__ndk1::vector<BehaviorContext*,std::__ndk1::allocator<BehaviorContext*>>::__append
          (vector<BehaviorContext*,std::__ndk1::allocator<BehaviorContext*>> *this,ulong param_1)
