...
/* CryptoPP::DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,
   CryptoPP::SHA256>::bits2octets(CryptoPP::SecBlock<unsigned char,
   CryptoPP::AllocatorWithCleanup<unsigned char, false> > const&, CryptoPP::Integer const&) const */

void CryptoPP::DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA256>::bits2octets
...

{
  ...
  if ((uVar4 & 0xffffffff) <= (ulong)(*(long *)(param_2 + 0x10) * 8) && uVar2 != 0) {
                    /* try { // try from 00c8acb0 to 00c8acb7 has its CatchHandler @ 00c8ad90 */
    Integer::operator>>=((Integer *)local_78,uVar2);
  }
                    /* try { // try from 00c8acb8 to 00c8acc7 has its CatchHandler @ 00c8ada0 */
  Integer::Minus((Integer *)local_78);
                    /* try { // try from 00c8accc to 00c8acf3 has its CatchHandler @ 00c8ada8 */
  Integer::ByteCount();
  pppuVar1 = local_78;
  if (local_80 != 1) {
    pppuVar1 = local_a8;
  ...
  for (; local_98 != 0; local_98 = local_98 - 1) {
    *(undefined4 *)((long)local_88 + local_98 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00c8ad2c to 00c8ad2f has its CatchHandler @ 00c8ad9c */
  ...
  for (; local_68 != 0; local_68 = local_68 - 1) {
    *(undefined4 *)((long)local_58 + local_68 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00c8ad60 to 00c8ad63 has its CatchHandler @ 00c8ad98 */
