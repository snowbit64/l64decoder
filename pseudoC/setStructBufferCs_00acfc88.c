...
// Function: setStructBufferCs
// Entry Point: 00acfc88
// Size: 180 bytes
// Signature: undefined __thiscall setStructBufferCs(VulkanCommandBuffer * this, uint param_1, IStructBuffer * param_2)


/* non-virtual thunk to VulkanCommandBuffer::setStructBufferCs(unsigned int, IStructBuffer*) */

void __thiscall
VulkanCommandBuffer::setStructBufferCs
...

{
  ...
  if (param_2 != (IStructBuffer *)0x0) {
    ...
    setBufferInternal(this + -8,param_1,pBVar1,1,2);
    return;
  }
  lVar2 = *(long *)(this + 0x838);
  lVar3 = *(long *)(this + 0x840) - lVar2 >> 3;
  uVar5 = lVar3 * -0x3333333333333333;
  if ((uint)uVar5 <= param_1) {
    uVar4 = (ulong)(param_1 + 1);
    if (uVar4 <= uVar5) {
      if (uVar4 <= uVar5 && uVar5 - uVar4 != 0) {
        *(ulong *)(this + 0x840) = lVar2 + uVar4 * 0x28;
      }
    }
    else {
      std::__ndk1::
      ...
      ::__append((vector<VulkanCommandBuffer::DescriptorSetElementInfo,std::__ndk1::allocator<VulkanCommandBuffer::DescriptorSetElementInfo>>
                  *)(this + 0x838),uVar4 + lVar3 * 0x3333333333333333);
      lVar2 = *(long *)(this + 0x838);
    }
  }
