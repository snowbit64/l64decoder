...
// Function: addToBorderAdd
// Entry Point: 008631c0
// Size: 328 bytes
// Signature: undefined __cdecl addToBorderAdd(deque * param_1, ushort param_2, short param_3, ushort * param_4, int param_5, int param_6, int param_7, int param_8, short * param_9, short * param_10, short * param_11, short * param_12)


/* DensityMapHeightUpdater::addToBorderAdd(std::__ndk1::deque<std::__ndk1::pair<short, short>,
...
void DensityMapHeightUpdater::addToBorderAdd
...

{
  ...
  if (((((param_2 & 0x4800) == 0) && (0 < param_7)) && (0 < param_8)) &&
     (((param_7 < param_5 + -1 && (param_8 < param_6 + -1)) &&
      ((int)(param_2 & 0x3ff) <= (int)param_3)))) {
    lVar3 = *(long *)(param_1 + 8);
    uVar5 = 0;
    if (*(long *)(param_1 + 0x10) - lVar3 != 0) {
      uVar5 = (*(long *)(param_1 + 0x10) - lVar3) * 0x80 - 1;
    }
    ...
    uVar5 = -(ulong)(uVar2 >> 0x1f) & 0xfffffffe00000000 | (ulong)uVar2 << 1;
    *(uint *)(*(long *)(lVar3 + (uVar4 >> 7 & 0x1fffffffffffff8)) + (uVar4 & 0x3ff) * 4) =
         param_7 & 0xffffU | param_8 << 0x10;
    lVar3 = *(long *)(param_1 + 0x28);
    *(ushort *)((long)param_4 + uVar5) = *(ushort *)((long)param_4 + uVar5) | 0x800;
    sVar1 = *param_9;
