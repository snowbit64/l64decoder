...
// Function: __append
// Entry Point: 00b2f3ec
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<_jstring*,std::__ndk1::allocator<_jstring*>> * this, ulong param_1)


/* std::__ndk1::vector<_jstring*, std::__ndk1::allocator<_jstring*> >::__append(unsigned long) */

void __thiscall
std::__ndk1::vector<_jstring*,std::__ndk1::allocator<_jstring*>>::__append
          (vector<_jstring*,std::__ndk1::allocator<_jstring*>> *this,ulong param_1)
