...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
// Entry Point: 00813c24
// Size: 3964 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
    ...
    if (((uVar20 < local_98) || (uVar25 < local_94)) || ((uVar21 < local_94 || (uVar24 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar31 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar31 != 0
                    ...
                    /* try { // try from 00814b64 to 00814b6f has its CatchHandler @ 00814ba0 */
              ...
              do {
                ...
                if ((iVar31 == 2) || ((iVar31 == 0) != ((uVar38 & uVar14) != uVar6))) {
                  ...
                  if (((int)uVar38 < iVar5) || (iVar28 < (int)uVar38)) {
                    if (DVar10 != (DensityMapFilter)0x0) goto LAB_00814878;
                  }
...
LAB_008148c4:
  uVar37 = uVar37 + 1;
  if (uVar37 == uVar27) goto LAB_00814898;
  goto LAB_008148d0;
LAB_00814898:
  uVar36 = uVar36 + 1;
  if (uVar36 == uVar24) goto LAB_0081472c;
  goto LAB_008148a8;
}
