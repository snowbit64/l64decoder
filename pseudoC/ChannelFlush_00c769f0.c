...
// Entry Point: 00c769f0
// Size: 296 bytes
// Signature: undefined __thiscall ChannelFlush(Unflushable<CryptoPP::Filter> * this, basic_string * param_1, bool param_2, int param_3, bool param_4)


/* CryptoPP::Unflushable<CryptoPP::Filter>::ChannelFlush(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, bool, int, bool) */

uint __thiscall
CryptoPP::Unflushable<CryptoPP::Filter>::ChannelFlush
          (Unflushable<CryptoPP::Filter> *this,basic_string *param_1,bool param_2,int param_3,
          bool param_4)

{
  ...
  if ((param_2) && (uVar3 = (**(code **)(*(long *)this + 0x198))(this), (uVar3 & 1) == 0)) {
    this_00 = (CannotFlush *)__cxa_allocate_exception(0x28);
                    /* try { // try from 00c76ad8 to 00c76ae7 has its CatchHandler @ 00c76b40 */
    std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
    basic_string<decltype(nullptr)>
              ((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
               abStack_60,"Unflushable<T>: this object has buffered input that cannot be flushed");
                    /* try { // try from 00c76aec to 00c76b13 has its CatchHandler @ 00c76b18 */
