...
/* std::__ndk1::__split_buffer<TransformGroup**,
   std::__ndk1::allocator<TransformGroup**>&>::push_back(TransformGroup**&&) */
...

{
  ...
  if (puVar12 != *(undefined8 **)(this + 0x18)) goto LAB_00900bc0;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00900ba8;
      }
    }
    do {
      puVar11 = puVar8 + 1;
