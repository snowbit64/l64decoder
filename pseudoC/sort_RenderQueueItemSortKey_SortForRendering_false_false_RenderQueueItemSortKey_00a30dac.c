...
// Function: __sort<RenderQueueItemSortKey::SortForRendering<false,false>&,RenderQueueItemSortKey*>
// Entry Point: 00a30dac
// Size: 2288 bytes
// Signature: void __cdecl __sort<RenderQueueItemSortKey::SortForRendering<false,false>&,RenderQueueItemSortKey*>(RenderQueueItemSortKey * param_1, RenderQueueItemSortKey * param_2, SortForRendering * param_3)


/* void std::__ndk1::__sort<RenderQueueItemSortKey::SortForRendering<false, false>&,
...
LAB_00a30df8:
  ...
  case 2:
    ...
    else if (bVar9) goto switchD_00a3154c_caseD_0;
  ...
  case 4:
    ...
    goto switchD_00a3154c_caseD_0;
  case 5:
    FUN_00a31c48(param_1,(ulong *)((long)param_1 + 0x28),(ulong *)((long)param_1 + 0x50),
  ...
  if (uVar13 < 0x9c19) {
    ...
    uVar11 = __sort3<RenderQueueItemSortKey::SortForRendering<false,false>&,RenderQueueItemSortKey*>
                       (param_1,(RenderQueueItemSortKey *)puVar20,(RenderQueueItemSortKey *)puVar19,
                        param_3);
  }
  else {
    puVar20 = (ulong *)((long)param_1 + (uVar13 / 0x50) * 5 * 8);
    uVar11 = FUN_00a31c48(param_1,(ulong *)((long)param_1 + (uVar13 / 0xa0) * 5 * 8),puVar20,
  ...
  if ((((uVar4 == uVar5) &&
    ...
    if (*(float *)(puVar20 + 4) <= fVar22) goto LAB_00a30f04;
LAB_00a310d4:
...
LAB_00a310e0:
      ...
      do {
        ...
        if ((((uVar5 == uVar4) && (bVar9 = puVar20[1] <= puVar21[1], puVar21[1] == puVar20[1])) &&
          ...
          if (*(float *)(puVar20 + 4) <= *(float *)(puVar21 + 4)) goto LAB_00a3116c;
        }
        else if (bVar9) goto LAB_00a3116c;
        puVar21 = puVar21 + 5;
      } while( true );
    }
LAB_00a3124c:
...
LAB_00a312d4:
      ...
      else if (!bVar9) goto LAB_00a312d4;
    }
    if (uVar11 == 0) {
      bVar9 = __insertion_sort_incomplete<RenderQueueItemSortKey::SortForRendering<false,false>&,RenderQueueItemSortKey*>
                        (param_1,(RenderQueueItemSortKey *)puVar21,param_3);
      bVar10 = __insertion_sort_incomplete<RenderQueueItemSortKey::SortForRendering<false,false>&,RenderQueueItemSortKey*>
                         ((RenderQueueItemSortKey *)(puVar21 + 5),param_2,param_3);
      if (bVar10) goto LAB_00a3152c;
      puVar20 = puVar21 + 5;
      if (bVar9) goto LAB_00a30df8;
    }
...
LAB_00a310a0:
      ...
      else if (!bVar9) goto LAB_00a310a0;
      puVar15 = puVar15 + -5;
  ...
  if (((uVar4 == uVar11) &&
     ...
     (((bVar9 = *puVar19 <= *(ulong *)param_1, *(ulong *)param_1 == *puVar19 &&
      ...
      uVar2 >> 0x1f == uVar11)))) {
    if (*(float *)((long)param_2 + -8) <= fVar22) goto LAB_00a31014;
    goto LAB_00a313a8;
  }
  if (bVar9) {
LAB_00a31014:
    if (puVar20 != puVar19) {
      do {
        ...
        if (((((uVar4 == uVar11) &&
          ...
          if (fVar22 < *(float *)(puVar20 + 4)) goto LAB_00a31374;
        }
        else if (!bVar9) goto LAB_00a31374;
        puVar20 = puVar20 + 5;
      ...
      if (((uVar2 == uVar4) &&
         ...
         ((bVar9 = *puVar20 <= *(ulong *)param_1, *(ulong *)param_1 == *puVar20 &&
          (((bVar9 = puVar20[2] <= *(ulong *)((long)param_1 + 0x10),
           ...
           uVar11 == uVar4)))))) {
        if (*(float *)((long)param_1 + 0x20) < *(float *)(puVar20 + 4)) goto LAB_00a31440;
      }
      else if (!bVar9) goto LAB_00a31440;
      puVar20 = puVar20 + 5;
    } while( true );
  }
  goto switchD_00a3154c_caseD_0;
...
LAB_00a31440:
  ...
  if (puVar15 <= puVar20) goto LAB_00a30df8;
  uVar27 = puVar20[1];
  uVar25 = *puVar20;
  uVar17 = puVar20[3];
  uVar23 = puVar20[2];
...
LAB_00a3116c:
  ...
  if (puVar15 < puVar21) goto LAB_00a3124c;
  uVar24 = puVar21[1];
  uVar23 = *puVar21;
  uVar16 = puVar21[3];
  uVar13 = puVar21[2];
