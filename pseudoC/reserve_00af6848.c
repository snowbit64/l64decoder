...
// Function: reserve
// Entry Point: 00af6848
// Size: 208 bytes
// Signature: undefined __thiscall reserve(vector<GiantsAdsProvider::Impression,std::__ndk1::allocator<GiantsAdsProvider::Impression>> * this, ulong param_1)


/* std::__ndk1::vector<GiantsAdsProvider::Impression,
   std::__ndk1::allocator<GiantsAdsProvider::Impression> >::reserve(unsigned long) */

void __thiscall
std::__ndk1::
vector<GiantsAdsProvider::Impression,std::__ndk1::allocator<GiantsAdsProvider::Impression>>::reserve
