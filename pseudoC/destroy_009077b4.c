...
// Function: destroy
// Entry Point: 009077b4
// Size: 64 bytes
// Signature: undefined __thiscall destroy(__tree<std::__ndk1::__value_type<unsigned_int,I3DManager::SharedI3D*>,std::__ndk1::__map_value_compare<unsigned_int,std::__ndk1::__value_type<unsigned_int,I3DManager::SharedI3D*>,std::__ndk1::less<unsigned_int>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<unsigned_int,I3DManager::SharedI3D*>>> * this, __tree_node * param_1)


/* std::__ndk1::__tree<std::__ndk1::__value_type<unsigned int, I3DManager::SharedI3D*>,
   std::__ndk1::__map_value_compare<unsigned int, std::__ndk1::__value_type<unsigned int,
   I3DManager::SharedI3D*>, std::__ndk1::less<unsigned int>, true>,
   std::__ndk1::allocator<std::__ndk1::__value_type<unsigned int, I3DManager::SharedI3D*> >
   >::destroy(std::__ndk1::__tree_node<std::__ndk1::__value_type<unsigned int,
   I3DManager::SharedI3D*>, void*>*) */
