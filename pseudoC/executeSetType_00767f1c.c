...
// Function: executeSetType
// Entry Point: 00767f1c
// Size: 280 bytes
// Signature: undefined __thiscall executeSetType(DensityMapModifierLua * this, MethodInvocation * param_1)


/* DensityMapModifierLua::executeSetType(MethodInvocation*) */

void __thiscall
DensityMapModifierLua::executeSetType(DensityMapModifierLua *this,MethodInvocation *param_1)

{
  ...
  uVar5 = getFilters(this,param_1,0,"DensityMapModifier:executeSetType",&pDStack_b0,&local_b8,
                     &local_c0);
  if ((uVar5 & 1) != 0) {
    plVar6 = *(long **)this;
    ...
    DensityMapOperations::setTypeIndex<ParallelogramHelper>
              (aPStack_a8,pDStack_b0,local_b8,local_c0,*(uint *)(this + 0x30),&local_c8,&uStack_c4);
    *(uint *)(param_1 + 0x100) = uStack_c4;
    *(undefined4 *)(param_1 + 0x108) = 1;
    *(uint *)(param_1 + 0x110) = local_c8;
