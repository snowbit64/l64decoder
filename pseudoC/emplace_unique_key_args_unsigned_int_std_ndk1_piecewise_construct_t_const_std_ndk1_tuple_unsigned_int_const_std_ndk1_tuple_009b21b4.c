...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<unsigned
   int, Bt2Rope*>, void*>*>, bool> std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned
   int, Bt2Rope*>, std::__ndk1::__unordered_map_hasher<unsigned int,
   std::__ndk1::__hash_value_type<unsigned int, Bt2Rope*>, std::__ndk1::hash<unsigned int>, true>,
   std::__ndk1::__unordered_map_equal<unsigned int, std::__ndk1::__hash_value_type<unsigned int,
   Bt2Rope*>, std::__ndk1::equal_to<unsigned int>, true>,
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned int, Bt2Rope*> >
  ...
  if (plVar10 != (long *)0x0) {
    ...
    if (pplVar9 != (long **)0x0) {
      do {
        ...
        if (pplVar9 == (long **)0x0) goto LAB_009b2274;
        plVar6 = pplVar9[1];
        if (plVar6 != plVar11) {
          if (uVar3 < 2) {
          ...
          if (plVar6 != unaff_x24) goto LAB_009b2274;
        }
  ...
  if ((plVar10 == (long *)0x0) || (fVar14 * (float)ZEXT89(plVar10) < (float)(unkuint9)(lVar4 + 1)))
  {
    ...
    if (uVar7 <= uVar3) {
      uVar7 = uVar3;
                    ...
                    /* try { // try from 009b22e8 to 009b22ef has its CatchHandler @ 009b23bc */
