...
// Entry Point: 00a4eef4
// Size: 64 bytes
// Signature: undefined __cdecl setPositionImpl(float * param_1)


/* AudioSourceSample::setPositionImpl(float const*) */

void AudioSourceSample::setPositionImpl(float *param_1)

{
  ...
  if (*(long **)(pfVar1 + 0xc) != (long *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00a4ef2c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(**(long **)(pfVar1 + 0xc) + 0x58))();
    return;
  }
  return;
}
