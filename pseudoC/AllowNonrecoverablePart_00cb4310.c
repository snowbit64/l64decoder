...
void CryptoPP::PK_SignatureMessageEncodingMethod::AllowNonrecoverablePart(void)

{
  ...
  puVar1 = (undefined8 *)__cxa_allocate_exception(0x28);
                    /* try { // try from 00cb432c to 00cb4333 has its CatchHandler @ 00cb43fc */
  ...
  *(undefined4 *)(puVar1 + 1) = 0;
                    /* try { // try from 00cb4384 to 00cb438b has its CatchHandler @ 00cb43d0 */
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string((basic_string *)(puVar1 + 2));
  *puVar1 = &PTR__Exception_00fe0270;
                    /* try { // try from 00cb439c to 00cb43b3 has its CatchHandler @ 00cb43b4 */
