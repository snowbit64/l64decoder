...
// Entry Point: 009946fc
// Size: 60 bytes
// Signature: undefined __thiscall setLinearDamping(Bt2PhysicsRBObject * this, float param_1)


/* Bt2PhysicsRBObject::setLinearDamping(float) */

void __thiscall Bt2PhysicsRBObject::setLinearDamping(Bt2PhysicsRBObject *this,float param_1)
