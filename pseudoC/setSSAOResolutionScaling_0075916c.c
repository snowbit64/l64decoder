...
// Function: setSSAOResolutionScaling
// Entry Point: 0075916c
// Size: 220 bytes
// Signature: undefined __thiscall setSSAOResolutionScaling(HardwareScalability * this, float param_1)


/* HardwareScalability::setSSAOResolutionScaling(float) */

void __thiscall
HardwareScalability::setSSAOResolutionScaling(HardwareScalability *this,float param_1)
