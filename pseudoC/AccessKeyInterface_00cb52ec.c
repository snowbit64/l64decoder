...
/* non-virtual thunk to CryptoPP::DL_ObjectImplBase<CryptoPP::DL_SignerBase<CryptoPP::Integer>,
   ...
   CryptoPP::DSA2<CryptoPP::SHA1> > >::AccessKeyInterface() */
