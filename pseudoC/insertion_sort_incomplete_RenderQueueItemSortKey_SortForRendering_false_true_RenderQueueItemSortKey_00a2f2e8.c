...
// Function: __insertion_sort_incomplete<RenderQueueItemSortKey::SortForRendering<false,true>&,RenderQueueItemSortKey*>
// Entry Point: 00a2f2e8
// Size: 868 bytes
// Signature: bool __cdecl __insertion_sort_incomplete<RenderQueueItemSortKey::SortForRendering<false,true>&,RenderQueueItemSortKey*>(RenderQueueItemSortKey * param_1, RenderQueueItemSortKey * param_2, SortForRendering * param_3)


/* bool std::__ndk1::__insertion_sort_incomplete<RenderQueueItemSortKey::SortForRendering<false,
   true>&, RenderQueueItemSortKey*>(RenderQueueItemSortKey*, RenderQueueItemSortKey*,
   RenderQueueItemSortKey::SortForRendering<false, true>&) */

bool std::__ndk1::
     __insertion_sort_incomplete<RenderQueueItemSortKey::SortForRendering<false,true>&,RenderQueueItemSortKey*>
...
LAB_00a2f5e8:
      ...
      else if (!bVar6) goto LAB_00a2f5e8;
      break;
    case 3:
    ...
    case 4:
      ...
      break;
    case 5:
      FUN_00a2ee08(param_1,param_1 + 0x28,param_1 + 0x50,param_1 + 0x78,param_2 + -0x28);
    }
  }
  else {
    __sort3<RenderQueueItemSortKey::SortForRendering<false,true>&,RenderQueueItemSortKey*>
...
LAB_00a2f56c:
          ...
          else if (!bVar6) goto LAB_00a2f4d8;
        }
        else if (uVar3 < uVar4) {
          uVar7 = puVar13[1];
          goto LAB_00a2f4d8;
