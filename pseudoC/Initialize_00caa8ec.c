...
// Function: Initialize
// Entry Point: 00caa8ec
// Size: 188 bytes
// Signature: undefined __thiscall Initialize(DL_PrivateKey_ECGDSA<CryptoPP::ECP> * this, RandomNumberGenerator * param_1, ECP * param_2, ECPPoint * param_3, Integer * param_4)
...
CryptoPP::DL_PrivateKey_ECGDSA<CryptoPP::ECP>::Initialize
          (DL_PrivateKey_ECGDSA<CryptoPP::ECP> *this,RandomNumberGenerator *param_1,ECP *param_2,
...

{
  ...
  DL_GroupParameters_EC<CryptoPP::ECP>::DL_GroupParameters_EC
            ((DL_GroupParameters_EC<CryptoPP::ECP> *)local_1d0,param_2,param_3,param_4,pIVar2);
                    /* try { // try from 00caa95c to 00caa967 has its CatchHandler @ 00caa9a8 */
  (**(code **)(*(long *)this + 0x48))
