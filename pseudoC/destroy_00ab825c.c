...
// Function: destroy
// Entry Point: 00ab825c
// Size: 64 bytes
// Signature: undefined __thiscall destroy(__tree<std::__ndk1::__value_type<DepthStencilStateDesc,std::__ndk1::pair<VkPipelineDepthStencilStateCreateInfo,unsigned_int>>,std::__ndk1::__map_value_compare<DepthStencilStateDesc,std::__ndk1::__value_type<DepthStencilStateDesc,std::__ndk1::pair<VkPipelineDepthStencilStateCreateInfo,unsigned_int>>,ComparerUtil::DepthStencilStateDescComparer,true>,std::__ndk1::allocator<std::__ndk1::__value_type<DepthStencilStateDesc,std::__ndk1::pair<VkPipelineDepthStencilStateCreateInfo,unsigned_int>>>> * this, __tree_node * param_1)
...
/* std::__ndk1::__tree<std::__ndk1::__value_type<DepthStencilStateDesc,
   ...
   std::__ndk1::pair<VkPipelineDepthStencilStateCreateInfo, unsigned int> > >
   >::destroy(std::__ndk1::__tree_node<std::__ndk1::__value_type<DepthStencilStateDesc,
   std::__ndk1::pair<VkPipelineDepthStencilStateCreateInfo, unsigned int> >, void*>*) */
