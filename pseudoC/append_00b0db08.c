...
// Function: __append
// Entry Point: 00b0db08
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<SoftAudioSource*,std::__ndk1::allocator<SoftAudioSource*>> * this, ulong param_1)


/* std::__ndk1::vector<SoftAudioSource*, std::__ndk1::allocator<SoftAudioSource*>
   >::__append(unsigned long) */

void __thiscall
std::__ndk1::vector<SoftAudioSource*,std::__ndk1::allocator<SoftAudioSource*>>::__append
          (vector<SoftAudioSource*,std::__ndk1::allocator<SoftAudioSource*>> *this,ulong param_1)
