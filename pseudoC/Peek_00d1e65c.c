...
// Function: Peek
// Entry Point: 00d1e65c
// Size: 172 bytes
// Signature: undefined __thiscall Peek(ByteQueue * this, uchar * param_1, ulong param_2)


/* CryptoPP::ByteQueue::Peek(unsigned char*, unsigned long) const */

void __thiscall CryptoPP::ByteQueue::Peek(ByteQueue *this,uchar *param_1,ulong param_2)
