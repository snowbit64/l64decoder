...
// Entry Point: 00b9fe84
// Size: 616 bytes
// Signature: undefined __cdecl utf8ToLower(char * param_1)


/* WARNING: Removing unreachable block (ram,0x00ba00c0) */
/* StringUtil::utf8ToLower(char const*) */

void StringUtil::utf8ToLower(char *param_1)
  ...
  if (bVar2 == 0) {
    ...
    while (bVar2 != 0) {
      ...
      if ((char)bVar2 < '\0') {
        ...
        if (uVar11 < 0xffff) goto LAB_00b9ffc0;
        ...
        do {
          while( true ) {
            ...
            if (*(ushort *)
                 ...
                 (-(ulong)(uVar1 >> 0x1f) & 0xfffffffc00000000 | (ulong)uVar1 << 2)) <= uVar11) {
              uVar11 = (uint)*(ushort *)
                              (s_lowerCaseMappings + ((long)((ulong)uVar5 << 0x20) >> 0x21) * 4 + 2)
              ;
              goto LAB_00ba0018;
            }
            iVar9 = uVar1 - 1;
            if (iVar9 < iVar12) goto LAB_00ba0018;
          }
          iVar12 = uVar1 + 1;
        } while (iVar12 <= iVar9);
LAB_00ba0018:
        ...
        if (uVar11 < 0x80) {
          ...
          *pbVar8 = (byte)uVar11;
          ...
          if (0x7ff < uVar11) goto LAB_00ba004c;
          iVar12 = 2;
