...
// Function: setStructBufferPs
// Entry Point: 00acfb20
// Size: 180 bytes
// Signature: undefined __thiscall setStructBufferPs(VulkanCommandBuffer * this, uint param_1, IStructBuffer * param_2)


/* VulkanCommandBuffer::setStructBufferPs(unsigned int, IStructBuffer*) */

void __thiscall
VulkanCommandBuffer::setStructBufferPs
  ...
  if ((uint)uVar5 <= param_1) {
    ...
    if (uVar4 <= uVar5) {
      ...
      ::__append((vector<VulkanCommandBuffer::DescriptorSetElementInfo,std::__ndk1::allocator<VulkanCommandBuffer::DescriptorSetElementInfo>>
                  *)(this + 0x6c0),uVar4 + lVar3 * 0x3333333333333333);
      lVar2 = *(long *)(this + 0x6c0);
    }
  }
