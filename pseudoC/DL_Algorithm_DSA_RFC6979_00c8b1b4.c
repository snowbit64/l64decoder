...

{
  ...
  *(undefined ***)(this + -8) = &PTR__DL_Algorithm_DSA_RFC6979_00ff27c0;
  *(undefined ***)this = &PTR__DL_Algorithm_DSA_RFC6979_00ff2818;
  HMAC<CryptoPP::SHA384>::~HMAC((HMAC<CryptoPP::SHA384> *)(this + 0x168));
  pDVar2 = *(DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA384> **)(this + 0x160);
  ...
  if (this + 0xc0 + ((ulong)(uint)-(int)(this + 0xc0) & 8) == pDVar2) {
    this[0x149] = (DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA384>)0x0;
    for (; uVar1 != 0; uVar1 = uVar1 - 1) {
      *(undefined8 *)(pDVar2 + uVar1 * 8 + -8) = 0;
    }
  }
  pDVar2 = *(DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA384> **)(this + 0xb8);
  *(undefined ***)(this + 8) = &PTR__IteratedHash_01000e98;
  uVar1 = *(ulong *)(this + 0xa8);
  if (*(ulong *)(this + 0xb0) <= *(ulong *)(this + 0xa8)) {
    uVar1 = *(ulong *)(this + 0xb0);
  }
  if (pDVar2 == this + 0x20) {
    this[0xa1] = (DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA384>)0x0;
    for (; uVar1 != 0; uVar1 = uVar1 - 1) {
      *(undefined8 *)(pDVar2 + uVar1 * 8 + -8) = 0;
    }
  }
