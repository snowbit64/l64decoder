...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 007e4e0c
// Size: 4396 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
    ...
    if (((uVar21 < local_98) || (uVar26 < local_94)) || ((uVar22 < local_94 || (uVar25 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar34 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar34 != 0
                    ...
                    /* try { // try from 007e5efc to 007e5f07 has its CatchHandler @ 007e5f38 */
            ...
            do {
              ...
              if ((iVar6 == 2) || ((iVar6 == 0) != ((uVar40 & uVar15) != uVar7))) {
                ...
                if (((int)uVar40 < iVar34) || (iVar29 < (int)uVar40)) {
                  if (DVar11 != (DensityMapFilter)0x0) goto LAB_007e5b3c;
                }
...
LAB_007e5750:
  ...
  if (param_6[100] != (SetDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar38,*(uint *)(param_6 + 0x1c),*(uint *)(param_6 + 0x20),
...
LAB_007e5ca4:
      ...
      if (iVar10 == 2) goto LAB_007e5ca4;
LAB_007e5c84:
      if ((iVar10 == 0) != ((uVar30 & uVar17) != uVar9)) goto LAB_007e5ca4;
LAB_007e5bac:
      uVar32 = uVar32 + 1;
      uVar4 = uVar4 + 1;
    } while (uVar32 != uVar36);
...
LAB_007e59fc:
  uVar38 = uVar38 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar38) goto LAB_007e598c;
  goto LAB_007e5a24;
}
