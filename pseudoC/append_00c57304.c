...
// Function: __append
// Entry Point: 00c57304
// Size: 420 bytes
// Signature: undefined __thiscall __append(vector<StructFieldMapping,std::__ndk1::allocator<StructFieldMapping>> * this, ulong param_1)


/* std::__ndk1::vector<StructFieldMapping, std::__ndk1::allocator<StructFieldMapping>
   >::__append(unsigned long) */

void __thiscall
std::__ndk1::vector<StructFieldMapping,std::__ndk1::allocator<StructFieldMapping>>::__append
          (vector<StructFieldMapping,std::__ndk1::allocator<StructFieldMapping>> *this,ulong param_1
          )
