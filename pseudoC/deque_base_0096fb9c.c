...
// Entry Point: 0096fb9c
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<TextureStreamingManager::ChangeRequest,std::__ndk1::allocator<TextureStreamingManager::ChangeRequest>> * this)


/* std::__ndk1::__deque_base<TextureStreamingManager::ChangeRequest,
   std::__ndk1::allocator<TextureStreamingManager::ChangeRequest> >::~__deque_base() */
...

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_0096fc08;
    uVar4 = 0xaa;
  }
