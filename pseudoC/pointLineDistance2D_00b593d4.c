...
// Function: pointLineDistance2D
// Entry Point: 00b593d4
// Size: 72 bytes
// Signature: undefined __cdecl pointLineDistance2D(Vector2 * param_1, Vector2 * param_2, Vector2 * param_3)


/* MathUtil::pointLineDistance2D(Vector2 const&, Vector2 const&, Vector2 const&) */

float MathUtil::pointLineDistance2D(Vector2 *param_1,Vector2 *param_2,Vector2 *param_3)
