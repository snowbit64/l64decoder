...
// Function: __append
// Entry Point: 00a180ac
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<AudioSourceQueueItem,std::__ndk1::allocator<AudioSourceQueueItem>> * this, ulong param_1)


/* std::__ndk1::vector<AudioSourceQueueItem, std::__ndk1::allocator<AudioSourceQueueItem>
   >::__append(unsigned long) */

void __thiscall
std::__ndk1::vector<AudioSourceQueueItem,std::__ndk1::allocator<AudioSourceQueueItem>>::__append
          (vector<AudioSourceQueueItem,std::__ndk1::allocator<AudioSourceQueueItem>> *this,
          ulong param_1)
