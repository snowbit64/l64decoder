...
// Function: NewText
// Entry Point: 00dfc9e8
// Size: 380 bytes
// Signature: undefined __thiscall NewText(XMLDocument * this, char * param_1)
...

{
  ...
  puVar4 = (undefined8 *)(**(code **)(*(long *)(this + 0x208) + 0x18))(this + 0x208);
  puVar4[5] = 0;
  ...
  *puVar4 = &PTR_ToElement_010136c0;
  puVar4[1] = this;
  *(undefined *)(puVar4 + 0xd) = 0;
  puVar4[0xc] = this + 0x208;
  if (iVar9 < iVar2) {
