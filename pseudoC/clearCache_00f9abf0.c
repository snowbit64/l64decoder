...
void btSoftBodyTriangleCallback::clearCache(void)

{
  ...
  if (0 < *(int *)(in_x0 + 0x9c)) {
    ...
    do {
      ...
      pplVar8 = (long **)(*(long *)(in_x0 + 0xa8) + lVar7 * 0x10 + 8);
      plVar6 = *pplVar8;
      if (0 < iVar5) {
        lVar10 = 0;
        do {
            ...
            do {
              while (pvVar4 = pvVar3, pvVar3 = *(void **)((long)pvVar4 + 0x120),
                ...
                *ppvVar2 = pvVar3;
                ...
                if (pvVar3 == (void *)0x0) goto LAB_00f9ac5c;
              }
              pvVar11 = pvVar4;
