...
// Function: destroy
// Entry Point: 009222b4
// Size: 64 bytes
// Signature: undefined __thiscall destroy(__tree<std::__ndk1::__value_type<TransformGroup*,I3DSave::I3DTransformPoseObject>,std::__ndk1::__map_value_compare<TransformGroup*,std::__ndk1::__value_type<TransformGroup*,I3DSave::I3DTransformPoseObject>,std::__ndk1::less<TransformGroup*>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<TransformGroup*,I3DSave::I3DTransformPoseObject>>> * this, __tree_node * param_1)


/* std::__ndk1::__tree<std::__ndk1::__value_type<TransformGroup*, I3DSave::I3DTransformPoseObject>,
   std::__ndk1::__map_value_compare<TransformGroup*, std::__ndk1::__value_type<TransformGroup*,
   I3DSave::I3DTransformPoseObject>, std::__ndk1::less<TransformGroup*>, true>,
   std::__ndk1::allocator<std::__ndk1::__value_type<TransformGroup*,
   I3DSave::I3DTransformPoseObject> >
   >::destroy(std::__ndk1::__tree_node<std::__ndk1::__value_type<TransformGroup*,
   I3DSave::I3DTransformPoseObject>, void*>*) */
