...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
// Entry Point: 00815bc0
// Size: 3968 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
    ...
    if (((uVar20 < local_98) || (uVar24 < local_94)) || ((uVar21 < local_94 || (uVar23 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar31 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar31 != 0
                    ...
                    /* try { // try from 00816b04 to 00816b0f has its CatchHandler @ 00816b40 */
              ...
              do {
                ...
                if ((iVar6 == 2) || ((iVar6 == 0) != ((uVar29 & uVar14) != uVar5))) {
                  ...
                  if (((int)uVar29 < iVar31) || (iVar28 < (int)uVar29)) {
                    if (DVar10 != (DensityMapFilter)0x0) goto LAB_008167b8;
                  }
...
LAB_0081646c:
  ...
  if (param_6[0x5c] != (SetTypeProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar35,*(uint *)(param_6 + 0x14),*(uint *)(param_6 + 0x18),
...
LAB_0081683c:
  uVar29 = uVar29 + 1;
  uVar3 = uVar3 + uVar25;
  if (uVar29 == uVar21) goto LAB_008167f8;
  goto LAB_0081684c;
LAB_008167f8:
  uVar36 = uVar36 + 1;
  uVar37 = uVar37 + uVar23 * uVar25;
  if (uVar36 == uVar27) goto LAB_008166cc;
  goto LAB_00816810;
}
