...
// Function: __push_back_slow_path<ProceduralPlacementRule::ProceduralPlacementScriptArgDesc>
// Entry Point: 009e75e4
// Size: 532 bytes
// Signature: void __cdecl __push_back_slow_path<ProceduralPlacementRule::ProceduralPlacementScriptArgDesc>(ProceduralPlacementScriptArgDesc * param_1)
...
/* void std::__ndk1::vector<ProceduralPlacementRule::ProceduralPlacementScriptArgDesc,
   ...
   >::__push_back_slow_path<ProceduralPlacementRule::ProceduralPlacementScriptArgDesc>(ProceduralPlacementRule::ProceduralPlacementScriptArgDesc&&)
    */
...

{
  ...
  local_78 = pbVar12;
  pbStack_70 = pbVar12;
                    /* try { // try from 009e76c4 to 009e76cf has its CatchHandler @ 009e7838 */
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string(pbVar12);
                    /* try { // try from 009e76e0 to 009e76e7 has its CatchHandler @ 009e7818 */
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string((basic_string *)((long)pvVar5 + lVar6 * 8 + 0x18));
                    /* try { // try from 009e76f8 to 009e76fb has its CatchHandler @ 009e77f8 */
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string((basic_string *)((long)pvVar5 + lVar6 * 8 + 0x30));
  pbStack_70 = pbVar12 + 0x12;
                    /* try { // try from 009e7710 to 009e7717 has its CatchHandler @ 009e7838 */
  ...
  *(void **)(param_1 + 0x10) = local_68;
  ...
  do {
    ...
    if ((*(byte *)(pbVar4 + -6) & 1) == 0) {
      if ((*(byte *)(pbVar4 + -0xc) & 1) != 0) goto LAB_009e77b8;
LAB_009e779c:
      bVar2 = *(byte *)pbVar10;
    }
    else {
      operator_delete(*(void **)(pbVar4 + -2));
      if ((*(byte *)(pbVar4 + -0xc) & 1) == 0) goto LAB_009e779c;
LAB_009e77b8:
