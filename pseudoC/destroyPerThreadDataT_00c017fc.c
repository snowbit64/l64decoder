...
// Entry Point: 00c017fc
// Size: 52 bytes
// Signature: undefined __thiscall destroyPerThreadDataT(Main * this, PerThreadData * param_1)


/* DictionaryCreator::Main::destroyPerThreadDataT(DictionaryCreator::PerThreadData*) */

void __thiscall DictionaryCreator::Main::destroyPerThreadDataT(Main *this,PerThreadData *param_1)
