...
// Function: removeObjectFoliage
// Entry Point: 009d3b0c
// Size: 296 bytes
// Signature: undefined __thiscall removeObjectFoliage(ProceduralPlacementManager * this, basic_string * param_1)


/* ProceduralPlacementManager::removeObjectFoliage(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void __thiscall
ProceduralPlacementManager::removeObjectFoliage
...

{
  ...
  __s2 = *(byte **)(param_1 + 4);
  __dest = *(byte ***)(this + 0x20);
  ppbVar3 = *(byte ***)(this + 0x28);
  if ((*(byte *)param_1 & 1) == 0) {
