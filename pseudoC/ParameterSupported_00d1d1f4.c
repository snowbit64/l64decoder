...
// Entry Point: 00d1d1f4
// Size: 52 bytes
// Signature: undefined __thiscall ParameterSupported(TF_CryptoSystemBase<CryptoPP::PK_Encryptor,CryptoPP::TF_Base<CryptoPP::RandomizedTrapdoorFunction,CryptoPP::PK_EncryptionMessageEncodingMethod>> * this, char * param_1)
...

{
  ...
  plVar1 = (long *)(**(code **)(*(long *)(this + 0x10) + 0x20))();
                    /* WARNING: Could not recover jumptable at 0x00d1d224. Too many branches */
