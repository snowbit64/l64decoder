...
// Entry Point: 00acf758
// Size: 180 bytes
// Signature: undefined __thiscall setConstantBuffer(VulkanCommandBuffer * this, uint param_1, IConstantBuffer * param_2)


/* VulkanCommandBuffer::setConstantBuffer(unsigned int, IConstantBuffer*) */
...

{
  ...
  if (param_2 != (IConstantBuffer *)0x0) {
    ...
    setBufferInternal(this,param_1,pBVar1,0,3);
    return;
  }
  lVar2 = *(long *)(this + 0x680);
  lVar3 = *(long *)(this + 0x688) - lVar2 >> 3;
  uVar5 = lVar3 * -0x3333333333333333;
  if ((uint)uVar5 <= param_1) {
    uVar4 = (ulong)(param_1 + 1);
    if (uVar4 <= uVar5) {
      if (uVar4 <= uVar5 && uVar5 - uVar4 != 0) {
        *(ulong *)(this + 0x688) = lVar2 + uVar4 * 0x28;
      }
    }
    else {
      std::__ndk1::
      ...
      ::__append((vector<VulkanCommandBuffer::DescriptorSetElementInfo,std::__ndk1::allocator<VulkanCommandBuffer::DescriptorSetElementInfo>>
                  *)(this + 0x680),uVar4 + lVar3 * 0x3333333333333333);
      lVar2 = *(long *)(this + 0x680);
    }
  }
