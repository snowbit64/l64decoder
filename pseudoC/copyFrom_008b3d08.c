...
// Function: copyFrom
// Entry Point: 008b3d08
// Size: 316 bytes
// Signature: undefined __thiscall copyFrom(LoopSynthesisSample * this, LoopSynthesisSample * param_1)


/* LoopSynthesisSample::copyFrom(LoopSynthesisSample const&) */

void __thiscall
LoopSynthesisSample::copyFrom(LoopSynthesisSample *this,LoopSynthesisSample *param_1)

{
  ...
  LVar1 = this[0x30];
  if (lVar2 != lVar3 && LVar1 != (LoopSynthesisSample)0x0) {
    Sample::unload();
    LVar1 = this[0x30];
  }
  if ((LVar1 == (LoopSynthesisSample)0x0) && (param_1[0x30] != (LoopSynthesisSample)0x0)) {
