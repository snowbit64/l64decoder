...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 00800548
// Size: 3708 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
    ...
    if (((uVar18 < local_98) || (uVar22 < local_94)) || ((uVar19 < local_94 || (uVar21 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar28 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar28 != 0
                    ...
                    /* try { // try from 00801388 to 00801393 has its CatchHandler @ 008013c4 */
              ...
              do {
                ...
                if ((iVar28 == 2) || ((iVar28 == 0) != ((uVar26 & uVar12) != uVar4))) {
                  ...
                  if (((int)uVar26 < iVar3) || (iVar25 < (int)uVar26)) {
                    if (DVar8 != (DensityMapFilter)0x0) goto LAB_00801098;
                  }
...
LAB_00800fbc:
  ...
  if (param_6[0x6c] != (AddDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar31,*(uint *)(param_6 + 0x24),*(uint *)(param_6 + 0x28),
...
LAB_008010e8:
  uVar33 = uVar33 + 1;
  if (uVar33 == uVar19) goto LAB_008010c0;
  goto LAB_008010f4;
LAB_008010c0:
  uVar32 = uVar32 + 1;
  if (uVar32 == uVar21) goto LAB_00800fb0;
  goto LAB_008010d0;
}
