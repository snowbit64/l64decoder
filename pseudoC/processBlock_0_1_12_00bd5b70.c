...
// Function: processBlock_0_1_12
// Entry Point: 00bd5b70
// Size: 2952 bytes
// Signature: undefined __cdecl processBlock_0_1_12(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_0_1_12(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_0_1_12(CustomCipher *param_1,uchar *param_2)

{
  ...
  iVar15 = *(int *)(s_wL_I8 + ((ulong)bVar26 & 0xaa) * 2);
  iVar16 = *(int *)(s_wL_I8 + ((ulong)bVar24 & 0xaa) * 2);
  param_1[0x2b3] = param_1[uVar37 + 0x2b0];
  ...
  uVar14 = ((uint)(byte)CVar20 << 0x10 |
           ...
           (uVar19 | (iVar15 << 1 |
                      (iVar16 << 1 | (iVar13 << 1 | iVar12 << 2 | uVar14) << 2 | uVar17) << 2 |
                     uVar18) << 1);
