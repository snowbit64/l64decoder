...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
// Entry Point: 0080f8f0
// Size: 4312 bytes
...
/* bool DensityMapModifier::applyModuleToShapeWithMask2<ChunkedBitSquare, ChunkedBitSquare,
   BitVector, ParallelogramHelper, DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
    ...
    if (((uVar19 < local_98) || (uVar23 < local_94)) || ((uVar20 < local_94 || (uVar22 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar33 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar33 != 0
                    ...
                    /* try { // try from 0081098c to 00810997 has its CatchHandler @ 008109c8 */
            ...
            do {
              ...
              do {
                ...
                if (*(uint *)(param_3 + 0x34) < 2) {
                  uVar46 = (ulong)*(uint *)(param_3 + 0x34);
                  if (iVar33 != 2) goto LAB_008105f8;
LAB_00810618:
                  puVar1 = local_88;
                  uVar3 = uVar29 >> (ulong)(uVar5 & 0x1f) & uVar13;
                  if (((int)uVar3 < iVar28) || (iVar27 < (int)uVar3)) {
                    if (DVar10 != (DensityMapFilter)0x0) goto LAB_00810644;
                  }
...
LAB_00810644:
                  ...
                  if (iVar33 == 2) goto LAB_00810618;
LAB_008105f8:
                  if ((iVar33 == 0) != ((uVar29 & uVar14) != uVar6)) goto LAB_00810618;
                }
                uVar31 = uVar31 + 1;
                uVar4 = uVar4 + 1;
              } while (uVar31 != uVar35);
...
LAB_00810214:
  ...
  if (param_6[0x5c] != (SetTypeProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar26,*(uint *)(param_6 + 0x14),*(uint *)(param_6 + 0x18),
...
LAB_008106cc:
  uVar31 = uVar31 + 1;
  uVar4 = uVar4 + uVar24;
  if (uVar31 == uVar20) goto LAB_00810684;
  goto LAB_008106dc;
LAB_00810684:
  uVar38 = uVar38 + 1;
  uVar39 = uVar39 + uVar22 * uVar24;
  if (uVar38 == uVar37) goto LAB_00810490;
  goto LAB_0081069c;
}
