...
// Function: __sort<RenderQueueItemAllocator::TextureSetBucket::SortByDepth&,RenderQueueItemAllocator::TextureSetBucket*>
// Entry Point: 00a33dfc
// Size: 2000 bytes
// Signature: void __cdecl __sort<RenderQueueItemAllocator::TextureSetBucket::SortByDepth&,RenderQueueItemAllocator::TextureSetBucket*>(TextureSetBucket * param_1, TextureSetBucket * param_2, SortByDepth * param_3)


/* void std::__ndk1::__sort<RenderQueueItemAllocator::TextureSetBucket::SortByDepth&,
...
LAB_00a33e44:
  param_1 = (TextureSetBucket *)puVar11;
  uVar12 = (long)param_2 - (long)param_1;
  lVar7 = (long)uVar12 >> 5;
  switch(lVar7) {
  case 0:
  case 1:
    goto switchD_00a34284_caseD_0;
  case 2:
  ...
  case 4:
    __sort4<RenderQueueItemAllocator::TextureSetBucket::SortByDepth&,RenderQueueItemAllocator::TextureSetBucket*>
              (param_1,(TextureSetBucket *)((long)param_1 + 0x20),
               (TextureSetBucket *)((long)param_1 + 0x40),(TextureSetBucket *)puVar15,param_3);
    goto switchD_00a34284_caseD_0;
  case 5:
    puVar11 = (undefined8 *)((long)param_1 + 0x20);
    ...
    __sort4<RenderQueueItemAllocator::TextureSetBucket::SortByDepth&,RenderQueueItemAllocator::TextureSetBucket*>
              (param_1,(TextureSetBucket *)puVar11,(TextureSetBucket *)puVar15,
               (TextureSetBucket *)puVar10,param_3);
  ...
  if (uVar12 < 0x7ce1) {
    ...
    if (*(double *)((long)param_1 + 0x18) <= dVar21) {
      if (dVar21 <= *(double *)((long)param_2 + -8)) {
        ...
        *(undefined8 *)((long)param_2 + -8) = uVar23;
        *(undefined8 *)((long)param_2 + -0x10) = uVar16;
        if (*(double *)((long)param_1 + 0x18) <= *pdVar8) goto LAB_00a3403c;
        uVar26 = *(undefined8 *)((long)param_1 + 8);
        uVar22 = *(undefined8 *)param_1;
        uVar23 = *(undefined8 *)((long)param_1 + 0x18);
        uVar16 = *(undefined8 *)((long)param_1 + 0x10);
...
LAB_00a3403c:
    ...
    uVar5 = __sort4<RenderQueueItemAllocator::TextureSetBucket::SortByDepth&,RenderQueueItemAllocator::TextureSetBucket*>
                      (param_1,(TextureSetBucket *)puVar10,(TextureSetBucket *)puVar11,
                       (TextureSetBucket *)puVar13,param_3);
...
LAB_00a34050:
  ...
  if (*(double *)((long)param_1 + (lVar19 * 4 + 3) * 8) <= dVar21) {
    do {
      ...
      if (puVar10 == (undefined8 *)param_1) {
        ...
        puVar11 = puVar10;
        if (*(double *)((long)param_2 + -8) <= dVar21) goto joined_r0x00a341b8;
        goto LAB_00a341f0;
      }
  ...
  if (uVar5 == 0) {
    bVar3 = __insertion_sort_incomplete<RenderQueueItemAllocator::TextureSetBucket::SortByDepth&,RenderQueueItemAllocator::TextureSetBucket*>
                      (param_1,(TextureSetBucket *)puVar13,param_3);
    bVar4 = __insertion_sort_incomplete<RenderQueueItemAllocator::TextureSetBucket::SortByDepth&,RenderQueueItemAllocator::TextureSetBucket*>
                      ((TextureSetBucket *)(puVar13 + 4),param_2,param_3);
    if (bVar4) goto LAB_00a34264;
    puVar11 = puVar13 + 4;
    if (bVar3) goto LAB_00a33e44;
  }
  if ((long)param_2 - (long)puVar13 <= (long)puVar13 - (long)param_1) {
    __sort<RenderQueueItemAllocator::TextureSetBucket::SortByDepth&,RenderQueueItemAllocator::TextureSetBucket*>
              ((TextureSetBucket *)(puVar13 + 4),param_2,param_3);
    param_2 = (TextureSetBucket *)puVar13;
    goto LAB_00a33e3c;
  }
  __sort<RenderQueueItemAllocator::TextureSetBucket::SortByDepth&,RenderQueueItemAllocator::TextureSetBucket*>
            (param_1,(TextureSetBucket *)puVar13,param_3);
  ...
  goto LAB_00a33e44;
joined_r0x00a341b8:
  if (puVar11 == puVar15) goto switchD_00a34284_caseD_0;
  if (dVar21 < (double)puVar11[3]) goto LAB_00a341d8;
  puVar11 = puVar11 + 4;
  goto joined_r0x00a341b8;
LAB_00a341d8:
  uVar26 = puVar11[1];
  uVar22 = *puVar11;
  uVar23 = puVar11[3];
...
LAB_00a341f0:
  puVar13 = puVar15;
  if (puVar10 == puVar15) goto switchD_00a34284_caseD_0;
  while( true ) {
    puVar11 = puVar10 + -4;
    do {
      puVar17 = puVar11;
...
LAB_00a34264:
  param_2 = (TextureSetBucket *)puVar13;
  if (bVar3) goto switchD_00a34284_caseD_0;
  goto LAB_00a33e3c;
LAB_00a34538:
  do {
    ...
    if (dVar21 < (double)puVar11[3]) {
      ...
      do {
        ...
        *(undefined8 *)((long)param_1 + lVar18 + 0x70) =
        ...
        puVar11 = (undefined8 *)param_1;
        if (lVar18 == -0x40) goto LAB_00a34514;
        lVar19 = lVar18 + -0x20;
