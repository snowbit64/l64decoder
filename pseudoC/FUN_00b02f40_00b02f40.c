...
// Function: FUN_00b02f40
// Entry Point: 00b02f40
// Size: 440 bytes
// Signature: undefined FUN_00b02f40(void)


void FUN_00b02f40(void **param_1,undefined8 *param_2)

{
  ...
  if (puVar12 != (undefined8 *)param_1[3]) goto LAB_00b030c0;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00b030a8;
      }
    }
    do {
      puVar11 = puVar8 + 1;
