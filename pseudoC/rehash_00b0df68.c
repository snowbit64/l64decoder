...
// Function: __rehash
// Entry Point: 00b0df68
// Size: 384 bytes
// Signature: undefined __thiscall __rehash(__hash_table<SoftAudioSource*,std::__ndk1::hash<SoftAudioSource*>,std::__ndk1::equal_to<SoftAudioSource*>,std::__ndk1::allocator<SoftAudioSource*>> * this, ulong param_1)
...
::__rehash(__hash_table<SoftAudioSource*,std::__ndk1::hash<SoftAudioSource*>,std::__ndk1::equal_to<SoftAudioSource*>,std::__ndk1::allocator<SoftAudioSource*>>
           *this,ulong param_1)
