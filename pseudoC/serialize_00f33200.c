...
// Function: serialize
// Entry Point: 00f33200
// Size: 276 bytes
// Signature: undefined __thiscall serialize(btDiscreteDynamicsWorld * this, btSerializer * param_1)
...

{
  ...
  *(undefined4 *)((long)puVar3 + 0x24) = *(undefined4 *)(this + 0xb8);
  ...
  serializeRigidBodies(this,param_1);
                    /* WARNING: Could not recover jumptable at 0x00f33310. Too many branches */
