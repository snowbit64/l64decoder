...
/* PriorityQueue<GeometryUtil::_optimiseTriangles<unsigned int>(unsigned int, unsigned int, unsigned
   ...
   int*)::TriangleScore, unsigned int*> > > >::adjustDown(unsigned int) */
