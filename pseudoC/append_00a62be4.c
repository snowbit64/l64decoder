...
// Function: __append
// Entry Point: 00a62be4
// Size: 516 bytes
// Signature: undefined __thiscall __append(vector<std::__ndk1::vector<FoliageLayerGraphics::Layer_const*,std::__ndk1::allocator<FoliageLayerGraphics::Layer_const*>>,std::__ndk1::allocator<std::__ndk1::vector<FoliageLayerGraphics::Layer_const*,std::__ndk1::allocator<FoliageLayerGraphics::Layer_const*>>>> * this, ulong param_1)


/* std::__ndk1::vector<std::__ndk1::vector<FoliageLayerGraphics::Layer const*,
   std::__ndk1::allocator<FoliageLayerGraphics::Layer const*> >,
   std::__ndk1::allocator<std::__ndk1::vector<FoliageLayerGraphics::Layer const*,
   std::__ndk1::allocator<FoliageLayerGraphics::Layer const*> > > >::__append(unsigned long) */
