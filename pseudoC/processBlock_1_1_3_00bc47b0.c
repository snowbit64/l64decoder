...
// Function: processBlock_1_1_3
// Entry Point: 00bc47b0
// Size: 1428 bytes
// Signature: undefined __cdecl processBlock_1_1_3(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_1_1_3(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_1_1_3(CustomCipher *param_1,uchar *param_2)

{
  ...
  uVar3 = (&s_wPS)[(uVar17 >> 0xc ^ uVar4 >> 0x18) & 0x3f];
  uVar14 = *(uint *)(&DAT_0211e998 + (ulong)((uVar17 >> 8 ^ uVar4 >> 0x10) & 0x3f) * 4);
  uVar16 = *(uint *)(&DAT_0211ea98 + (ulong)((uVar17 >> 4 ^ uVar4 >> 8) & 0x3f) * 4);
  uVar4 = *(uint *)(&DAT_0211eb98 + (ulong)((uVar17 ^ uVar4) & 0x3f) * 4);
  CVar8 = param_1[0x2b1];
  ...
  CVar9 = param_1[0x2b2];
  uVar19 = uVar18 + (byte)CVar9 & 0xff;
  uVar1 = (uVar14 | uVar3 | uVar16 | uVar4) ^ uVar1 ^ (uVar7 | uVar5 | uVar6 | uVar15) ^
