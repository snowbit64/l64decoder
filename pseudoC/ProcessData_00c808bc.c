...
// Entry Point: 00c808bc
// Size: 816 bytes
// Signature: undefined __thiscall ProcessData(AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,CryptoPP::CTR_ModePolicy>> * this, uchar * param_1, uchar * param_2, ulong param_3)


/* CryptoPP::AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,
   CryptoPP::CTR_ModePolicy> >::ProcessData(unsigned char*, unsigned char const*, unsigned long) */
...

{
  ...
  if (uVar11 != 0) {
    ...
    xorbuf(param_1,param_2,(uchar *)((*(long *)(this + 0x80) + *(long *)(this + 0x78)) - uVar11),
           uVar15);
    param_3 = param_3 - uVar15;
    param_2 = param_2 + uVar15;
    param_1 = param_1 + uVar15;
    *(ulong *)(this + 0x88) = *(long *)(this + 0x88) - uVar15;
  }
  plVar6 = (long *)(**(code **)(*(long *)this + 0x100))(this);
  uVar4 = (**(code **)(*plVar6 + 0x18))();
  uVar15 = (ulong)uVar4;
  uVar11 = (**(code **)(*plVar6 + 0x38))(plVar6);
  if (((uVar11 & 1) == 0) || (param_3 < uVar15)) goto LAB_00c80a38;
  uVar11 = 0;
  if (uVar15 != 0) {
...
LAB_00c809bc:
    ...
    if (param_2 == (uchar *)(uVar14 * uVar13)) goto LAB_00c809b0;
LAB_00c809cc:
    bVar9 = 0;
    if (uVar5 != 0) goto LAB_00c809d4;
LAB_00c809f4:
    uVar13 = (ulong)uVar5;
    uVar14 = 0;
    if (uVar13 != 0) {
    ...
    uVar1 = uVar5 - 1;
    if (uVar1 != 0) {
      if ((uVar5 & uVar1) != 0) goto LAB_00c809bc;
      if ((uVar1 & (uint)param_2) == 0) goto LAB_00c809b0;
      goto LAB_00c809cc;
    }
LAB_00c809b0:
    bVar9 = 2;
    if (uVar5 == 0) goto LAB_00c809f4;
LAB_00c809d4:
    uVar1 = uVar5 - 1;
    if (uVar1 == 0) {
      bVar3 = true;
      ...
      if ((uVar5 & uVar1) != 0) goto LAB_00c809f4;
...
LAB_00c80a38:
  ...
  if (uVar11 <= param_3) {
    ...
    lVar12 = 0;
    do {
      (**(code **)(*plVar6 + 0x30))(plVar6,*(undefined8 *)(this + 0x80),uVar14);
      xorbuf(param_1 + lVar12,param_2 + lVar12,*(uchar **)(this + 0x80),uVar11);
  ...
  if (param_3 != 0) {
    if (-uVar15 < param_3) {
      puVar7 = (undefined8 *)__cxa_allocate_exception(0x28);
                    /* try { // try from 00c80b68 to 00c80b6f has its CatchHandler @ 00c80c28 */
      ...
      *(undefined4 *)(puVar7 + 1) = 1;
                    /* try { // try from 00c80bb8 to 00c80bbf has its CatchHandler @ 00c80c08 */
      std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
      basic_string((basic_string *)(puVar7 + 2));
      *puVar7 = &PTR__Exception_00fe9ee0;
                    /* try { // try from 00c80bd0 to 00c80be7 has its CatchHandler @ 00c80bec */
    ...
    (**(code **)(*plVar6 + 0x30))
              (plVar6,(*(long *)(this + 0x80) + *(long *)(this + 0x78)) - uVar11,uVar14);
    xorbuf(param_1,param_2,(uchar *)((*(long *)(this + 0x80) + *(long *)(this + 0x78)) - uVar11),
           param_3);
    *(ulong *)(this + 0x88) = uVar11 - param_3;
  }
