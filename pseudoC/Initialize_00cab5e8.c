...
// Function: Initialize
// Entry Point: 00cab5e8
// Size: 124 bytes
// Signature: undefined __thiscall Initialize(DL_PrivateKey_ECGDSA<CryptoPP::EC2N> * this, DL_GroupParameters_EC * param_1, Integer * param_2)


/* CryptoPP::DL_PrivateKey_ECGDSA<CryptoPP::EC2N>::Initialize(CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>
   const&, CryptoPP::Integer const&) */

void __thiscall
CryptoPP::DL_PrivateKey_ECGDSA<CryptoPP::EC2N>::Initialize
          (DL_PrivateKey_ECGDSA<CryptoPP::EC2N> *this,DL_GroupParameters_EC *param_1,
          Integer *param_2)

{
  ...
  *(undefined2 *)(this + 0x248) = *(undefined2 *)(param_1 + 0x1e8);
                    /* WARNING: Could not recover jumptable at 0x00cab660. Too many branches */
