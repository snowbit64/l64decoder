...
// Entry Point: 009e4b40
// Size: 604 bytes
// Signature: undefined __thiscall addTerrainFoliageObject(ProceduralPlacementRule * this, uint param_1, basic_string * param_2, basic_string * param_3, uint param_4, uint param_5, uint param_6, uint param_7, basic_string * param_8, uint param_9, int param_10)


/* ProceduralPlacementRule::addTerrainFoliageObject(unsigned int, std::__ndk1::basic_string<char,
...

{
  ...
  void *__dest;
  ProceduralPlacementFoliageObjectDesc **ppPVar5;
  long lVar6;
  ulong uVar7;
  ulong uVar8;
  ulong uVar9;
  ...
  this_00 = (ProceduralPlacementFoliageObjectDesc *)operator_new(0xa8);
                    /* try { // try from 009e4b94 to 009e4bbb has its CatchHandler @ 009e4d9c */
  ...
  ppPVar5 = *(ProceduralPlacementFoliageObjectDesc ***)(this + 0x70);
  if (*(int *)(this_00 + 0x28) != -1) goto LAB_009e4c34;
...
LAB_009e4c08:
      ...
      uVar9 = 0;
      if (((int)(uVar8 - 1) == -1) || (uVar8 - 1 >> 0x20 != 0)) goto LAB_009e4c08;
      ...
      if (uVar4 != uVar9) goto LAB_009e4c08;
    }
    iVar10 = iVar10 + 1;
  }
  *(int *)(this_00 + 0x28) = iVar10;
LAB_009e4c34:
  if (ppPVar5 < *(ProceduralPlacementFoliageObjectDesc ***)(this + 0x78)) {
    *ppPVar5 = this_00;
    *(ProceduralPlacementFoliageObjectDesc ***)(this + 0x70) = ppPVar5 + 1;
  }
  else {
    ...
    uVar7 = (long)*(ProceduralPlacementFoliageObjectDesc ***)(this + 0x78) - (long)__src;
    uVar8 = (long)uVar7 >> 2;
    if (uVar4 <= uVar8) {
      uVar4 = uVar8;
    }
    ...
    ppPVar5 = (ProceduralPlacementFoliageObjectDesc **)((long)__dest + ((long)__n >> 3) * 8);
    *ppPVar5 = this_00;
    if (0 < (long)__n) {
