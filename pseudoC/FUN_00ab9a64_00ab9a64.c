...
// Function: FUN_00ab9a64
// Entry Point: 00ab9a64
// Size: 440 bytes
// Signature: undefined FUN_00ab9a64(void)


void FUN_00ab9a64(void **param_1,undefined8 *param_2)

{
  ...
  if (puVar12 != (undefined8 *)param_1[3]) goto LAB_00ab9be4;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00ab9bcc;
      }
    }
    do {
      puVar11 = puVar8 + 1;
