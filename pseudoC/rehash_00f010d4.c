...
// Function: rehash
// Entry Point: 00f010d4
// Size: 344 bytes
// Signature: undefined rehash(void)


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* Luau::detail::DenseHashTable<Luau::AstLocal*, std::__ndk1::pair<Luau::AstLocal*, unsigned int>,
   std::__ndk1::pair<Luau::AstLocal* const, unsigned int>,
   Luau::detail::ItemInterfaceMap<Luau::AstLocal*, unsigned int>, Luau::DenseHashPointer,
...

{
  ...
  if (pvVar4 != (void *)0x0) {
    ...
    pvVar6 = *ppvVar3;
    ppvVar10 = ppvVar3;
    if (pvVar6 == pvVar7) goto LAB_00f011ec;
    do {
...
LAB_00f011d0:
        *ppvVar9 = pvVar6;
        ...
        do {
          ...
          ppvVar9 = (void **)((long)pvVar2 + uVar8 * 0x10);
          if (*ppvVar9 == pvVar12) goto LAB_00f011d0;
          lVar11 = lVar11 + 1;
