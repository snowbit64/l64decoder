...
// Function: setViewDistanceCoeff
// Entry Point: 007573e8
// Size: 220 bytes
// Signature: undefined __thiscall setViewDistanceCoeff(HardwareScalability * this, float param_1)


/* HardwareScalability::setViewDistanceCoeff(float) */

void __thiscall HardwareScalability::setViewDistanceCoeff(HardwareScalability *this,float param_1)
