...
/* std::__ndk1::__split_buffer<std::__ndk1::pair<unsigned short, unsigned short>*,
   ...
   >::push_front(std::__ndk1::pair<unsigned short, unsigned short>*&&) */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_0073039c;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00730384;
      }
    }
    do {
      puVar7 = puVar6 + 1;
