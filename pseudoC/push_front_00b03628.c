...
// Function: push_front
// Entry Point: 00b03628
// Size: 448 bytes
// Signature: undefined __thiscall push_front(__split_buffer<Streamable**,std::__ndk1::allocator<Streamable**>&> * this, Streamable * * * param_1)


/* std::__ndk1::__split_buffer<Streamable**,
   std::__ndk1::allocator<Streamable**>&>::push_front(Streamable** const&) */

void __thiscall
std::__ndk1::__split_buffer<Streamable**,std::__ndk1::allocator<Streamable**>&>::push_front
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00b037b0;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00b03798;
      }
    }
    do {
      puVar7 = puVar6 + 1;
