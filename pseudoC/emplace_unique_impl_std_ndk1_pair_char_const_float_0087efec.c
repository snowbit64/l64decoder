...
// Function: __emplace_unique_impl<std::__ndk1::pair<char_const*,float>>
// Entry Point: 0087efec
// Size: 232 bytes
// Signature: pair __cdecl __emplace_unique_impl<std::__ndk1::pair<char_const*,float>>(pair * param_1)


/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, float>,
   std::__ndk1::__tree_node<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, float>, void*>*, long>, bool>
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, float> >
   >::__emplace_unique_impl<std::__ndk1::pair<char const*, float> >(std::__ndk1::pair<char const*,
   float>&&) */
...
pair std::__ndk1::
     ...
     ::__emplace_unique_impl<std::__ndk1::pair<char_const*,float>>(pair *param_1)

{
  ...
  __construct_node<std::__ndk1::pair<char_const*,float>>(param_1);
                    /* try { // try from 0087f020 to 0087f02b has its CatchHandler @ 0087f0d4 */
  pp_Var2 = __find_equal<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,float>>
                      ((__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,float>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,float>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,float>>>
