...
// Function: getCurrentOffsetPose
// Entry Point: 00728560
// Size: 148 bytes
// Signature: undefined __thiscall getCurrentOffsetPose(StoppingPath * this, PlanarPose * param_1, float * param_2)


/* StoppingPath::getCurrentOffsetPose(PlanarPose&, float&) const */

void __thiscall
StoppingPath::getCurrentOffsetPose(StoppingPath *this,PlanarPose *param_1,float *param_2)
