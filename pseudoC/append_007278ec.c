...
// Function: __append
// Entry Point: 007278ec
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<HashTable<unsigned_int,DynamicAvoidance::ObstacleHash>::Entry,std::__ndk1::allocator<HashTable<unsigned_int,DynamicAvoidance::ObstacleHash>::Entry>> * this, ulong param_1)


/* std::__ndk1::vector<HashTable<unsigned int, DynamicAvoidance::ObstacleHash>::Entry,
   std::__ndk1::allocator<HashTable<unsigned int, DynamicAvoidance::ObstacleHash>::Entry>
