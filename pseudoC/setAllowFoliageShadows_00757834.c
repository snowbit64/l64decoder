...
// Function: setAllowFoliageShadows
// Entry Point: 00757834
// Size: 224 bytes
// Signature: undefined __thiscall setAllowFoliageShadows(HardwareScalability * this, bool param_1)


/* HardwareScalability::setAllowFoliageShadows(bool) */

void __thiscall HardwareScalability::setAllowFoliageShadows(HardwareScalability *this,bool param_1)

{
  ...
  if (this[0x3c] != (HardwareScalability)param_1) {
    this[0x3c] = (HardwareScalability)param_1;
