...
// Function: process
// Entry Point: 007ed154
// Size: 360 bytes
// Signature: undefined __thiscall process(SetDensityProcessor<ChunkedBitSquare,true> * this, HelperSource * param_1)


/* DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,
...
DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>::process
          (SetDensityProcessor<ChunkedBitSquare,true> *this,HelperSource *param_1)

{
  ...
  uint uVar4;
  uint uVar5;
  SetDensityProcessor<ChunkedBitSquare,true> SVar6;
  bool bVar7;
  uint uVar8;
  ...
  *(uint *)(this + 0x4c) = uVar1;
  ...
  if ((int)uVar8 < *(int *)(this + 0x34)) {
    ...
    if ((int)uVar8 <= *(int *)(this + 0x38)) {
      if (SVar6 != (SetDensityProcessor<ChunkedBitSquare,true>)0x0) {
        return;
      }
      goto LAB_007ed1ec;
    }
    ...
    *(int *)(this + 8) = *(int *)(this + 8) + 1;
    if (uVar5 == 0xffffffff) {
      if (uVar2 != uVar8) {
        ...
        this[100] = (SetDensityProcessor<ChunkedBitSquare,true>)0x1;
