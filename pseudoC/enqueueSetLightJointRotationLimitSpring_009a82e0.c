...
// Function: enqueueSetLightJointRotationLimitSpring
// Entry Point: 009a82e0
// Size: 120 bytes
// Signature: undefined __thiscall enqueueSetLightJointRotationLimitSpring(Bt2ScenegraphPhysicsContext * this, uint param_1, uint param_2, float param_3, float param_4)


/* Bt2ScenegraphPhysicsContext::enqueueSetLightJointRotationLimitSpring(unsigned int, unsigned int,
   float, float) */
...

{
  ...
  uStack_54 = 1;
  local_50[0] = (SetJointLimitSpring)0x0;
  local_58 = param_1;
  local_4c = param_2;
  local_48 = param_3;
  fStack_44 = param_4;
