...
// Function: FUN_0078edc4
// Entry Point: 0078edc4
// Size: 164 bytes
// Signature: undefined FUN_0078edc4(void)


void FUN_0078edc4(uint *param_1)

{
  ...
  if ((*param_1 == 0) ||
     (lVar1 = ReflectionUtil::getEntity(*param_1,0x400000000,"set2DMaskFromOverlay","texture"),
     lVar1 == 0)) {
    pTVar2 = (Texture *)0x0;
  }
  else {
    pTVar2 = (Texture *)ImageOverlay::getTexture();
  }
