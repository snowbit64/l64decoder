...
/* std::__ndk1::__split_buffer<BTBehavior**,
   std::__ndk1::allocator<BTBehavior**>&>::push_back(BTBehavior**&&) */
...

{
  ...
  if (puVar12 != *(undefined8 **)(this + 0x18)) goto LAB_0071350c;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_007134f4;
      }
    }
    do {
      puVar11 = puVar8 + 1;
