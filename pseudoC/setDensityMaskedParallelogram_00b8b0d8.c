...
// Function: setDensityMaskedParallelogram
// Entry Point: 00b8b0d8
// Size: 584 bytes
// Signature: undefined __thiscall setDensityMaskedParallelogram(DensityMapOldOperations * this, Parallelogram * param_1, uint param_2, uint param_3, int param_4, OPERATION param_5, uint param_6, int param_7, int param_8, uint param_9, uint param_10, DensityMap * param_11, uint param_12, uint param_13, OPERATION param_14, uint param_15, int param_16, int param_17, uint param_18, uint param_19, uint param_20, uint param_21, uint * param_22, uint * param_23)


/* DensityMapOldOperations::setDensityMaskedParallelogram(DensityMapOperationShapes::Parallelogram
   ...
   unsigned int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int&,
   unsigned int&) */

void __thiscall
DensityMapOldOperations::setDensityMaskedParallelogram
          ...
          uint param_15,int param_16,int param_17,uint param_18,uint param_19,uint param_20,
          uint param_21,uint *param_22,uint *param_23)

{
  ...
  uVar3 = DensityMapOperations::setDensity<ParallelogramHelper>
                    (aPStack_d0,(DensityMapFilter *)&local_100,(DensityMapFilter *)&local_130,
                     (DensityMapFilter *)0x0,param_20,param_21,param_4,param_22,param_23);
