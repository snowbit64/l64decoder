...
// Function: __emplace_unique_key_args<unsigned_long_long,std::__ndk1::pair<unsigned_long_long,VkPipeline_T*>>
// Entry Point: 00ad3468
// Size: 508 bytes
// Signature: pair __thiscall __emplace_unique_key_args<unsigned_long_long,std::__ndk1::pair<unsigned_long_long,VkPipeline_T*>>(__hash_table<std::__ndk1::__hash_value_type<unsigned_long_long,VkPipeline_T*>,std::__ndk1::__unordered_map_hasher<unsigned_long_long,std::__ndk1::__hash_value_type<unsigned_long_long,VkPipeline_T*>,std::__ndk1::hash<unsigned_long_long>,true>,std::__ndk1::__unordered_map_equal<unsigned_long_long,std::__ndk1::__hash_value_type<unsigned_long_long,VkPipeline_T*>,std::__ndk1::equal_to<unsigned_long_long>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned_long_long,VkPipeline_T*>>> * this, ulonglong * param_1, pair * param_2)


/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<unsigned
   long long, VkPipeline_T*>, void*>*>, bool>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned long long, VkPipeline_T*>,
   std::__ndk1::__unordered_map_hasher<unsigned long long, std::__ndk1::__hash_value_type<unsigned
   long long, VkPipeline_T*>, std::__ndk1::hash<unsigned long long>, true>,
   std::__ndk1::__unordered_map_equal<unsigned long long, std::__ndk1::__hash_value_type<unsigned
   long long, VkPipeline_T*>, std::__ndk1::equal_to<unsigned long long>, true>,
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned long long, VkPipeline_T*> >
   >::__emplace_unique_key_args<unsigned long long, std::__ndk1::pair<unsigned long long,
   VkPipeline_T*> >(unsigned long long const&, std::__ndk1::pair<unsigned long long,
   VkPipeline_T*>&&) */
  ...
  if (plVar9 != (long *)0x0) {
    ...
    if (pplVar8 != (long **)0x0) {
      do {
        ...
        if (pplVar8 == (long **)0x0) goto LAB_00ad3528;
        plVar5 = pplVar8[1];
        if (plVar5 != plVar10) {
          if (uVar3 < 2) {
          ...
          if (plVar5 != unaff_x24) goto LAB_00ad3528;
        }
  ...
  if ((plVar9 == (long *)0x0) || (fVar13 * (float)ZEXT89(plVar9) < (float)(unkuint9)(lVar2 + 1))) {
    ...
    if (uVar6 <= uVar3) {
      uVar6 = uVar3;
                    ...
                    /* try { // try from 00ad3594 to 00ad359b has its CatchHandler @ 00ad3664 */
    rehash(this,uVar6);
    plVar9 = *(long **)(this + 8);
