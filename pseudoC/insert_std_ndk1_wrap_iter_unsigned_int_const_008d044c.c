...
// Function: insert<std::__ndk1::__wrap_iter<unsigned_int_const*>>
// Entry Point: 008d044c
// Size: 1012 bytes
// Signature: type __thiscall insert<std::__ndk1::__wrap_iter<unsigned_int_const*>>(vector<unsigned_int,std::__ndk1::allocator<unsigned_int>> * this, __wrap_iter param_1, __wrap_iter param_2, __wrap_iter param_3)


/* std::__ndk1::enable_if<__is_cpp17_forward_iterator<std::__ndk1::__wrap_iter<unsigned int const*>
   >::value&&is_constructible<unsigned int,
   std::__ndk1::iterator_traits<std::__ndk1::__wrap_iter<unsigned int const*> >::reference>::value,
   std::__ndk1::__wrap_iter<unsigned int*> >::type std::__ndk1::vector<unsigned int,
   std::__ndk1::allocator<unsigned int> >::insert<std::__ndk1::__wrap_iter<unsigned int const*>
   >(std::__ndk1::__wrap_iter<unsigned int const*>, std::__ndk1::__wrap_iter<unsigned int const*>,
   std::__ndk1::__wrap_iter<unsigned int const*>) */
    ...
    if (lVar16 < lVar18) {
      ...
      if (puVar5 != puVar3) {
        ...
        if ((0x1b < uVar4) &&
          ...
          if (uVar4 == uVar12) goto LAB_008d06d4;
        }
        do {
          puVar11 = puVar10 + 1;
          *puVar6 = *puVar10;
...
LAB_008d06d4:
      *(undefined4 **)(this + 8) = puVar7;
      puVar3 = puVar5;
      if ((long)uVar8 < 1) goto LAB_008d0808;
    }
    ...
    if (puVar5 < puVar1) {
      ...
      if (0x1b < uVar4) {
        ...
        if (((undefined4 *)((long)__src_00 + (lVar15 + (uVar17 >> 2)) * 4 + 4) <= puVar7) ||
          ...
          puVar10 = puVar6;
          if (uVar17 == uVar9) goto LAB_008d07e0;
        }
      }
      do {
        puVar11 = puVar5 + 1;
...
LAB_008d05e0:
    ...
    __src = __src + uVar12;
    if (uVar4 != uVar12) goto LAB_008d05e0;
  }
  if (0 < (long)uVar17) {
