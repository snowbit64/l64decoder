...
/* Luau::detail::DenseHashTable<Luau::AstLocal*, std::__ndk1::pair<Luau::AstLocal*,
   Luau::Compile::Constant>, std::__ndk1::pair<Luau::AstLocal* const, Luau::Compile::Constant>,
   Luau::detail::ItemInterfaceMap<Luau::AstLocal*, Luau::Compile::Constant>, Luau::DenseHashPointer,
...
LAB_00ede210:
  ...
  pvVar12 = *ppvVar11;
  ppvVar13 = ppvVar11;
  if (pvVar12 == pvVar8) goto LAB_00ede1e4;
  do {
    uVar7 = 0;
    ...
    do {
      ...
      if (*ppvVar10 == pvVar14) {
        *ppvVar10 = pvVar12;
        pvVar12 = *ppvVar13;
        goto code_r0x00ede1d0;
      }
      if (*ppvVar10 == pvVar12) goto code_r0x00ede1d0;
      uVar7 = uVar7 + 1;
      uVar9 = uVar7 + uVar9;
...
LAB_00ede1e4:
    do {
      ...
      if (pvVar6 <= pvVar5) goto LAB_00ede210;
      ppvVar11 = (void **)*in_x0;
