...
// Function: int2octets
// Entry Point: 00c8a0a4
// Size: 404 bytes
// Signature: undefined __cdecl int2octets(Integer * param_1, ulong param_2)


/* CryptoPP::DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,
   CryptoPP::SHA224>::int2octets(CryptoPP::Integer const&, unsigned long) const */

void CryptoPP::DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA224>::int2octets
...

{
  ...
  local_50 = __src;
                    /* try { // try from 00c8a108 to 00c8a13b has its CatchHandler @ 00c8a254 */
...
LAB_00c8a184:
    ...
    pvVar4 = (void *)((long)pvVar4 + (in_x2 - uVar2));
                    ...
                    /* try { // try from 00c8a14c to 00c8a153 has its CatchHandler @ 00c8a238 */
    local_70 = (void *)UnalignedAllocate(in_x2);
    uVar3 = uVar2 - in_x2;
    if (uVar2 < in_x2 || uVar2 - in_x2 == 0) goto LAB_00c8a184;
LAB_00c8a164:
    __src = __src + uVar3;
    pvVar4 = local_70;
    uVar2 = in_x2;
  ...
  memcpy(pvVar4,__src,uVar2);
                    /* try { // try from 00c8a1a8 to 00c8a1b3 has its CatchHandler @ 00c8a240 */
  SecBlock<unsigned_char,CryptoPP::AllocatorWithCleanup<unsigned_char,false>>::SecBlock
            (in_x8,aSStack_88);
  uVar2 = local_80;
  ...
  for (; uVar2 != 0; uVar2 = uVar2 - 1) {
    *(undefined *)((long)local_70 + (uVar2 - 1)) = 0;
                    ...
                    /* try { // try from 00c8a1dc to 00c8a1df has its CatchHandler @ 00c8a23c */
...
LAB_00c8a1e0:
  ...
  for (; uVar2 != 0; uVar2 = uVar2 - 1) {
    local_50[uVar2 - 1] = '\0';
                    ...
                    /* try { // try from 00c8a208 to 00c8a20b has its CatchHandler @ 00c8a250 */
