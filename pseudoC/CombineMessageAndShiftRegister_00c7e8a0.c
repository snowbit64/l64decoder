...
// Entry Point: 00c7e8a0
// Size: 312 bytes
// Signature: undefined __thiscall CombineMessageAndShiftRegister(CFB_DecryptionTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::CFB_CipherAbstractPolicy,CryptoPP::SymmetricCipher>> * this, uchar * param_1, uchar * param_2, uchar * param_3, ulong param_4)
...
void __thiscall
CryptoPP::
CFB_DecryptionTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::CFB_CipherAbstractPolicy,CryptoPP::SymmetricCipher>>
  ...
  if (param_4 < 8) {
    ...
    if (((param_2 + param_4 <= param_1 || param_1 + param_4 <= param_2) &&
      ...
      if (param_4 < 0x20) {
        ...
        uVar3 = uVar2;
        if ((param_4 & 0x18) == 0) goto LAB_00c7e9a8;
      }
