...
// Function: __append
// Entry Point: 00ab3414
// Size: 420 bytes
// Signature: undefined __thiscall __append(vector<VkDescriptorImageInfo,std::__ndk1::allocator<VkDescriptorImageInfo>> * this, ulong param_1)
...
void __thiscall
std::__ndk1::vector<VkDescriptorImageInfo,std::__ndk1::allocator<VkDescriptorImageInfo>>::__append
          (vector<VkDescriptorImageInfo,std::__ndk1::allocator<VkDescriptorImageInfo>> *this,
          ulong param_1)
