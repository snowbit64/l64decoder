...
// Function: applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
// Entry Point: 008057b4
// Size: 3644 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, ChunkedBitSquare * param_3, ProceduralDensityPixelSource * param_4, ParallelogramHelper * param_5, AddDensityProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
    ...
    if (((uVar22 < local_98) || (uVar26 < local_94)) || ((uVar23 < local_94 || (uVar25 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar33 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar33 != 0
                    ...
                    /* try { // try from 008065b4 to 008065bf has its CatchHandler @ 008065f0 */
          ...
          do {
            ...
            do {
              ...
              if (*(uint *)(param_3 + 0x34) < 2) {
                uVar44 = (ulong)*(uint *)(param_3 + 0x34);
                if (iVar33 != 2) goto LAB_00806338;
LAB_00806358:
                uVar4 = uVar30 >> (ulong)(uVar5 & 0x1f) & uVar16;
                if (((int)uVar4 < iVar29) || (iVar8 < (int)uVar4)) {
                  if (DVar13 != (DensityMapFilter)0x0) goto LAB_00806384;
                }
...
LAB_00806384:
                ...
                if (iVar33 == 2) goto LAB_00806358;
LAB_00806338:
                if ((iVar33 == 0) != ((uVar30 & uVar17) != uVar6)) goto LAB_00806358;
              }
              uVar32 = uVar32 + 1;
              uVar2 = uVar2 + 1;
            } while (uVar32 != uVar36);
    ...
    do {
      ...
      if ((iVar9 == 2) || ((iVar9 == 0) != ((uVar32 & uVar19) != uVar10))) {
        ...
        if (((int)uVar32 < iVar11) || (iVar12 < (int)uVar32)) {
          if (DVar14 != (DensityMapFilter)0x0) goto LAB_00806458;
        }
...
LAB_008061f0:
  uVar28 = uVar28 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar28) goto LAB_00806190;
  goto LAB_00806204;
}
