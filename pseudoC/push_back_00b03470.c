...
/* std::__ndk1::__split_buffer<Streamable**,
   std::__ndk1::allocator<Streamable**>&>::push_back(Streamable**&&) */
...

{
  ...
  if (puVar12 != *(undefined8 **)(this + 0x18)) goto LAB_00b035f0;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00b035d8;
      }
    }
    do {
      puVar11 = puVar8 + 1;
