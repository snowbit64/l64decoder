...
// Entry Point: 009e8554
// Size: 304 bytes
// Signature: undefined __thiscall ProceduralPlacementScaleMask(ProceduralPlacementScaleMask * this, ProceduralPlacementScaleMask * param_1)


/* ProceduralPlacementScaleMask::ProceduralPlacementScaleMask(ProceduralPlacementScaleMask const&)
    */

void __thiscall
ProceduralPlacementScaleMask::ProceduralPlacementScaleMask
          (ProceduralPlacementScaleMask *this,ProceduralPlacementScaleMask *param_1)

{
  ...
  *(undefined ***)this = &PTR__ProceduralPlacementScaleMask_00fe2b28;
                    /* try { // try from 009e8594 to 009e8597 has its CatchHandler @ 009e8684 */
...
LAB_009e8604:
        ...
        if ((!CARRY4(uVar3 * iVar8,(uint)(uVar4 - 1))) && (uVar4 - 1 >> 0x20 == 0)) {
          ...
          if ((pvVar6 < (void *)((long)pvVar10 + uVar4 * 4)) &&
             (pvVar10 < (void *)((long)pvVar6 + uVar4 * 4))) goto LAB_009e8604;
          do {
            uVar13 = uVar13 - 8;
          ...
          uVar13 = uVar9;
          if (uVar9 == uVar4) goto LAB_009e8668;
        }
      }
