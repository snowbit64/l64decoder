...
// Function: setJointWorldRotations
// Entry Point: 0075fd78
// Size: 456 bytes
// Signature: undefined __thiscall setJointWorldRotations(JointConstructor * this, MethodInvocation * param_1)


/* JointConstructor::setJointWorldRotations(MethodInvocation*) */

void __thiscall
JointConstructor::setJointWorldRotations(JointConstructor *this,MethodInvocation *param_1)
