...
// Function: addDensityParallelogram
// Entry Point: 00b8b608
// Size: 428 bytes
// Signature: undefined __thiscall addDensityParallelogram(DensityMapOldOperations * this, Parallelogram * param_1, uint param_2, uint param_3, int param_4, OPERATION param_5, uint param_6, int param_7, int param_8, uint param_9, uint param_10, int param_11, uint param_12, uint * param_13, uint * param_14, int * param_15)


/* DensityMapOldOperations::addDensityParallelogram(DensityMapOperationShapes::Parallelogram const&,
   unsigned int, unsigned int, int, DensityMapFilter::OPERATION, unsigned int, int, int, unsigned
   int, unsigned int, int, unsigned int, unsigned int&, unsigned int&, int&) */

void __thiscall
DensityMapOldOperations::addDensityParallelogram
          ...
          uint param_10,int param_11,uint param_12,uint *param_13,uint *param_14,int *param_15)

{
  ...
  uVar3 = DensityMapOperations::addDensity<ParallelogramHelper>
                    (aPStack_d0,(DensityMapFilter *)&local_100,(DensityMapFilter *)0x0,
                     (DensityMapFilter *)0x0,param_11,param_12,param_4,param_13,param_14,param_15);
