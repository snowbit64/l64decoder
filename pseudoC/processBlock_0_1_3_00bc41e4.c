...
// Function: processBlock_0_1_3
// Entry Point: 00bc41e4
// Size: 1484 bytes
// Signature: undefined __cdecl processBlock_0_1_3(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_0_1_3(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_0_1_3(CustomCipher *param_1,uchar *param_2)

{
  ...
  uVar12 = *(uint *)(s_wL_I8 + ((ulong)bVar22 & 0xaa) * 2);
  uVar36 = uVar35 & 0xff;
  ...
  uVar12 = ((uint)(byte)CVar19 << 0x10 |
            (uint)(byte)param_1[((ulong)((uint)(byte)param_1[0x2b4] + (uint)(byte)CVar28) & 0xff) +
                                0x2b0] << 0x18 | (uint)(byte)CVar34 << 8 | (uint)(byte)CVar33) ^
           (uVar18 | (iVar16 << 1 |
                      (iVar14 << 1 | (iVar13 << 1 | iVar11 << 2 | uVar12) << 2 | uVar15) << 2 |
                     uVar17) << 1);
  uVar18 = uVar12 >> 0xf | uVar12 << 0x11;
  uVar15 = *(uint *)(param_1 + 0x228);
  uVar17 = *(uint *)(param_1 + 0x22c);
  uVar1 = ((uint)(byte)CVar31 << 0x10 | (uint)(byte)CVar32 << 0x18 | (uint)(byte)CVar30 << 8 |
          (uint)(byte)CVar29) ^
          (uVar10 | (iVar8 << 1 | (iVar6 << 1 | (iVar4 << 1 | iVar3 << 2 | uVar5) << 2 | uVar7) << 2
                    | uVar9) << 1) ^
          (*(uint *)(&DAT_0211e998 + (ulong)((uVar2 >> 0x10 ^ uVar18 >> 8) & 0x3f) * 4) |
           (&s_wPS)[(uVar2 >> 0x18 ^ uVar18 >> 0xc) & 0x3f] |
           *(uint *)(&DAT_0211ea98 + (ulong)((uVar2 >> 8 ^ uVar18 >> 4) & 0x3f) * 4) |
          *(uint *)(&DAT_0211eb98 + (ulong)((uVar2 ^ uVar18) & 0x3f) * 4)) ^
          (*(uint *)(&DAT_0211ed98 + (ulong)((uVar1 >> 0x10 ^ uVar12 >> 7) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ec98 + (ulong)((uVar1 >> 0x18 ^ uVar12 >> 0xb) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ee98 + (ulong)((uVar1 >> 8 ^ uVar12 >> 3) & 0x3f) * 4) |
          *(uint *)(&DAT_0211ef98 + (ulong)((uVar1 ^ uVar18 >> 0x10) & 0x3f) * 4));
  uVar2 = *(uint *)(param_1 + 0x230);
  uVar5 = *(uint *)(param_1 + 0x234);
  uVar7 = uVar1 >> 0xf | uVar1 << 0x11;
  uVar12 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar7 >> 8 ^ uVar15 >> 0x10) & 0x3f) * 4) |
            (&s_wPS)[(uVar7 >> 0xc ^ uVar15 >> 0x18) & 0x3f] |
            *(uint *)(&DAT_0211ea98 + (ulong)((uVar7 >> 4 ^ uVar15 >> 8) & 0x3f) * 4) |
           *(uint *)(&DAT_0211eb98 + (ulong)((uVar7 ^ uVar15) & 0x3f) * 4)) ^ uVar12 ^
  ...
  uVar15 = uVar12 >> 0xf | uVar12 << 0x11;
  uVar1 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar15 >> 8 ^ uVar2 >> 0x10) & 0x3f) * 4) |
           (&s_wPS)[(uVar15 >> 0xc ^ uVar2 >> 0x18) & 0x3f] |
           *(uint *)(&DAT_0211ea98 + (ulong)((uVar15 >> 4 ^ uVar2 >> 8) & 0x3f) * 4) |
          *(uint *)(&DAT_0211eb98 + (ulong)((uVar15 ^ uVar2) & 0x3f) * 4)) ^ uVar1 ^
          (*(uint *)(&DAT_0211ed98 + (ulong)((uVar5 >> 0x10 ^ uVar12 >> 7) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ec98 + (ulong)((uVar5 >> 0x18 ^ uVar12 >> 0xb) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ee98 + (ulong)((uVar5 >> 8 ^ uVar12 >> 3) & 0x3f) * 4) |
          *(uint *)(&DAT_0211ef98 + (ulong)((uVar5 ^ uVar15 >> 0x10) & 0x3f) * 4));
  uVar2 = *(uint *)(s_wO_L4 + (ulong)(uVar1 & 0xf) * 4) |
          *(int *)(s_wO_L4 + (ulong)(uVar12 & 0xf) * 4) << 1 |
          *(int *)(s_wO_L4 + (ulong)(uVar12 >> 8 & 0xf) * 4) << 3 |
          *(int *)(s_wO_L4 + (ulong)(uVar1 >> 8 & 0xf) * 4) << 2 |
          *(int *)(s_wO_L4 + (ulong)(uVar12 >> 0x10 & 0xf) * 4) << 5 |
          *(int *)(s_wO_L4 + (ulong)(uVar1 >> 0x10 & 0xf) * 4) << 4 |
          *(int *)(s_wO_L4 + (ulong)(uVar12 >> 0x18 & 0xf) * 4) << 7 |
          *(int *)(s_wO_L4 + (ulong)(uVar1 >> 0x18 & 0xf) * 4) << 6;
  uVar12 = *(uint *)(s_wO_L4 + (ulong)(uVar1 >> 4 & 0xf) * 4) |
           *(int *)(s_wO_L4 + (ulong)(uVar12 >> 4 & 0xf) * 4) << 1 |
           *(int *)(s_wO_L4 + (ulong)(uVar12 >> 0xc & 0xf) * 4) << 3 |
           *(int *)(s_wO_L4 + (ulong)(uVar1 >> 0xc & 0xf) * 4) << 2 |
           *(int *)(s_wO_L4 + (ulong)(uVar12 >> 0x14 & 0xf) * 4) << 5 |
           *(int *)(s_wO_L4 + (ulong)(uVar1 >> 0x14 & 0xf) * 4) << 4 |
           *(int *)(s_wO_L4 + (ulong)(uVar12 >> 0x1c) * 4) << 7 |
           *(int *)(s_wO_L4 + (ulong)(uVar1 >> 0x1c) * 4) << 6;
  uVar12 = (uVar12 & 0xff00ff00) >> 8 | (uVar12 & 0xff00ff) << 8;
  param_2[3] = (uchar)uVar2;
  param_2[2] = (uchar)(uVar2 >> 8);
  *(uint *)(param_2 + 4) = uVar12 >> 0x10 | uVar12 << 0x10;
