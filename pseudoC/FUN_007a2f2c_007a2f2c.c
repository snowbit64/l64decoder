...
// Function: FUN_007a2f2c
// Entry Point: 007a2f2c
// Size: 900 bytes
// Signature: undefined FUN_007a2f2c(void)


/* WARNING: Removing unreachable block (ram,0x007a320c) */
/* WARNING: Removing unreachable block (ram,0x007a31bc) */
/* WARNING: Removing unreachable block (ram,0x007a325c) */

void FUN_007a2f2c(TransformGroup *param_1,float *param_2,undefined8 param_3)

{
  ...
  if (param_2[2] != 5.605194e-45) {
    FUN_0079f4f0(&local_448,param_2,param_3,"TransformGroup_setRotation");
    DebugUtil::message((char *)&local_448,"","pArgs->arg[0].m_type == Value::FloatType",
                       "T:/src/engine/app/ReflectionAndScriptBinding.cpp",0x2214);
  ...
  if (param_2[6] != 5.605194e-45) {
    ...
    DebugUtil::message((char *)&local_448,"","pArgs->arg[1].m_type == Value::FloatType",
                       "T:/src/engine/app/ReflectionAndScriptBinding.cpp",0x2215);
    ScriptSystemManager::getInstance();
    pLVar3 = (LuauScriptSystem *)ScriptSystemManager::getCurrentScriptSystem();
    LuauScriptSystem::handleInternalError(pLVar3,"handleInternalError");
  }
  ...
  if (param_2[10] != 5.605194e-45) {
    ...
    DebugUtil::message((char *)&local_448,"","pArgs->arg[2].m_type == Value::FloatType",
                       "T:/src/engine/app/ReflectionAndScriptBinding.cpp",0x2216);
    ScriptSystemManager::getInstance();
    pLVar3 = (LuauScriptSystem *)ScriptSystemManager::getCurrentScriptSystem();
    LuauScriptSystem::handleInternalError(pLVar3,"handleInternalError");
  }
  ...
  local_440 = fVar4;
  TransformGroup::setRotation(param_1,(Vector3 *)&local_448);
