...
void CryptoPP::CipherModeFinalTemplate_ExternalCipher<CryptoPP::CBC_CTS_Encryption>::
...

{
  ...
  *in_x0 = &PTR__BlockOrientedCipherModeBase_00ff1e80;
  in_x0[1] = &PTR__CipherModeFinalTemplate_ExternalCipher_00ff1f70;
  return;
}
