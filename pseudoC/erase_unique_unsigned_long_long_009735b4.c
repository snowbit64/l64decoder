...
// Entry Point: 009735b4
// Size: 268 bytes
// Signature: ulong __thiscall __erase_unique<unsigned_long_long>(__hash_table<std::__ndk1::__hash_value_type<unsigned_long_long,TextureStreamingManager::Status>,std::__ndk1::__unordered_map_hasher<unsigned_long_long,std::__ndk1::__hash_value_type<unsigned_long_long,TextureStreamingManager::Status>,std::__ndk1::hash<unsigned_long_long>,true>,std::__ndk1::__unordered_map_equal<unsigned_long_long,std::__ndk1::__hash_value_type<unsigned_long_long,TextureStreamingManager::Status>,std::__ndk1::equal_to<unsigned_long_long>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned_long_long,TextureStreamingManager::Status>>> * this, ulonglong * param_1)
...
/* unsigned long std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned long long,
   ...
   TextureStreamingManager::Status> > >::__erase_unique<unsigned long long>(unsigned long long
   const&) */
