...
// Function: __construct_node<std::__ndk1::pair<char_const*,BehaviorDataSource::RangeData>>
// Entry Point: 0087f42c
// Size: 208 bytes
// Signature: unique_ptr __cdecl __construct_node<std::__ndk1::pair<char_const*,BehaviorDataSource::RangeData>>(pair * param_1)
...
/* std::__ndk1::unique_ptr<std::__ndk1::__tree_node<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, BehaviorDataSource::RangeData> >
   >::__construct_node<std::__ndk1::pair<char const*, BehaviorDataSource::RangeData>
...
::__construct_node<std::__ndk1::pair<char_const*,BehaviorDataSource::RangeData>>(pair *param_1)

{
  ...
  *(undefined *)(in_x8 + 2) = 0;
  ...
  if (0xffffffffffffffef < __n) {
                    /* try { // try from 0087f4f4 to 0087f4fb has its CatchHandler @ 0087f4fc */
  ...
  if (__n < 0x17) {
    ...
    *(char *)((long)pvVar2 + 0x20) = (char)((int)__n << 1);
    ...
    uVar5 = __n + 0x10 & 0xfffffffffffffff0;
                    /* try { // try from 0087f4a0 to 0087f4a7 has its CatchHandler @ 0087f4fc */
