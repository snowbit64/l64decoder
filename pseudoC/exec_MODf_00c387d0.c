...
// Function: exec_MODf
// Entry Point: 00c387d0
// Size: 136 bytes
// Signature: undefined __cdecl exec_MODf(IR_Const * param_1, IR_Const * param_2)


/* IR_Interpreter::exec_MODf(IR_Const const&, IR_Const const&) */

undefined  [16] IR_Interpreter::exec_MODf(IR_Const *param_1,IR_Const *param_2)
