...
// Function: setShadowMapAutoSplitDistances
// Entry Point: 00a543b8
// Size: 676 bytes
// Signature: undefined __thiscall setShadowMapAutoSplitDistances(LightSource * this, bool param_1)


/* LightSource::setShadowMapAutoSplitDistances(bool) */

void __thiscall LightSource::setShadowMapAutoSplitDistances(LightSource *this,bool param_1)

{
  ...
  this[0x1c8] = (LightSource)param_1;
  if (!param_1) {
    return;
  }
  uVar1 = *(uint *)(this + 0x1c4);
  fVar23 = *(float *)(this + 0x1bc);
  if (1 < uVar1) {
    ...
    if (uVar3 < 4) {
      ...
      if (uVar3 == uVar4) goto LAB_00a5459c;
    }
    do {
      fVar22 = (float)(uVar2 & 0xffffffff) / fVar17;
      fVar9 = powf(__x,fVar22);
      fVar22 = (float)NEON_fmadd(fVar23 + -0.15,fVar22,0x3e19999a);
...
LAB_00a5459c:
  uVar3 = (ulong)(uVar1 - 1);
  if (uVar1 - 1 < 8) {
    *(float *)(this + uVar3 * 4 + 0x1d0) = fVar23;
    if ((int)(uVar3 + 1) != 8) {
      *(float *)(this + (uVar3 + 1) * 4 + 0x1d0) = fVar23;
      if ((int)(uVar3 + 2) != 8) {
        *(float *)(this + (uVar3 + 2) * 4 + 0x1d0) = fVar23;
        if ((int)(uVar3 + 3) != 8) {
          *(float *)(this + (uVar3 + 3) * 4 + 0x1d0) = fVar23;
          if ((int)(uVar3 + 4) != 8) {
            *(float *)(this + (uVar3 + 4) * 4 + 0x1d0) = fVar23;
            if ((int)(uVar3 + 5) != 8) {
              *(float *)(this + (uVar3 + 5) * 4 + 0x1d0) = fVar23;
              if ((int)(uVar3 + 6) != 8) {
                *(float *)(this + (uVar3 + 6) * 4 + 0x1d0) = fVar23;
                if ((int)(uVar3 + 7) != 8) {
                  *(float *)(this + (uVar3 + 7) * 4 + 0x1d0) = fVar23;
                }
              }
            }
          }
