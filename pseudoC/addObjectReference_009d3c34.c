...
// Entry Point: 009d3c34
// Size: 332 bytes
// Signature: undefined __thiscall addObjectReference(ProceduralPlacementManager * this, basic_string * param_1, basic_string * param_2, basic_string * param_3)


/* ProceduralPlacementManager::addObjectReference(std::__ndk1::basic_string<char,
...

{
  ...
  *this_00 = 0;
  ...
  if (puVar2 == *(undefined8 **)(this + 0x48)) {
    ...
    *(void **)(this + 0x48) = (void *)((long)__dest + uVar1 * 8);
    if (__src != (void *)0x0) {
