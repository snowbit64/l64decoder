...
// Function: FUN_009777f8
// Entry Point: 009777f8
// Size: 440 bytes
// Signature: undefined FUN_009777f8(void)


void FUN_009777f8(void **param_1,undefined8 *param_2)

{
  ...
  if (puVar12 != (undefined8 *)param_1[3]) goto LAB_00977978;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00977960;
      }
    }
    do {
      puVar11 = puVar8 + 1;
