...
// Function: __emplace_unique_key_args<unsigned_int,std::__ndk1::pair<unsigned_int,Entity*>>
// Entry Point: 00a77f48
// Size: 520 bytes
// Signature: pair __thiscall __emplace_unique_key_args<unsigned_int,std::__ndk1::pair<unsigned_int,Entity*>>(__hash_table<std::__ndk1::__hash_value_type<unsigned_int,Entity*>,std::__ndk1::__unordered_map_hasher<unsigned_int,std::__ndk1::__hash_value_type<unsigned_int,Entity*>,std::__ndk1::hash<unsigned_int>,true>,std::__ndk1::__unordered_map_equal<unsigned_int,std::__ndk1::__hash_value_type<unsigned_int,Entity*>,std::__ndk1::equal_to<unsigned_int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned_int,Entity*>>> * this, uint * param_1, pair * param_2)


/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<unsigned
   int, Entity*>, void*>*>, bool> std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned
   int, Entity*>, std::__ndk1::__unordered_map_hasher<unsigned int,
   std::__ndk1::__hash_value_type<unsigned int, Entity*>, std::__ndk1::hash<unsigned int>, true>,
   std::__ndk1::__unordered_map_equal<unsigned int, std::__ndk1::__hash_value_type<unsigned int,
   Entity*>, std::__ndk1::equal_to<unsigned int>, true>,
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned int, Entity*> >
   >::__emplace_unique_key_args<unsigned int, std::__ndk1::pair<unsigned int, Entity*> >(unsigned
   int const&, std::__ndk1::pair<unsigned int, Entity*>&&) */
  ...
  if (plVar10 != (long *)0x0) {
    ...
    if (pplVar9 != (long **)0x0) {
      do {
        ...
        if (pplVar9 == (long **)0x0) goto LAB_00a78008;
        plVar6 = pplVar9[1];
        if (plVar6 != plVar11) {
          if (uVar4 < 2) {
          ...
          if (plVar6 != unaff_x24) goto LAB_00a78008;
        }
  ...
  if ((plVar10 == (long *)0x0) || (fVar14 * (float)ZEXT89(plVar10) < (float)(unkuint9)(lVar3 + 1)))
  {
    ...
    if (uVar7 <= uVar4) {
      uVar7 = uVar4;
                    ...
                    /* try { // try from 00a7807c to 00a78083 has its CatchHandler @ 00a78150 */
    rehash(this,uVar7);
    plVar10 = *(long **)(this + 8);
