...
// Function: __append
// Entry Point: 00ac3bf8
// Size: 420 bytes
// Signature: undefined __thiscall __append(vector<VulkanResourceAllocator::ReleasedDescriptorPool,std::__ndk1::allocator<VulkanResourceAllocator::ReleasedDescriptorPool>> * this, ulong param_1)


/* std::__ndk1::vector<VulkanResourceAllocator::ReleasedDescriptorPool,
   std::__ndk1::allocator<VulkanResourceAllocator::ReleasedDescriptorPool> >::__append(unsigned
   long) */
