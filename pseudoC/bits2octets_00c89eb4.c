...
/* CryptoPP::DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,
   CryptoPP::SHA224>::bits2octets(CryptoPP::SecBlock<unsigned char,
   CryptoPP::AllocatorWithCleanup<unsigned char, false> > const&, CryptoPP::Integer const&) const */

void CryptoPP::DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA224>::bits2octets
...

{
  ...
  if ((uVar4 & 0xffffffff) <= (ulong)(*(long *)(param_2 + 0x10) * 8) && uVar2 != 0) {
                    /* try { // try from 00c89f18 to 00c89f1f has its CatchHandler @ 00c89ff8 */
    Integer::operator>>=((Integer *)local_78,uVar2);
  }
                    /* try { // try from 00c89f20 to 00c89f2f has its CatchHandler @ 00c8a008 */
  Integer::Minus((Integer *)local_78);
                    /* try { // try from 00c89f34 to 00c89f5b has its CatchHandler @ 00c8a010 */
  Integer::ByteCount();
  pppuVar1 = local_78;
  if (local_80 != 1) {
    pppuVar1 = local_a8;
  ...
  for (; local_98 != 0; local_98 = local_98 - 1) {
    *(undefined4 *)((long)local_88 + local_98 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00c89f94 to 00c89f97 has its CatchHandler @ 00c8a004 */
  ...
  for (; local_68 != 0; local_68 = local_68 - 1) {
    *(undefined4 *)((long)local_58 + local_68 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00c89fc8 to 00c89fcb has its CatchHandler @ 00c8a000 */
