...
// Function: setPostProcessAntiAliasing
// Entry Point: 00758554
// Size: 232 bytes
// Signature: undefined __thiscall setPostProcessAntiAliasing(HardwareScalability * this, POST_PROCESS_ANTI_ALIASING param_1)


/* HardwareScalability::setPostProcessAntiAliasing(HardwareScalability::POST_PROCESS_ANTI_ALIASING)
    */

void __thiscall
HardwareScalability::setPostProcessAntiAliasing
          (HardwareScalability *this,POST_PROCESS_ANTI_ALIASING param_1)

{
  ...
  if (*(POST_PROCESS_ANTI_ALIASING *)(this + 0x80) != param_1) {
    *(POST_PROCESS_ANTI_ALIASING *)(this + 0x80) = param_1;
    if (1 < param_1) {
