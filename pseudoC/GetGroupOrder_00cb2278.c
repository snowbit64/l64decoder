...
// Entry Point: 00cb2278
// Size: 192 bytes
// Signature: undefined GetGroupOrder(void)


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* CryptoPP::DL_GroupParameters<CryptoPP::EC2NPoint>::GetGroupOrder() const */

void CryptoPP::DL_GroupParameters<CryptoPP::EC2NPoint>::GetGroupOrder(void)

{
  ...
  (**(code **)(*in_x0 + 0xb8))(local_68);
                    /* try { // try from 00cb22c4 to 00cb22d3 has its CatchHandler @ 00cb233c */
  ...
  for (; local_58 != 0; local_58 = local_58 - 1) {
    *(undefined4 *)((long)local_48 + local_58 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00cb230c to 00cb230f has its CatchHandler @ 00cb2338 */
