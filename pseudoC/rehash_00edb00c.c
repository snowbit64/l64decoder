...
// Function: rehash
// Entry Point: 00edb00c
// Size: 460 bytes
// Signature: undefined rehash(void)


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* Luau::detail::DenseHashTable<Luau::AstExprTable*, std::__ndk1::pair<Luau::AstExprTable*,
   Luau::Compile::TableShape>, std::__ndk1::pair<Luau::AstExprTable* const,
   Luau::Compile::TableShape>, Luau::detail::ItemInterfaceMap<Luau::AstExprTable*,
...
LAB_00edb0f0:
    ...
    if (((((void *)((long)pvVar3 + lVar4) < pvVar3) || (bVar2)) ||
        ((long)pvVar3 + 8U + lVar4 < (long)pvVar3 + 8U)) || (bVar2)) goto LAB_00edb0f0;
    ...
    if (pvVar1 != pvVar6) goto LAB_00edb0f0;
  }
  ppvVar5 = (void **)*in_x0;
  pvVar6 = in_x0[1];
joined_r0x00edb064:
...
joined_r0x00edb06c:
  ...
  pvVar11 = *ppvVar5;
  ppvVar12 = ppvVar5;
  if (pvVar11 == pvVar8) goto LAB_00edb198;
  do {
...
LAB_00edb17c:
      *ppvVar13 = pvVar11;
      ...
      do {
        ...
        ppvVar13 = (void **)((long)pvVar3 + uVar9 * 0x10);
        if (*ppvVar13 == pvVar14) goto LAB_00edb17c;
        lVar4 = lVar4 + 1;
