...
// Entry Point: 00cb92c0
// Size: 52 bytes
// Signature: undefined __cdecl ChannelMessageSeriesEnd(basic_string * param_1, int param_2, bool param_3)


/* CryptoPP::InputRejecting<CryptoPP::Filter>::ChannelMessageSeriesEnd(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, int, bool) */

void CryptoPP::InputRejecting<CryptoPP::Filter>::ChannelMessageSeriesEnd
...

{
  ...
  this = (InputRejected *)__cxa_allocate_exception(0x28,param_2,param_3);
                    /* try { // try from 00cb92d8 to 00cb92db has its CatchHandler @ 00cb92f4 */
