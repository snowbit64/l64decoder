...
// Function: NewElement
// Entry Point: 00e00318
// Size: 384 bytes
// Signature: undefined __thiscall NewElement(XMLDocument * this, char * param_1)
...

{
  ...
  puVar4 = (undefined8 *)(**(code **)(*(long *)(this + 0x108) + 0x18))(this + 0x108);
  puVar4[5] = 0;
  ...
  *puVar4 = &PTR_ToElement_01013508;
  puVar4[1] = this;
  *(undefined4 *)(puVar4 + 0xd) = 0;
  puVar4[0xe] = 0;
  puVar4[0xc] = this + 0x108;
  if (iVar9 < iVar2) {
