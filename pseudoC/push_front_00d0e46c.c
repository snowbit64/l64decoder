...
// Function: push_front
// Entry Point: 00d0e46c
// Size: 448 bytes
// Signature: undefined __thiscall push_front(__split_buffer<unsigned_long*,std::__ndk1::allocator<unsigned_long*>&> * this, ulong * * param_1)


/* std::__ndk1::__split_buffer<unsigned long*, std::__ndk1::allocator<unsigned
   long*>&>::push_front(unsigned long* const&) */

void __thiscall
std::__ndk1::__split_buffer<unsigned_long*,std::__ndk1::allocator<unsigned_long*>&>::push_front
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00d0e5f4;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00d0e5dc;
      }
    }
    do {
      puVar7 = puVar6 + 1;
