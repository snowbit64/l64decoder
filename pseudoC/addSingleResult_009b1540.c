...
/* Bt2SceneQueryUtil::PointCloudArrayContactResultCallback::addSingleResult(btManifoldPoint&,
   btCollisionObjectWrapper const*, int, int, btCollisionObjectWrapper const*, int, int) */

undefined  [16]
Bt2SceneQueryUtil::PointCloudArrayContactResultCallback::addSingleResult
...

{
  ...
  if (0.0 <= *(float *)(param_2 + 0x50)) goto LAB_009b1690;
