...
// Function: __append
// Entry Point: 00ad62bc
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<VkPresentModeKHR,std::__ndk1::allocator<VkPresentModeKHR>> * this, ulong param_1)


/* std::__ndk1::vector<VkPresentModeKHR, std::__ndk1::allocator<VkPresentModeKHR>
   >::__append(unsigned long) */

void __thiscall
std::__ndk1::vector<VkPresentModeKHR,std::__ndk1::allocator<VkPresentModeKHR>>::__append
