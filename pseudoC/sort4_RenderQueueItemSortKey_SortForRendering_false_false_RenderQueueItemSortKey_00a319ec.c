...
// Function: __sort4<RenderQueueItemSortKey::SortForRendering<false,false>&,RenderQueueItemSortKey*>
// Entry Point: 00a319ec
// Size: 604 bytes
// Signature: uint __cdecl __sort4<RenderQueueItemSortKey::SortForRendering<false,false>&,RenderQueueItemSortKey*>(RenderQueueItemSortKey * param_1, RenderQueueItemSortKey * param_2, RenderQueueItemSortKey * param_3, RenderQueueItemSortKey * param_4, SortForRendering * param_5)


/* unsigned int std::__ndk1::__sort4<RenderQueueItemSortKey::SortForRendering<false, false>&,
...

{
  ...
  uVar5 = __sort3<RenderQueueItemSortKey::SortForRendering<false,false>&,RenderQueueItemSortKey*>
  ...
  if (((((uVar1 == uVar2) &&
    ...
    if (*(float *)(param_3 + 0x20) <= *(float *)(param_4 + 0x20)) goto LAB_00a31c18;
  }
  else if (bVar4) goto LAB_00a31c18;
  ...
  if (((uVar1 == uVar2) &&
     ...
     ((bVar4 = *(ulong *)param_2 <= *(ulong *)param_3, *(ulong *)param_3 == *(ulong *)param_2 &&
      (((bVar4 = *(ulong *)(param_2 + 0x10) <= *(ulong *)(param_3 + 0x10),
       ...
       , bVar4 = uVar2 <= uVar1, uVar1 == uVar2)))))) {
    if (*(float *)(param_2 + 0x20) <= *(float *)(param_3 + 0x20)) goto LAB_00a31c18;
  }
  else if (bVar4) goto LAB_00a31c18;
  ...
  *(undefined8 *)(param_3 + 0x10) = uVar14;
  ...
  if ((((uVar1 == uVar2) &&
     ...
     bVar4 = uVar2 <= uVar1, uVar1 == uVar2)) {
    if (*(float *)(param_1 + 0x20) <= *(float *)(param_2 + 0x20)) goto LAB_00a31c18;
  }
  else if (bVar4) goto LAB_00a31c18;
