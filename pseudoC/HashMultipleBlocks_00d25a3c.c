...
// Entry Point: 00d25a3c
// Size: 348 bytes
// Signature: undefined __thiscall HashMultipleBlocks(SHA256 * this, uint * param_1, ulong param_2)


/* CryptoPP::SHA256::HashMultipleBlocks(unsigned int const*, unsigned long) */

ulong __thiscall CryptoPP::SHA256::HashMultipleBlocks(SHA256 *this,uint *param_1,ulong param_2)
