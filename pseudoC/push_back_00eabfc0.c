...
// Function: push_back
// Entry Point: 00eabfc0
// Size: 432 bytes
// Signature: undefined __thiscall push_back(__split_buffer<simplejobsystem::SimpleJob**,std::__ndk1::allocator<simplejobsystem::SimpleJob**>> * this, SimpleJob * * * param_1)


/* std::__ndk1::__split_buffer<simplejobsystem::SimpleJob**,
   std::__ndk1::allocator<simplejobsystem::SimpleJob**> >::push_back(simplejobsystem::SimpleJob**&&)
    */
...

{
  ...
  if (puVar12 != *(undefined8 **)(this + 0x18)) goto LAB_00eac140;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00eac128;
      }
    }
    do {
      puVar11 = puVar8 + 1;
