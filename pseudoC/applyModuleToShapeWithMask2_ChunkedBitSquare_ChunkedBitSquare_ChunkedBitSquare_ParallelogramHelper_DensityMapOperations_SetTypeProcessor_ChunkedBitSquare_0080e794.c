...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
// Entry Point: 0080e794
// Size: 4420 bytes
...
/* bool DensityMapModifier::applyModuleToShapeWithMask2<ChunkedBitSquare, ChunkedBitSquare,
   ...
   >(IDensityPixelSource*, ChunkedBitSquare*, ChunkedBitSquare*, ChunkedBitSquare*,
   ParallelogramHelper&, DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>&, DensityMapFilter
   const&, DensityMapFilter const&) */

bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
    ...
    if (((uVar20 < local_98) || (uVar24 < local_94)) || ((uVar21 < local_94 || (uVar23 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar33 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar33 != 0
                    ...
                    /* try { // try from 0080f88c to 0080f89f has its CatchHandler @ 0080f8d8 */
          ...
          do {
            ...
            do {
              ...
              if (*(uint *)(param_3 + 0x34) < 2) {
                uVar41 = (ulong)*(uint *)(param_3 + 0x34);
                if (iVar33 != 2) goto LAB_0080f488;
LAB_0080f4a8:
                uVar5 = uVar29 >> (ulong)(uVar6 & 0x1f) & uVar14;
                if (((int)uVar5 < iVar27) || (iVar28 < (int)uVar5)) {
                  if (DVar11 != (DensityMapFilter)0x0) goto LAB_0080f4d4;
                }
...
LAB_0080f4d4:
                ...
                if (iVar33 == 2) goto LAB_0080f4a8;
LAB_0080f488:
                if ((iVar33 == 0) != ((uVar29 & uVar15) != uVar7)) goto LAB_0080f4a8;
              }
              uVar31 = uVar31 + 1;
              uVar3 = uVar3 + 1;
            } while (uVar31 != uVar36);
...
LAB_0080f640:
      ...
      if (iVar9 == 2) goto LAB_0080f640;
LAB_0080f620:
      if ((iVar9 == 0) != ((uVar29 & uVar17) != uVar10)) goto LAB_0080f640;
LAB_0080f54c:
      uVar31 = uVar31 + 1;
      uVar3 = uVar3 + 1;
    } while (uVar31 != uVar21);
...
LAB_0080f338:
  uVar37 = uVar37 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar37) goto LAB_0080f2d4;
  goto LAB_0080f350;
}
