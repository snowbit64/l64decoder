...
// Function: __emplace_unique_key_args<MaterialShaderHash,std::__ndk1::pair<MaterialShaderHash_const,MaterialShader*>const&>
// Entry Point: 00957d00
// Size: 300 bytes
// Signature: pair __thiscall __emplace_unique_key_args<MaterialShaderHash,std::__ndk1::pair<MaterialShaderHash_const,MaterialShader*>const&>(__tree<std::__ndk1::__value_type<MaterialShaderHash,MaterialShader*>,std::__ndk1::__map_value_compare<MaterialShaderHash,std::__ndk1::__value_type<MaterialShaderHash,MaterialShader*>,std::__ndk1::less<MaterialShaderHash>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<MaterialShaderHash,MaterialShader*>>> * this, MaterialShaderHash * param_1, pair * param_2)
...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<MaterialShaderHash,
   ...
   >::__emplace_unique_key_args<MaterialShaderHash, std::__ndk1::pair<MaterialShaderHash const,
   MaterialShader*> const&>(MaterialShaderHash const&, std::__ndk1::pair<MaterialShaderHash const,
   MaterialShader*> const&) */
