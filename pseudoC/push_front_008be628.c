...
/* std::__ndk1::__split_buffer<SoundPlayer::SampleLoadInfo*,
   std::__ndk1::allocator<SoundPlayer::SampleLoadInfo*>
   >::push_front(SoundPlayer::SampleLoadInfo*&&) */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_008be7b0;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_008be798;
      }
    }
    do {
      puVar7 = puVar6 + 1;
