...
// Function: Integer
// Entry Point: 00cf517c
// Size: 308 bytes
// Signature: undefined __thiscall Integer(Integer * this, Sign param_1, uint param_2, uint param_3)


/* CryptoPP::Integer::Integer(CryptoPP::Integer::Sign, unsigned int, unsigned int) */

void __thiscall CryptoPP::Integer::Integer(Integer *this,Sign param_1,uint param_2,uint param_3)

{
  ...
  *(undefined ***)this = &PTR__Integer_0100c890;
  puVar1 = (uint *)UnalignedAllocate(8);
  *(Sign *)(this + 0x28) = param_1;
  *(uint **)(this + 0x20) = puVar1;
  *puVar1 = param_3;
  puVar1[1] = param_2;
  return;
}
