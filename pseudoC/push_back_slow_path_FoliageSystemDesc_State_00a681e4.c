...
// Function: __push_back_slow_path<FoliageSystemDesc::State>
// Entry Point: 00a681e4
// Size: 472 bytes
// Signature: void __thiscall __push_back_slow_path<FoliageSystemDesc::State>(vector<FoliageSystemDesc::State,std::__ndk1::allocator<FoliageSystemDesc::State>> * this, State * param_1)


/* void std::__ndk1::vector<FoliageSystemDesc::State,
   std::__ndk1::allocator<FoliageSystemDesc::State>
   >::__push_back_slow_path<FoliageSystemDesc::State>(FoliageSystemDesc::State&&) */
...

{
  ...
  local_78 = pbVar10;
  pbStack_70 = pbVar10;
                    /* try { // try from 00a682c4 to 00a682cf has its CatchHandler @ 00a683fc */
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string(pbVar10);
                    /* try { // try from 00a682e0 to 00a682e7 has its CatchHandler @ 00a683dc */
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  ...
  *(undefined8 *)((long)pvVar4 + lVar5 * 8 + 0x3c) = uVar11;
                    /* try { // try from 00a68308 to 00a6830b has its CatchHandler @ 00a683bc */
  ...
  pbStack_70 = pbVar10 + 0x1a;
                    /* try { // try from 00a68320 to 00a68327 has its CatchHandler @ 00a683fc */
