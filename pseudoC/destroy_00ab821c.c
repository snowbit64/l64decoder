...
// Function: destroy
// Entry Point: 00ab821c
// Size: 64 bytes
// Signature: undefined __thiscall destroy(__tree<std::__ndk1::__value_type<BlendStateDesc,std::__ndk1::pair<VkPipelineColorBlendStateCreateInfo,unsigned_int>>,std::__ndk1::__map_value_compare<BlendStateDesc,std::__ndk1::__value_type<BlendStateDesc,std::__ndk1::pair<VkPipelineColorBlendStateCreateInfo,unsigned_int>>,ComparerUtil::BlendStateDescComparer,true>,std::__ndk1::allocator<std::__ndk1::__value_type<BlendStateDesc,std::__ndk1::pair<VkPipelineColorBlendStateCreateInfo,unsigned_int>>>> * this, __tree_node * param_1)
...
/* std::__ndk1::__tree<std::__ndk1::__value_type<BlendStateDesc,
   ...
   std::__ndk1::pair<VkPipelineColorBlendStateCreateInfo, unsigned int> > >
   >::destroy(std::__ndk1::__tree_node<std::__ndk1::__value_type<BlendStateDesc,
   std::__ndk1::pair<VkPipelineColorBlendStateCreateInfo, unsigned int> >, void*>*) */
