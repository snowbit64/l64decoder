...
// Entry Point: 00d07738
// Size: 212 bytes
// Signature: undefined __thiscall PadLastBlock(IteratedHashBase<unsigned_long,CryptoPP::MessageAuthenticationCode> * this, uint param_1, uchar param_2)
...
void __thiscall
CryptoPP::IteratedHashBase<unsigned_long,CryptoPP::MessageAuthenticationCode>::PadLastBlock
          (IteratedHashBase<unsigned_long,CryptoPP::MessageAuthenticationCode> *this,uint param_1,
          uchar param_2)
