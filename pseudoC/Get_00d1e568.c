...
// Function: Get
// Entry Point: 00d1e568
// Size: 168 bytes
// Signature: undefined __thiscall Get(ByteQueue * this, uchar * param_1, ulong param_2)


/* CryptoPP::ByteQueue::Get(unsigned char*, unsigned long) */

void __thiscall CryptoPP::ByteQueue::Get(ByteQueue *this,uchar *param_1,ulong param_2)
