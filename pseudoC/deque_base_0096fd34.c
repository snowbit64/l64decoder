...
// Entry Point: 0096fd34
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<TextureStreamingManager::UpgradePipeline::ReallocateRequest,std::__ndk1::allocator<TextureStreamingManager::UpgradePipeline::ReallocateRequest>> * this)


/* std::__ndk1::__deque_base<TextureStreamingManager::UpgradePipeline::ReallocateRequest,
...

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_0096fda0;
    uVar4 = 0x55;
  }
