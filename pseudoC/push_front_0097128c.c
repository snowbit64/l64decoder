...
// Function: push_front
// Entry Point: 0097128c
// Size: 448 bytes
// Signature: undefined __thiscall push_front(__split_buffer<TextureStreamingManager::DowngradePipeline::ReallocateRequest*,std::__ndk1::allocator<TextureStreamingManager::DowngradePipeline::ReallocateRequest*>&> * this, ReallocateRequest * * param_1)


/* std::__ndk1::__split_buffer<TextureStreamingManager::DowngradePipeline::ReallocateRequest*,
   std::__ndk1::allocator<TextureStreamingManager::DowngradePipeline::ReallocateRequest*>&>::push_front(TextureStreamingManager::DowngradePipeline::ReallocateRequest*
   const&) */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00971414;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_009713fc;
      }
    }
    do {
      puVar7 = puVar6 + 1;
