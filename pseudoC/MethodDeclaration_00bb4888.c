...
// Entry Point: 00bb4888
// Size: 64 bytes
// Signature: undefined __thiscall MethodDeclaration(MethodDeclaration * this, Type param_1, Type param_2, Type param_3, Type param_4, void * param_5, Type param_6, Type param_7, Type param_8, Type param_9, Type param_10)
...

{
  ...
  *(undefined8 *)(this + 0x60) = 0x400000005;
  return;
}
