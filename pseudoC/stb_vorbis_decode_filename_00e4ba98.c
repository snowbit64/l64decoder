...
// Function: stb_vorbis_decode_filename
// Entry Point: 00e4ba98
// Size: 368 bytes
// Signature: undefined stb_vorbis_decode_filename(void)


int stb_vorbis_decode_filename(undefined8 param_1,int *param_2,undefined4 *param_3,void **param_4)

{
  ...
  __ptr = (undefined4 *)stb_vorbis_open_filename(param_1,auStack_6c,0);
