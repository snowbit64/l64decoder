...
// Function: emplace_back<Vector3_const&,unsigned_short&>
// Entry Point: 00b631c8
// Size: 316 bytes
// Signature: void __thiscall emplace_back<Vector3_const&,unsigned_short&>(vector<Brep::Vertex,std::__ndk1::allocator<Brep::Vertex>> * this, Vector3 * param_1, ushort * param_2)


/* void std::__ndk1::vector<Brep::Vertex, std::__ndk1::allocator<Brep::Vertex>
   >::emplace_back<Vector3 const&, unsigned short&>(Vector3 const&, unsigned short&) */
