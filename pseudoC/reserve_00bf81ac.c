...
// Function: reserve
// Entry Point: 00bf81ac
// Size: 208 bytes
// Signature: undefined __thiscall reserve(vector<CompiledShaderArchive::ProgramEntry,std::__ndk1::allocator<CompiledShaderArchive::ProgramEntry>> * this, ulong param_1)


/* std::__ndk1::vector<CompiledShaderArchive::ProgramEntry,
   std::__ndk1::allocator<CompiledShaderArchive::ProgramEntry> >::reserve(unsigned long) */
