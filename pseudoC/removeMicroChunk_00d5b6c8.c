...
// Entry Point: 00d5b6c8
// Size: 144 bytes
// Signature: undefined __thiscall removeMicroChunk(MyMicroAllocator * this, MemoryChunk * param_1)


/* non-virtual thunk to HACD::MyMicroAllocator::removeMicroChunk(HACD::MemoryChunk*) */
...

{
  ...
  uVar3 = *(uint *)(this + 0x844);
  *(undefined8 *)(this + 0x848) = 0;
  if (uVar3 != 0) {
    uVar5 = 0;
    lVar4 = 0x10;
    do {
      if (*(MemoryChunk **)(*(long *)(this + 0x850) + lVar4) == param_1) {
        *(uint *)(this + 0x844) = uVar3 - 1;
        if (uVar3 - 1 <= (uint)uVar5) {
          return;
        }
        puVar1 = (undefined8 *)(*(long *)(this + 0x850) + lVar4);
        uVar5 = uVar5 + 1;
        puVar1[-1] = puVar1[3];
        puVar1[-2] = puVar1[2];
        puVar1[1] = puVar1[5];
        *puVar1 = puVar1[4];
        if (*(uint *)(this + 0x844) <= uVar5) {
          return;
        }
        lVar4 = lVar4 + -0x10;
        do {
          uVar5 = uVar5 + 1;
          lVar2 = *(long *)(this + 0x850) + lVar4;
          lVar4 = lVar4 + 0x20;
