...
// Function: setMaxNumLights
// Entry Point: 00758dfc
// Size: 220 bytes
// Signature: undefined __thiscall setMaxNumLights(HardwareScalability * this, uint param_1)


/* HardwareScalability::setMaxNumLights(unsigned int) */

void __thiscall HardwareScalability::setMaxNumLights(HardwareScalability *this,uint param_1)

{
  ...
  if (*(uint *)(this + 0x9c) != param_1) {
    *(uint *)(this + 0x9c) = param_1;
