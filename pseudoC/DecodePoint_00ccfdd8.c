...
// Entry Point: 00ccfdd8
// Size: 132 bytes
// Signature: undefined __thiscall DecodePoint(EC2N * this, EC2NPoint * param_1, uchar * param_2, ulong param_3)


/* CryptoPP::EC2N::DecodePoint(CryptoPP::EC2NPoint&, unsigned char const*, unsigned long) const */
...

{
  ...
  uVar2 = (**(code **)(*(long *)this + 0x80))(this,param_1,aSStack_70,param_3);
