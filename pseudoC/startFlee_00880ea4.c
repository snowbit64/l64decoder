...
// Function: startFlee
// Entry Point: 00880ea4
// Size: 284 bytes
// Signature: undefined __cdecl startFlee(float param_1, float param_2)


/* AnimalSteering::startFlee(float, float) */

void AnimalSteering::startFlee(float param_1,float param_2)
