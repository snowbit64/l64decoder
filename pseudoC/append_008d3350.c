...
// Function: __append
// Entry Point: 008d3350
// Size: 396 bytes
// Signature: undefined __thiscall __append(vector<FillPlaneGeometry::EdgeInfo,std::__ndk1::allocator<FillPlaneGeometry::EdgeInfo>> * this, ulong param_1, EdgeInfo * param_2)


/* std::__ndk1::vector<FillPlaneGeometry::EdgeInfo,
   std::__ndk1::allocator<FillPlaneGeometry::EdgeInfo> >::__append(unsigned long,
...
::__append(vector<FillPlaneGeometry::EdgeInfo,std::__ndk1::allocator<FillPlaneGeometry::EdgeInfo>>
