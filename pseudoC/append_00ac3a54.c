...
// Function: __append
// Entry Point: 00ac3a54
// Size: 420 bytes
// Signature: undefined __thiscall __append(vector<VulkanResourceAllocator::ReleasedCommandPool,std::__ndk1::allocator<VulkanResourceAllocator::ReleasedCommandPool>> * this, ulong param_1)


/* std::__ndk1::vector<VulkanResourceAllocator::ReleasedCommandPool,
   std::__ndk1::allocator<VulkanResourceAllocator::ReleasedCommandPool> >::__append(unsigned long)
    */
