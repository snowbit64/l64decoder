...
// Function: assign<unsigned_int*>
// Entry Point: 00c4b6f0
// Size: 332 bytes
// Signature: type __thiscall assign<unsigned_int*>(vector<unsigned_int,std::__ndk1::allocator<unsigned_int>> * this, uint * param_1, uint * param_2)


/* std::__ndk1::enable_if<__is_cpp17_forward_iterator<unsigned
   int*>::value&&is_constructible<unsigned int, std::__ndk1::iterator_traits<unsigned
   int*>::reference>::value, void>::type std::__ndk1::vector<unsigned int,
   std::__ndk1::allocator<unsigned int> >::assign<unsigned int*>(unsigned int*, unsigned int*) */
...

{
  ...
  type tVar1;
  void *pvVar2;
  vector<unsigned_int,std::__ndk1::allocator<unsigned_int>> *pvVar3;
  ulong uVar4;
  size_t sVar5;
  void *pvVar6;
  ulong uVar7;
  ...
  if (uVar7 <= (ulong)((long)(uVar4 - (long)pvVar6) >> 2)) {
    ...
    __src = (uint *)((long)param_1 + (*(long *)(this + 8) - (long)pvVar6));
    if (uVar7 <= uVar4) {
      __src = param_2;
    }
    ...
    pvVar3 = this;
    if (sVar5 != 0) {
      pvVar3 = (vector<unsigned_int,std::__ndk1::allocator<unsigned_int>> *)
