...
// Function: applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
// Entry Point: 00819e2c
// Size: 3996 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>(IDensityPixelSource * param_1, BitVector * param_2, ChunkedBitSquare * param_3, ChunkedBitSquare * param_4, ParallelogramHelper * param_5, SetTypeProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)


/* bool DensityMapModifier::applyModuleToShapeWithMask2<BitVector, ChunkedBitSquare,
   ChunkedBitSquare, ParallelogramHelper, DensityMapOperations::SetTypeProcessor<BitVector>
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
    ...
    if (((uVar22 < local_98) || (uVar26 < local_94)) || ((uVar23 < local_94 || (uVar25 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar32 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar32 != 0
                    ...
                    /* try { // try from 0081ad8c to 0081ad97 has its CatchHandler @ 0081adc8 */
          ...
          do {
            ...
            do {
              ...
              if (*(uint *)(param_3 + 0x34) < 2) {
                uVar42 = (ulong)*(uint *)(param_3 + 0x34);
                if (iVar32 != 2) goto LAB_0081aa40;
LAB_0081aa60:
                uVar4 = uVar30 >> (ulong)(uVar5 & 0x1f) & uVar16;
                if (((int)uVar4 < iVar29) || (iVar8 < (int)uVar4)) {
                  if (DVar13 != (DensityMapFilter)0x0) goto LAB_0081aa8c;
                }
...
LAB_0081aa8c:
                ...
                if (iVar32 == 2) goto LAB_0081aa60;
LAB_0081aa40:
                if ((iVar32 == 0) != ((uVar30 & uVar17) != uVar6)) goto LAB_0081aa60;
              }
              uVar44 = uVar44 + 1;
              uVar2 = uVar2 + 1;
            } while (uVar44 != uVar35);
...
LAB_0081a630:
  ...
  if (param_6[0x5c] != (SetTypeProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar36,*(uint *)(param_6 + 0x14),*(uint *)(param_6 + 0x18),
  ...
  do {
    ...
    do {
      ...
      if (*(uint *)(param_4 + 0x34) < 2) {
        uVar42 = (ulong)*(uint *)(param_4 + 0x34);
        if (iVar9 != 2) goto LAB_0081abdc;
LAB_0081abfc:
        uVar4 = uVar30 >> (ulong)(uVar24 & 0x1f) & uVar18;
        if (((int)uVar4 < iVar11) || (iVar12 < (int)uVar4)) {
          if (DVar14 != (DensityMapFilter)0x0) goto LAB_0081ac28;
        }
...
LAB_0081ac28:
        ...
        if (iVar9 == 2) goto LAB_0081abfc;
LAB_0081abdc:
        if ((iVar9 == 0) != ((uVar30 & uVar19) != uVar10)) goto LAB_0081abfc;
      }
      uVar44 = uVar44 + 1;
      uVar2 = uVar2 + 1;
    } while (uVar44 != uVar23);
...
LAB_0081a8fc:
  uVar36 = uVar36 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar36) goto LAB_0081a89c;
  goto LAB_0081a90c;
}
