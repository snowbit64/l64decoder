...
// Function: push_back
// Entry Point: 009710d4
// Size: 440 bytes
// Signature: undefined __thiscall push_back(__split_buffer<TextureStreamingManager::DowngradePipeline::ReallocateRequest*,std::__ndk1::allocator<TextureStreamingManager::DowngradePipeline::ReallocateRequest*>&> * this, ReallocateRequest * * param_1)


/* std::__ndk1::__split_buffer<TextureStreamingManager::DowngradePipeline::ReallocateRequest*,
   std::__ndk1::allocator<TextureStreamingManager::DowngradePipeline::ReallocateRequest*>&>::push_back(TextureStreamingManager::DowngradePipeline::ReallocateRequest*&&)
    */
...

{
  ...
  if (ppRVar12 != *(ReallocateRequest ***)(this + 0x18)) goto LAB_00971254;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_0097123c;
      }
    }
    do {
      ppRVar11 = ppRVar8 + 1;
