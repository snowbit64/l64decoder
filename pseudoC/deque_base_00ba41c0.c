...
// Entry Point: 00ba41c0
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<ThreadPool::Task*,std::__ndk1::allocator<ThreadPool::Task*>> * this)
...
void __thiscall
std::__ndk1::__deque_base<ThreadPool::Task*,std::__ndk1::allocator<ThreadPool::Task*>>::
~__deque_base(__deque_base<ThreadPool::Task*,std::__ndk1::allocator<ThreadPool::Task*>> *this)

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_00ba422c;
    uVar4 = 0x200;
  }
