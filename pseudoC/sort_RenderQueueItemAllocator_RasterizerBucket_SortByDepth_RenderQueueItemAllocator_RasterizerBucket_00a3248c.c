...
// Function: __sort<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>
// Entry Point: 00a3248c
// Size: 2000 bytes
// Signature: void __cdecl __sort<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>(RasterizerBucket * param_1, RasterizerBucket * param_2, SortByDepth * param_3)


/* void std::__ndk1::__sort<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,
   RenderQueueItemAllocator::RasterizerBucket*>(RenderQueueItemAllocator::RasterizerBucket*,
   RenderQueueItemAllocator::RasterizerBucket*,
   RenderQueueItemAllocator::RasterizerBucket::SortByDepth&) */

void std::__ndk1::
     __sort<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>
               (RasterizerBucket *param_1,RasterizerBucket *param_2,SortByDepth *param_3)
...
LAB_00a324d4:
  param_1 = (RasterizerBucket *)puVar11;
  uVar12 = (long)param_2 - (long)param_1;
  lVar7 = (long)uVar12 >> 5;
  switch(lVar7) {
  case 0:
  case 1:
    goto switchD_00a32914_caseD_0;
  case 2:
  ...
  case 3:
    ...
    goto switchD_00a32914_caseD_0;
  case 4:
    __sort4<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>
              (param_1,(RasterizerBucket *)((long)param_1 + 0x20),
               (RasterizerBucket *)((long)param_1 + 0x40),(RasterizerBucket *)puVar15,param_3);
    goto switchD_00a32914_caseD_0;
  case 5:
    puVar11 = (undefined8 *)((long)param_1 + 0x20);
    ...
    __sort4<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>
              (param_1,(RasterizerBucket *)puVar11,(RasterizerBucket *)puVar15,
               (RasterizerBucket *)puVar10,param_3);
  ...
  if (uVar12 < 0x7ce1) {
    ...
    if (*(double *)((long)param_1 + 0x18) <= dVar21) {
      if (dVar21 <= *(double *)((long)param_2 + -8)) {
        ...
        *(undefined8 *)((long)param_2 + -8) = uVar23;
        *(undefined8 *)((long)param_2 + -0x10) = uVar16;
        if (*(double *)((long)param_1 + 0x18) <= *pdVar8) goto LAB_00a326cc;
        uVar26 = *(undefined8 *)((long)param_1 + 8);
        uVar22 = *(undefined8 *)param_1;
        uVar23 = *(undefined8 *)((long)param_1 + 0x18);
        uVar16 = *(undefined8 *)((long)param_1 + 0x10);
...
LAB_00a326cc:
    ...
    uVar5 = __sort4<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>
                      (param_1,(RasterizerBucket *)puVar10,(RasterizerBucket *)puVar11,
                       (RasterizerBucket *)puVar13,param_3);
...
LAB_00a326e0:
  ...
  if (*(double *)((long)param_1 + (lVar19 * 4 + 3) * 8) <= dVar21) {
    do {
      ...
      if (puVar10 == (undefined8 *)param_1) {
        ...
        puVar11 = puVar10;
        if (*(double *)((long)param_2 + -8) <= dVar21) goto joined_r0x00a32848;
        goto LAB_00a32880;
      }
  ...
  if (uVar5 == 0) {
    bVar3 = __insertion_sort_incomplete<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>
                      (param_1,(RasterizerBucket *)puVar13,param_3);
    bVar4 = __insertion_sort_incomplete<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>
                      ((RasterizerBucket *)(puVar13 + 4),param_2,param_3);
    if (bVar4) goto LAB_00a328f4;
    puVar11 = puVar13 + 4;
    if (bVar3) goto LAB_00a324d4;
  }
  if ((long)param_2 - (long)puVar13 <= (long)puVar13 - (long)param_1) {
    __sort<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>
              ((RasterizerBucket *)(puVar13 + 4),param_2,param_3);
    param_2 = (RasterizerBucket *)puVar13;
    goto LAB_00a324cc;
  }
  __sort<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>
            (param_1,(RasterizerBucket *)puVar13,param_3);
  ...
  goto LAB_00a324d4;
joined_r0x00a32848:
  if (puVar11 == puVar15) goto switchD_00a32914_caseD_0;
  if (dVar21 < (double)puVar11[3]) goto LAB_00a32868;
  puVar11 = puVar11 + 4;
  goto joined_r0x00a32848;
LAB_00a32868:
  uVar26 = puVar11[1];
  uVar22 = *puVar11;
  uVar23 = puVar11[3];
...
LAB_00a32880:
  puVar13 = puVar15;
  if (puVar10 == puVar15) goto switchD_00a32914_caseD_0;
  while( true ) {
    puVar11 = puVar10 + -4;
    do {
      puVar17 = puVar11;
...
LAB_00a328f4:
  param_2 = (RasterizerBucket *)puVar13;
  if (bVar3) goto switchD_00a32914_caseD_0;
  goto LAB_00a324cc;
LAB_00a32bc8:
  do {
    ...
    if (dVar21 < (double)puVar11[3]) {
      ...
      do {
        ...
        *(undefined8 *)((long)param_1 + lVar18 + 0x70) =
        ...
        puVar11 = (undefined8 *)param_1;
        if (lVar18 == -0x40) goto LAB_00a32ba4;
        lVar19 = lVar18 + -0x20;
