...
// Function: setVolumeMeshTessellationCoeff
// Entry Point: 00757914
// Size: 220 bytes
// Signature: undefined __thiscall setVolumeMeshTessellationCoeff(HardwareScalability * this, float param_1)


/* HardwareScalability::setVolumeMeshTessellationCoeff(float) */

void __thiscall
HardwareScalability::setVolumeMeshTessellationCoeff(HardwareScalability *this,float param_1)
