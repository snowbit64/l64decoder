...
// Function: getLowerCostPosition
// Entry Point: 00741124
// Size: 72 bytes
// Signature: undefined __thiscall getLowerCostPosition(VehicleNavigationGridAdapter * this, ushort * param_1, ushort * param_2, float * param_3, float * param_4, Vector2 * param_5)


/* VehicleNavigationGridAdapter::getLowerCostPosition(unsigned short&, unsigned short&, float&,
