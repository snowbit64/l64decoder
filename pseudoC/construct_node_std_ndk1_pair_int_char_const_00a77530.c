...
// Function: __construct_node<std::__ndk1::pair<int,char_const*>>
// Entry Point: 00a77530
// Size: 200 bytes
// Signature: unique_ptr __cdecl __construct_node<std::__ndk1::pair<int,char_const*>>(pair * param_1)
...
/* std::__ndk1::unique_ptr<std::__ndk1::__tree_node<std::__ndk1::__value_type<unsigned int,
   ...
   int, std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char>
   > > > >::__construct_node<std::__ndk1::pair<int, char const*> >(std::__ndk1::pair<int, char
   const*>&&) */
...
::__construct_node<std::__ndk1::pair<int,char_const*>>(pair *param_1)

{
  ...
  *(undefined *)(in_x8 + 2) = 0;
  ...
  if (0xffffffffffffffef < __n) {
                    /* try { // try from 00a775f0 to 00a775f7 has its CatchHandler @ 00a775f8 */
  ...
  if (__n < 0x17) {
    ...
    *(char *)((long)pvVar3 + 0x28) = (char)((int)__n << 1);
    ...
    uVar4 = __n + 0x10 & 0xfffffffffffffff0;
                    /* try { // try from 00a775a8 to 00a775af has its CatchHandler @ 00a775f8 */
