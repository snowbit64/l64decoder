...
// Function: setMaxNumDirLights
// Entry Point: 00758ed8
// Size: 220 bytes
// Signature: undefined __thiscall setMaxNumDirLights(HardwareScalability * this, uint param_1)


/* HardwareScalability::setMaxNumDirLights(unsigned int) */

void __thiscall HardwareScalability::setMaxNumDirLights(HardwareScalability *this,uint param_1)

{
  ...
  if (*(uint *)(this + 0xa0) != param_1) {
    *(uint *)(this + 0xa0) = param_1;
