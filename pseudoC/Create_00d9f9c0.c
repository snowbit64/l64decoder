...
// Function: Create
// Entry Point: 00d9f9c0
// Size: 192 bytes
// Signature: undefined __cdecl Create(Implementation param_1)


/* MaskedOcclusionCulling::Create(MaskedOcclusionCulling::Implementation) */

void MaskedOcclusionCulling::Create(Implementation param_1)

{
  undefined8 *puVar1;
  
  puVar1 = (undefined8 *)memalign(0x40,0x150);
  *(undefined4 *)(puVar1 + 0x24) = 0;
  puVar1[1] = aligned_alloc;
  puVar1[2] = aligned_free;
