...
/* CryptoPP::ClonableImpl<CryptoPP::SHA256, CryptoPP::AlgorithmImpl<CryptoPP::IteratedHash<unsigned
   ...
   CryptoPP::SHA256> >::Clone() const */

undefined8 *
CryptoPP::
ClonableImpl<CryptoPP::SHA256,CryptoPP::AlgorithmImpl<CryptoPP::IteratedHash<unsigned_int,CryptoPP::EnumToType<CryptoPP::ByteOrder,1>,64u,CryptoPP::HashTransformation>,CryptoPP::SHA256>>
::Clone(void)

{
  ...
  *puVar1 = &PTR__IteratedHash_00fe9de8;
  puVar1[1] = uVar2;
                    /* try { // try from 00b49b5c to 00b49b63 has its CatchHandler @ 00b49be8 */
  ...
  *puVar1 = &PTR__IteratedHashWithStaticTransform_00fe9ca8;
                    /* try { // try from 00b49b7c to 00b49b7f has its CatchHandler @ 00b49ba4 */
  ...
  *puVar1 = &PTR__IteratedHashWithStaticTransform_01010888;
  return puVar1;
}
