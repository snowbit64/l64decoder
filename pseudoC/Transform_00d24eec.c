...
void CryptoPP::SHA256::Transform(uint *param_1,uint *param_2)
...
LAB_00d25530:
      uVar27 = ((uVar26 >> 7 | uVar26 << 0x19) ^ (uVar26 >> 0x12 | uVar26 << 0xe) ^ uVar26 >> 3) +
               uVar27 + uStack_68._4_4_ +
               ((uStack_7c >> 0x11 | uStack_7c << 0xf) ^ (uStack_7c >> 0x13 | uStack_7c << 0xd) ^
               uStack_7c >> 10);
...
LAB_00d255f4:
      ...
      uStack_7c = ((uVar28 >> 7 | uVar28 << 0x19) ^ (uVar28 >> 0x12 | uVar28 << 0xe) ^ uVar28 >> 3)
                  + uStack_7c + uStack_6c +
                  ((uVar13 >> 0x11 | uVar13 << 0xf) ^ (uVar13 >> 0x13 | uVar13 << 0xd) ^
                  uVar13 >> 10);
      if (uVar30 == 0xfffffffffffffff0) goto LAB_00d2565c;
      uVar28 = ((uVar27 >> 7 | uVar27 << 0x19) ^ (uVar27 >> 0x12 | uVar27 << 0xe) ^ uVar27 >> 3) +
               uVar28 + (uint)uStack_68 +
...
LAB_00d25718:
      uStack_6c = (((uint)uStack_68 >> 7 | (uint)uStack_68 << 0x19) ^
                   ((uint)uStack_68 >> 0x12 | (uint)uStack_68 << 0xe) ^ (uint)uStack_68 >> 3) +
                  uStack_6c + uVar27 +
                  ((uVar22 >> 0x11 | uVar22 << 0xf) ^ (uVar22 >> 0x13 | uVar22 << 0xd) ^
                  uVar22 >> 10);
      iStack_8c = piVar29[2];
      if (uVar30 != 0xfffffffffffffff0) goto LAB_00d2575c;
LAB_00d25904:
      uStack_68._0_4_ = param_2[10];
      iStack_90 = piVar29[3];
      if (uVar30 == 0xfffffffffffffff0) goto LAB_00d25924;
LAB_00d257a0:
      uStack_68 = CONCAT44(((uVar11 >> 7 | uVar11 << 0x19) ^ (uVar11 >> 0x12 | uVar11 << 0xe) ^
                           uVar11 >> 3) + uStack_68._4_4_ + uVar25 +
                           ((uStack_6c >> 0x11 | uStack_6c << 0xf) ^
                            (uStack_6c >> 0x13 | uStack_6c << 0xd) ^ uStack_6c >> 10),
                           (uint)uStack_68);
      iStack_98 = piVar29[4];
...
LAB_00d2581c:
      uVar14 = ((uVar13 >> 7 | uVar13 << 0x19) ^ (uVar13 >> 0x12 | uVar13 << 0xe) ^ uVar13 >> 3) +
               uVar14 + uVar23 +
               ((uStack_68._4_4_ >> 0x11 | uStack_68._4_4_ << 0xf) ^
                (uStack_68._4_4_ >> 0x13 | uStack_68._4_4_ << 0xd) ^ uStack_68._4_4_ >> 10);
      iStack_a0 = piVar29[6];
...
LAB_00d25980:
      uVar19 = ((uStack_7c >> 7 | uStack_7c << 0x19) ^ (uStack_7c >> 0x12 | uStack_7c << 0xe) ^
               uStack_7c >> 3) + uVar19 + uVar21 +
      ...
      uVar21 = ((uStack_6c >> 7 | uStack_6c << 0x19) ^ (uStack_6c >> 0x12 | uStack_6c << 0xe) ^
               uStack_6c >> 3) + uVar21 + uVar28 +
...
LAB_00d2575c:
      uStack_68._0_4_ =
           ((uStack_68._4_4_ >> 7 | uStack_68._4_4_ << 0x19) ^
            (uStack_68._4_4_ >> 0x12 | uStack_68._4_4_ << 0xe) ^ uStack_68._4_4_ >> 3) +
           (uint)uStack_68 + uVar26 +
           ((uVar21 >> 0x11 | uVar21 << 0xf) ^ (uVar21 >> 0x13 | uVar21 << 0xd) ^ uVar21 >> 10);
      iStack_90 = piVar29[3];
      if (uVar30 != 0xfffffffffffffff0) goto LAB_00d257a0;
LAB_00d25924:
      uStack_68 = CONCAT44(param_2[0xb],(uint)uStack_68);
      iStack_98 = piVar29[4];
      if (uVar30 == 0xfffffffffffffff0) goto LAB_00d25940;
LAB_00d257e4:
      uVar11 = ((uVar14 >> 7 | uVar14 << 0x19) ^ (uVar14 >> 0x12 | uVar14 << 0xe) ^ uVar14 >> 3) +
               uVar11 + uVar24 +
               (((uint)uStack_68 >> 0x11 | (uint)uStack_68 << 0xf) ^
                ((uint)uStack_68 >> 0x13 | (uint)uStack_68 << 0xd) ^ (uint)uStack_68 >> 10);
      iStack_9c = piVar29[5];
...
LAB_00d24f90:
    ...
    iVar5 = *piVar1 + ((uVar15 >> 6 | uVar15 << 0x1a) ^ (uVar15 >> 0xb | uVar15 << 0x15) ^
            ...
            (uVar16 & uVar15 | uVar32 & (uVar15 ^ 0xffffffff)) + uStack_7c + uVar31;
    uVar17 = uVar17 + iVar5;
    ...
    uVar12 = ((uVar20 >> 2 | uVar20 * 0x40000000) ^ (uVar20 >> 0xd | uVar20 * 0x80000) ^
             ...
             iVar5;
    iVar5 = iStack_84 + uVar31 + (uVar16 & uVar15 | uVar32 & (uVar15 ^ 0xffffffff)) +
    ...
    uVar31 = ((uVar12 >> 2 | uVar12 * 0x40000000) ^ (uVar12 >> 0xd | uVar12 * 0x80000) ^
             ...
             iVar5;
    iVar5 = iStack_88 + uVar32 + (uVar15 & uVar17 | uVar16 & (uVar17 ^ 0xffffffff)) +
            ((uVar17 >> 6 | uVar17 * 0x4000000) ^ (uVar17 >> 0xb | uVar17 * 0x200000) ^
            (uVar17 >> 0x19 | uVar17 * 0x80)) + uStack_6c;
    uVar18 = iVar5 + uVar18;
    uVar32 = ((uVar31 >> 2 | uVar31 * 0x40000000) ^ (uVar31 >> 0xd | uVar31 * 0x80000) ^
             (uVar31 >> 0x16 | uVar31 * 0x400)) + ((uVar31 ^ uVar12) & (uVar12 ^ uVar20) ^ uVar12) +
             iVar5;
    iVar5 = iStack_8c + uVar16 + (uVar17 & uVar18 | uVar15 & (uVar18 ^ 0xffffffff)) +
            ((uVar18 >> 6 | uVar18 * 0x4000000) ^ (uVar18 >> 0xb | uVar18 * 0x200000) ^
            (uVar18 >> 0x19 | uVar18 * 0x80)) + (uint)uStack_68;
    uVar20 = iVar5 + uVar20;
    uVar16 = ((uVar32 >> 2 | uVar32 * 0x40000000) ^ (uVar32 >> 0xd | uVar32 * 0x80000) ^
             (uVar32 >> 0x16 | uVar32 * 0x400)) + ((uVar32 ^ uVar31) & (uVar31 ^ uVar12) ^ uVar31) +
             iVar5;
    iVar5 = iStack_90 + uVar15 + (uVar18 & uVar20 | uVar17 & (uVar20 ^ 0xffffffff)) +
            ((uVar20 >> 6 | uVar20 * 0x4000000) ^ (uVar20 >> 0xb | uVar20 * 0x200000) ^
            (uVar20 >> 0x19 | uVar20 * 0x80)) + uStack_68._4_4_;
    uVar12 = iVar5 + uVar12;
    uVar15 = ((uVar16 >> 2 | uVar16 * 0x40000000) ^ (uVar16 >> 0xd | uVar16 * 0x80000) ^
             (uVar16 >> 0x16 | uVar16 * 0x400)) + ((uVar16 ^ uVar32) & (uVar32 ^ uVar31) ^ uVar32) +
             iVar5;
    iVar5 = iStack_98 + uVar17 + (uVar20 & uVar12 | uVar18 & (uVar12 ^ 0xffffffff)) +
            ((uVar12 >> 6 | uVar12 * 0x4000000) ^ (uVar12 >> 0xb | uVar12 * 0x200000) ^
    ...
    uVar17 = ((uVar15 >> 2 | uVar15 * 0x40000000) ^ (uVar15 >> 0xd | uVar15 * 0x80000) ^
             (uVar15 >> 0x16 | uVar15 * 0x400)) + ((uVar15 ^ uVar16) & (uVar16 ^ uVar32) ^ uVar16) +
             iVar5;
    iVar5 = iStack_9c + uVar18 + (uVar12 & uVar31 | uVar20 & (uVar31 ^ 0xffffffff)) +
            ((uVar31 >> 6 | uVar31 * 0x4000000) ^ (uVar31 >> 0xb | uVar31 * 0x200000) ^
    ...
    uVar18 = ((uVar17 >> 2 | uVar17 * 0x40000000) ^ (uVar17 >> 0xd | uVar17 * 0x80000) ^
             ...
             iVar5;
    uVar6 = uVar18 ^ uVar17;
    iVar5 = iStack_a0 + uVar20 + (uVar31 & uVar32 | uVar12 & (uVar32 ^ 0xffffffff)) +
            ((uVar32 >> 6 | uVar32 * 0x4000000) ^ (uVar32 >> 0xb | uVar32 * 0x200000) ^
            (uVar32 >> 0x19 | uVar32 * 0x80)) + uVar13;
    uVar16 = iVar5 + uVar16;
    uVar20 = ((uVar18 >> 2 | uVar18 * 0x40000000) ^ (uVar18 >> 0xd | uVar18 * 0x80000) ^
             (uVar18 >> 0x16 | uVar18 * 0x400)) + (uVar6 & (uVar17 ^ uVar15) ^ uVar17) + iVar5;
    iVar5 = iStack_a4 + uVar12 + (uVar32 & uVar16 | uVar31 & (uVar16 ^ 0xffffffff)) +
            ((uVar16 >> 6 | uVar16 * 0x4000000) ^ (uVar16 >> 0xb | uVar16 * 0x200000) ^
