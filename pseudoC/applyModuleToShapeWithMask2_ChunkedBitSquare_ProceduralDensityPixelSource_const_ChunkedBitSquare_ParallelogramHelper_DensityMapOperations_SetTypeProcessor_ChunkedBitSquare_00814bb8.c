...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
// Entry Point: 00814bb8
// Size: 4080 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
    ...
    if (((uVar20 < local_98) || (uVar24 < local_94)) || ((uVar21 < local_94 || (uVar23 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar33 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar33 != 0
                    ...
                    /* try { // try from 00815b6c to 00815b77 has its CatchHandler @ 00815ba8 */
            ...
            do {
              ...
              if ((iVar33 == 2) || ((iVar33 == 0) != ((uVar29 & uVar15) != uVar7))) {
                ...
                if (((int)uVar29 < iVar27) || (iVar28 < (int)uVar29)) {
                  if (DVar11 != (DensityMapFilter)0x0) goto LAB_008157b4;
                }
...
LAB_00815920:
      ...
      if (iVar9 == 2) goto LAB_00815920;
LAB_00815900:
      if ((iVar9 == 0) != ((uVar30 & uVar17) != uVar10)) goto LAB_00815920;
LAB_00815828:
      uVar29 = uVar29 + 1;
      uVar3 = uVar3 + 1;
    } while (uVar29 != uVar21);
...
LAB_008156d4:
  uVar26 = uVar26 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar26) goto LAB_0081566c;
  goto LAB_008156f8;
}
