...
// Function: assign<StoppingPath::PathKnot*>
// Entry Point: 00726d54
// Size: 428 bytes
// Signature: type __thiscall assign<StoppingPath::PathKnot*>(vector<StoppingPath::PathKnot,std::__ndk1::allocator<StoppingPath::PathKnot>> * this, PathKnot * param_1, PathKnot * param_2)


/* std::__ndk1::enable_if<__is_cpp17_forward_iterator<StoppingPath::PathKnot*>::value&&is_constructible<StoppingPath::PathKnot,
   std::__ndk1::iterator_traits<StoppingPath::PathKnot*>::reference>::value, void>::type
   std::__ndk1::vector<StoppingPath::PathKnot, std::__ndk1::allocator<StoppingPath::PathKnot>
   >::assign<StoppingPath::PathKnot*>(StoppingPath::PathKnot*, StoppingPath::PathKnot*) */

type __thiscall
std::__ndk1::vector<StoppingPath::PathKnot,std::__ndk1::allocator<StoppingPath::PathKnot>>::
assign<StoppingPath::PathKnot*>
          (vector<StoppingPath::PathKnot,std::__ndk1::allocator<StoppingPath::PathKnot>> *this,
          PathKnot *param_1,PathKnot *param_2)

{
  PathKnot *__src;
  type tVar1;
  void *pvVar2;
  vector<StoppingPath::PathKnot,std::__ndk1::allocator<StoppingPath::PathKnot>> *pvVar3;
  size_t sVar4;
  long lVar5;
  ulong uVar6;
  long lVar7;
  ...
  if (uVar9 < (ulong)(lVar7 * -0x5555555555555555) || uVar9 + lVar7 * 0x5555555555555555 == 0) {
    ...
    pvVar3 = this;
    if (sVar4 != 0) {
      pvVar3 = (vector<StoppingPath::PathKnot,std::__ndk1::allocator<StoppingPath::PathKnot>> *)
