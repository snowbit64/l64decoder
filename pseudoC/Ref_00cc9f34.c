...
/* CryptoPP::Singleton<CryptoPP::DL_Algorithm_ECDSA<CryptoPP::EC2N>,
   CryptoPP::NewObject<CryptoPP::DL_Algorithm_ECDSA<CryptoPP::EC2N> >, 0>::Ref() const */

undefined8 *
CryptoPP::
Singleton<CryptoPP::DL_Algorithm_ECDSA<CryptoPP::EC2N>,CryptoPP::NewObject<CryptoPP::DL_Algorithm_ECDSA<CryptoPP::EC2N>>,0>
::Ref(void)

{
  ...
  DataMemoryBarrier(2,1);
  if (Ref()::s_pObject == (undefined8 *)0x0) {
                    /* try { // try from 00cc9f8c to 00cc9f93 has its CatchHandler @ 00cca008 */
    Ref()::s_pObject = (undefined8 *)operator_new(8);
    *Ref()::s_pObject = &PTR__DL_Algorithm_GDSA_01004d68;
