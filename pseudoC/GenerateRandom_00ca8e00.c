...

{
  ...
  bVar2 = NameValuePairs::GetThisObject<CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>>
                    (param_2,(DL_GroupParameters_EC *)plVar4);
  if (!bVar2) {
    (**(code **)(*plVar4 + 0x60))(plVar4,param_1,param_2);
  }
  pIVar3 = (Integer *)Integer::One();
  plVar4 = (long *)(**(code **)(*(long *)this + 0x10))(this);
  (**(code **)(*plVar4 + 0xa8))(local_a8);
                    /* try { // try from 00ca8e84 to 00ca8eaf has its CatchHandler @ 00ca8f74 */
  ...
  for (; local_98 != 0; local_98 = local_98 - 1) {
    *(undefined4 *)((long)local_88 + local_98 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00ca8ee8 to 00ca8eeb has its CatchHandler @ 00ca8f70 */
  UnalignedDeallocate(local_88);
                    /* try { // try from 00ca8ef4 to 00ca8eff has its CatchHandler @ 00ca8f64 */
  ...
  for (; local_68 != 0; local_68 = local_68 - 1) {
    *(undefined4 *)((long)local_58 + local_68 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00ca8f30 to 00ca8f33 has its CatchHandler @ 00ca8f60 */
