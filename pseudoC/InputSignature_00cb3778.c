...
// Entry Point: 00cb3778
// Size: 340 bytes
// Signature: undefined __cdecl InputSignature(PK_MessageAccumulator * param_1, uchar * param_2, ulong param_3)


/* CryptoPP::DL_VerifierBase<CryptoPP::Integer>::InputSignature(CryptoPP::PK_MessageAccumulator&,
   unsigned char const*, unsigned long) const */

void CryptoPP::DL_VerifierBase<CryptoPP::Integer>::InputSignature
...
LAB_00cb3844:
  ...
  *(undefined8 *)(param_2 + 0x70) = 0xffffffffffffffff;
  ...
  uVar3 = (**(code **)(*(long *)param_2 + 0xa0))(param_2);
                    /* WARNING: Could not recover jumptable at 0x00cb38c8. Too many branches */
