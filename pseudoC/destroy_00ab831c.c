...
// Function: destroy
// Entry Point: 00ab831c
// Size: 64 bytes
// Signature: undefined __thiscall destroy(__tree<std::__ndk1::__value_type<SamplerObjectDesc,VkSampler_T*>,std::__ndk1::__map_value_compare<SamplerObjectDesc,std::__ndk1::__value_type<SamplerObjectDesc,VkSampler_T*>,ComparerUtil::SamplerObjectDescComparer,true>,std::__ndk1::allocator<std::__ndk1::__value_type<SamplerObjectDesc,VkSampler_T*>>> * this, __tree_node * param_1)
...
/* std::__ndk1::__tree<std::__ndk1::__value_type<SamplerObjectDesc, VkSampler_T*>,
   ...
   >::destroy(std::__ndk1::__tree_node<std::__ndk1::__value_type<SamplerObjectDesc, VkSampler_T*>,
   void*>*) */
