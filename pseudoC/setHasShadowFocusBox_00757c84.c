...
// Function: setHasShadowFocusBox
// Entry Point: 00757c84
// Size: 224 bytes
// Signature: undefined __thiscall setHasShadowFocusBox(HardwareScalability * this, bool param_1)


/* HardwareScalability::setHasShadowFocusBox(bool) */

void __thiscall HardwareScalability::setHasShadowFocusBox(HardwareScalability *this,bool param_1)

{
  ...
  if (this[0x50] != (HardwareScalability)param_1) {
    this[0x50] = (HardwareScalability)param_1;
