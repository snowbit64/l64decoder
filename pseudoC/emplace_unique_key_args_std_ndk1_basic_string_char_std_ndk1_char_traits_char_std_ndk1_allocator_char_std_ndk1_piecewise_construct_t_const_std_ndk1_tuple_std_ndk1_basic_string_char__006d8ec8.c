...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, IConsoleCommand*>, void*>*,
...

{
  ...
  if (puVar4 == (undefined8 *)0x0) {
    puVar4 = (undefined8 *)operator_new(0x40);
                    /* try { // try from 006d8f28 to 006d8f2b has its CatchHandler @ 006d8fa4 */
