...
// Function: setShaderQuality
// Entry Point: 00757ff8
// Size: 228 bytes
// Signature: undefined __thiscall setShaderQuality(HardwareScalability * this, uint param_1)


/* HardwareScalability::setShaderQuality(unsigned int) */

void __thiscall HardwareScalability::setShaderQuality(HardwareScalability *this,uint param_1)

{
  ...
  if ((param_1 < 4) && (*(uint *)(this + 0x60) != param_1)) {
