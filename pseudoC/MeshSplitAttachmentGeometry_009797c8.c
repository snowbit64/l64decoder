...

{
  ...
  *(undefined ***)this = &PTR__MeshSplitAttachmentGeometry_00fe0778;
  iVar2 = iVar1 + -1;
  *(undefined ***)(this + -0x10) = &PTR__MeshSplitAttachmentGeometry_00fe0720;
  *(undefined ***)(this + 0x48) = &PTR__MeshSplitAttachmentGeometry_00fe0798;
  if (iVar1 == 0 || iVar2 == 0) {
    (**(code **)(*plVar3 + 8))();
