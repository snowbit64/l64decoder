...
// Function: applyModuleToShapeWithMask2<BitVector,BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
// Entry Point: 007f1e98
// Size: 3564 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, BitVector * param_3, ProceduralDensityPixelSource * param_4, ParallelogramHelper * param_5, SetDensityProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
    ...
    if (((uVar20 < local_98) || (uVar25 < local_94)) || ((uVar21 < local_94 || (uVar24 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar29 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar29 != 0
                    ...
                    /* try { // try from 007f2c48 to 007f2c53 has its CatchHandler @ 007f2c84 */
            ...
            do {
              ...
              if ((iVar29 == 2) || ((iVar29 == 0) != ((uVar35 & uVar15) != uVar4))) {
                ...
                if (((int)uVar35 < iVar5) || (iVar6 < (int)uVar35)) {
                  if (DVar12 != (DensityMapFilter)0x0) goto LAB_007f2a1c;
                }
    ...
    do {
      ...
      if ((iVar10 == 2) || ((iVar10 == 0) != ((uVar28 & uVar17) != uVar26))) {
        ...
        if (((int)uVar28 < iVar8) || (iVar9 < (int)uVar28)) {
          if (DVar13 != (DensityMapFilter)0x0) goto LAB_007f2ae8;
        }
...
LAB_007f28fc:
  uVar32 = uVar32 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar32) goto LAB_007f2894;
  goto LAB_007f2910;
}
