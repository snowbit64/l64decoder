...
// Function: __push_back_slow_path<VulkanShaderSerializer::GlobalVarInfo_const&>
// Entry Point: 00ac8138
// Size: 480 bytes
// Signature: void __thiscall __push_back_slow_path<VulkanShaderSerializer::GlobalVarInfo_const&>(vector<VulkanShaderSerializer::GlobalVarInfo,std::__ndk1::allocator<VulkanShaderSerializer::GlobalVarInfo>> * this, GlobalVarInfo * param_1)


/* void std::__ndk1::vector<VulkanShaderSerializer::GlobalVarInfo,
   std::__ndk1::allocator<VulkanShaderSerializer::GlobalVarInfo>
   >::__push_back_slow_path<VulkanShaderSerializer::GlobalVarInfo
   const&>(VulkanShaderSerializer::GlobalVarInfo const&) */
...

{
  ...
  *puVar12 = *(undefined4 *)param_1;
                    /* try { // try from 00ac8210 to 00ac8213 has its CatchHandler @ 00ac8318 */
