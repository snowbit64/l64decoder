...
// Function: FUN_0094da18
// Entry Point: 0094da18
// Size: 292 bytes
// Signature: undefined FUN_0094da18(void)


long FUN_0094da18(long *param_1,long **param_2)

{
  ...
  plVar2 = (long *)(ulong)*(uint *)(param_2 + 2);
  param_2[1] = plVar2;
  plVar2 = (long *)FUN_0094db3c(param_1,plVar2,param_2 + 2);
  ...
  if (plVar2 == (long *)0x0) {
    ...
    *(long ***)(*param_1 + (long)plVar4 * 8) = pplVar5;
    if (*param_2 == (long *)0x0) goto LAB_0094db1c;
    ...
    *plVar2 = (long)param_2;
    ...
    if (plVar2 == plVar4) goto LAB_0094db1c;
  }
