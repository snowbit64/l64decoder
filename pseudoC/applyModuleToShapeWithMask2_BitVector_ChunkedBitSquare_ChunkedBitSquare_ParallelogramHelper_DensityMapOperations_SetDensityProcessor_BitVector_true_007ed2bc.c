...
// Function: applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
// Entry Point: 007ed2bc
// Size: 3996 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, ChunkedBitSquare * param_3, ChunkedBitSquare * param_4, ParallelogramHelper * param_5, SetDensityProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)


/* bool DensityMapModifier::applyModuleToShapeWithMask2<BitVector, ChunkedBitSquare,
   ChunkedBitSquare, ParallelogramHelper, DensityMapOperations::SetDensityProcessor<BitVector, true>
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
    ...
    if (((uVar22 < local_98) || (uVar26 < local_94)) || ((uVar23 < local_94 || (uVar25 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar32 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar32 != 0
                    ...
                    /* try { // try from 007ee21c to 007ee227 has its CatchHandler @ 007ee258 */
          ...
          do {
            ...
            do {
              ...
              if (*(uint *)(param_3 + 0x34) < 2) {
                uVar42 = (ulong)*(uint *)(param_3 + 0x34);
                if (iVar32 != 2) goto LAB_007eded0;
LAB_007edef0:
                uVar4 = uVar30 >> (ulong)(uVar5 & 0x1f) & uVar16;
                if (((int)uVar4 < iVar29) || (iVar8 < (int)uVar4)) {
                  if (DVar13 != (DensityMapFilter)0x0) goto LAB_007edf1c;
                }
...
LAB_007edf1c:
                ...
                if (iVar32 == 2) goto LAB_007edef0;
LAB_007eded0:
                if ((iVar32 == 0) != ((uVar30 & uVar17) != uVar6)) goto LAB_007edef0;
              }
              uVar44 = uVar44 + 1;
              uVar2 = uVar2 + 1;
            } while (uVar44 != uVar35);
...
LAB_007edac0:
  ...
  if (param_6[100] != (SetDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar36,*(uint *)(param_6 + 0x1c),*(uint *)(param_6 + 0x20),
  ...
  do {
    ...
    do {
      ...
      if (*(uint *)(param_4 + 0x34) < 2) {
        uVar42 = (ulong)*(uint *)(param_4 + 0x34);
        if (iVar9 != 2) goto LAB_007ee06c;
LAB_007ee08c:
        uVar4 = uVar30 >> (ulong)(uVar24 & 0x1f) & uVar18;
        if (((int)uVar4 < iVar11) || (iVar12 < (int)uVar4)) {
          if (DVar14 != (DensityMapFilter)0x0) goto LAB_007ee0b8;
        }
...
LAB_007ee0b8:
        ...
        if (iVar9 == 2) goto LAB_007ee08c;
LAB_007ee06c:
        if ((iVar9 == 0) != ((uVar30 & uVar19) != uVar10)) goto LAB_007ee08c;
      }
      uVar44 = uVar44 + 1;
      uVar2 = uVar2 + 1;
    } while (uVar44 != uVar23);
...
LAB_007edd8c:
  uVar36 = uVar36 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar36) goto LAB_007edd2c;
  goto LAB_007edd9c;
}
