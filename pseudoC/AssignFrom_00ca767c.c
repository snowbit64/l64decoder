...

{
  ...
  bVar3 = NameValuePairs::GetThisPointer<CryptoPP::DL_PrivateKey_ECGDSA<CryptoPP::EC2N>>
  ...
  if (bVar3) {
    ...
    local_50 = plVar1;
    pNStack_48 = param_1;
    bVar3 = NameValuePairs::GetThisObject<CryptoPP::DL_PublicKey_ECGDSA<CryptoPP::EC2N>>
