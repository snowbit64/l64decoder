...
// Function: FUN_007b4200
// Entry Point: 007b4200
// Size: 224 bytes
// Signature: undefined FUN_007b4200(void)


void FUN_007b4200(long param_1,char **param_2)

{
  ...
  if (0xffffffffffffffef < __n) {
                    /* try { // try from 007b42d8 to 007b42df has its CatchHandler @ 007b42e0 */
  ...
  if (__n < 0x17) {
    ...
    *(char *)puVar1 = (char)((int)__n << 1);
    if (__n == 0) goto LAB_007b42a8;
  }
  else {
    uVar2 = __n + 0x10 & 0xfffffffffffffff0;
                    /* try { // try from 007b4280 to 007b4287 has its CatchHandler @ 007b42e0 */
