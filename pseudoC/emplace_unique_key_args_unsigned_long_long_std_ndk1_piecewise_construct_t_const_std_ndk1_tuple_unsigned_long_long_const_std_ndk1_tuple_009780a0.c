  ...
  if (puVar7 != (ulonglong *)0x0) {
    ...
    if (ppuVar6 != (ulonglong **)0x0) {
      do {
        ...
        if (ppuVar6 == (ulonglong **)0x0) goto LAB_00978160;
        puVar4 = ppuVar6[1];
        if (puVar4 != puVar8) {
          if (uVar2 < 2) {
          ...
          if (puVar4 != unaff_x24) goto LAB_00978160;
        }
  ...
  if ((puVar7 == (ulonglong *)0x0) ||
    ...
    if (uVar5 <= uVar2) {
      uVar5 = uVar2;
                    ...
                    /* try { // try from 009781d0 to 009781d7 has its CatchHandler @ 009782a0 */
