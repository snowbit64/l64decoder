...
// Function: applyModuleToShapeWithMask<BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
// Entry Point: 007f6930
// Size: 2068 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask<BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, ProceduralDensityPixelSource * param_3, ParallelogramHelper * param_4, SetDensityProcessor * param_5, DensityMapFilter * param_6)


/* bool DensityMapModifier::applyModuleToShapeWithMask<BitVector, ProceduralDensityPixelSource
   const, ParallelogramHelper, DensityMapOperations::SetDensityProcessor<BitVector, true>
...
bool DensityMapModifier::
     applyModuleToShapeWithMask<BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
    ...
    if ((uVar12 < uVar10) || (uVar13 < uVar11)) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar16 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar16 != 0
                    ...
                    /* try { // try from 007f7100 to 007f7107 has its CatchHandler @ 007f7154 */
        this = (Logger *)operator_new(0x38);
                    /* try { // try from 007f710c to 007f710f has its CatchHandler @ 007f7144 */
        Logger::Logger(this);
              ...
              do {
                ...
                if ((iVar2 == 2) || ((iVar2 == 0) != ((uVar15 & uVar14) != uVar4))) {
                  ...
                  if (((int)uVar15 < iVar16) || (iVar3 < (int)uVar15)) {
                    if (DVar6 != (DensityMapFilter)0x0) goto LAB_007f6fac;
                  }
...
LAB_007f6ef0:
  ...
  if (param_5[100] != (SetDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_4 + 0x54),uVar12,*(uint *)(param_5 + 0x1c),*(uint *)(param_5 + 0x20),
