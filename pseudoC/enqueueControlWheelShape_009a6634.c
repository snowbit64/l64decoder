...
// Function: enqueueControlWheelShape
// Entry Point: 009a6634
// Size: 212 bytes
// Signature: undefined __thiscall enqueueControlWheelShape(Bt2ScenegraphPhysicsContext * this, TransformGroup * param_1, uint param_2, float param_3, float param_4, float param_5, float param_6)


/* Bt2ScenegraphPhysicsContext::enqueueControlWheelShape(TransformGroup*, unsigned int, float,
   float, float, float) */
  ...
  if (param_1 != (TransformGroup *)0x0) {
    ...
    if ((*(uint *)(lVar2 + 8) & 3) != 0) {
      ...
      if ((this[0x488] == (Bt2ScenegraphPhysicsContext)0x0) && ((*(uint *)(lVar2 + 8) & 1) != 0)) {
        controlWheelShape(this,param_1,(ControlWheel *)&local_98);
      }
      else {
