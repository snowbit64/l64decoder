...
// Function: Multiply
// Entry Point: 00d058d0
// Size: 164 bytes
// Signature: undefined __cdecl Multiply(Integer * param_1, Integer * param_2)


/* CryptoPP::EuclideanDomainOf<CryptoPP::Integer>::Multiply(CryptoPP::Integer const&,
   CryptoPP::Integer const&) const */

Integer * CryptoPP::EuclideanDomainOf<CryptoPP::Integer>::Multiply
...

{
  ...
  Integer::Times(param_2);
                    /* try { // try from 00d05904 to 00d0590f has its CatchHandler @ 00d05978 */
  ...
  for (; local_48 != 0; local_48 = local_48 - 1) {
    *(undefined4 *)((long)local_38 + local_48 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00d05948 to 00d0594b has its CatchHandler @ 00d05974 */
