...
// Function: push_front
// Entry Point: 00aba14c
// Size: 448 bytes
// Signature: undefined __thiscall push_front(__split_buffer<std::__ndk1::pair<VkImageView_T*,unsigned_int>*,std::__ndk1::allocator<std::__ndk1::pair<VkImageView_T*,unsigned_int>*>&> * this, pair * * param_1)


/* std::__ndk1::__split_buffer<std::__ndk1::pair<VkImageView_T*, unsigned int>*,
   std::__ndk1::allocator<std::__ndk1::pair<VkImageView_T*, unsigned
   int>*>&>::push_front(std::__ndk1::pair<VkImageView_T*, unsigned int>* const&) */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00aba2d4;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00aba2bc;
      }
    }
    do {
      puVar7 = puVar6 + 1;
