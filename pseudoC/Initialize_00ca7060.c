...
// Function: Initialize
// Entry Point: 00ca7060
// Size: 124 bytes
// Signature: undefined __thiscall Initialize(DL_PublicKey_ECGDSA<CryptoPP::EC2N> * this, DL_GroupParameters_EC * param_1, EC2NPoint * param_2)


/* CryptoPP::DL_PublicKey_ECGDSA<CryptoPP::EC2N>::Initialize(CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>
   const&, CryptoPP::EC2NPoint const&) */

void __thiscall
CryptoPP::DL_PublicKey_ECGDSA<CryptoPP::EC2N>::Initialize
          (DL_PublicKey_ECGDSA<CryptoPP::EC2N> *this,DL_GroupParameters_EC *param_1,
          EC2NPoint *param_2)

{
  ...
  *(undefined2 *)(this + 0x200) = *(undefined2 *)(param_1 + 0x1e8);
                    /* WARNING: Could not recover jumptable at 0x00ca70d8. Too many branches */
