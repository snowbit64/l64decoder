...
// Function: __emplace_unique_impl<std::__ndk1::pair<char_const*,BehaviorDataSource::RangeData>>
// Entry Point: 0087f330
// Size: 232 bytes
// Signature: pair __cdecl __emplace_unique_impl<std::__ndk1::pair<char_const*,BehaviorDataSource::RangeData>>(pair * param_1)


/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, BehaviorDataSource::RangeData>,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, BehaviorDataSource::RangeData> >
   >::__emplace_unique_impl<std::__ndk1::pair<char const*, BehaviorDataSource::RangeData>
   >(std::__ndk1::pair<char const*, BehaviorDataSource::RangeData>&&) */
...

{
  ...
  __construct_node<std::__ndk1::pair<char_const*,BehaviorDataSource::RangeData>>(param_1);
                    /* try { // try from 0087f364 to 0087f36f has its CatchHandler @ 0087f418 */
  pp_Var2 = __find_equal<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,BehaviorDataSource::RangeData>>
                      ((__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,BehaviorDataSource::RangeData>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,BehaviorDataSource::RangeData>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,BehaviorDataSource::RangeData>>>
