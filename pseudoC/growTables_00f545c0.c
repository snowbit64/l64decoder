...
// Function: growTables
// Entry Point: 00f545c0
// Size: 864 bytes
// Signature: undefined __cdecl growTables(btHashInt * param_1)


/* btHashMap<btHashInt, btTriangleInfo>::growTables(btHashInt const&) */

void btHashMap<btHashInt,btTriangleInfo>::growTables(btHashInt *param_1)
  ...
  if (*(int *)(param_1 + 8) < (int)uVar1) {
    ...
    if ((int)uVar10 < 1) {
      ...
      if ((uVar10 < 8) || ((uVar5 < uVar6 + uVar7 * 4 && (uVar6 < uVar5 + uVar7 * 4)))) {
        ...
        if (uVar11 == uVar7) goto LAB_00f546e0;
      }
      lVar8 = uVar7 - uVar11;
...
LAB_00f546e0:
  ...
  *(uint *)(param_1 + 4) = uVar1;
  if ((int)uVar1 <= (int)uVar10) goto LAB_00f54870;
  ...
  if (*(int *)(param_1 + 0x28) < (int)uVar1) {
    ...
    if ((int)uVar10 < 1) {
      ...
      if ((uVar10 < 8) || ((uVar5 < uVar6 + uVar7 * 4 && (uVar6 < uVar5 + uVar7 * 4)))) {
        ...
        if (uVar11 == uVar7) goto LAB_00f54824;
      }
      lVar9 = uVar7 - uVar11;
      puVar12 = (undefined4 *)(uVar6 + uVar11 * 4);
      puVar13 = (undefined4 *)(uVar5 + uVar11 * 4);
