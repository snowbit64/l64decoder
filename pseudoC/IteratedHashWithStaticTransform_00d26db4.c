...
// Entry Point: 00d26db4
// Size: 144 bytes
// Signature: undefined __thiscall ~IteratedHashWithStaticTransform(IteratedHashWithStaticTransform<unsigned_long,CryptoPP::EnumToType<CryptoPP::ByteOrder,1>,128u,64u,CryptoPP::SHA512,64u,true> * this)
...

{
  ...
  *pIVar2;
  ...
  pIVar2 = *(IteratedHashWithStaticTransform<unsigned_long,CryptoPP::EnumToType<CryptoPP::ByteOrder,1>,128u,64u,CryptoPP::SHA512,64u,true>
             **)(this + 0x158);
  ...
  if (this + 0xb8 + ((ulong)(uint)-(int)(this + 0xb8) & 8) == pIVar2) {
    this[0x141] = (IteratedHashWithStaticTransform<unsigned_long,CryptoPP::EnumToType<CryptoPP::ByteOrder,1>,128u,64u,CryptoPP::SHA512,64u,true>
                   )0x0;
  ...
  *(undefined ***)this = &PTR__IteratedHash_01000e98;
  ...
  if (pIVar2 == this + 0x18) {
    this[0x99] = (IteratedHashWithStaticTransform<unsigned_long,CryptoPP::EnumToType<CryptoPP::ByteOrder,1>,128u,64u,CryptoPP::SHA512,64u,true>
                  )0x0;
    for (; uVar1 != 0; uVar1 = uVar1 - 1) {
      *(undefined8 *)(pIVar2 + uVar1 * 8 + -8) = 0;
    }
