...
// Function: getLightActorLinearVelocity
// Entry Point: 0099ba10
// Size: 96 bytes
// Signature: undefined __thiscall getLightActorLinearVelocity(Bt2ScenegraphPhysicsContext * this, uint param_1, float * param_2)


/* Bt2ScenegraphPhysicsContext::getLightActorLinearVelocity(unsigned int, float*) */
...

{
  ...
  if (pBVar3 != (Bt2ScenegraphPhysicsContext *)0x0) {
    ...
    if (((pBVar1 != this + 0x268) && (*(uint *)(pBVar1 + 0x20) <= param_1)) &&
      ...
      *param_2 = *(float *)(lVar2 + 0x17c);
      param_2[1] = *(float *)(lVar2 + 0x180);
      param_2[2] = *(float *)(lVar2 + 0x184);
    }
  }
  return;
}
