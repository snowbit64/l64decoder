...
void CryptoPP::BlockOrientedCipherModeBase::ResizeBuffers(void)

{
  ...
  if (uVar1 == uVar6) {
    uVar1 = *(ulong *)(in_x0 + 0x48);
    pvVar3 = *(void **)(in_x0 + 0x50);
  ...
  if (uVar1 != uVar6) {
    ...
    if (uVar4 != 0) {
      uVar5 = UnalignedAllocate(uVar6);
      *(ulong *)(in_x0 + 0x48) = uVar6;
      *(undefined8 *)(in_x0 + 0x50) = uVar5;
      *(undefined8 *)(in_x0 + 0x40) = 0xffffffffffffffff;
      return;
    }
    *(ulong *)(in_x0 + 0x48) = uVar6;
