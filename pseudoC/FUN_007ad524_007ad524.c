...
// Function: FUN_007ad524
// Entry Point: 007ad524
// Size: 96 bytes
// Signature: undefined FUN_007ad524(void)


void FUN_007ad524(undefined8 param_1,long param_2)

{
  long lVar1;
  undefined *puVar2;
  
  lVar1 = GsMaterial::getGlossMap();
  if (lVar1 == 0) {
    puVar2 = &DAT_0050a39f;
  }
  else {
