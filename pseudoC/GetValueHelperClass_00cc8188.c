...
// Entry Point: 00cc8188
// Size: 416 bytes
// Signature: undefined __thiscall GetValueHelperClass(GetValueHelperClass<CryptoPP::DL_PrivateKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>>,CryptoPP::DL_PrivateKey<CryptoPP::EC2NPoint>> * this, DL_PrivateKeyImpl * param_1, char * param_2, type_info * param_3, void * param_4, NameValuePairs * param_5)
...
/* CryptoPP::GetValueHelperClass<CryptoPP::DL_PrivateKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>
   ...
   >::GetValueHelperClass(CryptoPP::DL_PrivateKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>
  ...
  *(undefined2 *)(this + 0x20) = 0;
  ...
  if (iVar3 == 0) {
    *(undefined2 *)(this + 0x20) = 0x101;
    ...
    DL_PrivateKey<CryptoPP::EC2NPoint>::GetVoidValue
              ((DL_PrivateKey<CryptoPP::EC2NPoint> *)param_1,*(char **)(this + 8),param_3,param_4);
  ...
  if ((iVar3 == 0) &&
    ...
    GVar5 = (GetValueHelperClass<CryptoPP::DL_PrivateKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>>,CryptoPP::DL_PrivateKey<CryptoPP::EC2NPoint>>
             )0x1;
    *(DL_PrivateKeyImpl **)param_4 = param_1;
    ...
    if (param_5 != (NameValuePairs *)0x0) {
      ...
      this[0x20] = (GetValueHelperClass<CryptoPP::DL_PrivateKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>>,CryptoPP::DL_PrivateKey<CryptoPP::EC2NPoint>>
                    )(bVar2 & 1);
      if ((bVar2 & 1) != 0) {
        return;
      }
    }
    bVar2 = DL_PrivateKey<CryptoPP::EC2NPoint>::GetVoidValue
                      ((DL_PrivateKey<CryptoPP::EC2NPoint> *)param_1,*(char **)(this + 8),param_3,
                       param_4);
    GVar5 = (GetValueHelperClass<CryptoPP::DL_PrivateKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>>,CryptoPP::DL_PrivateKey<CryptoPP::EC2NPoint>>
             )(bVar2 & 1);
  }
