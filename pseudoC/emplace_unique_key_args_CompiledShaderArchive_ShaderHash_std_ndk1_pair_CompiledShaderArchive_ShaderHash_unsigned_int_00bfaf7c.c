...
// Function: __emplace_unique_key_args<CompiledShaderArchive::ShaderHash,std::__ndk1::pair<CompiledShaderArchive::ShaderHash,unsigned_int>>
// Entry Point: 00bfaf7c
// Size: 376 bytes
// Signature: pair __thiscall __emplace_unique_key_args<CompiledShaderArchive::ShaderHash,std::__ndk1::pair<CompiledShaderArchive::ShaderHash,unsigned_int>>(__tree<std::__ndk1::__value_type<CompiledShaderArchive::ShaderHash,unsigned_int>,std::__ndk1::__map_value_compare<CompiledShaderArchive::ShaderHash,std::__ndk1::__value_type<CompiledShaderArchive::ShaderHash,unsigned_int>,std::__ndk1::less<CompiledShaderArchive::ShaderHash>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<CompiledShaderArchive::ShaderHash,unsigned_int>>> * this, ShaderHash * param_1, pair * param_2)


/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<CompiledShaderArchive::ShaderHash,
   unsigned int>,
   std::__ndk1::__tree_node<std::__ndk1::__value_type<CompiledShaderArchive::ShaderHash, unsigned
   int>, void*>*, long>, bool>
   ...
   > >::__emplace_unique_key_args<CompiledShaderArchive::ShaderHash,
   std::__ndk1::pair<CompiledShaderArchive::ShaderHash, unsigned int>
   >(CompiledShaderArchive::ShaderHash const&, std::__ndk1::pair<CompiledShaderArchive::ShaderHash,
   unsigned int>&&) */
...
__emplace_unique_key_args<CompiledShaderArchive::ShaderHash,std::__ndk1::pair<CompiledShaderArchive::ShaderHash,unsigned_int>>
          (__tree<std::__ndk1::__value_type<CompiledShaderArchive::ShaderHash,unsigned_int>,std::__ndk1::__map_value_compare<CompiledShaderArchive::ShaderHash,std::__ndk1::__value_type<CompiledShaderArchive::ShaderHash,unsigned_int>,std::__ndk1::less<CompiledShaderArchive::ShaderHash>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<CompiledShaderArchive::ShaderHash,unsigned_int>>>
           *this,ShaderHash *param_1,pair *param_2)
...
LAB_00bfb004:
        ...
        if (uVar5 == uVar6) {
          ...
          uVar6 = (uVar6 & 0xffff0000ffff0000) >> 0x10 | (uVar6 & 0xffff0000ffff) << 0x10;
          uVar6 = uVar6 >> 0x20 | uVar6 << 0x20;
          if (uVar5 == uVar6) goto LAB_00bfb064;
        }
        iVar1 = 1;
        if (uVar5 < uVar6) {
          iVar1 = -1;
        }
        if (-1 < iVar1) goto LAB_00bfb064;
        puVar7 = puVar3 + 1;
        puVar8 = (undefined8 *)*puVar7;
        if ((undefined8 *)*puVar7 == (undefined8 *)0x0) goto LAB_00bfb064;
      }
      iVar1 = 1;
      if (uVar5 < uVar6) {
        iVar1 = -1;
      }
      if (-1 < iVar1) goto LAB_00bfb004;
      puVar7 = puVar3;
