...
// Function: setReflectionMapRatio
// Entry Point: 007581b8
// Size: 220 bytes
// Signature: undefined __thiscall setReflectionMapRatio(HardwareScalability * this, float param_1)


/* HardwareScalability::setReflectionMapRatio(float) */

void __thiscall HardwareScalability::setReflectionMapRatio(HardwareScalability *this,float param_1)
