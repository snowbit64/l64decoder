...
// Entry Point: 00f042c4
// Size: 144 bytes
// Signature: undefined __cdecl lua_tocfunction(lua_State * param_1, int param_2)


/* lua_tocfunction(lua_State*, int) */

undefined8 lua_tocfunction(lua_State *param_1,int param_2)
