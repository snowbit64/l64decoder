...
/* std::__ndk1::__split_buffer<CryptoPP::MeterFilter::MessageRange*,
   std::__ndk1::allocator<CryptoPP::MeterFilter::MessageRange*>&>::push_back(CryptoPP::MeterFilter::MessageRange*&&)
    */
...

{
  ...
  if (ppMVar12 != *(MessageRange ***)(this + 0x18)) goto LAB_00cdef3c;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
         ...
         ((MessageRange **)((long)pvVar5 + uVar13 * 8 + (uVar9 & 0xfffffffffffffff8) + 8) <= __src))
      {
        ...
        if (uVar9 == uVar10) goto LAB_00cdef24;
      }
    }
    do {
      ppMVar11 = ppMVar8 + 1;
