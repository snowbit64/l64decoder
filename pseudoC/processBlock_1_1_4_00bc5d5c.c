...
// Function: processBlock_1_1_4
// Entry Point: 00bc5d5c
// Size: 1592 bytes
// Signature: undefined __cdecl processBlock_1_1_4(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_1_1_4(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_1_1_4(CustomCipher *param_1,uchar *param_2)

{
  ...
  uVar3 = uVar2 >> 0xf | uVar2 << 0x11;
  uVar14 = *(uint *)(param_1 + 0x224);
  uVar3 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar3 >> 8 ^ uVar4 >> 0x10) & 0x3f) * 4) |
           (&s_wPS)[(uVar3 >> 0xc ^ uVar4 >> 0x18) & 0x3f] |
           *(uint *)(&DAT_0211ea98 + (ulong)((uVar3 >> 4 ^ uVar4 >> 8) & 0x3f) * 4) |
          *(uint *)(&DAT_0211eb98 + (ulong)((uVar3 ^ uVar4) & 0x3f) * 4)) ^ uVar1 ^
          ...
          *(uint *)(&DAT_0211ef98 + (ulong)((uVar15 ^ uVar3 >> 0x10) & 0x3f) * 4));
  uVar1 = *(uint *)(param_1 + 0x220);
  uVar17 = uVar3 >> 0xf | uVar3 << 0x11;
  uVar15 = (&s_wPS)[(uVar17 >> 0xc ^ uVar1 >> 0x18) & 0x3f];
  ...
  uVar5 = *(uint *)(&DAT_0211ec98 + (ulong)((uVar14 >> 0x18 ^ uVar3 >> 0xb) & 0x3f) * 4);
  uVar6 = *(uint *)(&DAT_0211ee98 + (ulong)((uVar14 >> 8 ^ uVar3 >> 3) & 0x3f) * 4);
  uVar7 = *(uint *)(&DAT_0211ed98 + (ulong)((uVar14 >> 0x10 ^ uVar3 >> 7) & 0x3f) * 4);
  ...
  CVar9 = param_1[0x2b2];
  uVar19 = uVar18 + (byte)CVar9 & 0xff;
  uVar1 = (uVar16 | uVar15 | uVar4 | uVar1) ^ uVar2 ^ (uVar7 | uVar5 | uVar6 | uVar14) ^
