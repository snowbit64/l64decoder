...
void CryptoPP::DL_PrivateKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::ECP>>::DL_PrivateKeyImpl
               (void)

{
  ...
  *in_x0 = (long)&PTR__DL_Key_010047c0;
  plVar2 = in_x0 + 1;
  ...
  *(long *)((long)plVar2 + *(long *)(lVar1 + -0x18)) = in_x1[0xd];
                    /* try { // try from 00cc934c to 00cc934f has its CatchHandler @ 00cc93a8 */
  ...
  *(long *)((long)in_x0 + *(long *)(lVar1 + -0x18)) = in_x1[0x10];
                    /* try { // try from 00cc9378 to 00cc937b has its CatchHandler @ 00cc9390 */
  Integer::Integer((Integer *)(in_x0 + 0x3b));
  return;
}
