...
// Entry Point: 00cde5a8
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<CryptoPP::MeterFilter::MessageRange,std::__ndk1::allocator<CryptoPP::MeterFilter::MessageRange>> * this)


/* std::__ndk1::__deque_base<CryptoPP::MeterFilter::MessageRange,
   std::__ndk1::allocator<CryptoPP::MeterFilter::MessageRange> >::~__deque_base() */
...

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_00cde614;
    uVar4 = 0xaa;
  }
