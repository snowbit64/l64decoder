...
// Function: push_front
// Entry Point: 00eac4d8
// Size: 440 bytes
// Signature: undefined __thiscall push_front(__split_buffer<simplejobsystem::SimpleJob**,std::__ndk1::allocator<simplejobsystem::SimpleJob**>&> * this, SimpleJob * * * param_1)


/* std::__ndk1::__split_buffer<simplejobsystem::SimpleJob**,
   std::__ndk1::allocator<simplejobsystem::SimpleJob**>&>::push_front(simplejobsystem::SimpleJob**
   const&) */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00eac660;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00eac648;
      }
    }
    do {
      puVar7 = puVar6 + 1;
