...
// Entry Point: 008dab6c
// Size: 336 bytes
// Signature: undefined createDefaultMesh(void)


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* ParticleSystemManager::createDefaultMesh() */

void ParticleSystemManager::createDefaultMesh(void)

{
  ...
  if (((InstancedGeometryManager::getInstance()::s_instance & 1) == 0) &&
     (iVar2 = __cxa_guard_acquire(&InstancedGeometryManager::getInstance()::s_instance), iVar2 != 0)
                    ...
                    /* try { // try from 008dac80 to 008dac8b has its CatchHandler @ 008dacbc */
  ...
  InstancedGeometryManager::registerInstancedMesh
            ((InstancedGeometryManager *)InstancedGeometryManager::getInstance()::s_instance,0x10,4,
             &local_78,6,(ushort *)&local_38,false,0xffff);
