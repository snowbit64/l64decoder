...

{
  ...
  bool bVar2;
  long *plVar3;
  DL_PrivateKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::EC2N>> *local_50;
  ...
  if (!bVar2) {
    ...
    local_50 = this;
    pNStack_48 = param_1;
    bVar2 = NameValuePairs::GetThisObject<CryptoPP::DL_PrivateKey<CryptoPP::EC2NPoint>>
