...
// Function: FUN_007a79f0
// Entry Point: 007a79f0
// Size: 400 bytes
// Signature: undefined FUN_007a79f0(void)


void FUN_007a79f0(RawTransformGroup *param_1,undefined4 *param_2)

{
  ...
  if (puVar4 != (undefined8 *)0x0) {
    ...
    uStack_6c = (undefined4)((ulong)*puVar4 >> 0x20);
    uStack_58 = (uint)puVar4[3];
    local_54 = (undefined4)((ulong)puVar4[3] >> 0x20);
    uStack_60 = (undefined4)puVar4[2];
    uStack_5c = (undefined4)((ulong)puVar4[2] >> 0x20);
  }
  local_70 = (undefined2)*param_2;
  uStack_6e = (undefined2)param_2[4];
  if (((VisibilityConditionManager::getInstance()::instance & 1) == 0) &&
    ...
    VisibilityConditionManager::getInstance()::instance = &DAT_0107c5b8;
                    /* try { // try from 007a7aec to 007a7af7 has its CatchHandler @ 007a7b90 */
  ...
  if (((VisibilityConditionManager::getInstance()::instance & 1) == 0) &&
    ...
    DAT_0107c5b8 = 0;
    VisibilityConditionManager::getInstance()::instance = &DAT_0107c5b8;
                    /* try { // try from 007a7b44 to 007a7b4f has its CatchHandler @ 007a7b80 */
    Mutex::Mutex((Mutex *)&DAT_0107c5c8,true);
    __cxa_atexit(VisibilityConditionManager::~VisibilityConditionManager,
                 &VisibilityConditionManager::getInstance()::instance,&PTR_LOOP_00fd8de0);
    __cxa_guard_release(&VisibilityConditionManager::getInstance()::instance);
