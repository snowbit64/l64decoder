...
// Function: RenderTriangles<0,0>
// Entry Point: 00da0c2c
// Size: 896 bytes
// Signature: CullingResult __thiscall RenderTriangles<0,0>(MaskedOcclusionCullingPrivate * this, float * param_1, ushort * param_2, int param_3, float * param_4, BackfaceWinding param_5, ClipPlanes param_6, VertexLayout * param_7)


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* MaskedOcclusionCulling::CullingResult
   MaskedOcclusionCullingNEON::MaskedOcclusionCullingPrivate::RenderTriangles<0, 0>(float const*,
...
MaskedOcclusionCullingNEON::MaskedOcclusionCullingPrivate::RenderTriangles<0,0>
...

{
  ...
  if (param_3 < 1) {
    uVar5 = 3;
    if (*(long *)(lVar1 + 0x28) != local_78) goto LAB_00da0fa8;
  }
  else {
    uVar5 = 3;
    do {
