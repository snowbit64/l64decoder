...
// Function: push_front
// Entry Point: 00ba3ba8
// Size: 448 bytes
// Signature: undefined __thiscall push_front(__split_buffer<ThreadPool::TaskAndMgr*,std::__ndk1::allocator<ThreadPool::TaskAndMgr*>&> * this, TaskAndMgr * * param_1)


/* std::__ndk1::__split_buffer<ThreadPool::TaskAndMgr*,
   std::__ndk1::allocator<ThreadPool::TaskAndMgr*>&>::push_front(ThreadPool::TaskAndMgr* const&) */

void __thiscall
std::__ndk1::
__split_buffer<ThreadPool::TaskAndMgr*,std::__ndk1::allocator<ThreadPool::TaskAndMgr*>&>::push_front
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00ba3d30;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00ba3d18;
      }
    }
    do {
      puVar7 = puVar6 + 1;
