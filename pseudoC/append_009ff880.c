...
// Function: __append
// Entry Point: 009ff880
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<LightSourceQueueItem*,std::__ndk1::allocator<LightSourceQueueItem*>> * this, ulong param_1)
...
void __thiscall
std::__ndk1::vector<LightSourceQueueItem*,std::__ndk1::allocator<LightSourceQueueItem*>>::__append
          (vector<LightSourceQueueItem*,std::__ndk1::allocator<LightSourceQueueItem*>> *this,
          ulong param_1)
