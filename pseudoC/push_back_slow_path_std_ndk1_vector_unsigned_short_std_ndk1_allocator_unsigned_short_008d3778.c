...
// Function: __push_back_slow_path<std::__ndk1::vector<unsigned_short,std::__ndk1::allocator<unsigned_short>>>
// Entry Point: 008d3778
// Size: 352 bytes
// Signature: void __thiscall __push_back_slow_path<std::__ndk1::vector<unsigned_short,std::__ndk1::allocator<unsigned_short>>>(vector<std::__ndk1::vector<unsigned_short,std::__ndk1::allocator<unsigned_short>>,std::__ndk1::allocator<std::__ndk1::vector<unsigned_short,std::__ndk1::allocator<unsigned_short>>>> * this, vector * param_1)


/* void std::__ndk1::vector<std::__ndk1::vector<unsigned short, std::__ndk1::allocator<unsigned
   short> >, std::__ndk1::allocator<std::__ndk1::vector<unsigned short,
   std::__ndk1::allocator<unsigned short> > > >::__push_back_slow_path<std::__ndk1::vector<unsigned
   short, std::__ndk1::allocator<unsigned short> > >(std::__ndk1::vector<unsigned short,
