...
void CryptoPP::DL_PrivateKey_ECGDSA<CryptoPP::ECP>::BERDecodePrivateKey
...

{
  ...
  ppuStack_88 = &PTR__BERSequenceDecoder_01000c08;
                    /* try { // try from 00caae1c to 00caae33 has its CatchHandler @ 00cab358 */
  BERDecodeUnsigned<unsigned_int>((BufferedTransformation *)&local_90,&uStack_1bc,'\x02',1,1);
                    /* try { // try from 00caae34 to 00caae43 has its CatchHandler @ 00cab350 */
  ...
  if (local_97 == '\0') {
    ...
    *puVar4 = &PTR__Exception_00fe0298;
                    /* try { // try from 00cab0e4 to 00cab0eb has its CatchHandler @ 00cab2f4 */
    ...
    *puVar4 = &PTR__Exception_01002700;
                    /* try { // try from 00cab11c to 00cab133 has its CatchHandler @ 00cab2ec */
                    /* WARNING: Subroutine does not return */
    __cxa_throw(puVar4,&BERDecodeErr::typeinfo,Exception::~Exception);
  }
                    /* try { // try from 00caae4c to 00caae53 has its CatchHandler @ 00cab348 */
  Integer::Integer((Integer *)local_f8);
                    /* try { // try from 00caae58 to 00caae9b has its CatchHandler @ 00cab360 */
  ...
  if (((param_3 & 1) == 0) && (cVar2 = BERGeneralDecoder::PeekByte(), cVar2 != -0x60)) {
    ...
    *(undefined4 *)(puVar4 + 1) = 1;
    *puVar4 = &PTR__Exception_00fe0298;
                    /* try { // try from 00cab20c to 00cab213 has its CatchHandler @ 00cab264 */
    std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
    basic_string((basic_string *)(puVar4 + 2));
    *puVar4 = &PTR__Exception_00fe9ee0;
    if (((byte)local_1a0 & 1) != 0) {
    ...
    *puVar4 = &PTR__Exception_01002700;
                    /* try { // try from 00cab244 to 00cab25b has its CatchHandler @ 00cab360 */
                    /* WARNING: Subroutine does not return */
    __cxa_throw(puVar4,&BERDecodeErr::typeinfo,Exception::~Exception);
  }
  uVar3 = BERGeneralDecoder::EndReached();
  if (((uVar3 & 1) == 0) && (cVar2 = BERGeneralDecoder::PeekByte(), cVar2 == -0x60)) {
                    /* try { // try from 00caaea8 to 00caaeb7 has its CatchHandler @ 00cab260 */
    BERGeneralDecoder::BERGeneralDecoder(&local_1a0,(BERGeneralDecoder *)&local_90,0xa0);
                    /* try { // try from 00caaebc to 00caaecb has its CatchHandler @ 00cab2d4 */
    ...
    BERGeneralDecoder::~BERGeneralDecoder(&local_1a0);
                    ...
                    /* try { // try from 00caaed4 to 00caaedb has its CatchHandler @ 00cab360 */
  uVar3 = BERGeneralDecoder::EndReached();
  if ((uVar3 & 1) == 0) {
    local_1d0 = 0;
    local_1c8 = (void *)0x0;
    local_1d8 = 0xffffffffffffffff;
                    /* try { // try from 00caaef4 to 00caaf03 has its CatchHandler @ 00cab2e4 */
    BERGeneralDecoder::BERGeneralDecoder(aBStack_130,(BERGeneralDecoder *)&local_90,0xa1);
                    /* try { // try from 00caaf04 to 00caaf1b has its CatchHandler @ 00cab330 */
    BERDecodeBitString((BufferedTransformation *)aBStack_130,aSStack_1e0,&local_1e4);
    BERGeneralDecoder::MessageEnd();
    local_1a0 = (BERGeneralDecoder)0xd8;
    uStack_19f = 0xfe9f;
                    /* try { // try from 00caaf34 to 00caaf3b has its CatchHandler @ 00cab2d0 */
    Integer::Integer(&IStack_198);
                    /* try { // try from 00caaf40 to 00caaf43 has its CatchHandler @ 00cab2c0 */
    Integer::Integer((Integer *)local_168);
    local_138 = 1;
                    /* try { // try from 00caaf64 to 00caaf6b has its CatchHandler @ 00cab320 */
    if ((local_1e4 != 0) ||
      ...
      *(undefined4 *)(puVar4 + 1) = 1;
      *puVar4 = &PTR__Exception_00fe0298;
                    /* try { // try from 00cab178 to 00cab17f has its CatchHandler @ 00cab298 */
      std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
      basic_string((basic_string *)(puVar4 + 2));
      *puVar4 = &PTR__Exception_00fe9ee0;
      if ((local_1b8 & 1) != 0) {
      ...
      *puVar4 = &PTR__Exception_01002700;
                    /* try { // try from 00cab1b0 to 00cab1c7 has its CatchHandler @ 00cab320 */
                    /* WARNING: Subroutine does not return */
      __cxa_throw(puVar4,&BERDecodeErr::typeinfo,Exception::~Exception);
    }
    ...
    for (; local_158 != 0; local_158 = local_158 - 1) {
      *(undefined4 *)((long)local_148 + local_158 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00caafa8 to 00caafab has its CatchHandler @ 00cab294 */
    ...
    for (; local_188 != 0; local_188 = local_188 - 1) {
      *(undefined4 *)((long)local_178 + local_188 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00caafdc to 00caafdf has its CatchHandler @ 00cab290 */
    ...
    for (; uVar3 != 0; uVar3 = uVar3 - 1) {
      *(undefined *)((long)local_1c8 + (uVar3 - 1)) = 0;
                    ...
                    /* try { // try from 00cab010 to 00cab013 has its CatchHandler @ 00cab28c */
    UnalignedDeallocate(local_1c8);
  }
                    /* try { // try from 00cab014 to 00cab02f has its CatchHandler @ 00cab360 */
  BERGeneralDecoder::MessageEnd();
  ...
  for (; local_e8 != 0; local_e8 = local_e8 - 1) {
    *(undefined4 *)((long)local_d8 + local_e8 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00cab060 to 00cab063 has its CatchHandler @ 00cab31c */
