...
// Function: rehash
// Entry Point: 00b41ac0
// Size: 220 bytes
// Signature: undefined __thiscall rehash(__hash_table<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::allocator<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>> * this, ulong param_1)
...
/* std::__ndk1::__hash_table<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > > >::rehash(unsigned long) */
...

{
  ...
  uVar2 = *(ulong *)(this + 8);
  uVar1 = param_1;
  if (uVar2 < param_1) goto LAB_00b41b74;
  if (uVar2 <= param_1) {
    return;
  }
...
LAB_00b41b60:
    ...
    if (1 < (uint)CONCAT62((int6)((ulong)uVar4 >> 0x10),uVar3)) goto LAB_00b41b60;
    if (1 < uVar1) {
