...
// Function: __append
// Entry Point: 0096193c
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<MultiresTextureGpuUpdater::TileUVs,std::__ndk1::allocator<MultiresTextureGpuUpdater::TileUVs>> * this, ulong param_1)


/* std::__ndk1::vector<MultiresTextureGpuUpdater::TileUVs,
   std::__ndk1::allocator<MultiresTextureGpuUpdater::TileUVs> >::__append(unsigned long) */
