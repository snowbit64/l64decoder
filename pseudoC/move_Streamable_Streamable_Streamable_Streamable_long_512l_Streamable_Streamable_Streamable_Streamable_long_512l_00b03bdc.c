...
// Function: move<Streamable*,Streamable**,Streamable*&,Streamable***,long,512l,Streamable*,Streamable**,Streamable*&,Streamable***,long,512l>
// Entry Point: 00b03bdc
// Size: 408 bytes
// Signature: __deque_iterator __cdecl move<Streamable*,Streamable**,Streamable*&,Streamable***,long,512l,Streamable*,Streamable**,Streamable*&,Streamable***,long,512l>(__deque_iterator param_1, __deque_iterator param_2, __deque_iterator param_3)


/* std::__ndk1::__deque_iterator<Streamable*, Streamable**, Streamable*&, Streamable***, long, 512l>
   std::__ndk1::move<Streamable*, Streamable**, Streamable*&, Streamable***, long, 512l,
