...
// Function: FUN_007ac454
// Entry Point: 007ac454
// Size: 868 bytes
// Signature: undefined FUN_007ac454(void)


void FUN_007ac454(GsMaterial *param_1,char **param_2)

{
  ...
  lVar4 = EntityRegistryManager::getEntityById(this,*(uint *)(param_2 + 2));
  if ((((lVar4 != 0) && ((*(byte *)(lVar4 + 0x15) >> 4 & 1) != 0)) &&
      (this_00 = (CustomShader *)GsMaterial::getCustomShader(), this_00 != (CustomShader *)0x0)) &&
     (uVar5 = CustomShader::getTextureIndex(this_00,*(uint *)(param_1 + 0x88),*param_2,&local_2bc),
     (uVar5 & 1) != 0)) {
    pTVar7 = *(Texture **)(param_1 + 0x70);
    if (pTVar7 != (Texture *)0x0) {
      pTVar7 = *(Texture **)(pTVar7 + (ulong)local_2bc * 8);
    }
    if (*(Texture **)(lVar4 + 0x20) != pTVar7) {
      if (*(char *)(param_2 + 4) == '\0') {
        ...
        local_238[local_2bc] = *(undefined8 *)(lVar4 + 0x20);
        ...
        GsMaterial::setCustomTexture(param_1,local_2bc,*(Texture **)(lVar4 + 0x20));
