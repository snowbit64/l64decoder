...
// Function: __construct_node<std::__ndk1::pair<btCollisionObject*,char*>>
// Entry Point: 00998018
// Size: 196 bytes
// Signature: unique_ptr __cdecl __construct_node<std::__ndk1::pair<btCollisionObject*,char*>>(pair * param_1)
...
/* std::__ndk1::unique_ptr<std::__ndk1::__tree_node<std::__ndk1::__value_type<btCollisionObject
   ...
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > >
   > >::__construct_node<std::__ndk1::pair<btCollisionObject*, char*>
   >(std::__ndk1::pair<btCollisionObject*, char*>&&) */
...
::__construct_node<std::__ndk1::pair<btCollisionObject*,char*>>(pair *param_1)

{
  ...
  *(undefined8 *)((long)pvVar3 + 0x20) = uVar1;
  ...
  if (0xffffffffffffffef < __n) {
                    /* try { // try from 009980d4 to 009980db has its CatchHandler @ 009980dc */
  ...
  if (__n < 0x17) {
    ...
    *(char *)((long)pvVar3 + 0x28) = (char)((int)__n << 1);
    ...
    uVar4 = __n + 0x10 & 0xfffffffffffffff0;
                    /* try { // try from 0099808c to 00998093 has its CatchHandler @ 009980dc */
