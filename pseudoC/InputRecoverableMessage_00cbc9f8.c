...
// Entry Point: 00cbc9f8
// Size: 228 bytes
// Signature: undefined __thiscall InputRecoverableMessage(DL_SignerBase<CryptoPP::ECPPoint> * this, PK_MessageAccumulator * param_1, uchar * param_2, ulong param_3)


/* CryptoPP::DL_SignerBase<CryptoPP::ECPPoint>::InputRecoverableMessage(CryptoPP::PK_MessageAccumulator&,
   unsigned char const*, unsigned long) const */

void __thiscall
CryptoPP::DL_SignerBase<CryptoPP::ECPPoint>::InputRecoverableMessage
          (DL_SignerBase<CryptoPP::ECPPoint> *this,PK_MessageAccumulator *param_1,uchar *param_2,
          ulong param_3)
...
LAB_00cbca7c:
  ...
  *(undefined8 *)(param_1 + 0x10) = 0xffffffffffffffff;
  ...
  uVar3 = (**(code **)(*(long *)param_1 + 0xa0))(param_1);
                    /* WARNING: Could not recover jumptable at 0x00cbcad8. Too many branches */
