...
// Entry Point: 00ab8050
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<std::__ndk1::pair<VkImageView_T*,unsigned_int>,std::__ndk1::allocator<std::__ndk1::pair<VkImageView_T*,unsigned_int>>> * this)


/* std::__ndk1::__deque_base<std::__ndk1::pair<VkImageView_T*, unsigned int>,
   std::__ndk1::allocator<std::__ndk1::pair<VkImageView_T*, unsigned int> > >::~__deque_base() */
...

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_00ab80bc;
    uVar4 = 0x100;
  }
