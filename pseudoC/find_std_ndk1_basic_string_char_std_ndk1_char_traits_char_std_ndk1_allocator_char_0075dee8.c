...

{
  ...
  if ((*(byte *)param_1 & 1) == 0) {
    ...
    uVar7 = (ulong)(*(byte *)param_1 >> 1);
                    ...
                    /* try { // try from 0075df34 to 0075df3b has its CatchHandler @ 0075e0a4 */
      ...
      if (plVar10 != (long *)0x0) {
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                while (*(char *)((long)plVar10 + uVar9 + 0x11) == *(char *)((long)pvVar2 + uVar9)) {
                  uVar9 = uVar9 + 1;
                  if (bVar3 >> 1 == uVar9) goto LAB_0075e06c;
                }
              }
            ...
            if (uVar9 != uVar13) goto LAB_0075e068;
          }
