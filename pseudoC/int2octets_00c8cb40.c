...
// Function: int2octets
// Entry Point: 00c8cb40
// Size: 404 bytes
// Signature: undefined __cdecl int2octets(Integer * param_1, ulong param_2)


/* CryptoPP::DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,
   CryptoPP::SHA512>::int2octets(CryptoPP::Integer const&, unsigned long) const */

void CryptoPP::DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA512>::int2octets
...

{
  ...
  local_50 = __src;
                    /* try { // try from 00c8cba4 to 00c8cbd7 has its CatchHandler @ 00c8ccf0 */
...
LAB_00c8cc20:
    ...
    pvVar4 = (void *)((long)pvVar4 + (in_x2 - uVar2));
                    ...
                    /* try { // try from 00c8cbe8 to 00c8cbef has its CatchHandler @ 00c8ccd4 */
    local_70 = (void *)UnalignedAllocate(in_x2);
    uVar3 = uVar2 - in_x2;
    if (uVar2 < in_x2 || uVar2 - in_x2 == 0) goto LAB_00c8cc20;
LAB_00c8cc00:
    __src = __src + uVar3;
    pvVar4 = local_70;
    uVar2 = in_x2;
  ...
  memcpy(pvVar4,__src,uVar2);
                    /* try { // try from 00c8cc44 to 00c8cc4f has its CatchHandler @ 00c8ccdc */
  SecBlock<unsigned_char,CryptoPP::AllocatorWithCleanup<unsigned_char,false>>::SecBlock
            (in_x8,aSStack_88);
  uVar2 = local_80;
  ...
  for (; uVar2 != 0; uVar2 = uVar2 - 1) {
    *(undefined *)((long)local_70 + (uVar2 - 1)) = 0;
                    ...
                    /* try { // try from 00c8cc78 to 00c8cc7b has its CatchHandler @ 00c8ccd8 */
...
LAB_00c8cc7c:
  ...
  for (; uVar2 != 0; uVar2 = uVar2 - 1) {
    local_50[uVar2 - 1] = '\0';
                    ...
                    /* try { // try from 00c8cca4 to 00c8cca7 has its CatchHandler @ 00c8ccec */
