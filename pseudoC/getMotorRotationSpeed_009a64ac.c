...
// Function: getMotorRotationSpeed
// Entry Point: 009a64ac
// Size: 196 bytes
// Signature: undefined __thiscall getMotorRotationSpeed(Bt2ScenegraphPhysicsContext * this, TransformGroup * param_1, float * param_2, float * param_3, float * param_4)


/* Bt2ScenegraphPhysicsContext::getMotorRotationSpeed(TransformGroup*, float&, float&, float&) */

void __thiscall
Bt2ScenegraphPhysicsContext::getMotorRotationSpeed
  ...
  if (((*(uint *)(lVar1 + 8) ^ 0xffffffff) & 0x88) == 0) {
    ...
    if (pBVar4 != (Bt2ScenegraphPhysicsContext *)0x0) {
      ...
      if ((pBVar2 != this + 400) && (*(ulong *)(pBVar2 + 0x20) <= uVar3)) {
        ...
        *param_2 = *(float *)(lVar1 + 0xe0);
        *param_3 = *(float *)(lVar1 + 0xe4);
        *param_4 = *(float *)(lVar1 + 0xe8);
      }
    }
  }
  return;
