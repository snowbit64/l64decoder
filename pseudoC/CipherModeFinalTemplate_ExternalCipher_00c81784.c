...
void CryptoPP::CipherModeFinalTemplate_ExternalCipher<CryptoPP::ECB_OneWay>::
...

{
  ...
  *in_x0 = &PTR__BlockOrientedCipherModeBase_00ff1a00;
  in_x0[1] = &PTR__CipherModeFinalTemplate_ExternalCipher_00ff1ae8;
  return;
}
