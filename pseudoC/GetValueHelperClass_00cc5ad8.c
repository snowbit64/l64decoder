...
// Entry Point: 00cc5ad8
// Size: 364 bytes
// Signature: undefined __thiscall GetValueHelperClass(GetValueHelperClass<CryptoPP::DL_PublicKey<CryptoPP::ECPPoint>,CryptoPP::DL_PublicKey<CryptoPP::ECPPoint>> * this, DL_PublicKey * param_1, char * param_2, type_info * param_3, void * param_4, NameValuePairs * param_5)


/* CryptoPP::GetValueHelperClass<CryptoPP::DL_PublicKey<CryptoPP::ECPPoint>,
   CryptoPP::DL_PublicKey<CryptoPP::ECPPoint>
   >::GetValueHelperClass(CryptoPP::DL_PublicKey<CryptoPP::ECPPoint> const*, char const*,
...

{
  ...
  *(undefined2 *)(this + 0x20) = 0;
  ...
  if ((iVar3 == 0) &&
     (iVar3 = strcmp(param_2 + 0xc,"N8CryptoPP12DL_PublicKeyINS_8ECPPointEEE"), iVar3 == 0)) {
    NameValuePairs::ThrowIfTypeMismatch
              (param_2,(type_info *)&DL_PublicKey<CryptoPP::ECPPoint>*::typeinfo,
               *(type_info **)(this + 0x10));
    GVar5 = (GetValueHelperClass<CryptoPP::DL_PublicKey<CryptoPP::ECPPoint>,CryptoPP::DL_PublicKey<CryptoPP::ECPPoint>>
             )0x1;
