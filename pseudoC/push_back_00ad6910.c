...
/* std::__ndk1::__split_buffer<VulkanRenderWindow::ReleasedSwapChain*,
   ...
   >::push_back(VulkanRenderWindow::ReleasedSwapChain*&&) */
...

{
  ...
  if (ppRVar12 != *(ReleasedSwapChain ***)(this + 0x18)) goto LAB_00ad6a90;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00ad6a78;
      }
    }
    do {
      ppRVar11 = ppRVar8 + 1;
