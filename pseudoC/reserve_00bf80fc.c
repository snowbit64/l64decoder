...
// Function: reserve
// Entry Point: 00bf80fc
// Size: 176 bytes
// Signature: undefined __thiscall reserve(vector<CompiledShaderArchive::ShaderEntry,std::__ndk1::allocator<CompiledShaderArchive::ShaderEntry>> * this, ulong param_1)


/* std::__ndk1::vector<CompiledShaderArchive::ShaderEntry,
   std::__ndk1::allocator<CompiledShaderArchive::ShaderEntry> >::reserve(unsigned long) */
