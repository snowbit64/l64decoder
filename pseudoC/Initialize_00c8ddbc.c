...
// Function: Initialize
// Entry Point: 00c8ddbc
// Size: 92 bytes
// Signature: undefined __thiscall Initialize(DL_PrivateKey_GFP<CryptoPP::DL_GroupParameters_DSA> * this, Integer * param_1, Integer * param_2, Integer * param_3, Integer * param_4)
...
{
  (**(code **)(*(long *)(this + 0x60) + 0xa8))(this + 0x60,param_1,param_3);
  Integer::operator=((Integer *)(this + 0x78),param_2);
  *(undefined4 *)(this + 0x70) = 0;
                    /* WARNING: Could not recover jumptable at 0x00c8de14. Too many branches */
