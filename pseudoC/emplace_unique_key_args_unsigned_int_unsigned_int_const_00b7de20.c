...
// Function: __emplace_unique_key_args<unsigned_int,unsigned_int_const&>
// Entry Point: 00b7de20
// Size: 512 bytes
// Signature: pair __thiscall __emplace_unique_key_args<unsigned_int,unsigned_int_const&>(__hash_table<unsigned_int,std::__ndk1::hash<unsigned_int>,std::__ndk1::equal_to<unsigned_int>,std::__ndk1::allocator<unsigned_int>> * this, uint * param_1, uint * param_2)


/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<unsigned int, void*>*>,
   bool> std::__ndk1::__hash_table<unsigned int, std::__ndk1::hash<unsigned int>,
   std::__ndk1::equal_to<unsigned int>, std::__ndk1::allocator<unsigned int>
   >::__emplace_unique_key_args<unsigned int, unsigned int const&>(unsigned int const&, unsigned int
   const&) */
  ...
  if (plVar10 != (long *)0x0) {
    ...
    if (pplVar9 != (long **)0x0) {
      do {
        ...
        if (pplVar9 == (long **)0x0) goto LAB_00b7dee0;
        plVar6 = pplVar9[1];
        if (plVar6 != plVar11) {
          if (uVar4 < 2) {
          ...
          if (plVar6 != unaff_x24) goto LAB_00b7dee0;
        }
  ...
  if ((plVar10 == (long *)0x0) || (fVar14 * (float)ZEXT89(plVar10) < (float)(unkuint9)(lVar3 + 1)))
  {
    ...
    if (uVar7 <= uVar4) {
      uVar7 = uVar4;
                    ...
                    /* try { // try from 00b7df4c to 00b7df53 has its CatchHandler @ 00b7e020 */
    rehash(this,uVar7);
    plVar10 = *(long **)(this + 8);
