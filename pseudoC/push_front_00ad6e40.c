...
// Function: push_front
// Entry Point: 00ad6e40
// Size: 448 bytes
// Signature: undefined __thiscall push_front(__split_buffer<VulkanRenderWindow::ReleasedSwapChain*,std::__ndk1::allocator<VulkanRenderWindow::ReleasedSwapChain*>&> * this, ReleasedSwapChain * * param_1)


/* std::__ndk1::__split_buffer<VulkanRenderWindow::ReleasedSwapChain*,
   std::__ndk1::allocator<VulkanRenderWindow::ReleasedSwapChain*>&>::push_front(VulkanRenderWindow::ReleasedSwapChain*
   const&) */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00ad6fc8;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00ad6fb0;
      }
    }
    do {
      puVar7 = puVar6 + 1;
