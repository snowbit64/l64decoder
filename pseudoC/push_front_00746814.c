...
// Function: push_front
// Entry Point: 00746814
// Size: 448 bytes
// Signature: undefined __thiscall push_front(__split_buffer<VehicleNavigationAgent**,std::__ndk1::allocator<VehicleNavigationAgent**>&> * this, VehicleNavigationAgent * * * param_1)


/* std::__ndk1::__split_buffer<VehicleNavigationAgent**,
   std::__ndk1::allocator<VehicleNavigationAgent**>&>::push_front(VehicleNavigationAgent** const&)
    */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_0074699c;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00746984;
      }
    }
    do {
      puVar7 = puVar6 + 1;
