...
// Entry Point: 00ac68a4
// Size: 300 bytes
// Signature: undefined __thiscall getOutputVariables(SpirvReflect * this, vector * param_1)


/* SpirvReflect::getOutputVariables(std::__ndk1::vector<SpvReflectInterfaceVariable*,
   std::__ndk1::allocator<SpvReflectInterfaceVariable*> >&) */

void __thiscall SpirvReflect::getOutputVariables(SpirvReflect *this,vector *param_1)

{
  ...
  local_64 = 0;
  SVar3 = spvReflectEnumerateOutputVariables(this + 8,&local_64,0);
  ...
  *(undefined8 *)(this + 0x4c0) = local_50;
  if (iVar1 == 0) {
    ...
    SVar3 = spvReflectEnumerateOutputVariables(this + 8,&local_64,lVar4);
    *(SpvReflectResult *)this = SVar3;
    *(SpvReflectResult *)(this + 0x4a8) = SVar3;
    ToStringResult(SVar3);
    if (((byte)this[0x4b0] & 1) != 0) {
