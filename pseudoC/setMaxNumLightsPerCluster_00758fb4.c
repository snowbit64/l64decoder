...
// Function: setMaxNumLightsPerCluster
// Entry Point: 00758fb4
// Size: 220 bytes
// Signature: undefined __thiscall setMaxNumLightsPerCluster(HardwareScalability * this, uint param_1)


/* HardwareScalability::setMaxNumLightsPerCluster(unsigned int) */

void __thiscall
HardwareScalability::setMaxNumLightsPerCluster(HardwareScalability *this,uint param_1)
