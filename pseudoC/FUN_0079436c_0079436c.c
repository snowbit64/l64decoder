...
// Function: FUN_0079436c
// Entry Point: 0079436c
// Size: 476 bytes
// Signature: undefined FUN_0079436c(void)


void FUN_0079436c(uint *param_1)

{
  ...
  if ((((lVar2 == 0) || ((*(byte *)(lVar2 + 0x11) >> 3 & 1) == 0)) ||
    ...
    if ((float)param_1[0x18] <= 0.001) {
      fVar4 = 0.001;
    }
    uVar6 = (**(code **)(*plVar3 + 0x28))(param_1[4],param_1[8],fVar4,plVar3,&local_98,&local_a8);
    RawTransformGroup::updateWorldTransformation();
