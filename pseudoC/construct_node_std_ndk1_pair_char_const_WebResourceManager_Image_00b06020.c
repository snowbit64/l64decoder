...
// Function: __construct_node<std::__ndk1::pair<char_const*,WebResourceManager::Image*>>
// Entry Point: 00b06020
// Size: 208 bytes
// Signature: unique_ptr __cdecl __construct_node<std::__ndk1::pair<char_const*,WebResourceManager::Image*>>(pair * param_1)
...
/* std::__ndk1::unique_ptr<std::__ndk1::__tree_node<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, WebResourceManager::Image*> >
   >::__construct_node<std::__ndk1::pair<char const*, WebResourceManager::Image*>
...
::__construct_node<std::__ndk1::pair<char_const*,WebResourceManager::Image*>>(pair *param_1)

{
  ...
  *(undefined *)(in_x8 + 2) = 0;
  ...
  if (0xffffffffffffffef < __n) {
                    /* try { // try from 00b060e8 to 00b060ef has its CatchHandler @ 00b060f0 */
  ...
  if (__n < 0x17) {
    ...
    *(char *)((long)pvVar2 + 0x20) = (char)((int)__n << 1);
    ...
    uVar5 = __n + 0x10 & 0xfffffffffffffff0;
                    /* try { // try from 00b06094 to 00b0609b has its CatchHandler @ 00b060f0 */
