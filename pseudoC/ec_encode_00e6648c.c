...
// Function: ec_encode
// Entry Point: 00e6648c
// Size: 352 bytes
// Signature: undefined ec_encode(void)


void ec_encode(long *param_1,int param_2,int param_3,uint param_4)

{
  ...
  if (param_2 == 0) {
    uVar4 = uVar3 + uVar1 * (param_3 - param_4);
    ...
    *(uint *)((long)param_1 + 0x24) =
         uVar3 + uVar1 * (param_2 - param_4) + *(int *)((long)param_1 + 0x24);
  }
  if (uVar4 < 0x800001) {
