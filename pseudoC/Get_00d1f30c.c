...
// Function: Get
// Entry Point: 00d1f30c
// Size: 168 bytes
// Signature: undefined __thiscall Get(Walker * this, uchar * param_1, ulong param_2)


/* CryptoPP::ByteQueue::Walker::Get(unsigned char*, unsigned long) */

void __thiscall CryptoPP::ByteQueue::Walker::Get(Walker *this,uchar *param_1,ulong param_2)
