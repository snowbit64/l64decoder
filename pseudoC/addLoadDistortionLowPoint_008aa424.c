...
// Function: addLoadDistortionLowPoint
// Entry Point: 008aa424
// Size: 368 bytes
// Signature: undefined __thiscall addLoadDistortionLowPoint(LoadSimulationRuntimeSettings * this, float param_1, float param_2)


/* LoadSimulationRuntimeSettings::addLoadDistortionLowPoint(float, float) */

void __thiscall
LoadSimulationRuntimeSettings::addLoadDistortionLowPoint
...
LAB_008aa4c4:
    ...
    local_64 = 0x3f800000;
    uStack_60 = 0;
    uStack_70 = (ulong)(uint)param_2;
    local_98 = param_1;
    if (puVar6 == *(ulong **)(this + 0x58)) {
                    /* try { // try from 008aa538 to 008aa543 has its CatchHandler @ 008aa594 */
      std::__ndk1::
      ...
      *puVar6 = (ulong)(uint)param_1;
                    /* try { // try from 008aa514 to 008aa517 has its CatchHandler @ 008aa59c */
      std::__ndk1::
    ...
    if (*pfVar2 != param_1) {
      ...
      do {
        pfVar5 = pfVar5 + 0x10;
        if (uVar4 - 1 == uVar3) goto LAB_008aa4c4;
        uVar3 = uVar3 + 1;
      } while (*pfVar5 != param_1);
      if (uVar4 <= uVar3) goto LAB_008aa4c4;
    }
    pfVar2[uVar3 * 0x10 + 10] = param_2;
  }
  std::__ndk1::
  __sort<std::__ndk1::__less<LoadSimulationRuntimeSettings::LoadPoint,LoadSimulationRuntimeSettings::LoadPoint>&,LoadSimulationRuntimeSettings::LoadPoint*>
