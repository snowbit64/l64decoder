...
// Entry Point: 00c0fab4
// Size: 276 bytes
// Signature: __tree_const_iterator __thiscall find<SHC_String>(__tree<std::__ndk1::__value_type<SHC_String,GsTSymbol*>,std::__ndk1::__map_value_compare<SHC_String,std::__ndk1::__value_type<SHC_String,GsTSymbol*>,std::__ndk1::less<SHC_String>,true>,SHC_STLPoolAllocator<std::__ndk1::__value_type<SHC_String,GsTSymbol*>>> * this, SHC_String * param_1)


/* std::__ndk1::__tree_const_iterator<std::__ndk1::__value_type<SHC_String, GsTSymbol*>,
   ...
   GsTSymbol*> > >::find<SHC_String>(SHC_String const&) const */
...
LAB_00c0faf4:
    ...
    if (pp_Var9 != pp_Var8) {
      ...
      if (p_Var2 != (__tree<std::__ndk1::__value_type<SHC_String,GsTSymbol*>,std::__ndk1::__map_value_compare<SHC_String,std::__ndk1::__value_type<SHC_String,GsTSymbol*>,std::__ndk1::less<SHC_String>,true>,SHC_STLPoolAllocator<std::__ndk1::__value_type<SHC_String,GsTSymbol*>>>
        ...
        if (iVar6 != 0) {
          if (-1 < iVar6) goto LAB_00c0fbb0;
          goto LAB_00c0fbac;
        }
      }
      if (p_Var1 <= p_Var3) goto LAB_00c0fbb0;
    }
  }
LAB_00c0fbac:
  pp_Var9 = pp_Var8;
