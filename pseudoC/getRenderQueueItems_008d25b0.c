...

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    *(undefined8 *)(pRStack_50 + 0x38) = *(undefined8 *)(param_1 + 0x70);
    uVar1 = *(undefined4 *)(param_1 + 0x8c);
    *(undefined8 *)(pRStack_50 + 0x68) = 0;
    *(undefined4 *)(pRStack_50 + 100) = uVar1;
    *(undefined4 *)(pRStack_50 + 0x70) = *(undefined4 *)(param_1 + 0x90);
    *(undefined4 *)(pRStack_50 + 0x74) = 0;
    *(undefined8 *)(pRStack_50 + 0x78) = *(undefined8 *)(param_1 + 0x78);
