...
// Entry Point: 00b2d844
// Size: 216 bytes
// Signature: undefined __thiscall pushComment(XMLPrinter * this, char * param_1)


/* XMLPrinter::pushComment(char const*) */

void __thiscall XMLPrinter::pushComment(XMLPrinter *this,char *param_1)
