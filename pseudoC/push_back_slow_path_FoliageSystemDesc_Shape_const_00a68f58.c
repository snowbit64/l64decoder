...
// Function: __push_back_slow_path<FoliageSystemDesc::Shape_const&>
// Entry Point: 00a68f58
// Size: 464 bytes
// Signature: void __thiscall __push_back_slow_path<FoliageSystemDesc::Shape_const&>(vector<FoliageSystemDesc::Shape,std::__ndk1::allocator<FoliageSystemDesc::Shape>> * this, Shape * param_1)


/* void std::__ndk1::vector<FoliageSystemDesc::Shape,
   std::__ndk1::allocator<FoliageSystemDesc::Shape>
   >::__push_back_slow_path<FoliageSystemDesc::Shape const&>(FoliageSystemDesc::Shape const&) */
...

{
  ...
  *puVar12 = *(undefined4 *)param_1;
                    /* try { // try from 00a69004 to 00a6900b has its CatchHandler @ 00a69128 */
    ...
    do {
      *(undefined4 *)((long)puVar12 + lVar10 + -0x20) =
           *(undefined4 *)((long)pvVar13 + lVar10 + -0x20);
                    /* try { // try from 00a6903c to 00a6903f has its CatchHandler @ 00a6912c */
      vector<FoliageSystemDesc::Lod,std::__ndk1::allocator<FoliageSystemDesc::Lod>>::vector
                ((vector<FoliageSystemDesc::Lod,std::__ndk1::allocator<FoliageSystemDesc::Lod>> *)
