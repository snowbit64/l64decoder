...
// Function: assign<BiquadResonantFilter::Settings*>
// Entry Point: 008abe1c
// Size: 428 bytes
// Signature: type __thiscall assign<BiquadResonantFilter::Settings*>(vector<BiquadResonantFilter::Settings,std::__ndk1::allocator<BiquadResonantFilter::Settings>> * this, Settings * param_1, Settings * param_2)


/* std::__ndk1::enable_if<__is_cpp17_forward_iterator<BiquadResonantFilter::Settings*>::value&&is_constructible<BiquadResonantFilter::Settings,
   std::__ndk1::iterator_traits<BiquadResonantFilter::Settings*>::reference>::value, void>::type
   std::__ndk1::vector<BiquadResonantFilter::Settings,
   std::__ndk1::allocator<BiquadResonantFilter::Settings>
   >::assign<BiquadResonantFilter::Settings*>(BiquadResonantFilter::Settings*,
   BiquadResonantFilter::Settings*) */
...
assign<BiquadResonantFilter::Settings*>
          (vector<BiquadResonantFilter::Settings,std::__ndk1::allocator<BiquadResonantFilter::Settings>>
           *this,Settings *param_1,Settings *param_2)

{
  ...
  *pvVar3;
  ...
  if (uVar9 < (ulong)(lVar7 * -0x5555555555555555) || uVar9 + lVar7 * 0x5555555555555555 == 0) {
    ...
    pvVar3 = this;
    if (sVar4 != 0) {
      pvVar3 = (vector<BiquadResonantFilter::Settings,std::__ndk1::allocator<BiquadResonantFilter::Settings>>
