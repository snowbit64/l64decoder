...

{
  ...
  this = (InputRejected *)__cxa_allocate_exception(0x28,param_2,param_3,param_4,param_5);
                    /* try { // try from 00cb9290 to 00cb9293 has its CatchHandler @ 00cb92ac */
