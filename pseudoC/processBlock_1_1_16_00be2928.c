...
// Function: processBlock_1_1_16
// Entry Point: 00be2928
// Size: 3560 bytes
// Signature: undefined __cdecl processBlock_1_1_16(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_1_1_16(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_1_1_16(CustomCipher *param_1,uchar *param_2)

{
  ...
  uVar15 = *(uint *)(param_1 + 0x294);
  uVar16 = uVar1 >> 0xf | uVar1 << 0x11;
  uVar3 = *(uint *)(param_1 + 0x28c);
  ...
  uVar15 = *(uint *)(param_1 + 0x284);
  uVar14 = *(uint *)(param_1 + 0x280);
  ...
  uVar4 = *(uint *)(&DAT_0211e998 + (ulong)((uVar17 >> 8 ^ uVar1 >> 0x10) & 0x3f) * 4);
  uVar16 = *(uint *)(&DAT_0211ea98 + (ulong)((uVar17 >> 4 ^ uVar1 >> 8) & 0x3f) * 4);
  ...
  uVar6 = *(uint *)(&DAT_0211ed98 + (ulong)((uVar14 >> 0x10 ^ uVar15 >> 7) & 0x3f) * 4);
  uVar7 = *(uint *)(&DAT_0211ee98 + (ulong)((uVar14 >> 8 ^ uVar15 >> 3) & 0x3f) * 4);
  ...
  CVar9 = param_1[0x2b2];
  uVar19 = uVar18 + (byte)CVar9 & 0xff;
  uVar1 = (uVar4 | uVar3 | uVar16 | uVar1) ^ uVar2 ^ (uVar6 | uVar5 | uVar7 | uVar14) ^
