...
// Function: getDensityMasked2Parallelogram
// Entry Point: 00b8aafc
// Size: 720 bytes
// Signature: undefined __thiscall getDensityMasked2Parallelogram(DensityMapOldOperations * this, Parallelogram * param_1, uint param_2, uint param_3, int param_4, OPERATION param_5, uint param_6, int param_7, int param_8, uint param_9, uint param_10, DensityMap * param_11, uint param_12, uint param_13, OPERATION param_14, uint param_15, int param_16, int param_17, uint param_18, uint param_19, DensityMap * param_20, uint param_21, uint param_22, OPERATION param_23, uint param_24, int param_25, int param_26, uint param_27, uint param_28, uint * param_29, uint * param_30)


/* DensityMapOldOperations::getDensityMasked2Parallelogram(DensityMapOperationShapes::Parallelogram
...
void __thiscall
DensityMapOldOperations::getDensityMasked2Parallelogram
...

{
  ...
  uVar3 = DensityMapOperations::getDensity<ParallelogramHelper>
                    (aPStack_d0,(DensityMapFilter *)&local_100,(DensityMapFilter *)&local_130,
                     (DensityMapFilter *)&local_160,param_4,param_29,param_30);
