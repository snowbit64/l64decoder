...
// Function: FUN_00d9ef48
// Entry Point: 00d9ef48
// Size: 468 bytes
// Signature: undefined FUN_00d9ef48(void)


void FUN_00d9ef48(byte **param_1,int param_2)
...
LAB_00d9f100:
      ...
      lVar19 = (ulong)(((uVar4 ^ (uint)pbVar17[2] << 8) & *(uint *)(param_1 + 7)) + 0x400) * 4;
      pbVar6 = param_1[5];
      pbVar7 = param_1[6];
      iVar13 = *(int *)(pbVar6 + lVar19);
      *(undefined4 *)(pbVar6 + lVar19) = uVar9;
...
LAB_00d9f0d8:
      ...
      *(int *)(param_1 + 3) = *(int *)(param_1 + 3) + 1;
      *(int *)(param_1 + 1) = iVar16 + 1;
      if (iVar16 + 1 == *(int *)((long)param_1 + 0xc)) goto LAB_00d9f100;
    }
    param_2 = param_2 + -1;
    if (param_2 == 0) {
      return;
