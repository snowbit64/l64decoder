...
// Function: Precompute
// Entry Point: 00bea068
// Size: 160 bytes
// Signature: undefined __cdecl Precompute(uint param_1)


/* CryptoPP::CryptoMaterial::Precompute(unsigned int) */

void CryptoPP::CryptoMaterial::Precompute(uint param_1)

{
  ...
  puVar1 = (undefined8 *)__cxa_allocate_exception(0x28);
                    /* try { // try from 00bea084 to 00bea08b has its CatchHandler @ 00bea144 */
  ...
  *puVar1 = &PTR__Exception_00fe0298;
                    /* try { // try from 00bea0d8 to 00bea0df has its CatchHandler @ 00bea124 */
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string((basic_string *)(puVar1 + 2));
  *puVar1 = &PTR__Exception_00fe0270;
                    /* try { // try from 00bea0f0 to 00bea107 has its CatchHandler @ 00bea108 */
