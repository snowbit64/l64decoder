...
// Function: __emplace_unique_key_args<LanguageUtil::LANGUAGE_TYPE,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<LanguageUtil::LANGUAGE_TYPE_const&>,std::__ndk1::tuple<>>
// Entry Point: 00754114
// Size: 520 bytes
// Signature: pair __cdecl __emplace_unique_key_args<LanguageUtil::LANGUAGE_TYPE,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<LanguageUtil::LANGUAGE_TYPE_const&>,std::__ndk1::tuple<>>(LANGUAGE_TYPE * param_1, piecewise_construct_t * param_2, tuple * param_3, tuple * param_4)


/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<LanguageUtil::LANGUAGE_TYPE,
   ...
   >::__emplace_unique_key_args<LanguageUtil::LANGUAGE_TYPE, std::__ndk1::piecewise_construct_t
   const&, std::__ndk1::tuple<LanguageUtil::LANGUAGE_TYPE const&>, std::__ndk1::tuple<>
   >(LanguageUtil::LANGUAGE_TYPE const&, std::__ndk1::piecewise_construct_t const&,
   std::__ndk1::tuple<LanguageUtil::LANGUAGE_TYPE const&>&&, std::__ndk1::tuple<>&&) */
...
pair std::__ndk1::
     ...
     __emplace_unique_key_args<LanguageUtil::LANGUAGE_TYPE,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<LanguageUtil::LANGUAGE_TYPE_const&>,std::__ndk1::tuple<>>
               (LANGUAGE_TYPE *param_1,piecewise_construct_t *param_2,tuple *param_3,tuple *param_4)
  ...
  if (plVar10 != (long *)0x0) {
    ...
    if (pplVar9 != (long **)0x0) {
      do {
        ...
        if (pplVar9 == (long **)0x0) goto LAB_007541d4;
        plVar6 = pplVar9[1];
        if (plVar6 != plVar11) {
          if (uVar3 < 2) {
          ...
          if (plVar6 != unaff_x24) goto LAB_007541d4;
        }
  ...
  if ((plVar10 == (long *)0x0) || (fVar14 * (float)ZEXT89(plVar10) < (float)(unkuint9)(lVar4 + 1)))
  {
    ...
    if (uVar7 <= uVar3) {
      uVar7 = uVar3;
                    ...
                    /* try { // try from 00754248 to 0075424f has its CatchHandler @ 0075431c */
