...
// Function: addDensity<ParallelogramHelper>
// Entry Point: 00767bb4
// Size: 844 bytes
// Signature: uint __cdecl addDensity<ParallelogramHelper>(ParallelogramHelper * param_1, DensityMapFilter * param_2, DensityMapFilter * param_3, DensityMapFilter * param_4, int param_5, uint param_6, int param_7, uint * param_8, uint * param_9, int * param_10)


/* unsigned int DensityMapOperations::addDensity<ParallelogramHelper>(ParallelogramHelper&,
   DensityMapFilter const&, DensityMapFilter const*, DensityMapFilter const*, int, unsigned int,
   int, unsigned int&, unsigned int&, int&) */

uint DensityMapOperations::addDensity<ParallelogramHelper>
               (ParallelogramHelper *param_1,DensityMapFilter *param_2,DensityMapFilter *param_3,
               DensityMapFilter *param_4,int param_5,uint param_6,int param_7,uint *param_8,
  ...
  if (*(long **)param_2 == (long *)0x0) {
    if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
       (iVar6 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar6 != 0)) {
                    /* try { // try from 00767e7c to 00767e87 has its CatchHandler @ 00767f04 */
    ...
    if (plVar7 == (long *)0x0) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar6 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar6 != 0))
      {
                    /* try { // try from 00767ec4 to 00767ecf has its CatchHandler @ 00767f00 */
        LogManager::LogManager((LogManager *)&LogManager::getInstance()::singletonLogManager);
        __cxa_atexit(LogManager::~LogManager,&LogManager::getInstance()::singletonLogManager,
                     &PTR_LOOP_00fd8de0);
        __cxa_guard_release(&LogManager::getInstance()::singletonLogManager);
        ...
        bVar3 = DensityMapModifier::
                applyModuleToShape<BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
                          ((IDensityPixelSource *)(plVar7 + 0xb),pBVar10,param_1,
                           (AddDensityProcessor *)&local_e0,param_3,param_4);
        if (bVar3) goto LAB_00767e04;
      }
      else {
        local_e0 = 0;
        uStack_d8 = 0;
...
LAB_00767e04:
          uVar5 = (uint)local_e0;
          *param_8 = local_e0._4_4_;
          *param_9 = (uint)uStack_d8;
          *param_10 = uStack_d8._4_4_;
          goto LAB_00767e3c;
        }
      }
    }
