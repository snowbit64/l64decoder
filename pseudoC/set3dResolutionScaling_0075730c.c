...
// Function: set3dResolutionScaling
// Entry Point: 0075730c
// Size: 220 bytes
// Signature: undefined __thiscall set3dResolutionScaling(HardwareScalability * this, float param_1)


/* HardwareScalability::set3dResolutionScaling(float) */

void __thiscall HardwareScalability::set3dResolutionScaling(HardwareScalability *this,float param_1)
