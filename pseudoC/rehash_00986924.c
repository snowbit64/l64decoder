...

{
  ...
  uVar2 = *(ulong *)(this + 8);
  uVar1 = param_1;
  if (uVar2 < param_1) goto LAB_009869d8;
  if (uVar2 <= param_1) {
    return;
  }
...
LAB_009869c4:
    ...
    if (1 < (uint)CONCAT62((int6)((ulong)uVar4 >> 0x10),uVar3)) goto LAB_009869c4;
    if (1 < uVar1) {
