...
// Function: __emplace_back_slow_path<unsigned_short&,unsigned_short&,unsigned_int&,unsigned_short&>
// Entry Point: 00b7271c
// Size: 328 bytes
// Signature: void __thiscall __emplace_back_slow_path<unsigned_short&,unsigned_short&,unsigned_int&,unsigned_short&>(vector<Brep::VertexCone,std::__ndk1::allocator<Brep::VertexCone>> * this, ushort * param_1, ushort * param_2, uint * param_3, ushort * param_4)


/* void std::__ndk1::vector<Brep::VertexCone, std::__ndk1::allocator<Brep::VertexCone>
   >::__emplace_back_slow_path<unsigned short&, unsigned short&, unsigned int&, unsigned
   short&>(unsigned short&, unsigned short&, unsigned int&, unsigned short&) */
