...
// Entry Point: 00bfeeb0
// Size: 248 bytes
// Signature: undefined __thiscall deserialize(CompressionDictionary * this, uchar * * param_1)


/* CompressionDictionary::deserialize(unsigned char const*&) */

void __thiscall CompressionDictionary::deserialize(CompressionDictionary *this,uchar **param_1)
