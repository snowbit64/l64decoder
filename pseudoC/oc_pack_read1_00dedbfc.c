...
// Function: oc_pack_read1
// Entry Point: 00dedbfc
// Size: 556 bytes
// Signature: undefined oc_pack_read1(void)


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

ulong oc_pack_read1(ulong *param_1)

{
  ...
  iVar8 = *(int *)(param_1 + 3);
  uVar10 = *param_1;
  if (0 < iVar8) goto LAB_00dedc14;
  puVar13 = (undefined8 *)param_1[1];
  puVar1 = (undefined8 *)param_1[2];
  if (puVar1 <= puVar13) goto LAB_00dede08;
  pbVar15 = (byte *)(ulong)(0x38U - iVar8 >> 3);
...
LAB_00dedd98:
    ...
    do {
      ...
      iVar8 = iVar9 + 8;
      uVar10 = (ulong)*(byte *)puVar13 << ((ulong)uVar86 & 0x3f) | uVar10;
      iVar40 = iVar8;
      if (0x30 < iVar9) break;
      uVar86 = uVar86 - 8;
      puVar13 = puVar12;
    ...
    puVar13 = puVar12;
    if (pbVar15 != pbVar16) goto LAB_00dedd98;
    iVar40 = iVar8 + (int)pbVar16 * 8;
  ...
  if (uVar86 == 0xfffffff8 || iVar40 < 0 != SCARRY4(uVar86,8)) {
    if ((bVar7 & 1) != 0) {
      bVar7 = *(byte *)puVar12;
      *(int *)(param_1 + 3) = iVar8 + -1;
      *param_1 = (uVar10 | bVar7 >> ((ulong)uVar86 & 7)) << 1;
      return uVar10 >> 0x3f;
    }
LAB_00dede08:
    *(undefined4 *)(param_1 + 3) = 0x3fffffff;
