...
// Function: _decode<BitVector,unsigned_short,CompressedIoUtil::CompressedFileInput<unsigned_short,BufferedFileReader>>
// Entry Point: 00b98e30
// Size: 776 bytes
// Signature: void __cdecl _decode<BitVector,unsigned_short,CompressedIoUtil::CompressedFileInput<unsigned_short,BufferedFileReader>>(CompressedFileInput * param_1, uint param_2, uint param_3, BitVector * param_4)


/* void RLEUtil::_decode<BitVector, unsigned short, CompressedIoUtil::CompressedFileInput<unsigned
   short, BufferedFileReader> >(CompressedIoUtil::CompressedFileInput<unsigned short,
...

{
  ...
  if ((ulong)*(uint *)(param_1 + 0xc) + 2 <= (ulong)*(uint *)(param_1 + 8)) {
    ...
    uVar18 = 0;
    do {
      iVar7 = BufferedFileReader::readInlined(*(BufferedFileReader **)param_1,local_6c,2);
      if (iVar7 != 2) break;
      ...
      *(int *)(param_1 + 0xc) = *(int *)(param_1 + 0xc) + 2;
      ...
      if ((((local_6c[0] == uVar18) && (((uVar16 ^ 1) & 1) == 0)) &&
         ...
         && (iVar7 = BufferedFileReader::readInlined(*(BufferedFileReader **)param_1,local_70,2),
            iVar7 == 2)) {
