...
// Entry Point: 00dcf7b0
// Size: 464 bytes
// Signature: undefined __thiscall findNearestPolyInTile(dtNavMesh * this, dtMeshTile * param_1, float * param_2, float * param_3, float * param_4)
...

{
  ...
  this_00 = (dtNavMesh *)queryPolygonsInTile(this,param_1,&local_8c,&local_98,local_298,0x80);
  if ((int)this_00 < 1) {
    uVar2 = 0;
  }
  else {
    ...
    if (param_4 == (float *)0x0) {
      ...
      do {
        ...
        this_00 = (dtNavMesh *)
                  closestPointOnPolyInTile
                            (this_00,param_1,
                             uVar2 & (-1 << (ulong)(*(uint *)(this + 0x60) & 0x1f) ^ 0xffffffffU),
                             param_2,&local_2a4);
      ...
      do {
        ...
        this_00 = (dtNavMesh *)
                  closestPointOnPolyInTile
                            (this_00,param_1,
                             uVar3 & (-1 << (ulong)(*(uint *)(this + 0x60) & 0x1f) ^ 0xffffffffU),
                             param_2,&local_2a4);
        uVar6 = NEON_fmadd(local_2a4 - *param_2,local_2a4 - *param_2,
                           (fStack_2a0 - param_2[1]) * (fStack_2a0 - param_2[1]));
        fVar7 = (float)NEON_fmadd(local_29c - param_2[2],local_29c - param_2[2],uVar6);
