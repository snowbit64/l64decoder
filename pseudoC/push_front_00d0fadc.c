...
// Function: push_front
// Entry Point: 00d0fadc
// Size: 448 bytes
// Signature: undefined __thiscall push_front(__split_buffer<unsigned_int*,std::__ndk1::allocator<unsigned_int*>> * this, uint * * param_1)


/* std::__ndk1::__split_buffer<unsigned int*, std::__ndk1::allocator<unsigned int*>
   >::push_front(unsigned int*&&) */

void __thiscall
std::__ndk1::__split_buffer<unsigned_int*,std::__ndk1::allocator<unsigned_int*>>::push_front
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00d0fc64;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00d0fc4c;
      }
    }
    do {
      puVar7 = puVar6 + 1;
