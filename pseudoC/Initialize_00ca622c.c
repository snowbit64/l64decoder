...
// Function: Initialize
// Entry Point: 00ca622c
// Size: 124 bytes
// Signature: undefined __thiscall Initialize(DL_PublicKey_ECGDSA<CryptoPP::ECP> * this, DL_GroupParameters_EC * param_1, ECPPoint * param_2)


/* CryptoPP::DL_PublicKey_ECGDSA<CryptoPP::ECP>::Initialize(CryptoPP::DL_GroupParameters_EC<CryptoPP::ECP>
   const&, CryptoPP::ECPPoint const&) */

void __thiscall
CryptoPP::DL_PublicKey_ECGDSA<CryptoPP::ECP>::Initialize
          (DL_PublicKey_ECGDSA<CryptoPP::ECP> *this,DL_GroupParameters_EC *param_1,ECPPoint *param_2
          )

{
  ...
  *(undefined2 *)(this + 0x188) = *(undefined2 *)(param_1 + 0x170);
                    /* WARNING: Could not recover jumptable at 0x00ca62a4. Too many branches */
