...
// Function: applyModuleToShapeWithMask<BitVector,BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
// Entry Point: 0080c58c
// Size: 2416 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask<BitVector,BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, BitVector * param_3, ParallelogramHelper * param_4, AddDensityProcessor * param_5, DensityMapFilter * param_6)
...
/* bool DensityMapModifier::applyModuleToShapeWithMask<BitVector, BitVector, ParallelogramHelper,
   ...
   BitVector*, ParallelogramHelper&, DensityMapOperations::AddDensityProcessor<BitVector, true>&,
   DensityMapFilter const&) */

bool DensityMapModifier::
     applyModuleToShapeWithMask<BitVector,BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
    ...
    if ((uVar15 < uVar13) || (uVar16 < uVar14)) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar19 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar19 != 0
                    ...
                    /* try { // try from 0080ceb0 to 0080cebb has its CatchHandler @ 0080cf0c */
        this = (Logger *)operator_new(0x38);
                    /* try { // try from 0080cec0 to 0080cec3 has its CatchHandler @ 0080cefc */
        Logger::Logger(this);
              ...
              do {
                ...
                if ((iVar4 == 2) || ((iVar4 == 0) != ((uVar26 & uVar18) != uVar6))) {
                  ...
                  if (((int)uVar26 < iVar19) || (iVar5 < (int)uVar26)) {
                    if (DVar8 != (DensityMapFilter)0x0) goto LAB_0080cd60;
                  }
