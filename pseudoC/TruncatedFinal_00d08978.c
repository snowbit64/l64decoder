...

{
  ...
  lVar8 = (**(code **)(*(long *)this + 0xd8))(this);
  __src = (uchar *)(**(code **)(*(long *)this + 0xe0))(this);
  uVar3 = (**(code **)(*(long *)(this + 8) + 0x50))(this_00);
  uVar4 = (**(code **)(*(long *)this + 0xc0))(this);
  uVar17 = uVar3 - 8;
  iVar5 = (**(code **)(*(long *)(this + 8) + 0x50))(this_00);
  uVar7 = 0;
  if (iVar5 != 0) {
    uVar7 = iVar5 - 1;
  }
  ...
  *(undefined *)((long)__s + (ulong)uVar7) = 0x80;
  if (uVar7 < uVar17) {
    ...
    uVar6 = (**(code **)(*(long *)(this + 8) + 0x50))(this_00);
    (**(code **)(*(long *)this + 0xd0))(this,__s,uVar6);
  }
  memset(__s,0,(ulong)uVar17);
  uVar7 = *(int *)(this + 0x10) << 3;
  ...
  *(uint *)(lVar8 + ((ulong)(uVar3 >> 2) + (ulong)uVar4) * 4 + -8) = uVar7;
  uVar7 = (uint)(*(ulong *)(this + 0x10) >> 0x1d);
  uVar17 = (uVar7 & 0xff00ff00) >> 8 | (uVar7 & 0xff00ff) << 8;
  if (uVar4 != 0) {
    uVar7 = uVar17 >> 0x10 | uVar17 << 0x10;
  }
  *(uint *)(lVar8 + (~(ulong)uVar4 + (ulong)(uVar3 >> 2)) * 4) = uVar7;
  uVar6 = (**(code **)(lVar13 + 0x50))(this_00);
  (**(code **)(*(long *)this + 0xd0))(this,lVar8,uVar6);
  if ((((uint)param_1 | (uint)param_2) & 3) == 0) {
    if (uVar4 != 0) {
      if (3 < param_2) {
        ...
        if ((param_2 < 0x10) ||
          ...
          if (uVar9 == uVar11) goto LAB_00d08c20;
        }
        lVar8 = uVar9 - uVar11;
    ...
    if (__src == param_1) goto LAB_00d08c20;
  }
  else {
    ...
    if ((uVar4 != 0) && (3 < uVar7)) {
      ...
      if (uVar7 < 0x10) {
        ...
        if (uVar10 == uVar9) goto LAB_00d08c14;
      }
      lVar8 = uVar9 - uVar10;
...
LAB_00d08c20:
                    /* WARNING: Could not recover jumptable at 0x00d08c48. Too many branches */
