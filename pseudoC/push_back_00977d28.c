...
/* std::__ndk1::__split_buffer<TextureStreamingManager::ChangeRequest*,
   std::__ndk1::allocator<TextureStreamingManager::ChangeRequest*>&>::push_back(TextureStreamingManager::ChangeRequest*&&)
    */
...

{
  ...
  if (ppCVar12 != *(ChangeRequest ***)(this + 0x18)) goto LAB_00977ea8;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00977e90;
      }
    }
    do {
      ppCVar11 = ppCVar8 + 1;
