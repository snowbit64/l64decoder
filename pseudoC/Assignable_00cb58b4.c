...

{
  ...
  if (*(char *)(in_x0 + 4) == '\0') {
    ...
    if ((iVar2 == 0) &&
       (iVar2 = strcmp((char *)(__s1 + 0xb),"N8CryptoPP22DL_GroupParameters_GFPE"), iVar2 == 0)) {
      NameValuePairs::ThrowIfTypeMismatch
                ((char *)__s1,(type_info *)&DL_GroupParameters_GFP::typeinfo,(type_info *)in_x0[2]);
