...
// Function: applyModuleToShapeWithMask2<BitVector,ProceduralDensityPixelSource_const,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
// Entry Point: 007f2c9c
// Size: 3704 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,ProceduralDensityPixelSource_const,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, ProceduralDensityPixelSource * param_3, ChunkedBitSquare * param_4, ParallelogramHelper * param_5, SetDensityProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,ProceduralDensityPixelSource_const,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
    ...
    if (((uVar22 < local_98) || (uVar26 < local_94)) || ((uVar23 < local_94 || (uVar25 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar34 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar34 != 0
                    ...
                    /* try { // try from 007f3ad0 to 007f3adf has its CatchHandler @ 007f3b14 */
            ...
            do {
              ...
              if ((iVar34 == 2) || ((iVar34 == 0) != ((uVar31 & uVar17) != uVar6))) {
                ...
                if (((int)uVar31 < iVar30) || (iVar8 < (int)uVar31)) {
                  if (DVar13 != (DensityMapFilter)0x0) goto LAB_007f37c8;
                }
...
LAB_007f342c:
  ...
  if (param_6[100] != (SetDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar37,*(uint *)(param_6 + 0x1c),*(uint *)(param_6 + 0x20),
  ...
  do {
    ...
    do {
      ...
      if (*(uint *)(param_4 + 0x34) < 2) {
        uVar44 = (ulong)*(uint *)(param_4 + 0x34);
        if (iVar9 != 2) goto LAB_007f391c;
LAB_007f393c:
        uVar4 = uVar32 >> (ulong)(uVar24 & 0x1f) & uVar18;
        if (((int)uVar4 < iVar11) || (iVar12 < (int)uVar4)) {
          if (DVar14 != (DensityMapFilter)0x0) goto LAB_007f3968;
        }
...
LAB_007f3968:
        ...
        if (iVar9 == 2) goto LAB_007f393c;
LAB_007f391c:
        if ((iVar9 == 0) != ((uVar32 & uVar19) != uVar10)) goto LAB_007f393c;
      }
      uVar31 = uVar31 + 1;
      uVar2 = uVar2 + 1;
    } while (uVar31 != uVar23);
...
LAB_007f3700:
  uVar37 = uVar37 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar37) goto LAB_007f36a0;
  goto LAB_007f3714;
}
