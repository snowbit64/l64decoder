...
// Entry Point: 00cc040c
// Size: 364 bytes
// Signature: undefined __thiscall GetValueHelperClass(GetValueHelperClass<CryptoPP::DL_GroupParameters<CryptoPP::Integer>,CryptoPP::DL_GroupParameters<CryptoPP::Integer>> * this, DL_GroupParameters * param_1, char * param_2, type_info * param_3, void * param_4, NameValuePairs * param_5)


/* CryptoPP::GetValueHelperClass<CryptoPP::DL_GroupParameters<CryptoPP::Integer>,
   CryptoPP::DL_GroupParameters<CryptoPP::Integer>
   >::GetValueHelperClass(CryptoPP::DL_GroupParameters<CryptoPP::Integer> const*, char const*,
...

{
  ...
  *(undefined2 *)(this + 0x20) = 0;
  ...
  if ((iVar3 == 0) &&
     (iVar3 = strcmp(param_2 + 0xc,"N8CryptoPP18DL_GroupParametersINS_7IntegerEEE"), iVar3 == 0)) {
    NameValuePairs::ThrowIfTypeMismatch
              (param_2,(type_info *)&DL_GroupParameters<CryptoPP::Integer>*::typeinfo,
               *(type_info **)(this + 0x10));
    GVar5 = (GetValueHelperClass<CryptoPP::DL_GroupParameters<CryptoPP::Integer>,CryptoPP::DL_GroupParameters<CryptoPP::Integer>>
             )0x1;
