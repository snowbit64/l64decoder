...
// Function: process
// Entry Point: 0080d940
// Size: 388 bytes
// Signature: undefined __thiscall process(AddDensityProcessor<BitVector,true> * this, HelperSource * param_1)


/* DensityMapOperations::AddDensityProcessor<BitVector,
   true>::process(DensityMapAccessUtil::HelperSource<BitVector>&) */

void __thiscall
DensityMapOperations::AddDensityProcessor<BitVector,true>::process
          (AddDensityProcessor<BitVector,true> *this,HelperSource *param_1)

{
  ...
  uint uVar7;
  uint uVar8;
  AddDensityProcessor<BitVector,true> AVar9;
  bool bVar10;
  uint uVar11;
  ...
  *(uint *)(this + 0x54) = uVar2;
  ...
  if ((int)uVar11 < *(int *)(this + 0x3c)) {
    ...
    if ((int)uVar11 <= *(int *)(this + 0x40)) {
      if (AVar9 != (AddDensityProcessor<BitVector,true>)0x0) {
        return;
      }
      goto LAB_0080d9d8;
    }
    ...
    *(uint *)(this + 0xc) = (*(int *)(this + 0xc) - uVar11) + uVar4;
    if (uVar6 == 0xffffffff) {
      if (uVar3 != uVar4) {
        ...
        this[0x6c] = (AddDensityProcessor<BitVector,true>)0x1;
