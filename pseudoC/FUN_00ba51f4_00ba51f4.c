...
// Function: FUN_00ba51f4
// Entry Point: 00ba51f4
// Size: 440 bytes
// Signature: undefined FUN_00ba51f4(void)


void FUN_00ba51f4(void **param_1,undefined8 *param_2)

{
  ...
  if (puVar12 != (undefined8 *)param_1[3]) goto LAB_00ba5374;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00ba535c;
      }
    }
    do {
      puVar11 = puVar8 + 1;
