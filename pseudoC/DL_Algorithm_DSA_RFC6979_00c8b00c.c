...

{
  ...
  *(undefined ***)(this + 8) = &PTR__DL_Algorithm_DSA_RFC6979_00ff2818;
  ...
  if (this + 200 + ((ulong)(uint)-(int)(this + 200) & 8) == pDVar2) {
    this[0x151] = (DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA384>)0x0;
  ...
  *(undefined ***)(this + 0x10) = &PTR__IteratedHash_01000e98;
  ...
  if (pDVar2 == this + 0x28) {
    this[0xa9] = (DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA384>)0x0;
    for (; uVar1 != 0; uVar1 = uVar1 - 1) {
      *(undefined8 *)(pDVar2 + uVar1 * 8 + -8) = 0;
    }
  }
