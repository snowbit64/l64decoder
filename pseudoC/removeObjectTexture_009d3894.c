...
// Entry Point: 009d3894
// Size: 296 bytes
// Signature: undefined __thiscall removeObjectTexture(ProceduralPlacementManager * this, basic_string * param_1)


/* ProceduralPlacementManager::removeObjectTexture(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void __thiscall
ProceduralPlacementManager::removeObjectTexture
...
LAB_009d3988:
        ...
        *(size_t *)(this + 0x10) = (long)__dest + sVar2;
        return;
      }
    }
    __dest = __dest + 1;
