...
// Function: _INIT_3
// Entry Point: 00d063b4
// Size: 324 bytes
// Signature: undefined _INIT_3(void)
...

{
  ...
  DAT_02120870 = &PTR__Integer_0100c890;
  uRam0000000002120888 = 2;
  _DAT_02120880 = 0x3fffffffffffffff;
  DAT_02120890 = (undefined8 *)CryptoPP::UnalignedAllocate(8);
  DAT_02120898 = 0;
  *DAT_02120890 = 2;
  __cxa_atexit(CryptoPP::Integer::~Integer,&DAT_02120870,&PTR_LOOP_00fd8de0);
  return;
}
