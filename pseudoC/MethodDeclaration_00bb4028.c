...
// Entry Point: 00bb4028
// Size: 44 bytes
// Signature: undefined __thiscall MethodDeclaration(MethodDeclaration * this, Type param_1, Type param_2, void * param_3, Type param_4, Type param_5, Type param_6)
...

{
  ...
  *(undefined8 *)(this + 0x60) = 0x200000003;
