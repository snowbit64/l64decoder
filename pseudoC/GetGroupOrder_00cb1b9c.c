...
// Entry Point: 00cb1b9c
// Size: 192 bytes
// Signature: undefined GetGroupOrder(void)


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* CryptoPP::DL_GroupParameters<CryptoPP::ECPPoint>::GetGroupOrder() const */

void CryptoPP::DL_GroupParameters<CryptoPP::ECPPoint>::GetGroupOrder(void)

{
  ...
  (**(code **)(*in_x0 + 0xb8))(local_68);
                    /* try { // try from 00cb1be8 to 00cb1bf7 has its CatchHandler @ 00cb1c60 */
  ...
  for (; local_58 != 0; local_58 = local_58 - 1) {
    *(undefined4 *)((long)local_48 + local_58 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00cb1c30 to 00cb1c33 has its CatchHandler @ 00cb1c5c */
