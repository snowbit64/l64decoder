...
// Function: FUN_009ca92c
// Entry Point: 009ca92c
// Size: 272 bytes
// Signature: undefined FUN_009ca92c(void)


long * FUN_009ca92c(long **param_1,long *param_2)
  ...
  if (pplVar6 != (long **)0x0) {
    ...
    do {
      while( true ) {
        ...
        if (iVar3 == 0) break;
        if (-1 < iVar3) goto LAB_009ca974;
LAB_009ca9cc:
        pplVar5 = pplVar7;
        pplVar6 = (long **)*pplVar7;
        if ((long **)*pplVar7 == (long **)0x0) goto LAB_009ca9e8;
      }
      if (plVar4 < plVar1) goto LAB_009ca9cc;
LAB_009ca974:
