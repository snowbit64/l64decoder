...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<unsigned
   long long, TextureStreamingManager::Status>, void*>*>, bool>
   ...
   TextureStreamingManager::Status> > >::__emplace_unique_key_args<unsigned long long,
  ...
  if (puVar7 != (ulonglong *)0x0) {
    ...
    if (ppuVar6 != (ulonglong **)0x0) {
      do {
        ...
        if (ppuVar6 == (ulonglong **)0x0) goto LAB_00972e8c;
        puVar4 = ppuVar6[1];
        if (puVar4 != puVar8) {
          if (uVar2 < 2) {
          ...
          if (puVar4 != unaff_x24) goto LAB_00972e8c;
        }
  ...
  if ((puVar7 == (ulonglong *)0x0) ||
    ...
    if (uVar5 <= uVar2) {
      uVar5 = uVar2;
                    ...
                    /* try { // try from 00972f00 to 00972f07 has its CatchHandler @ 00972fd0 */
