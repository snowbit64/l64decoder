...

{
  ...
  *puVar3 = &PTR__DL_GroupParametersImpl_0100b6d0;
  ...
  *puVar3 = &PTR__DL_GroupParameters_IntegerBased_0100b938;
  *(undefined ***)this = &PTR__DL_GroupParameters_IntegerBased_0100ba68;
  *(undefined ***)(this + 0x10) = &PTR__Integer_0100c890;
  for (; uVar1 != 0; uVar1 = uVar1 - 1) {
    *(undefined4 *)((long)pvVar2 + uVar1 * 4 + -4) = 0;
  }
                    /* try { // try from 00cecad8 to 00cecadb has its CatchHandler @ 00cecaec */
