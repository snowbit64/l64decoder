...
// Entry Point: 008f9e64
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<ThreadPool::TaskAndMgr,std::__ndk1::allocator<ThreadPool::TaskAndMgr>> * this)
...

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_008f9ed0;
    uVar4 = 0x100;
  }
