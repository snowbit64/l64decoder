...
// Function: applyModuleToShapeWithMask2<BitVector,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
// Entry Point: 007f3b2c
// Size: 3508 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, ProceduralDensityPixelSource * param_3, BitVector * param_4, ParallelogramHelper * param_5, SetDensityProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)


/* bool DensityMapModifier::applyModuleToShapeWithMask2<BitVector, ProceduralDensityPixelSource
   const, BitVector, ParallelogramHelper, DensityMapOperations::SetDensityProcessor<BitVector, true>
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
    ...
    if (((uVar20 < local_98) || (uVar24 < local_94)) || ((uVar21 < local_94 || (uVar23 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar29 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar29 != 0
                    ...
                    /* try { // try from 007f48a4 to 007f48af has its CatchHandler @ 007f48e0 */
            ...
            do {
              ...
              if ((iVar29 == 2) || ((iVar29 == 0) != ((uVar28 & uVar15) != uVar4))) {
                ...
                if (((int)uVar28 < iVar5) || (iVar6 < (int)uVar28)) {
                  if (DVar12 != (DensityMapFilter)0x0) goto LAB_007f4624;
                }
...
LAB_007f4294:
  ...
  if (param_6[100] != (SetDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar32,*(uint *)(param_6 + 0x1c),*(uint *)(param_6 + 0x20),
    ...
    do {
      ...
      if ((iVar8 == 2) || ((iVar8 == 0) != ((uVar35 & uVar17) != uVar9))) {
        ...
        if (((int)uVar35 < iVar10) || (iVar11 < (int)uVar35)) {
          if (DVar13 != (DensityMapFilter)0x0) goto LAB_007f4754;
        }
...
LAB_007f455c:
  uVar32 = uVar32 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar32) goto LAB_007f44f4;
  goto LAB_007f4570;
}
