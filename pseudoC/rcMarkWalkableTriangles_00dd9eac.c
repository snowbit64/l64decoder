...
// Function: rcMarkWalkableTriangles
// Entry Point: 00dd9eac
// Size: 284 bytes
// Signature: undefined __cdecl rcMarkWalkableTriangles(rcContext * param_1, float param_2, float * param_3, int param_4, int * param_5, int param_6, uchar * param_7)


/* rcMarkWalkableTriangles(rcContext*, float, float const*, int, int const*, int, unsigned char*) */
...

{
  ...
  if (0 < param_6) {
    ...
    do {
      ...
      if (fVar6 < fVar8 * (1.0 / SQRT(fVar7 * fVar7 + fVar10 * fVar10 + fVar8 * fVar8))) {
        *param_7 = '?';
      }
      piVar1 = piVar1 + 3;
      param_7 = param_7 + 1;
