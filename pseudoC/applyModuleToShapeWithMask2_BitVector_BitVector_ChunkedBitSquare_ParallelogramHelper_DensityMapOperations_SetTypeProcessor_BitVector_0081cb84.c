...
// Function: applyModuleToShapeWithMask2<BitVector,BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
// Entry Point: 0081cb84
// Size: 4000 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>(IDensityPixelSource * param_1, BitVector * param_2, BitVector * param_3, ChunkedBitSquare * param_4, ParallelogramHelper * param_5, SetTypeProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
    ...
    if (((uVar21 < local_98) || (uVar26 < local_94)) || ((uVar22 < local_94 || (uVar25 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar32 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar32 != 0
                    ...
                    /* try { // try from 0081dae8 to 0081daf3 has its CatchHandler @ 0081db24 */
            ...
            do {
              ...
              if ((iVar32 == 2) || ((iVar32 == 0) != ((uVar38 & uVar15) != uVar4))) {
                ...
                if (((int)uVar38 < iVar29) || (iVar6 < (int)uVar38)) {
                  if (DVar11 != (DensityMapFilter)0x0) goto LAB_0081d7dc;
                }
...
LAB_0081d398:
  ...
  if (param_6[0x5c] != (SetTypeProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar34,*(uint *)(param_6 + 0x14),*(uint *)(param_6 + 0x18),
  ...
  do {
    ...
    do {
      ...
      if (*(uint *)(param_4 + 0x34) < 2) {
        uVar40 = (ulong)*(uint *)(param_4 + 0x34);
        if (iVar7 != 2) goto LAB_0081d930;
LAB_0081d950:
        uVar2 = uVar30 >> (ulong)(uVar24 & 0x1f) & uVar16;
        if (((int)uVar2 < iVar10) || (iVar8 < (int)uVar2)) {
          if (DVar12 != (DensityMapFilter)0x0) goto LAB_0081d97c;
        }
...
LAB_0081d97c:
        ...
        if (iVar7 == 2) goto LAB_0081d950;
LAB_0081d930:
        if ((iVar7 == 0) != ((uVar30 & uVar17) != uVar9)) goto LAB_0081d950;
      }
      uVar36 = uVar36 + 1;
      uVar45 = uVar45 + 1;
    } while (uVar36 != uVar18);
...
LAB_0081d6b8:
  uVar34 = uVar34 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar34) goto LAB_0081d64c;
  goto LAB_0081d6d0;
}
