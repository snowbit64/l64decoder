...
// Function: BinTriangles<true>
// Entry Point: 00da7ce4
// Size: 1624 bytes
// Signature: void __thiscall BinTriangles<true>(MaskedOcclusionCullingPrivate * this, float * param_1, ushort * param_2, int param_3, TriList * param_4, uint param_5, uint param_6, float * param_7, BackfaceWinding param_8, ClipPlanes param_9, VertexLayout * param_10)


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* void MaskedOcclusionCullingNEON::MaskedOcclusionCullingPrivate::BinTriangles<true>(float const*,
...
void __thiscall
MaskedOcclusionCullingNEON::MaskedOcclusionCullingPrivate::BinTriangles<true>
    ...
    do {
      do {
        ...
        GatherTransformClip<1>
                  ((int *)this,(int *)((long)&local_798 + 4),(int *)&local_798,(int)&local_7a4,
                   (int *)(ulong)(uint)param_3,(__Float32x4_t *)&local_7a8,
                   (__Float32x4_t *)local_6a0,(__Float32x4_t *)local_6d0,(float *)local_700,
                   (ushort **)param_1,(VertexLayout *)&local_7a0,(float *)param_10,
                   (__Float32x4_t *)param_7,auStack_670,(ClipPlanes)&local_7ac);
        if (local_7ac != 0) {
