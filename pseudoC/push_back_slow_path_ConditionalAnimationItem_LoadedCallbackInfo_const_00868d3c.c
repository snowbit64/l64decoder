...
// Function: __push_back_slow_path<ConditionalAnimationItem::LoadedCallbackInfo_const&>
// Entry Point: 00868d3c
// Size: 392 bytes
// Signature: void __thiscall __push_back_slow_path<ConditionalAnimationItem::LoadedCallbackInfo_const&>(vector<ConditionalAnimationItem::LoadedCallbackInfo,std::__ndk1::allocator<ConditionalAnimationItem::LoadedCallbackInfo>> * this, LoadedCallbackInfo * param_1)


/* void std::__ndk1::vector<ConditionalAnimationItem::LoadedCallbackInfo,
   std::__ndk1::allocator<ConditionalAnimationItem::LoadedCallbackInfo>
   >::__push_back_slow_path<ConditionalAnimationItem::LoadedCallbackInfo
   const&>(ConditionalAnimationItem::LoadedCallbackInfo const&) */
...
::__push_back_slow_path<ConditionalAnimationItem::LoadedCallbackInfo_const&>
          (vector<ConditionalAnimationItem::LoadedCallbackInfo,std::__ndk1::allocator<ConditionalAnimationItem::LoadedCallbackInfo>>
           *this,LoadedCallbackInfo *param_1)

{
  ...
  *puVar12 = *(undefined8 *)param_1;
                    /* try { // try from 00868de4 to 00868deb has its CatchHandler @ 00868ec4 */
