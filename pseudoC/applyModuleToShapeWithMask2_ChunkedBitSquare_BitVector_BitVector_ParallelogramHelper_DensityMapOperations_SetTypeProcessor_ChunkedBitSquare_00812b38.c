...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,BitVector,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
// Entry Point: 00812b38
// Size: 4308 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,BitVector,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
    ...
    if (((uVar21 < local_98) || (uVar26 < local_94)) || ((uVar22 < local_94 || (uVar25 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar33 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar33 != 0
                    ...
                    /* try { // try from 00813bd0 to 00813bdb has its CatchHandler @ 00813c0c */
              ...
              do {
                ...
                if ((iVar33 == 2) || ((iVar33 == 0) != ((uVar39 & uVar14) != uVar5))) {
                  ...
                  if (((int)uVar39 < iVar6) || (iVar30 < (int)uVar39)) {
                    if (DVar10 != (DensityMapFilter)0x0) goto LAB_00813898;
                  }
...
LAB_00813904:
  uVar31 = uVar31 + 1;
  uVar3 = uVar3 + uVar27;
  if (uVar31 == uVar17) goto LAB_008138cc;
  goto LAB_00813914;
LAB_008138cc:
  uVar37 = uVar37 + 1;
  uVar38 = uVar38 + uVar25 * uVar27;
  if (uVar37 == uVar35) goto LAB_0081374c;
  goto LAB_008138e4;
}
