...
// Function: __append
// Entry Point: 00ac6c44
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<SpvReflectDescriptorBinding*,std::__ndk1::allocator<SpvReflectDescriptorBinding*>> * this, ulong param_1)


/* std::__ndk1::vector<SpvReflectDescriptorBinding*,
   std::__ndk1::allocator<SpvReflectDescriptorBinding*> >::__append(unsigned long) */

void __thiscall
std::__ndk1::
vector<SpvReflectDescriptorBinding*,std::__ndk1::allocator<SpvReflectDescriptorBinding*>>::__append
