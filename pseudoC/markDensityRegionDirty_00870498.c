...
/* DensityMapVisualizationOverlay::markDensityRegionDirty(DensityMap*, unsigned int, unsigned int,
   unsigned int, unsigned int, unsigned int, bool) */

void DensityMapVisualizationOverlay::markDensityRegionDirty
