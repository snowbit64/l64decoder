...

{
  ...
  *(undefined ***)(this + 8) = &PTR__DL_Algorithm_DSA_RFC6979_00ff2718;
  ...
  if (this + 0x80 + ((ulong)(uint)-(int)(this + 0x80) & 8) == pDVar2) {
    this[0xc9] = (DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA224>)0x0;
  ...
  *(undefined ***)(this + 0x10) = &PTR__IteratedHash_00fe9de8;
  ...
  if (pDVar2 == this + 0x20) {
    this[0x61] = (DL_Algorithm_DSA_RFC6979<CryptoPP::Integer,CryptoPP::SHA224>)0x0;
    for (; uVar1 != 0; uVar1 = uVar1 - 1) {
      *(undefined4 *)(pDVar2 + uVar1 * 4 + -4) = 0;
    }
  }
