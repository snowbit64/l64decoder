...
// Function: checkTypedModuleMasks<ProceduralDensityPixelSource_const,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
// Entry Point: 00833ab4
// Size: 704 bytes
// Signature: bool __cdecl checkTypedModuleMasks<ProceduralDensityPixelSource_const,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>(TypedModuleWithMasks * param_1, IDensityPixelSource * param_2, uint param_3, uint param_4, HelperSource * param_5, IDensityPixelSource * param_6, uint param_7, uint param_8, uint param_9, uint param_10, uint param_11)
...
bool DensityMapModifier::
     checkTypedModuleMasks<ProceduralDensityPixelSource_const,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
...
joined_r0x00833bd4:
      ...
      TVar1 = param_1[0x98];
      if (*(int *)(param_1 + 0x94) < (int)uVar9) goto joined_r0x00833bd4;
      if (TVar1 != (TypedModuleWithMasks)0x0) {
        return false;
      }
    }
  ...
  else if (*(IDensityPixelSource **)(param_1 + 0xa8) == param_2) goto LAB_00833c08;
...
joined_r0x00833bbc:
    ...
    TVar1 = param_1[200];
    if (*(int *)(param_1 + 0xc4) < (int)uVar9) goto joined_r0x00833bbc;
    if (TVar1 != (TypedModuleWithMasks)0x0) {
      return false;
    }
  }
        ...
        *(uint *)(param_5 + 0x20) = uVar6;
        ...
        if ((*(int *)(param_1 + 0x80) == 2) ||
          ...
          if ((int)uVar6 < *(int *)(param_1 + 0x90)) {
            TVar1 = param_1[0x98];
joined_r0x00833ce0:
            if (TVar1 == (TypedModuleWithMasks)0x0) goto LAB_00833c44;
          }
          else {
            TVar1 = param_1[0x98];
            if (*(int *)(param_1 + 0x94) < (int)uVar6) goto joined_r0x00833ce0;
            if (TVar1 != (TypedModuleWithMasks)0x0) goto LAB_00833c44;
          }
