...
// Function: __append
// Entry Point: 00ab36f0
// Size: 516 bytes
// Signature: undefined __thiscall __append(vector<std::__ndk1::vector<VkImageView_T*,std::__ndk1::allocator<VkImageView_T*>>,std::__ndk1::allocator<std::__ndk1::vector<VkImageView_T*,std::__ndk1::allocator<VkImageView_T*>>>> * this, ulong param_1)


/* std::__ndk1::vector<std::__ndk1::vector<VkImageView_T*, std::__ndk1::allocator<VkImageView_T*> >,
   std::__ndk1::allocator<std::__ndk1::vector<VkImageView_T*, std::__ndk1::allocator<VkImageView_T*>
