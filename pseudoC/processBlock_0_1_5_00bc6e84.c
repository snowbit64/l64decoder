...
// Function: processBlock_0_1_5
// Entry Point: 00bc6e84
// Size: 1812 bytes
// Signature: undefined __cdecl processBlock_0_1_5(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_0_1_5(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_0_1_5(CustomCipher *param_1,uchar *param_2)

{
  ...
  uVar18 = uVar1 >> 0xf | uVar1 << 0x11;
  uVar14 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar18 >> 8 ^ uVar5 >> 0x10) & 0x3f) * 4) |
            (&s_wPS)[(uVar18 >> 0xc ^ uVar5 >> 0x18) & 0x3f] |
            *(uint *)(&DAT_0211ea98 + (ulong)((uVar18 >> 4 ^ uVar5 >> 8) & 0x3f) * 4) |
           *(uint *)(&DAT_0211eb98 + (ulong)((uVar18 ^ uVar5) & 0x3f) * 4)) ^ uVar14 ^
           ...
           *(uint *)(&DAT_0211ef98 + (ulong)((uVar15 ^ uVar18 >> 0x10) & 0x3f) * 4));
  uVar15 = uVar14 >> 0xf | uVar14 << 0x11;
  uVar1 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar15 >> 8 ^ uVar17 >> 0x10) & 0x3f) * 4) |
           (&s_wPS)[(uVar15 >> 0xc ^ uVar17 >> 0x18) & 0x3f] |
           *(uint *)(&DAT_0211ea98 + (ulong)((uVar15 >> 4 ^ uVar17 >> 8) & 0x3f) * 4) |
          *(uint *)(&DAT_0211eb98 + (ulong)((uVar15 ^ uVar17) & 0x3f) * 4)) ^ uVar1 ^
          (*(uint *)(&DAT_0211ed98 + (ulong)((uVar2 >> 0x10 ^ uVar14 >> 7) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ec98 + (ulong)((uVar2 >> 0x18 ^ uVar14 >> 0xb) & 0x3f) * 4) |
           *(uint *)(&DAT_0211ee98 + (ulong)((uVar2 >> 8 ^ uVar14 >> 3) & 0x3f) * 4) |
          *(uint *)(&DAT_0211ef98 + (ulong)((uVar2 ^ uVar15 >> 0x10) & 0x3f) * 4));
  uVar2 = *(uint *)(s_wO_L4 + (ulong)(uVar1 & 0xf) * 4) |
          *(int *)(s_wO_L4 + (ulong)(uVar14 & 0xf) * 4) << 1 |
          *(int *)(s_wO_L4 + (ulong)(uVar14 >> 8 & 0xf) * 4) << 3 |
          *(int *)(s_wO_L4 + (ulong)(uVar1 >> 8 & 0xf) * 4) << 2 |
          *(int *)(s_wO_L4 + (ulong)(uVar14 >> 0x10 & 0xf) * 4) << 5 |
          *(int *)(s_wO_L4 + (ulong)(uVar1 >> 0x10 & 0xf) * 4) << 4 |
          *(int *)(s_wO_L4 + (ulong)(uVar14 >> 0x18 & 0xf) * 4) << 7 |
          *(int *)(s_wO_L4 + (ulong)(uVar1 >> 0x18 & 0xf) * 4) << 6;
  uVar14 = *(uint *)(s_wO_L4 + (ulong)(uVar1 >> 4 & 0xf) * 4) |
           *(int *)(s_wO_L4 + (ulong)(uVar14 >> 4 & 0xf) * 4) << 1 |
           *(int *)(s_wO_L4 + (ulong)(uVar14 >> 0xc & 0xf) * 4) << 3 |
           *(int *)(s_wO_L4 + (ulong)(uVar1 >> 0xc & 0xf) * 4) << 2 |
           *(int *)(s_wO_L4 + (ulong)(uVar14 >> 0x14 & 0xf) * 4) << 5 |
           *(int *)(s_wO_L4 + (ulong)(uVar1 >> 0x14 & 0xf) * 4) << 4 |
           *(int *)(s_wO_L4 + (ulong)(uVar14 >> 0x1c) * 4) << 7 |
