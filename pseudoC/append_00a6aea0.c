...
// Function: __append
// Entry Point: 00a6aea0
// Size: 420 bytes
// Signature: undefined __thiscall __append(vector<FoliageCellGeometry::RenderPartitionInfo,std::__ndk1::allocator<FoliageCellGeometry::RenderPartitionInfo>> * this, ulong param_1)


/* std::__ndk1::vector<FoliageCellGeometry::RenderPartitionInfo,
   std::__ndk1::allocator<FoliageCellGeometry::RenderPartitionInfo> >::__append(unsigned long) */
