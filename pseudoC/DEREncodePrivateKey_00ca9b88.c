...
// Entry Point: 00ca9b88
// Size: 272 bytes
// Signature: undefined __thiscall DEREncodePrivateKey(DL_PrivateKey_EC<CryptoPP::ECP> * this, BufferedTransformation * param_1)


/* CryptoPP::DL_PrivateKey_EC<CryptoPP::ECP>::DEREncodePrivateKey(CryptoPP::BufferedTransformation&)
   const */

void __thiscall
CryptoPP::DL_PrivateKey_EC<CryptoPP::ECP>::DEREncodePrivateKey
          (DL_PrivateKey_EC<CryptoPP::ECP> *this,BufferedTransformation *param_1)

{
  ...
  ppuStack_90 = &PTR__DERSequenceEncoder_01000e20;
                    /* try { // try from 00ca9be0 to 00ca9c67 has its CatchHandler @ 00ca9c98 */
