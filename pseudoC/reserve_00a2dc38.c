...
// Function: reserve
// Entry Point: 00a2dc38
// Size: 208 bytes
// Signature: undefined __thiscall reserve(vector<RenderQueueItemSortKey,std::__ndk1::allocator<RenderQueueItemSortKey>> * this, ulong param_1)
...
void __thiscall
std::__ndk1::vector<RenderQueueItemSortKey,std::__ndk1::allocator<RenderQueueItemSortKey>>::reserve
