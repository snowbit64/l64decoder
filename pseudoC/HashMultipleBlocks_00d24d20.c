...
// Entry Point: 00d24d20
// Size: 348 bytes
// Signature: undefined __thiscall HashMultipleBlocks(SHA1 * this, uint * param_1, ulong param_2)


/* CryptoPP::SHA1::HashMultipleBlocks(unsigned int const*, unsigned long) */

ulong __thiscall CryptoPP::SHA1::HashMultipleBlocks(SHA1 *this,uint *param_1,ulong param_2)

{
  ...
  if (iVar2 == 0) {
    do {
      FUN_00d23d80(*(undefined8 *)(this + 200),param_1);
