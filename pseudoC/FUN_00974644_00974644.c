...
// Function: FUN_00974644
// Entry Point: 00974644
// Size: 1780 bytes
// Signature: undefined FUN_00974644(void)


void FUN_00974644(undefined8 *param_1,undefined8 *param_2)
...
LAB_00974698:
    while( true ) {
      ...
      case 0:
      case 1:
        goto switchD_00974a6c_caseD_0;
      case 2:
        puVar15 = param_2 + -3;
        if ((*(int *)param_1 < *(int *)puVar15) ||
        ...
        goto switchD_00974a6c_caseD_0;
      case 3:
        FUN_00974d38(param_1,param_1 + 3,puVar14);
        goto switchD_00974a6c_caseD_0;
      case 4:
        puVar15 = param_1 + 3;
        puVar14 = param_1 + 6;
        FUN_00974d38(param_1,puVar15,puVar14);
        puVar8 = param_2 + -3;
        ...
        goto switchD_00974a6c_caseD_0;
      case 5:
        FUN_00974ee0(param_1,param_1 + 3,param_1 + 6,param_1 + 9,puVar14);
        goto switchD_00974a6c_caseD_0;
      }
      if ((long)uVar7 < 0x2e8) {
        FUN_00974d38(param_1,param_1 + 3,param_1 + 6);
        if (param_1 + 9 == param_2) goto switchD_00974a6c_caseD_0;
        lVar11 = 0;
        puVar15 = param_1 + 9;
        puVar14 = param_1 + 6;
        goto LAB_00974c34;
      ...
      if (uVar7 < 0x5da9) {
        ...
        iVar4 = FUN_00974d38(param_1,puVar15,puVar14);
      }
      else {
        puVar15 = param_1 + (uVar7 / 0x30) * 3;
        iVar4 = FUN_00974ee0(param_1,param_1 + (uVar7 / 0x60) * 3,puVar15,
      ...
      puVar8 = param_1 + 3;
      if ((iVar13 <= *(int *)puVar14) &&
         ((iVar13 != *(int *)puVar14 || ((double)param_2[-2] <= (double)param_1[1])))) {
        while( true ) {
          if (puVar8 == puVar14) goto switchD_00974a6c_caseD_0;
          if ((*(int *)puVar8 < iVar13) ||
      ...
      while( true ) {
        ...
        iVar13 = *(int *)puVar8;
        puVar15 = puVar8;
        while ((iVar4 <= iVar13 && ((iVar4 != iVar13 || ((double)puVar15[1] <= (double)param_1[1])))
               )) {
          puVar15 = puVar15 + 3;
          iVar13 = *(int *)puVar15;
        }
...
LAB_0097472c:
    ...
    if (iVar4 != 0) goto LAB_00974a04;
    uVar7 = FUN_00975174(param_1,puVar9);
    uVar5 = FUN_00975174(puVar9 + 3,param_2);
    if ((uVar5 & 1) == 0) goto code_r0x00974a00;
    param_2 = puVar9;
  } while ((uVar7 & 1) == 0);
  goto switchD_00974a6c_caseD_0;
LAB_00974c34:
...
LAB_00974a04:
    if (((long)param_2 - (long)puVar9 >> 3) * -0x5555555555555555 <=
      ...
      FUN_00974644(puVar9 + 3,param_2);
      param_2 = puVar9;
      goto LAB_0097468c;
    }
    FUN_00974644(param_1,puVar9);
    puVar15 = puVar9 + 3;
  }
  goto LAB_00974698;
}
