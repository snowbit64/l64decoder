...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 007fb3e4
// Size: 4396 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
    ...
    if (((uVar21 < local_98) || (uVar26 < local_94)) || ((uVar22 < local_94 || (uVar25 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar34 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar34 != 0
                    ...
                    /* try { // try from 007fc4d4 to 007fc4df has its CatchHandler @ 007fc510 */
            ...
            do {
              ...
              if ((iVar6 == 2) || ((iVar6 == 0) != ((uVar40 & uVar15) != uVar7))) {
                ...
                if (((int)uVar40 < iVar34) || (iVar29 < (int)uVar40)) {
                  if (DVar11 != (DensityMapFilter)0x0) goto LAB_007fc114;
                }
...
LAB_007fbd28:
  ...
  if (param_6[0x6c] != (AddDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar38,*(uint *)(param_6 + 0x24),*(uint *)(param_6 + 0x28),
...
LAB_007fc27c:
      ...
      if (iVar10 == 2) goto LAB_007fc27c;
LAB_007fc25c:
      if ((iVar10 == 0) != ((uVar30 & uVar17) != uVar9)) goto LAB_007fc27c;
LAB_007fc184:
      uVar32 = uVar32 + 1;
      uVar4 = uVar4 + 1;
    } while (uVar32 != uVar36);
...
LAB_007fbfd4:
  uVar38 = uVar38 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar38) goto LAB_007fbf64;
  goto LAB_007fbffc;
}
