...
// Function: __append
// Entry Point: 00a2aca4
// Size: 420 bytes
// Signature: undefined __thiscall __append(vector<LightListRasterizer::ZExtent,std::__ndk1::allocator<LightListRasterizer::ZExtent>> * this, ulong param_1)


/* std::__ndk1::vector<LightListRasterizer::ZExtent,
   std::__ndk1::allocator<LightListRasterizer::ZExtent> >::__append(unsigned long) */

void __thiscall
std::__ndk1::
vector<LightListRasterizer::ZExtent,std::__ndk1::allocator<LightListRasterizer::ZExtent>>::__append
