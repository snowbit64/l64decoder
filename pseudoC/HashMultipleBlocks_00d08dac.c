...
// Entry Point: 00d08dac
// Size: 656 bytes
// Signature: undefined __thiscall HashMultipleBlocks(IteratedHashBase<unsigned_int,CryptoPP::MessageAuthenticationCode> * this, uint * param_1, ulong param_2)


/* CryptoPP::IteratedHashBase<unsigned int,
   CryptoPP::MessageAuthenticationCode>::HashMultipleBlocks(unsigned int const*, unsigned long) */

ulong __thiscall
CryptoPP::IteratedHashBase<unsigned_int,CryptoPP::MessageAuthenticationCode>::HashMultipleBlocks
...

{
  ...
  __dest = (uint *)(**(code **)(*(long *)this + 0xd8))(this);
  uVar13 = __n >> 2;
  if (iVar4 == 0) {
    lVar12 = 0;
    do {
      ...
      do {
        if (((ulong)puVar6 & 3) == 0) {
          if (uVar11 < 0x10) {
            ...
            uVar8 = uVar14;
            if (uVar13 == uVar14) goto LAB_00d08eec;
          }
          do {
            uVar1 = uVar8 + 1;
