...
// Function: push_front
// Entry Point: 009011ac
// Size: 448 bytes
// Signature: undefined __thiscall push_front(__split_buffer<TransformGroup**,std::__ndk1::allocator<TransformGroup**>> * this, TransformGroup * * * param_1)


/* std::__ndk1::__split_buffer<TransformGroup**, std::__ndk1::allocator<TransformGroup**>
   >::push_front(TransformGroup** const&) */

void __thiscall
std::__ndk1::__split_buffer<TransformGroup**,std::__ndk1::allocator<TransformGroup**>>::push_front
          (__split_buffer<TransformGroup**,std::__ndk1::allocator<TransformGroup**>> *this,
          TransformGroup ***param_1)

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00901334;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_0090131c;
      }
    }
    do {
      puVar7 = puVar6 + 1;
