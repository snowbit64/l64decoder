...
// Function: push_back
// Entry Point: 009006c8
// Size: 440 bytes
// Signature: undefined __thiscall push_back(__split_buffer<TransformGroup**,std::__ndk1::allocator<TransformGroup**>> * this, TransformGroup * * * param_1)


/* std::__ndk1::__split_buffer<TransformGroup**, std::__ndk1::allocator<TransformGroup**>
   >::push_back(TransformGroup**&&) */

void __thiscall
std::__ndk1::__split_buffer<TransformGroup**,std::__ndk1::allocator<TransformGroup**>>::push_back
...

{
  ...
  if (puVar12 != *(undefined8 **)(this + 0x18)) goto LAB_00900848;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00900830;
      }
    }
    do {
      puVar11 = puVar8 + 1;
