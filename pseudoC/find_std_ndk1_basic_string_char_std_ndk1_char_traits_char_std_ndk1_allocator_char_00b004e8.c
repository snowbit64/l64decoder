...

{
  ...
  if ((*(byte *)param_1 & 1) == 0) {
    ...
    uVar7 = (ulong)(*(byte *)param_1 >> 1);
                    ...
                    /* try { // try from 00b00534 to 00b0053b has its CatchHandler @ 00b006a4 */
      ...
      if (plVar10 != (long *)0x0) {
        do {
          ...
          if (uVar7 == uVar9) {
            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                while (*(char *)((long)plVar10 + uVar9 + 0x11) == *(char *)((long)pvVar2 + uVar9)) {
                  uVar9 = uVar9 + 1;
                  if (bVar3 >> 1 == uVar9) goto LAB_00b0066c;
                }
              }
            ...
            if (uVar9 != uVar13) goto LAB_00b00668;
          }
