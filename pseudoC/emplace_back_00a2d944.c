...
// Entry Point: 00a2d944
// Size: 272 bytes
// Signature: void emplace_back<>(void)


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void std::__ndk1::vector<RenderQueueItemAllocator::TextureSetBucket,
   std::__ndk1::allocator<RenderQueueItemAllocator::TextureSetBucket> >::emplace_back<>() */
