...
// Function: growTables
// Entry Point: 00f786d8
// Size: 872 bytes
// Signature: undefined __cdecl growTables(btHashPtr * param_1)


/* btHashMap<btHashPtr, int>::growTables(btHashPtr const&) */

void btHashMap<btHashPtr,int>::growTables(btHashPtr *param_1)
  ...
  if (*(int *)(param_1 + 8) < (int)uVar3) {
    ...
    if ((int)uVar11 < 1) {
      ...
      if ((uVar11 < 8) || ((uVar6 < uVar7 + uVar8 * 4 && (uVar7 < uVar6 + uVar8 * 4)))) {
        ...
        if (uVar12 == uVar8) goto LAB_00f787f8;
      }
      lVar9 = uVar8 - uVar12;
...
LAB_00f787f8:
  ...
  *(uint *)(param_1 + 4) = uVar3;
  if ((int)uVar3 <= (int)uVar11) goto LAB_00f78988;
  ...
  if (*(int *)(param_1 + 0x28) < (int)uVar3) {
    ...
    if ((int)uVar11 < 1) {
      ...
      if ((uVar11 < 8) || ((uVar6 < uVar7 + uVar8 * 4 && (uVar7 < uVar6 + uVar8 * 4)))) {
        ...
        if (uVar12 == uVar8) goto LAB_00f7893c;
      }
      lVar10 = uVar8 - uVar12;
      puVar13 = (undefined4 *)(uVar7 + uVar12 * 4);
      puVar14 = (undefined4 *)(uVar6 + uVar12 * 4);
