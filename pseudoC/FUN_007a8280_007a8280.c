...
// Function: FUN_007a8280
// Entry Point: 007a8280
// Size: 400 bytes
// Signature: undefined FUN_007a8280(void)


void FUN_007a8280(RawTransformGroup *param_1,undefined4 *param_2)

{
  ...
  if (puVar4 != (undefined8 *)0x0) {
    uStack_68 = puVar4[1];
    local_70._0_4_ = (undefined4)*puVar4;
    local_58 = puVar4[3];
    local_60 = puVar4[2];
  }
  local_70 = CONCAT26((short)param_2[4],CONCAT24((short)*param_2,(undefined4)local_70));
  if (((VisibilityConditionManager::getInstance()::instance & 1) == 0) &&
    ...
    VisibilityConditionManager::getInstance()::instance = &DAT_0107c5b8;
                    /* try { // try from 007a837c to 007a8387 has its CatchHandler @ 007a8420 */
  ...
  if (((VisibilityConditionManager::getInstance()::instance & 1) == 0) &&
    ...
    DAT_0107c5b8 = 0;
    VisibilityConditionManager::getInstance()::instance = &DAT_0107c5b8;
                    /* try { // try from 007a83d4 to 007a83df has its CatchHandler @ 007a8410 */
    Mutex::Mutex((Mutex *)&DAT_0107c5c8,true);
    __cxa_atexit(VisibilityConditionManager::~VisibilityConditionManager,
                 &VisibilityConditionManager::getInstance()::instance,&PTR_LOOP_00fd8de0);
    __cxa_guard_release(&VisibilityConditionManager::getInstance()::instance);
