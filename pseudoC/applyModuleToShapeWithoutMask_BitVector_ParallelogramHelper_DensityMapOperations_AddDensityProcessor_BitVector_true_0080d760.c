...
// Function: applyModuleToShapeWithoutMask<BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
// Entry Point: 0080d760
// Size: 480 bytes
// Signature: bool __cdecl applyModuleToShapeWithoutMask<BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, ParallelogramHelper * param_3, AddDensityProcessor * param_4)
...
bool DensityMapModifier::
     applyModuleToShapeWithoutMask<BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
...

{
    ...
    do {
      ...
      for (uVar3 = *(uint *)(param_3 + 0x58); uVar3 < uVar4; uVar3 = uVar3 + 1) {
        ...
        DensityMapOperations::AddDensityProcessor<BitVector,true>::process
                  ((AddDensityProcessor<BitVector,true> *)param_4,(HelperSource *)&local_80);
        if (uVar4 != local_60) {
  ...
  if (param_4[0x6c] != (AddDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_3 + 0x54),uVar3,*(uint *)(param_4 + 0x24),*(uint *)(param_4 + 0x28),
