...
// Function: applyModuleToShapeWithMask2<BitVector,BitVector,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
// Entry Point: 0081db3c
// Size: 3764 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,BitVector,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>(IDensityPixelSource * param_1, BitVector * param_2, BitVector * param_3, BitVector * param_4, ParallelogramHelper * param_5, SetTypeProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,BitVector,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
    ...
    if (((uVar21 < local_98) || (uVar26 < local_94)) || ((uVar22 < local_94 || (uVar25 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar29 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar29 != 0
                    ...
                    /* try { // try from 0081e9b4 to 0081e9bf has its CatchHandler @ 0081e9f0 */
            ...
            do {
              ...
              if ((iVar29 == 2) || ((iVar29 == 0) != ((uVar37 & uVar15) != uVar4))) {
                ...
                if (((int)uVar37 < iVar5) || (iVar6 < (int)uVar37)) {
                  if (DVar12 != (DensityMapFilter)0x0) goto LAB_0081e744;
                }
    ...
    do {
      ...
      if ((iVar8 == 2) || ((iVar8 == 0) != ((uVar37 & uVar17) != uVar10))) {
        ...
        if (((int)uVar37 < iVar11) || (iVar9 < (int)uVar37)) {
          if (DVar13 != (DensityMapFilter)0x0) goto LAB_0081e864;
        }
...
LAB_0081e620:
  uVar34 = uVar34 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar34) goto LAB_0081e5b8;
  goto LAB_0081e634;
}
