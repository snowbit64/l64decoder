...
// Function: FUN_00bf3ddc
// Entry Point: 00bf3ddc
// Size: 440 bytes
// Signature: undefined FUN_00bf3ddc(void)


void FUN_00bf3ddc(void **param_1,undefined8 *param_2)

{
  ...
  if (puVar12 != (undefined8 *)param_1[3]) goto LAB_00bf3f5c;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00bf3f44;
      }
    }
    do {
      puVar11 = puVar8 + 1;
