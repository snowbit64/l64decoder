...
// Entry Point: 00c80650
// Size: 520 bytes
// Signature: undefined __thiscall GenerateBlock(AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,CryptoPP::CTR_ModePolicy>> * this, uchar * param_1, ulong param_2)


/* CryptoPP::AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,
   CryptoPP::CTR_ModePolicy> >::GenerateBlock(unsigned char*, unsigned long) */

void __thiscall
CryptoPP::
AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,CryptoPP::CTR_ModePolicy>>
::GenerateBlock(AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,CryptoPP::CTR_ModePolicy>>
...

{
  ...
  if (uVar8 != 0) {
    ...
    memcpy(param_1,(void *)((*(long *)(this + 0x80) + *(long *)(this + 0x78)) - uVar8),__n);
    param_2 = param_2 - __n;
    *(size_t *)(this + 0x88) = *(long *)(this + 0x88) - __n;
    if (param_2 == 0) goto LAB_00c8079c;
    param_1 = param_1 + __n;
  }
  plVar4 = (long *)(**(code **)(*(long *)this + 0x100))(this);
  ...
  if (param_2 != 0) {
    if (-uVar8 < param_2) {
      puVar5 = (undefined8 *)__cxa_allocate_exception(0x28);
                    /* try { // try from 00c807d4 to 00c807db has its CatchHandler @ 00c80894 */
      ...
      *(undefined4 *)(puVar5 + 1) = 1;
                    /* try { // try from 00c80824 to 00c8082b has its CatchHandler @ 00c80874 */
      std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
      basic_string((basic_string *)(puVar5 + 2));
      *puVar5 = &PTR__Exception_00fe9ee0;
                    /* try { // try from 00c8083c to 00c80853 has its CatchHandler @ 00c80858 */
    ...
    (**(code **)(*plVar4 + 0x30))
              (plVar4,(*(long *)(this + 0x80) + *(long *)(this + 0x78)) - uVar9,uVar1);
    memcpy(param_1,(void *)((*(long *)(this + 0x80) + *(long *)(this + 0x78)) - uVar9),param_2);
    *(ulong *)(this + 0x88) = uVar9 - param_2;
  }
LAB_00c8079c:
