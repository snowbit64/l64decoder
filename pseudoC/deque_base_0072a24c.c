...
// Entry Point: 0072a24c
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<std::__ndk1::pair<unsigned_short,unsigned_short>,std::__ndk1::allocator<std::__ndk1::pair<unsigned_short,unsigned_short>>> * this)


/* std::__ndk1::__deque_base<std::__ndk1::pair<unsigned short, unsigned short>,
   std::__ndk1::allocator<std::__ndk1::pair<unsigned short, unsigned short> > >::~__deque_base() */
...

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_0072a2b8;
    uVar4 = 0x400;
  }
