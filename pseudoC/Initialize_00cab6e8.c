...
// Function: Initialize
// Entry Point: 00cab6e8
// Size: 188 bytes
// Signature: undefined __thiscall Initialize(DL_PrivateKey_ECGDSA<CryptoPP::EC2N> * this, RandomNumberGenerator * param_1, EC2N * param_2, EC2NPoint * param_3, Integer * param_4)
...
CryptoPP::DL_PrivateKey_ECGDSA<CryptoPP::EC2N>::Initialize
          (DL_PrivateKey_ECGDSA<CryptoPP::EC2N> *this,RandomNumberGenerator *param_1,EC2N *param_2,
...

{
  ...
  DL_GroupParameters_EC<CryptoPP::EC2N>::DL_GroupParameters_EC
            ((DL_GroupParameters_EC<CryptoPP::EC2N> *)local_248,param_2,param_3,param_4,pIVar2);
                    /* try { // try from 00cab758 to 00cab763 has its CatchHandler @ 00cab7a4 */
  (**(code **)(*(long *)this + 0x48))
