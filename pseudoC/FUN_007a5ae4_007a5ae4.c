...
// Function: FUN_007a5ae4
// Entry Point: 007a5ae4
// Size: 172 bytes
// Signature: undefined FUN_007a5ae4(void)


void FUN_007a5ae4(TransformGroup *param_1,undefined4 *param_2)

{
  ...
  if (((*(uint *)(lVar2 + 8) ^ 0xffffffff) & 0x88) == 0) {
    ...
    Bt2ScenegraphPhysicsContext::enqueueAddForce
              (this,param_1,(Vector3 *)&local_48,(Vector3 *)&local_58,*(bool *)(param_2 + 0x18),true
              );
  }
