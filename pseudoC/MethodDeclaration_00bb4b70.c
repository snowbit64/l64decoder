...
// Entry Point: 00bb4b70
// Size: 48 bytes
// Signature: undefined __thiscall MethodDeclaration(MethodDeclaration * this, Type param_1, Type param_2, Type param_3, Type param_4, Type param_5, void * param_6, Type param_7)


/* MethodDeclaration::MethodDeclaration(Value::Type, Value::Type, Value::Type, Value::Type,
   Value::Type, void*, Value::Type) */

void __thiscall
MethodDeclaration::MethodDeclaration
          (MethodDeclaration *this,Type param_1,Type param_2,Type param_3,Type param_4,Type param_5,
          void *param_6,Type param_7)

{
  ...
  *(Type *)(this + 8) = param_7;
  *(undefined8 *)(this + 0x60) = 0x500000001;
