...
// Function: applyModuleToShapeWithMask<BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
// Entry Point: 007f55d0
// Size: 2464 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask<BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, ChunkedBitSquare * param_3, ParallelogramHelper * param_4, SetDensityProcessor * param_5, DensityMapFilter * param_6)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask<BitVector,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
    ...
    if ((uVar16 < uVar14) || (uVar17 < uVar15)) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar23 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar23 != 0
                    ...
                    /* try { // try from 007f5f2c to 007f5f33 has its CatchHandler @ 007f5f80 */
        this = (Logger *)operator_new(0x38);
                    /* try { // try from 007f5f38 to 007f5f3b has its CatchHandler @ 007f5f70 */
        Logger::Logger(this);
            ...
            do {
              ...
              do {
                ...
                if (*(uint *)(param_3 + 0x34) < 2) {
                  uVar31 = (ulong)*(uint *)(param_3 + 0x34);
                  if (iVar23 != 2) goto LAB_007f5d88;
LAB_007f5da8:
                  uVar4 = uVar21 >> (ulong)(uVar5 & 0x1f) & uVar10;
                  if (((int)uVar4 < iVar20) || (iVar7 < (int)uVar4)) {
                    if (DVar8 != (DensityMapFilter)0x0) goto LAB_007f5dd4;
                  }
...
LAB_007f5dd4:
                    if ((uVar18 == 0) || ((uVar4 & uVar18) != 0)) {
                      ...
                      DensityMapOperations::SetDensityProcessor<BitVector,true>::process
                                ((SetDensityProcessor<BitVector,true> *)param_5,
                  ...
                  if (iVar23 == 2) goto LAB_007f5da8;
LAB_007f5d88:
                  if ((iVar23 == 0) != ((uVar21 & uVar11) != uVar6)) goto LAB_007f5da8;
                }
                uVar28 = uVar28 + 1;
                uVar2 = uVar2 + 1;
              } while (uVar28 != uVar26);
        ...
        if (uVar15 < *(uint *)(param_4 + 0x5c)) {
          ...
          do {
            ...
            if ((((iVar23 == 2) || ((iVar23 == 0) != ((uVar19 & uVar11) != uVar6))) &&
              ...
              local_78 = uVar17;
              DensityMapOperations::SetDensityProcessor<BitVector,true>::process
                        ((SetDensityProcessor<BitVector,true> *)param_5,(HelperSource *)&local_98);
              if (uVar17 != local_78) {
                DensityMapAccessUtil::writeValue
