...
// Function: convertPixels<PixelFormatConverter::BGRA32toRGBA32>
// Entry Point: 00a9f090
// Size: 280 bytes
// Signature: void __cdecl convertPixels<PixelFormatConverter::BGRA32toRGBA32>(void * param_1, uint param_2, void * param_3, uint param_4, uint param_5, uint param_6)


/* void PixelFormatConverter::convertPixels<PixelFormatConverter::BGRA32toRGBA32>(void const*,
   unsigned int, void*, unsigned int, unsigned int, unsigned int) */

void PixelFormatConverter::convertPixels<PixelFormatConverter::BGRA32toRGBA32>
    ...
    do {
      if (uVar3 != 0) {
        if ((uVar3 < 8) ||
          ...
          uVar5 = uVar8;
          if (uVar8 == uVar7) goto LAB_00a9f0cc;
        }
        do {
          uVar12 = uVar5 + 1;
