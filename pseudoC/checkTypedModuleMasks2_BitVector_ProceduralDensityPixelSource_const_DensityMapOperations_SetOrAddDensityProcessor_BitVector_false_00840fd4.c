...
// Function: checkTypedModuleMasks2<BitVector,ProceduralDensityPixelSource_const,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>
// Entry Point: 00840fd4
// Size: 1184 bytes
...
bool DensityMapModifier::
     checkTypedModuleMasks2<BitVector,ProceduralDensityPixelSource_const,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>
...
joined_r0x008410f0:
      ...
      TVar10 = param_1[0x98];
      if (*(int *)(param_1 + 0x94) < (int)uVar23) goto joined_r0x008410f0;
      if (TVar10 != (TypedModuleWithMasks)0x0) {
        return false;
      }
    }
    ...
    local_70 = *(IDensityPixelSource **)(param_1 + 0xa8);
    if (local_70 == param_2) goto LAB_00841124;
  }
...
joined_r0x008410d8:
    ...
    TVar10 = param_1[200];
    if (*(int *)(param_1 + 0xc4) < (int)uVar23) goto joined_r0x008410d8;
    if (TVar10 != (TypedModuleWithMasks)0x0) {
      return false;
    }
  }
          ...
          *(uint *)(param_5 + 0x20) = uVar16;
          if ((bool)(bVar12 | pIVar18 != param_6)) {
            ...
            if (((int)uVar16 < iVar5) || (iVar8 < (int)uVar16)) {
              if (TVar10 != (TypedModuleWithMasks)0x0) goto LAB_008413fc;
            }
        ...
        *(uint *)(param_12 + 0x20) = uVar15;
        ...
        if ((*(IDensityPixelSource **)(param_1 + 0x78) == param_13) &&
          ...
          if ((int)uVar15 < *(int *)(param_1 + 0x90)) {
            TVar10 = param_1[0x98];
joined_r0x0084123c:
            if (TVar10 == (TypedModuleWithMasks)0x0) goto LAB_00841190;
          }
          else {
            TVar10 = param_1[0x98];
            if (*(int *)(param_1 + 0x94) < (int)uVar15) goto joined_r0x0084123c;
            if (TVar10 != (TypedModuleWithMasks)0x0) goto LAB_00841190;
          }
