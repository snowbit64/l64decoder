...
// Entry Point: 00c810ac
// Size: 560 bytes
// Signature: undefined __thiscall UncheckedSetKey(AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,CryptoPP::CTR_ModePolicy>> * this, uchar * param_1, uint param_2, NameValuePairs * param_3)


/* CryptoPP::AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,
   CryptoPP::CTR_ModePolicy> >::UncheckedSetKey(unsigned char const*, unsigned int,
...
::UncheckedSetKey(AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,CryptoPP::CTR_ModePolicy>>
...

{
  ...
  plVar6 = (long *)(**(code **)(*(long *)this + 0x100))(this,param_1,param_2);
  ...
  if ((uVar7 & 1) == 0) {
    if (-uVar1 < 0x400) {
      puVar9 = (undefined8 *)__cxa_allocate_exception(0x28);
                    /* try { // try from 00c81258 to 00c8125f has its CatchHandler @ 00c81318 */
      ...
      *(undefined4 *)(puVar9 + 1) = 1;
                    /* try { // try from 00c812a8 to 00c812af has its CatchHandler @ 00c812f8 */
      std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
      basic_string((basic_string *)(puVar9 + 2));
      *puVar9 = &PTR__Exception_00fe9ee0;
                    /* try { // try from 00c812c0 to 00c812d7 has its CatchHandler @ 00c812dc */
    ...
    if (uVar7 == uVar10) goto LAB_00c811d4;
  }
  else {
LAB_00c81178:
    uVar7 = *(ulong *)(this + 0x78);
...
LAB_00c811d4:
  ...
  *(undefined8 *)(this + 0x70) = 0xffffffffffffffff;
  ...
  if (iVar4 < 4) {
    ...
    (**(code **)(*plVar6 + 0x50))(plVar6,*(undefined8 *)(this + 0x80),uVar12,local_60);
  }
