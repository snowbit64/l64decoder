...
/* std::__ndk1::__split_buffer<BTBehavior**, std::__ndk1::allocator<BTBehavior**>
   >::push_front(BTBehavior** const&) */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00712fdc;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00712fc4;
      }
    }
    do {
      puVar7 = puVar6 + 1;
