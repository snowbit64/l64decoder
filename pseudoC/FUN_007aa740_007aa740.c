...
// Function: FUN_007aa740
// Entry Point: 007aa740
// Size: 108 bytes
// Signature: undefined FUN_007aa740(void)


void FUN_007aa740(long param_1,uint *param_2)
  ...
  *(undefined *)(param_2 + 0x40) = 0;
  ...
  if ((*(byte *)(lVar3 + 0x31) & 1) != 0) {
    ...
    if ((lVar3 != 0) && ((*(byte *)(lVar3 + 0x10) & 1) != 0)) {
      ...
      bVar1 = FillPlaneGeometry::writeVertexVolumesToStream(this_00,pGVar2);
