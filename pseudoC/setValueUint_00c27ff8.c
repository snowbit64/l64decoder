...
// Function: setValueUint
// Entry Point: 00c27ff8
// Size: 120 bytes
// Signature: undefined __thiscall setValueUint(AST_ConstantNode * this, uint param_1, uint param_2, GsTBasicType param_3)


/* AST_ConstantNode::setValueUint(unsigned int, unsigned int, GsTBasicType) */

void __thiscall
AST_ConstantNode::setValueUint
          (AST_ConstantNode *this,uint param_1,uint param_2,GsTBasicType param_3)
