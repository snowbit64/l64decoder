...
// Entry Point: 00b7d2e0
// Size: 136 bytes
// Signature: undefined __cdecl optimiseVertices(uint param_1, uint param_2, uint param_3, uint * param_4, uint * param_5)


/* GeometryUtil::optimiseVertices(unsigned int, unsigned int, unsigned int, unsigned int const*,
   unsigned int*) */
