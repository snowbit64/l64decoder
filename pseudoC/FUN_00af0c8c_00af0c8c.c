...
// Function: FUN_00af0c8c
// Entry Point: 00af0c8c
// Size: 620 bytes
// Signature: undefined FUN_00af0c8c(void)


bool FUN_00af0c8c(long *param_1,long *param_2)
...
LAB_00af0e5c:
    ...
    else if (*(uint *)(lVar3 + 0x18) < *(uint *)(lVar6 + 0x18)) goto LAB_00af0e5c;
    break;
  case 3:
    FUN_00af09b0(param_1,param_1 + 1,param_2 + -1);
    break;
  case 4:
    plVar10 = param_1 + 2;
    FUN_00af09b0(param_1,param_1 + 1,plVar10);
    lVar3 = param_2[-1];
    lVar6 = param_1[2];
    if (*(uint *)(lVar3 + 0x18) == *(uint *)(lVar6 + 0x18)) {
...
LAB_00af0eec:
      ...
      else if (uVar1 < *(uint *)(lVar8 + 0x18)) goto LAB_00af0eec;
    }
    break;
  case 5:
    FUN_00af0ad0(param_1,param_1 + 1,param_1 + 2,param_1 + 3,param_2 + -1);
    break;
  default:
