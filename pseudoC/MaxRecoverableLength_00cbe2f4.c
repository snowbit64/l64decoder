...
/* CryptoPP::DL_SignatureSchemeBase<CryptoPP::PK_Signer,
   CryptoPP::DL_PrivateKey<CryptoPP::EC2NPoint> >::MaxRecoverableLength() const */
...

{
  ...
  uVar2 = (**(code **)(*in_x0 + 0xa0))();
                    /* WARNING: Could not recover jumptable at 0x00cbe360. Too many branches */
