...
// Entry Point: 00f48624
// Size: 136 bytes
// Signature: undefined __thiscall serializeSingleObject(btCollisionObject * this, btSerializer * param_1)
...

{
  ...
  uVar3 = (**(code **)(*(long *)this + 0x28))(this,*(undefined8 *)(lVar2 + 8),param_1);
                    /* WARNING: Could not recover jumptable at 0x00f486a8. Too many branches */
