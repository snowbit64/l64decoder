...
// Function: processBlock_0_1_4
// Entry Point: 00bc56ec
// Size: 1648 bytes
// Signature: undefined __cdecl processBlock_0_1_4(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_0_1_4(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_0_1_4(CustomCipher *param_1,uchar *param_2)

{
  ...
  iVar12 = *(int *)(s_wL_I8 + ((ulong)bVar23 & 0xaa) * 2);
  uVar37 = uVar36 & 0xff;
  ...
  param_1[0x2b3] = param_1[uVar37 + 0x2b0];
  param_1[uVar37 + 0x2b0] = CVar19;
  uVar15 = *(uint *)(s_wL_I8 + ((ulong)bVar26 & 0xaa) * 2);
  CVar28 = param_1[0x2b4];
  uVar16 = *(uint *)(s_wL_I8 + ((ulong)bVar24 & 0xaa) * 2);
  iVar17 = *(int *)(s_wL_I8 + ((ulong)bVar25 & 0xaa) * 2);
  ...
  uVar14 = ((uint)(byte)CVar19 << 0x10 |
           ...
           (uVar18 | (iVar17 << 1 |
                      (iVar12 << 1 | (iVar13 << 1 | iVar11 << 2 | uVar14) << 2 | uVar16) << 2 |
                     uVar15) << 1);
  uVar35 = uVar14 >> 0xf | uVar14 << 0x11;
  uVar15 = *(uint *)(param_1 + 0x228);
  uVar16 = *(uint *)(param_1 + 0x22c);
  ...
  uVar16 = uVar14 >> 0xf | uVar14 << 0x11;
  uVar1 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar16 >> 8 ^ uVar18 >> 0x10) & 0x3f) * 4) |
           (&s_wPS)[(uVar16 >> 0xc ^ uVar18 >> 0x18) & 0x3f] |
           *(uint *)(&DAT_0211ea98 + (ulong)((uVar16 >> 4 ^ uVar18 >> 8) & 0x3f) * 4) |
          *(uint *)(&DAT_0211eb98 + (ulong)((uVar16 ^ uVar18) & 0x3f) * 4)) ^ uVar1 ^
  ...
  uVar14 = (*(uint *)(&DAT_0211e998 + (ulong)((uVar2 >> 8 ^ uVar5 >> 0x10) & 0x3f) * 4) |
            (&s_wPS)[(uVar2 >> 0xc ^ uVar5 >> 0x18) & 0x3f] |
            *(uint *)(&DAT_0211ea98 + (ulong)((uVar2 >> 4 ^ uVar5 >> 8) & 0x3f) * 4) |
           *(uint *)(&DAT_0211eb98 + (ulong)((uVar2 ^ uVar5) & 0x3f) * 4)) ^ uVar14 ^
