...
// Function: applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
// Entry Point: 007ef1c0
// Size: 3644 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, ChunkedBitSquare * param_3, ProceduralDensityPixelSource * param_4, ParallelogramHelper * param_5, SetDensityProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
    ...
    if (((uVar22 < local_98) || (uVar26 < local_94)) || ((uVar23 < local_94 || (uVar25 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar33 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar33 != 0
                    ...
                    /* try { // try from 007effc0 to 007effcb has its CatchHandler @ 007efffc */
          ...
          do {
            ...
            do {
              ...
              if (*(uint *)(param_3 + 0x34) < 2) {
                uVar44 = (ulong)*(uint *)(param_3 + 0x34);
                if (iVar33 != 2) goto LAB_007efd44;
LAB_007efd64:
                uVar4 = uVar30 >> (ulong)(uVar5 & 0x1f) & uVar16;
                if (((int)uVar4 < iVar29) || (iVar8 < (int)uVar4)) {
                  if (DVar13 != (DensityMapFilter)0x0) goto LAB_007efd90;
                }
...
LAB_007efd90:
                ...
                if (iVar33 == 2) goto LAB_007efd64;
LAB_007efd44:
                if ((iVar33 == 0) != ((uVar30 & uVar17) != uVar6)) goto LAB_007efd64;
              }
              uVar32 = uVar32 + 1;
              uVar2 = uVar2 + 1;
            } while (uVar32 != uVar36);
...
LAB_007efb9c:
  ...
  if (param_6[100] != (SetDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar28,*(uint *)(param_6 + 0x1c),*(uint *)(param_6 + 0x20),
    ...
    do {
      ...
      if ((iVar9 == 2) || ((iVar9 == 0) != ((uVar32 & uVar19) != uVar10))) {
        ...
        if (((int)uVar32 < iVar11) || (iVar12 < (int)uVar32)) {
          if (DVar14 != (DensityMapFilter)0x0) goto LAB_007efe64;
        }
...
LAB_007efbfc:
  uVar28 = uVar28 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar28) goto LAB_007efb9c;
  goto LAB_007efc10;
}
