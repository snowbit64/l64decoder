...
// Entry Point: 00d0c508
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<unsigned_long,std::__ndk1::allocator<unsigned_long>> * this)


/* std::__ndk1::__deque_base<unsigned long, std::__ndk1::allocator<unsigned long> >::~__deque_base()
    */

void __thiscall
std::__ndk1::__deque_base<unsigned_long,std::__ndk1::allocator<unsigned_long>>::~__deque_base
          (__deque_base<unsigned_long,std::__ndk1::allocator<unsigned_long>> *this)

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_00d0c574;
    uVar4 = 0x200;
  }
