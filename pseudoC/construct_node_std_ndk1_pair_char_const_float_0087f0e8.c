...
// Function: __construct_node<std::__ndk1::pair<char_const*,float>>
// Entry Point: 0087f0e8
// Size: 208 bytes
// Signature: unique_ptr __cdecl __construct_node<std::__ndk1::pair<char_const*,float>>(pair * param_1)


/* std::__ndk1::unique_ptr<std::__ndk1::__tree_node<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, float>, void*>,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, float> >
   >::__construct_node<std::__ndk1::pair<char const*, float> >(std::__ndk1::pair<char const*,
   float>&&) */
...
::__construct_node<std::__ndk1::pair<char_const*,float>>(pair *param_1)

{
  ...
  *(undefined *)(in_x8 + 2) = 0;
  ...
  if (0xffffffffffffffef < __n) {
                    /* try { // try from 0087f1b0 to 0087f1b7 has its CatchHandler @ 0087f1b8 */
  ...
  if (__n < 0x17) {
    ...
    *(char *)((long)pvVar2 + 0x20) = (char)((int)__n << 1);
    ...
    uVar4 = __n + 0x10 & 0xfffffffffffffff0;
                    /* try { // try from 0087f15c to 0087f163 has its CatchHandler @ 0087f1b8 */
    __dest = operator_new(uVar4);
    *(size_t *)((long)pvVar2 + 0x28) = __n;
    *(void **)((long)pvVar2 + 0x30) = __dest;
    *(ulong *)((long)pvVar2 + 0x20) = uVar4 | 1;
  }
  pvVar3 = memcpy(__dest,__s,__n);
  uVar1 = (unique_ptr)pvVar3;
LAB_0087f184:
  *(undefined *)((long)__dest + __n) = 0;
  uVar5 = *(undefined4 *)(in_x1 + 1);
  *(undefined *)(in_x8 + 2) = 1;
  *(undefined4 *)((long)pvVar2 + 0x38) = uVar5;
  return uVar1;
}
