...
// Function: applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
// Entry Point: 0081ade0
// Size: 3896 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>(IDensityPixelSource * param_1, BitVector * param_2, ChunkedBitSquare * param_3, BitVector * param_4, ParallelogramHelper * param_5, SetTypeProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
               (IDensityPixelSource *param_1,BitVector *param_2,ChunkedBitSquare *param_3,
               BitVector *param_4,ParallelogramHelper *param_5,SetTypeProcessor *param_6,
    ...
    if (((uVar21 < local_98) || (uVar25 < local_94)) || ((uVar22 < local_94 || (uVar24 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar32 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar32 != 0
                    ...
                    /* try { // try from 0081bcdc to 0081bce7 has its CatchHandler @ 0081bd18 */
          ...
          do {
            ...
            do {
              ...
              if (*(uint *)(param_3 + 0x34) < 2) {
                uVar46 = (ulong)*(uint *)(param_3 + 0x34);
                if (iVar32 != 2) goto LAB_0081ba04;
LAB_0081ba24:
                uVar2 = uVar30 >> (ulong)(uVar4 & 0x1f) & uVar15;
                if (((int)uVar2 < iVar6) || (iVar29 < (int)uVar2)) {
                  if (DVar12 != (DensityMapFilter)0x0) goto LAB_0081ba50;
                }
...
LAB_0081ba50:
                ...
                if (iVar32 == 2) goto LAB_0081ba24;
LAB_0081ba04:
                if ((iVar32 == 0) != ((uVar30 & uVar16) != uVar5)) goto LAB_0081ba24;
              }
              uVar41 = uVar41 + 1;
              uVar3 = uVar3 + 1;
            } while (uVar41 != uVar34);
    ...
    do {
      ...
      if ((iVar8 == 2) || ((iVar8 == 0) != ((uVar39 & uVar18) != uVar10))) {
        ...
        if (((int)uVar39 < iVar11) || (iVar9 < (int)uVar39)) {
          if (DVar13 != (DensityMapFilter)0x0) goto LAB_0081bb88;
        }
...
LAB_0081b8bc:
  uVar28 = uVar28 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar28) goto LAB_0081b854;
  goto LAB_0081b8d0;
}
