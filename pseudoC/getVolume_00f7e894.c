...
// Function: getVolume
// Entry Point: 00f7e894
// Size: 188 bytes
// Signature: undefined getVolume(void)


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* btSoftBody::getVolume() const */

float btSoftBody::getVolume(void)

{
  ...
  fVar7 = 0.0;
  if ((0 < *(int *)(in_x0 + 0x374)) &&
     (uVar2 = (ulong)*(uint *)(in_x0 + 0x3b4), 0 < (int)*(uint *)(in_x0 + 0x3b4))) {
    lVar4 = *(long *)(in_x0 + 0x380);
    fVar7 = 0.0;
    fVar6 = *(float *)(lVar4 + 0x10);
    fVar8 = *(float *)(lVar4 + 0x14);
    plVar3 = (long *)(*(long *)(in_x0 + 0x3c0) + 0x20);
