...
// Entry Point: 00dff2ec
// Size: 140 bytes
// Signature: undefined __thiscall QueryFloatText(XMLElement * this, float * param_1)


/* tinyxml2::XMLElement::QueryFloatText(float*) const */

long __thiscall tinyxml2::XMLElement::QueryFloatText(XMLElement *this,float *param_1)
