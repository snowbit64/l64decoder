...
/* CryptoPP::DL_SignatureSchemeBase<CryptoPP::PK_Verifier,
   CryptoPP::DL_PublicKey<CryptoPP::ECPPoint> >::RecoverablePartFirst() const */
...

{
  ...
  plVar1 = (long *)(**(code **)(*in_x0 + 0xa0))();
                    /* WARNING: Could not recover jumptable at 0x00cbbc2c. Too many branches */
