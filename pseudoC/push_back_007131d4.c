...
// Function: push_back
// Entry Point: 007131d4
// Size: 440 bytes
// Signature: undefined __thiscall push_back(__split_buffer<BTBehavior**,std::__ndk1::allocator<BTBehavior**>> * this, BTBehavior * * * param_1)


/* std::__ndk1::__split_buffer<BTBehavior**, std::__ndk1::allocator<BTBehavior**>
   >::push_back(BTBehavior**&&) */

void __thiscall
std::__ndk1::__split_buffer<BTBehavior**,std::__ndk1::allocator<BTBehavior**>>::push_back
...

{
  ...
  if (puVar12 != *(undefined8 **)(this + 0x18)) goto LAB_00713354;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_0071333c;
      }
    }
    do {
      puVar11 = puVar8 + 1;
