...
// Function: __insertion_sort_incomplete<RenderQueueItemAllocator::GeometryBucket::SortByDepth&,RenderQueueItemAllocator::GeometryBucket*>
// Entry Point: 00a353f0
// Size: 892 bytes
// Signature: bool __cdecl __insertion_sort_incomplete<RenderQueueItemAllocator::GeometryBucket::SortByDepth&,RenderQueueItemAllocator::GeometryBucket*>(GeometryBucket * param_1, GeometryBucket * param_2, SortByDepth * param_3)


/* bool 
   std::__ndk1::__insertion_sort_incomplete<RenderQueueItemAllocator::GeometryBucket::SortByDepth&,
...
bool std::__ndk1::
     __insertion_sort_incomplete<RenderQueueItemAllocator::GeometryBucket::SortByDepth&,RenderQueueItemAllocator::GeometryBucket*>
...

{
  ...
  if (uVar5 < 6) {
    ...
    case 5:
      ...
      __sort4<RenderQueueItemAllocator::GeometryBucket::SortByDepth&,RenderQueueItemAllocator::GeometryBucket*>
                (param_1,(GeometryBucket *)puVar6,(GeometryBucket *)puVar8,(GeometryBucket *)puVar1,
                 param_3);
    ...
    if (*(double *)(param_1 + 0x18) <= dVar17) {
      ...
      if (dVar17 <= dVar14) {
        ...
        *(undefined8 *)(param_1 + 0x10) = uVar12;
        if (*(double *)(param_1 + 0x38) <= dVar14) goto LAB_00a35680;
        ...
        if (dVar14 < (double)puVar6[3]) {
          ...
          do {
            ...
            *(undefined8 *)(param_1 + lVar11 + 0x70) = *(undefined8 *)(param_1 + lVar11 + 0x50);
            ...
            if (lVar11 == -0x40) goto LAB_00a3569c;
            lVar3 = lVar11 + -0x20;
