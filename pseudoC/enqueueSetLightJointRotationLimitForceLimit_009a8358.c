...
// Function: enqueueSetLightJointRotationLimitForceLimit
// Entry Point: 009a8358
// Size: 236 bytes
// Signature: undefined __thiscall enqueueSetLightJointRotationLimitForceLimit(Bt2ScenegraphPhysicsContext * this, uint param_1, uint param_2, float param_3)


/* Bt2ScenegraphPhysicsContext::enqueueSetLightJointRotationLimitForceLimit(unsigned int, unsigned
   int, float) */
  ...
  if (this[0x488] == (Bt2ScenegraphPhysicsContext)0x0) {
    ...
    if (pBVar3 != (Bt2ScenegraphPhysicsContext *)0x0) {
      ...
      if ((pBVar2 != this + 0x1c8) && (*(uint *)(pBVar2 + 0x20) <= param_1)) {
        ...
        *(float *)(lVar4 + (long)(int)param_2 * 0x44 + 0x1cc) = fVar5;
