...
// Function: checkTypedModuleMasks2<BitVector,BitVector,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
// Entry Point: 00831c70
// Size: 1328 bytes
// Signature: bool __cdecl checkTypedModuleMasks2<BitVector,BitVector,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>(TypedModuleWithMasks * param_1, IDensityPixelSource * param_2, uint param_3, uint param_4, HelperSource * param_5, IDensityPixelSource * param_6, uint param_7, uint param_8, uint param_9, uint param_10, uint param_11, HelperSource * param_12, IDensityPixelSource * param_13, uint param_14, uint param_15, uint param_16, uint param_17, uint param_18)
...
bool DensityMapModifier::
     checkTypedModuleMasks2<BitVector,BitVector,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
  ...
  if (bVar13) {
    if ((*(int *)(param_1 + 0x80) == 2) ||
      ...
      if ((int)uVar16 < *(int *)(param_1 + 0x90)) {
        TVar11 = param_1[0x98];
joined_r0x00831d84:
        if (TVar11 == (TypedModuleWithMasks)0x0) goto LAB_00832144;
      }
      else {
        TVar11 = param_1[0x98];
        if (*(int *)(param_1 + 0x94) < (int)uVar16) goto joined_r0x00831d84;
        if (TVar11 != (TypedModuleWithMasks)0x0) goto LAB_00832144;
      }
      if ((*(uint *)(param_1 + 0x9c) != 0) &&
         (uVar16 = *(uint *)(param_1 + 0x9c) & uVar16, uVar16 == 0)) goto LAB_0083217c;
      local_70 = *(IDensityPixelSource **)(param_1 + 0xa8);
      if (local_70 != param_2) goto LAB_00831cb4;
      if (pIVar19 != param_2) goto LAB_00831db8;
      goto LAB_00832178;
    }
  }
  else {
...
joined_r0x00831d6c:
        ...
        TVar11 = param_1[200];
        if (*(int *)(param_1 + 0xc4) < (int)uVar16) goto joined_r0x00831d6c;
        if (TVar11 != (TypedModuleWithMasks)0x0) goto LAB_00832144;
      }
      uVar21 = (uint)(*(uint *)(param_1 + 0xcc) != 0 && (*(uint *)(param_1 + 0xcc) & uVar16) == 0);
      uVar16 = uVar21 ^ 1;
      if ((uVar21 != 0) || (pIVar19 == param_2)) goto LAB_0083217c;
    }
LAB_00831db8:
            ...
            *(uint *)(param_5 + 0x20) = uVar16;
            if ((bool)(bVar13 | pIVar19 != param_6)) {
              ...
              if (((int)uVar1 < iVar5) || (iVar8 < (int)uVar1)) {
                if (TVar11 != (TypedModuleWithMasks)0x0) goto LAB_00831fd8;
              }
              else if (TVar11 == (TypedModuleWithMasks)0x0) {
LAB_00831fd8:
                uVar16 = 1;
                if ((uVar10 == 0) || ((uVar10 & uVar1) != 0)) goto LAB_0083217c;
              }
            }
            bVar13 = false;
            uVar18 = uVar18 - 1;
            ...
            do {
              ...
              *(uint *)(param_12 + 0x20) = uVar16;
              if ((bool)(bVar13 | pIVar19 != param_13)) {
                ...
                uVar1 = uVar16 >> (ulong)(uVar3 & 0x1f) & ~(-1 << (ulong)(uVar6 & 0x1f));
                if (((int)uVar1 < iVar5) || (iVar8 < (int)uVar1)) {
                  if (TVar11 != (TypedModuleWithMasks)0x0) goto LAB_00832124;
                }
                else if (TVar11 == (TypedModuleWithMasks)0x0) {
LAB_00832124:
                  uVar16 = 1;
