...
// Entry Point: 00d1801c
// Size: 116 bytes
// Signature: undefined __cdecl DiscreteLogWorkFactor(uint param_1)


/* CryptoPP::DiscreteLogWorkFactor(unsigned int) */

int CryptoPP::DiscreteLogWorkFactor(uint param_1)
