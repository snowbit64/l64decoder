...
// Function: FUN_007ab748
// Entry Point: 007ab748
// Size: 1108 bytes
// Signature: undefined FUN_007ab748(void)


void FUN_007ab748(GsMaterial *param_1,char **param_2)

{
  ...
  FUN_007aacb0(param_1,uVar6,pRVar5,"normal map",1);
  if (*(char *)(param_2 + 6) == '\0') {
    local_2a8 = 1;
    ...
    uStack_298 = SUB84(pRVar5,0);
    uStack_294 = (undefined4)((ulong)pRVar5 >> 0x20);
    ...
    GsMaterial::setNormalMap(param_1,(Texture *)pRVar5);
