...
// Function: insert<std::__ndk1::__wrap_iter<RenderList::OccluderShapeInfo*>>
// Entry Point: 00a1b3ec
// Size: 632 bytes
// Signature: type __thiscall insert<std::__ndk1::__wrap_iter<RenderList::OccluderShapeInfo*>>(vector<RenderList::OccluderShapeInfo,std::__ndk1::allocator<RenderList::OccluderShapeInfo>> * this, __wrap_iter param_1, __wrap_iter param_2, __wrap_iter param_3)


/* std::__ndk1::enable_if<__is_cpp17_forward_iterator<std::__ndk1::__wrap_iter<RenderList::OccluderShapeInfo*>
   >::value&&is_constructible<RenderList::OccluderShapeInfo,
   std::__ndk1::iterator_traits<std::__ndk1::__wrap_iter<RenderList::OccluderShapeInfo*>
   >::reference>::value, std::__ndk1::__wrap_iter<RenderList::OccluderShapeInfo*> >::type
   std::__ndk1::vector<RenderList::OccluderShapeInfo,
   std::__ndk1::allocator<RenderList::OccluderShapeInfo>
   >::insert<std::__ndk1::__wrap_iter<RenderList::OccluderShapeInfo*>
   >(std::__ndk1::__wrap_iter<RenderList::OccluderShapeInfo const*>,
   std::__ndk1::__wrap_iter<RenderList::OccluderShapeInfo*>,
   std::__ndk1::__wrap_iter<RenderList::OccluderShapeInfo*>) */
      ...
      *(void **)(this + 0x10) = (void *)((long)pvVar4 + uVar10 * 0x18);
      ...
      if (lVar14 * -0x5555555555555555 < lVar2) {
        ...
        *(undefined8 **)(this + 8) = puVar9;
        ...
        if ((long)puVar1 - (long)__src < 1) goto LAB_00a1b634;
      }
