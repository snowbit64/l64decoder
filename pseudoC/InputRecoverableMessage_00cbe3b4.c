...
// Entry Point: 00cbe3b4
// Size: 228 bytes
// Signature: undefined __thiscall InputRecoverableMessage(DL_SignerBase<CryptoPP::EC2NPoint> * this, PK_MessageAccumulator * param_1, uchar * param_2, ulong param_3)


/* CryptoPP::DL_SignerBase<CryptoPP::EC2NPoint>::InputRecoverableMessage(CryptoPP::PK_MessageAccumulator&,
   unsigned char const*, unsigned long) const */

void __thiscall
CryptoPP::DL_SignerBase<CryptoPP::EC2NPoint>::InputRecoverableMessage
          (DL_SignerBase<CryptoPP::EC2NPoint> *this,PK_MessageAccumulator *param_1,uchar *param_2,
          ulong param_3)
...
LAB_00cbe438:
  ...
  *(undefined8 *)(param_1 + 0x10) = 0xffffffffffffffff;
  ...
  uVar3 = (**(code **)(*(long *)param_1 + 0xa0))(param_1);
                    /* WARNING: Could not recover jumptable at 0x00cbe494. Too many branches */
