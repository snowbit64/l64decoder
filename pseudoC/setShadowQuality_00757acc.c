...
// Entry Point: 00757acc
// Size: 220 bytes
// Signature: undefined __thiscall setShadowQuality(HardwareScalability * this, float param_1)


/* HardwareScalability::setShadowQuality(float) */

void __thiscall HardwareScalability::setShadowQuality(HardwareScalability *this,float param_1)
