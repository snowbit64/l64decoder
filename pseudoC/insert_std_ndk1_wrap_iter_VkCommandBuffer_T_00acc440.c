...
// Function: insert<std::__ndk1::__wrap_iter<VkCommandBuffer_T**>>
// Entry Point: 00acc440
// Size: 1004 bytes
// Signature: type __thiscall insert<std::__ndk1::__wrap_iter<VkCommandBuffer_T**>>(vector<VkCommandBuffer_T*,std::__ndk1::allocator<VkCommandBuffer_T*>> * this, __wrap_iter param_1, __wrap_iter param_2, __wrap_iter param_3)


/* std::__ndk1::enable_if<__is_cpp17_forward_iterator<std::__ndk1::__wrap_iter<VkCommandBuffer_T**>
   >::value&&is_constructible<VkCommandBuffer_T*,
   std::__ndk1::iterator_traits<std::__ndk1::__wrap_iter<VkCommandBuffer_T**> >::reference>::value,
   std::__ndk1::__wrap_iter<VkCommandBuffer_T**> >::type std::__ndk1::vector<VkCommandBuffer_T*,
   std::__ndk1::allocator<VkCommandBuffer_T*>
   >::insert<std::__ndk1::__wrap_iter<VkCommandBuffer_T**>
   >(std::__ndk1::__wrap_iter<VkCommandBuffer_T* const*>,
   std::__ndk1::__wrap_iter<VkCommandBuffer_T**>, std::__ndk1::__wrap_iter<VkCommandBuffer_T**>) */

type __thiscall
std::__ndk1::vector<VkCommandBuffer_T*,std::__ndk1::allocator<VkCommandBuffer_T*>>::
insert<std::__ndk1::__wrap_iter<VkCommandBuffer_T**>>
          (vector<VkCommandBuffer_T*,std::__ndk1::allocator<VkCommandBuffer_T*>> *this,
    ...
    if (lVar19 < lVar20) {
      ...
      if (puVar15 != puVar6) {
        ...
        if ((0x17 < uVar13) &&
          ...
          if (uVar13 == uVar16) goto LAB_00acc6c4;
        }
        do {
          puVar9 = puVar14 + 1;
          *puVar11 = *puVar14;
...
LAB_00acc6c4:
      *(undefined8 **)(this + 8) = puVar8;
      puVar6 = puVar15;
      if ((long)uVar10 < 1) goto LAB_00acc7f8;
    }
    ...
    if (puVar15 < puVar1) {
      ...
      if (0x17 < uVar13) {
        ...
        if (((undefined8 *)(uVar7 + (lVar3 + (uVar12 >> 3)) * 8 + 8) <= puVar8) ||
          ...
          puVar14 = puVar11;
          if (uVar12 == uVar13) goto LAB_00acc7d0;
        }
      }
      do {
        puVar9 = puVar15 + 1;
...
LAB_00acc5cc:
    ...
    if (uVar7 != uVar13) goto LAB_00acc5cc;
  }
