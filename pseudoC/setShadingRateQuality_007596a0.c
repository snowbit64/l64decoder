...
// Function: setShadingRateQuality
// Entry Point: 007596a0
// Size: 232 bytes
// Signature: undefined __thiscall setShadingRateQuality(HardwareScalability * this, uint param_1)


/* HardwareScalability::setShadingRateQuality(unsigned int) */

void __thiscall HardwareScalability::setShadingRateQuality(HardwareScalability *this,uint param_1)
