  ...
  if (plVar10 != (long *)0x0) {
    ...
    if (pplVar9 != (long **)0x0) {
      do {
        ...
        if (pplVar9 == (long **)0x0) goto LAB_009867cc;
        plVar6 = pplVar9[1];
        if (plVar6 != plVar11) {
          if (uVar3 < 2) {
          ...
          if (plVar6 != unaff_x24) goto LAB_009867cc;
        }
...
LAB_009867cc:
  ...
  *(undefined4 *)((long)pplVar9 + 0x14) = 0;
  if ((plVar10 == (long *)0x0) || (fVar14 * (float)ZEXT89(plVar10) < (float)(unkuint9)(lVar4 + 1)))
  {
    ...
    if (uVar7 <= uVar3) {
      uVar7 = uVar3;
                    ...
                    /* try { // try from 0098683c to 00986843 has its CatchHandler @ 00986910 */
