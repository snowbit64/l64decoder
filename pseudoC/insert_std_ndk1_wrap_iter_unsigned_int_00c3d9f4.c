    ...
    if (lVar19 < lVar20) {
      ...
      if (puVar15 != puVar6) {
        ...
        if ((0x17 < uVar13) &&
          ...
          if (uVar13 == uVar16) goto LAB_00c3dc78;
        }
        do {
          puVar9 = puVar14 + 1;
          *puVar11 = *puVar14;
...
LAB_00c3dc78:
      *(undefined8 **)(this + 8) = puVar8;
      puVar6 = puVar15;
      if ((long)uVar10 < 1) goto LAB_00c3ddac;
    }
    ...
    if (puVar15 < puVar1) {
      ...
      if (0x17 < uVar13) {
        ...
        if (((undefined8 *)(uVar7 + (lVar3 + (uVar12 >> 3)) * 8 + 8) <= puVar8) ||
          ...
          puVar14 = puVar11;
          if (uVar12 == uVar13) goto LAB_00c3dd84;
        }
      }
      do {
        puVar9 = puVar15 + 1;
...
LAB_00c3db80:
    ...
    if (uVar7 != uVar13) goto LAB_00c3db80;
  }
