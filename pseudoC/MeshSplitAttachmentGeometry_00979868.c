...
// Entry Point: 00979868
// Size: 156 bytes
// Signature: undefined __thiscall ~MeshSplitAttachmentGeometry(MeshSplitAttachmentGeometry * this)


/* non-virtual thunk to MeshSplitAttachmentGeometry::~MeshSplitAttachmentGeometry() */
...

{
  ...
  *(undefined ***)(this + -0x58) = &PTR__MeshSplitAttachmentGeometry_00fe0720;
  iVar1 = *(int *)((long)plVar3 + 0x54);
  *(undefined ***)(this + -0x48) = &PTR__MeshSplitAttachmentGeometry_00fe0778;
  *(undefined ***)this = &PTR__MeshSplitAttachmentGeometry_00fe0798;
  iVar2 = iVar1 + -1;
  if (iVar1 == 0 || iVar2 == 0) {
    (**(code **)(*plVar3 + 8))();
