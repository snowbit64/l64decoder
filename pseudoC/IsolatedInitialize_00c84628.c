...
// Entry Point: 00c84628
// Size: 188 bytes
// Signature: undefined __thiscall IsolatedInitialize(StringSinkTemplate<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>> * this, NameValuePairs * param_1)


/* CryptoPP::StringSinkTemplate<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > >::IsolatedInitialize(CryptoPP::NameValuePairs const&) */
...

{
  ...
  if ((uVar2 & 1) == 0) {
    this_00 = (InvalidArgument *)__cxa_allocate_exception(0x28);
                    /* try { // try from 00c846a4 to 00c846b3 has its CatchHandler @ 00c8470c */
    std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
    basic_string<decltype(nullptr)>
              ((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
               abStack_50,"StringSink: OutputStringPointer not specified");
                    /* try { // try from 00c846b8 to 00c846df has its CatchHandler @ 00c846e4 */
