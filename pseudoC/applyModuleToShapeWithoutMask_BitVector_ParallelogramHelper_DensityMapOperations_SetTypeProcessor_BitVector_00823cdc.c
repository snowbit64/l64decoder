...
// Function: applyModuleToShapeWithoutMask<BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
// Entry Point: 00823cdc
// Size: 480 bytes
// Signature: bool __cdecl applyModuleToShapeWithoutMask<BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>(IDensityPixelSource * param_1, BitVector * param_2, ParallelogramHelper * param_3, SetTypeProcessor * param_4)
...
/* bool DensityMapModifier::applyModuleToShapeWithoutMask<BitVector, ParallelogramHelper,
   ...
   ParallelogramHelper&, DensityMapOperations::SetTypeProcessor<BitVector>&) */

bool DensityMapModifier::
     applyModuleToShapeWithoutMask<BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<BitVector>>
...

{
    ...
    do {
      ...
      for (uVar3 = *(uint *)(param_3 + 0x58); uVar3 < uVar4; uVar3 = uVar3 + 1) {
        ...
        DensityMapOperations::SetTypeProcessor<BitVector>::process
                  ((SetTypeProcessor<BitVector> *)param_4,(HelperSource *)&local_80);
        if (uVar4 != local_60) {
  ...
  if (param_4[0x5c] != (SetTypeProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_3 + 0x54),uVar3,*(uint *)(param_4 + 0x14),*(uint *)(param_4 + 0x18),
