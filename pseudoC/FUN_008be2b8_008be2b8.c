...
// Function: FUN_008be2b8
// Entry Point: 008be2b8
// Size: 440 bytes
// Signature: undefined FUN_008be2b8(void)


void FUN_008be2b8(void **param_1,undefined8 *param_2)

{
  ...
  if (puVar12 != (undefined8 *)param_1[3]) goto LAB_008be438;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_008be420;
      }
    }
    do {
      puVar11 = puVar8 + 1;
