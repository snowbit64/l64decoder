...
// Function: __append
// Entry Point: 00edf5bc
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<Luau::AstLocal*,std::__ndk1::allocator<Luau::AstLocal*>> * this, ulong param_1)


/* std::__ndk1::vector<Luau::AstLocal*, std::__ndk1::allocator<Luau::AstLocal*> >::__append(unsigned
   long) */

void __thiscall
std::__ndk1::vector<Luau::AstLocal*,std::__ndk1::allocator<Luau::AstLocal*>>::__append
          (vector<Luau::AstLocal*,std::__ndk1::allocator<Luau::AstLocal*>> *this,ulong param_1)
