...
// Entry Point: 00c7dc18
// Size: 224 bytes
// Signature: undefined __thiscall Resynchronize(AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,CryptoPP::SymmetricCipher>> * this, uchar * param_1, int param_2)


/* CryptoPP::AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,
   CryptoPP::SymmetricCipher> >::Resynchronize(unsigned char const*, int) */

void __thiscall
CryptoPP::
AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,CryptoPP::SymmetricCipher>>
::Resynchronize(AdditiveCipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::AdditiveCipherAbstractPolicy,CryptoPP::SymmetricCipher>>
...

{
  ...
  plVar4 = (long *)(**(code **)(*(long *)this + 0x88))();
  lVar7 = *plVar4;
  ...
  *(undefined8 *)(this + 0x20) = 0xffffffffffffffff;
  uVar6 = SimpleKeyingInterface::ThrowIfInvalidIVLength((SimpleKeyingInterface *)this,param_2);
                    /* WARNING: Could not recover jumptable at 0x00c7dcf4. Too many branches */
