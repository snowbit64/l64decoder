...
// Function: getCapZW
// Entry Point: 00b50394
// Size: 596 bytes
// Signature: undefined __thiscall getCapZW(ClippingMesh * this, ClippingMesh * param_1, float param_2)


/* ClippingMesh::getCapZW(ClippingMesh&, float) const */

void __thiscall ClippingMesh::getCapZW(ClippingMesh *this,ClippingMesh *param_1,float param_2)
      ...
      do {
        ...
        *(undefined4 *)(param_1 + 0x10) = 0;
        if (uVar2 != 0) {
          ...
          uVar9 = 0;
          bVar5 = *(float *)(puVar7 + (ulong)(uVar2 - 1) * 2 + 1) !=
                  *(float *)((long)puVar7 + (ulong)(uVar2 - 1) * 0x10 + 0xc) * param_2;
          do {
            bVar6 = *(float *)(puVar7 + 1) == *(float *)((long)puVar7 + 0xc) * param_2;
            if (bVar6) {
