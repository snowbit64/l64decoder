...
// Function: FUN_007abb9c
// Entry Point: 007abb9c
// Size: 1124 bytes
// Signature: undefined FUN_007abb9c(void)


void FUN_007abb9c(GsMaterial *param_1,uint *param_2)

{
  ...
  if ((lVar5 != 0) && ((*(byte *)(lVar5 + 0x15) >> 4 & 1) != 0)) {
    uVar6 = GsMaterial::getGlossMap();
    FUN_007aacb0(param_1,uVar6,*(undefined8 *)(lVar5 + 0x20),"gloss map",0);
    lVar9 = *(long *)(lVar5 + 0x20);
    lVar7 = GsMaterial::getGlossMap();
    if (lVar9 != lVar7) {
      if (*(char *)(param_2 + 4) == '\0') {
        ...
        uStack_290 = (undefined4)*(undefined8 *)(lVar5 + 0x20);
        uStack_28c = (undefined4)((ulong)*(undefined8 *)(lVar5 + 0x20) >> 0x20);
        ...
        GsMaterial::setGlossMap(param_1,*(Texture **)(lVar5 + 0x20));
