...
// Entry Point: 00703ee0
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<BTBehavior*,std::__ndk1::allocator<BTBehavior*>> * this)
...
void __thiscall
std::__ndk1::__deque_base<BTBehavior*,std::__ndk1::allocator<BTBehavior*>>::~__deque_base
          (__deque_base<BTBehavior*,std::__ndk1::allocator<BTBehavior*>> *this)

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_00703f4c;
    uVar4 = 0x200;
  }
