...
// Function: applyModuleToShapeWithMask<ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 008013dc
// Size: 2904 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask<ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>(IDensityPixelSource * param_1, ChunkedBitSquare * param_2, ChunkedBitSquare * param_3, ParallelogramHelper * param_4, AddDensityProcessor * param_5, DensityMapFilter * param_6)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask<ChunkedBitSquare,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
    ...
    if ((uVar15 < uVar13) || (uVar16 < uVar14)) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar24 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar24 != 0
                    ...
                    /* try { // try from 00801ef0 to 00801ef7 has its CatchHandler @ 00801f44 */
        this = (Logger *)operator_new(0x38);
                    /* try { // try from 00801efc to 00801eff has its CatchHandler @ 00801f34 */
        Logger::Logger(this);
...
LAB_00801ca8:
                ...
                if (iVar24 == 2) goto LAB_00801ca8;
LAB_00801c88:
                if ((iVar24 == 0) != ((uVar21 & uVar10) != uVar7)) goto LAB_00801ca8;
LAB_00801bb0:
                uVar23 = uVar23 + 1;
                uVar3 = uVar3 + 1;
              } while (uVar23 != uVar27);
...
LAB_00801b34:
  ...
  if (param_5[0x6c] != (AddDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_4 + 0x54),uVar15,*(uint *)(param_5 + 0x24),*(uint *)(param_5 + 0x28),
