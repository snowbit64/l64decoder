...
/* CryptoPP::ClonableImpl<CryptoPP::SHA384, CryptoPP::AlgorithmImpl<CryptoPP::IteratedHash<unsigned
   ...
   CryptoPP::SHA384> >::Clone() const */

undefined8 *
CryptoPP::
ClonableImpl<CryptoPP::SHA384,CryptoPP::AlgorithmImpl<CryptoPP::IteratedHash<unsigned_long,CryptoPP::EnumToType<CryptoPP::ByteOrder,1>,128u,CryptoPP::HashTransformation>,CryptoPP::SHA384>>
::Clone(void)

{
  ...
  *puVar1 = &PTR__IteratedHash_01000e98;
                    /* try { // try from 00d26cb4 to 00d26cbb has its CatchHandler @ 00d26d40 */
  ...
  *puVar1 = &PTR__IteratedHashWithStaticTransform_01010ce0;
                    /* try { // try from 00d26cd4 to 00d26cd7 has its CatchHandler @ 00d26cfc */
  ...
  *puVar1 = &PTR__IteratedHashWithStaticTransform_01010980;
  return puVar1;
}
