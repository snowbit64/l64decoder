...
// Function: rehash
// Entry Point: 00754f70
// Size: 220 bytes
// Signature: undefined __thiscall rehash(__hash_table<std::__ndk1::__hash_value_type<unsigned_int,EngineManager::TriggerScriptCallbackInfo>,std::__ndk1::__unordered_map_hasher<unsigned_int,std::__ndk1::__hash_value_type<unsigned_int,EngineManager::TriggerScriptCallbackInfo>,std::__ndk1::hash<unsigned_int>,true>,std::__ndk1::__unordered_map_equal<unsigned_int,std::__ndk1::__hash_value_type<unsigned_int,EngineManager::TriggerScriptCallbackInfo>,std::__ndk1::equal_to<unsigned_int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned_int,EngineManager::TriggerScriptCallbackInfo>>> * this, ulong param_1)
...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned int,
   ...
   EngineManager::TriggerScriptCallbackInfo> > >::rehash(unsigned long) */
...
::rehash(__hash_table<std::__ndk1::__hash_value_type<unsigned_int,EngineManager::TriggerScriptCallbackInfo>,std::__ndk1::__unordered_map_hasher<unsigned_int,std::__ndk1::__hash_value_type<unsigned_int,EngineManager::TriggerScriptCallbackInfo>,std::__ndk1::hash<unsigned_int>,true>,std::__ndk1::__unordered_map_equal<unsigned_int,std::__ndk1::__hash_value_type<unsigned_int,EngineManager::TriggerScriptCallbackInfo>,std::__ndk1::equal_to<unsigned_int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned_int,EngineManager::TriggerScriptCallbackInfo>>>
         *this,ulong param_1)

{
  ...
  uVar2 = *(ulong *)(this + 8);
  uVar1 = param_1;
  if (uVar2 < param_1) goto LAB_00755024;
  if (uVar2 <= param_1) {
    return;
  }
...
LAB_00755010:
    ...
    if (1 < (uint)CONCAT62((int6)((ulong)uVar4 >> 0x10),uVar3)) goto LAB_00755010;
    if (1 < uVar1) {
