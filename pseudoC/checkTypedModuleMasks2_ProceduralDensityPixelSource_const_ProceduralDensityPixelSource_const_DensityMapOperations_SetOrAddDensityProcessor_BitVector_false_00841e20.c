...
// Function: checkTypedModuleMasks2<ProceduralDensityPixelSource_const,ProceduralDensityPixelSource_const,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>
// Entry Point: 00841e20
// Size: 1032 bytes
// Signature: bool __cdecl checkTypedModuleMasks2<ProceduralDensityPixelSource_const,ProceduralDensityPixelSource_const,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>(TypedModuleWithMasks * param_1, IDensityPixelSource * param_2, uint param_3, uint param_4, HelperSource * param_5, IDensityPixelSource * param_6, uint param_7, uint param_8, uint param_9, uint param_10, uint param_11, HelperSource * param_12, IDensityPixelSource * param_13, uint param_14, uint param_15, uint param_16, uint param_17, uint param_18)


/* bool DensityMapModifier::checkTypedModuleMasks2<ProceduralDensityPixelSource const,
   ProceduralDensityPixelSource const, DensityMapOperations::SetOrAddDensityProcessor<BitVector,
   false> 
...
bool DensityMapModifier::
     checkTypedModuleMasks2<ProceduralDensityPixelSource_const,ProceduralDensityPixelSource_const,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>
...
joined_r0x00841f44:
      ...
      TVar1 = param_1[0x98];
      if (*(int *)(param_1 + 0x94) < (int)uVar9) goto joined_r0x00841f44;
      if (TVar1 != (TypedModuleWithMasks)0x0) {
        return false;
      }
    }
    ...
    pIVar7 = *(IDensityPixelSource **)(param_1 + 0xa8);
    if (pIVar7 == param_2) goto LAB_00841f78;
  }
...
joined_r0x00841f2c:
    ...
    TVar1 = param_1[200];
    if (*(int *)(param_1 + 0xc4) < (int)uVar9) goto joined_r0x00841f2c;
    if (TVar1 != (TypedModuleWithMasks)0x0) {
      return false;
    }
  }
          ...
          *(uint *)(param_5 + 0x20) = uVar5;
          ...
          if ((*(IDensityPixelSource **)(param_1 + 0x78) == param_6) &&
            ...
            if ((int)uVar5 < *(int *)(param_1 + 0x90)) {
              TVar1 = param_1[0x98];
joined_r0x008421a8:
              if (TVar1 == (TypedModuleWithMasks)0x0) goto LAB_008420fc;
            }
            else {
              TVar1 = param_1[0x98];
              if (*(int *)(param_1 + 0x94) < (int)uVar5) goto joined_r0x008421a8;
              if (TVar1 != (TypedModuleWithMasks)0x0) goto LAB_008420fc;
            }
        ...
        *(uint *)(param_12 + 0x20) = uVar5;
        ...
        if ((*(IDensityPixelSource **)(param_1 + 0x78) == param_13) &&
          ...
          if ((int)uVar5 < *(int *)(param_1 + 0x90)) {
            TVar1 = param_1[0x98];
joined_r0x00842088:
            if (TVar1 == (TypedModuleWithMasks)0x0) goto LAB_00841fd8;
          }
          else {
            TVar1 = param_1[0x98];
            if (*(int *)(param_1 + 0x94) < (int)uVar5) goto joined_r0x00842088;
            if (TVar1 != (TypedModuleWithMasks)0x0) goto LAB_00841fd8;
          }
          if (*(uint *)(param_1 + 0x9c) == 0) {
            return true;
