...
// Function: operator()
// Entry Point: 00c9c7ac
// Size: 292 bytes
// Signature: GetValueHelperClass * __cdecl operator()(char * param_1, _func_ECP_ptr * param_2)
...
/* CryptoPP::GetValueHelperClass<CryptoPP::DL_GroupParameters_EC<CryptoPP::ECP>,
   ...
   CryptoPP::ECP const& (CryptoPP::DL_GroupParameters_EC<CryptoPP::ECP>::*)() const) */

GetValueHelperClass *
CryptoPP::
GetValueHelperClass<CryptoPP::DL_GroupParameters_EC<CryptoPP::ECP>,CryptoPP::DL_GroupParameters<CryptoPP::ECPPoint>>
::operator()(char *param_1,_func_ECP_ptr *param_2)

{
  ...
  if ((param_1[0x20] == '\0') &&
    ...
    NameValuePairs::ThrowIfTypeMismatch
              ((char *)param_2,(type_info *)&ECP::typeinfo,*(type_info **)(param_1 + 0x10));
    if ((in_x3 & 1) != 0) {
    ...
    *(long **)(lVar6 + 0x10) = plVar4;
    ...
    Integer::operator=((Integer *)(lVar6 + 0x18),(Integer *)(lVar3 + 0x18));
    Integer::operator=((Integer *)(lVar6 + 0x48),(Integer *)(lVar3 + 0x48));
    Integer::operator=((Integer *)(lVar6 + 0x80),(Integer *)(lVar3 + 0x80));
    Integer::operator=((Integer *)(lVar6 + 0xb0),(Integer *)(lVar3 + 0xb0));
    *(undefined *)(lVar6 + 0xe0) = *(undefined *)(lVar3 + 0xe0);
    param_1[0x20] = '\x01';
