...
// Entry Point: 00cac168
// Size: 272 bytes
// Signature: undefined __thiscall DEREncodePrivateKey(DL_PrivateKey_ECGDSA<CryptoPP::EC2N> * this, BufferedTransformation * param_1)


/* CryptoPP::DL_PrivateKey_ECGDSA<CryptoPP::EC2N>::DEREncodePrivateKey(CryptoPP::BufferedTransformation&)
   const */

void __thiscall
CryptoPP::DL_PrivateKey_ECGDSA<CryptoPP::EC2N>::DEREncodePrivateKey
          (DL_PrivateKey_ECGDSA<CryptoPP::EC2N> *this,BufferedTransformation *param_1)

{
  ...
  ppuStack_90 = &PTR__DERSequenceEncoder_01000e20;
                    /* try { // try from 00cac1c0 to 00cac247 has its CatchHandler @ 00cac278 */
