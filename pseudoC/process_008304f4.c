...
// Function: process
// Entry Point: 008304f4
// Size: 352 bytes
// Signature: undefined __thiscall process(SetOrAddDensityProcessor<ChunkedBitSquare,false> * this, HelperSource * param_1)


/* DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,
   false>::process(DensityMapAccessUtil::HelperSource<ChunkedBitSquare>&) */

void __thiscall
DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>::process
          (SetOrAddDensityProcessor<ChunkedBitSquare,false> *this,HelperSource *param_1)

{
  ...
  uint uVar4;
  uint uVar5;
  SetOrAddDensityProcessor<ChunkedBitSquare,false> SVar6;
  uint uVar7;
  ...
  *(int *)(this + 4) = *(int *)(this + 4) + 1;
  if ((int)uVar3 < *(int *)(this + 0x3c)) {
    ...
    if ((int)uVar3 <= *(int *)(this + 0x40)) {
      if (SVar6 != (SetOrAddDensityProcessor<ChunkedBitSquare,false>)0x0) {
        return;
      }
      goto LAB_00830550;
    }
    ...
    *(uint *)(this + 0xc) = (uVar7 - uVar3) + *(int *)(this + 0xc);
    if (uVar1 == 0xffffffff) {
      if (uVar7 != uVar3) {
        ...
        this[0x6c] = (SetOrAddDensityProcessor<ChunkedBitSquare,false>)0x1;
