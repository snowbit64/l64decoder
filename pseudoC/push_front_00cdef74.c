...
// Function: push_front
// Entry Point: 00cdef74
// Size: 448 bytes
// Signature: undefined __thiscall push_front(__split_buffer<CryptoPP::MeterFilter::MessageRange*,std::__ndk1::allocator<CryptoPP::MeterFilter::MessageRange*>&> * this, MessageRange * * param_1)


/* std::__ndk1::__split_buffer<CryptoPP::MeterFilter::MessageRange*,
   std::__ndk1::allocator<CryptoPP::MeterFilter::MessageRange*>&>::push_front(CryptoPP::MeterFilter::MessageRange*
   const&) */
...

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00cdf0fc;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00cdf0e4;
      }
    }
    do {
      puVar7 = puVar6 + 1;
