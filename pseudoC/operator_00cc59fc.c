...
/* CryptoPP::GetValueHelperClass<CryptoPP::DL_PublicKey<CryptoPP::ECPPoint>,
   ...
   CryptoPP::GetValueHelperClass<CryptoPP::DL_PublicKey<CryptoPP::ECPPoint>,
   CryptoPP::DL_PublicKey<CryptoPP::ECPPoint> >::TEMPNAMEPLACEHOLDERVALUE(char const*,
   CryptoPP::ECPPoint const& (CryptoPP::DL_PublicKey<CryptoPP::ECPPoint>::*)() const) */
