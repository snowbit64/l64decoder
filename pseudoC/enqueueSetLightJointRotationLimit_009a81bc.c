...
// Function: enqueueSetLightJointRotationLimit
// Entry Point: 009a81bc
// Size: 120 bytes
// Signature: undefined __thiscall enqueueSetLightJointRotationLimit(Bt2ScenegraphPhysicsContext * this, uint param_1, uint param_2, bool param_3, float param_4, float param_5)


/* Bt2ScenegraphPhysicsContext::enqueueSetLightJointRotationLimit(unsigned int, unsigned int, bool,
   float, float) */
