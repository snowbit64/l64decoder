...
// Entry Point: 0096fc68
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<TextureStreamingManager::UpgradePipeline::WorkerResult,std::__ndk1::allocator<TextureStreamingManager::UpgradePipeline::WorkerResult>> * this)


/* std::__ndk1::__deque_base<TextureStreamingManager::UpgradePipeline::WorkerResult,
   std::__ndk1::allocator<TextureStreamingManager::UpgradePipeline::WorkerResult> >::~__deque_base()
    */
...

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_0096fcd4;
    uVar4 = 0x66;
  }
