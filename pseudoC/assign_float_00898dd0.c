...
// Entry Point: 00898dd0
// Size: 332 bytes
// Signature: type __thiscall assign<float*>(vector<float,std::__ndk1::allocator<float>> * this, float * param_1, float * param_2)
...

{
  ...
  type tVar1;
  void *pvVar2;
  vector<float,std::__ndk1::allocator<float>> *pvVar3;
  ulong uVar4;
  size_t sVar5;
  void *pvVar6;
  ulong uVar7;
  ...
  if (uVar7 <= (ulong)((long)(uVar4 - (long)pvVar6) >> 2)) {
    ...
    __src = (float *)((long)param_1 + (*(long *)(this + 8) - (long)pvVar6));
    if (uVar7 <= uVar4) {
      __src = param_2;
    }
    ...
    pvVar3 = this;
    if (sVar5 != 0) {
      pvVar3 = (vector<float,std::__ndk1::allocator<float>> *)memmove(pvVar6,param_1,sVar5);
    }
    tVar1 = (type)pvVar3;
    if (uVar4 < uVar7) {
      pvVar6 = *(void **)(this + 8);
