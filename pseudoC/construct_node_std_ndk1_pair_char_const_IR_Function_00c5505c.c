...
// Function: __construct_node<std::__ndk1::pair<char_const*,IR_Function*>>
// Entry Point: 00c5505c
// Size: 208 bytes
// Signature: unique_ptr __cdecl __construct_node<std::__ndk1::pair<char_const*,IR_Function*>>(pair * param_1)


/* std::__ndk1::unique_ptr<std::__ndk1::__tree_node<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, IR_Function*>, void*>,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, IR_Function*> >
   >::__construct_node<std::__ndk1::pair<char const*, IR_Function*> >(std::__ndk1::pair<char const*,
   IR_Function*>&&) */
...
::__construct_node<std::__ndk1::pair<char_const*,IR_Function*>>(pair *param_1)

{
  ...
  *(undefined *)(in_x8 + 2) = 0;
  ...
  if (0xffffffffffffffef < __n) {
                    /* try { // try from 00c55124 to 00c5512b has its CatchHandler @ 00c5512c */
  ...
  if (__n < 0x17) {
    ...
    *(char *)((long)pvVar2 + 0x20) = (char)((int)__n << 1);
    ...
    uVar5 = __n + 0x10 & 0xfffffffffffffff0;
                    /* try { // try from 00c550d0 to 00c550d7 has its CatchHandler @ 00c5512c */
