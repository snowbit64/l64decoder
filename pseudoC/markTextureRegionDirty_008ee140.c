...
// Function: markTextureRegionDirty
// Entry Point: 008ee140
// Size: 300 bytes
// Signature: undefined __thiscall markTextureRegionDirty(BaseTerrainSyncer * this, int param_1, int param_2, uint param_3, uint param_4)


/* BaseTerrainSyncer::markTextureRegionDirty(int, int, unsigned int, unsigned int) */
...

{
  ...
  if (this[0x40] == (BaseTerrainSyncer)0x0) {
    ...
    if (lVar8 != 0) {
      uVar13 = 0;
      do {
        plVar14 = *(long **)(lVar11 + uVar13 * 0x20 + 0x18);
