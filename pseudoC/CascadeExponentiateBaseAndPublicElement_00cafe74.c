...
// Entry Point: 00cafe74
// Size: 156 bytes
// Signature: undefined __cdecl CascadeExponentiateBaseAndPublicElement(Integer * param_1, Integer * param_2)


/* CryptoPP::DL_PublicKey<CryptoPP::Integer>::CascadeExponentiateBaseAndPublicElement(CryptoPP::Integer
   const&, CryptoPP::Integer const&) const */

void CryptoPP::DL_PublicKey<CryptoPP::Integer>::CascadeExponentiateBaseAndPublicElement
...

{
  ...
  uVar4 = (**(code **)(*(long *)param_1 + 0x40))(param_1);
                    /* WARNING: Could not recover jumptable at 0x00caff0c. Too many branches */
