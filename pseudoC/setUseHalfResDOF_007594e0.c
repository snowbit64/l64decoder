...
// Function: setUseHalfResDOF
// Entry Point: 007594e0
// Size: 224 bytes
// Signature: undefined __thiscall setUseHalfResDOF(HardwareScalability * this, bool param_1)


/* HardwareScalability::setUseHalfResDOF(bool) */

void __thiscall HardwareScalability::setUseHalfResDOF(HardwareScalability *this,bool param_1)

{
  ...
  if (this[0xba] != (HardwareScalability)param_1) {
    this[0xba] = (HardwareScalability)param_1;
