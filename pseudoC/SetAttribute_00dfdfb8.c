...
// Entry Point: 00dfdfb8
// Size: 204 bytes
// Signature: undefined __thiscall SetAttribute(XMLAttribute * this, ulong param_1)


/* tinyxml2::XMLAttribute::SetAttribute(unsigned long) */

void __thiscall tinyxml2::XMLAttribute::SetAttribute(XMLAttribute *this,ulong param_1)

{
  ...
  FUN_00dfa4ec(auStack_110,200,200,&DAT_004fd003,param_1);
