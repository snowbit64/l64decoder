...
// Entry Point: 00bb4290
// Size: 112 bytes
// Signature: undefined __thiscall MethodDeclaration(MethodDeclaration * this, Type param_1, Type param_2, void * param_3, Type param_4, Type param_5, Type param_6, Type param_7, Type param_8, Type param_9, Type param_10, Type param_11, Type param_12, Type param_13, Type param_14, Type param_15, Type param_16)
...

{
  ...
  *(Type *)(this + 0x2c) = param_13;
  *(Type *)(this + 0x30) = param_14;
  *(undefined8 *)(this + 0x60) = 0x20000000d;
  *(Type *)(this + 0x28) = param_12;
  *(Type *)(this + 0x34) = param_15;
  *(Type *)(this + 0x38) = param_16;
  return;
}
