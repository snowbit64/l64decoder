...
// Entry Point: 00cd8b3c
// Size: 476 bytes
// Signature: undefined __thiscall StreamTransformationFilter(StreamTransformationFilter * this, StreamTransformation * param_1, BufferedTransformation * param_2, BlockPaddingScheme param_3)


/* CryptoPP::StreamTransformationFilter::StreamTransformationFilter(CryptoPP::StreamTransformation&,
   CryptoPP::BufferedTransformation*, CryptoPP::BlockPaddingSchemeDef::BlockPaddingScheme) */
...
CryptoPP::StreamTransformationFilter::StreamTransformationFilter
          ...
          BufferedTransformation *param_2,BlockPaddingScheme param_3)

{
  ...
  *(undefined4 *)(this + 0xc0) = 5;
  ...
  if (lVar6 != 0) {
    this_00 = (InvalidArgument *)__cxa_allocate_exception(0x28);
                    /* try { // try from 00cd8cd8 to 00cd8ce7 has its CatchHandler @ 00cd8d3c */
    ...
    basic_string<decltype(nullptr)>
              ((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
               ...
               "StreamTransformationFilter: please use AuthenticatedEncryptionFilter and AuthenticatedDecryptionFilter for AuthenticatedSymmetricCipher"
                    ...
                    /* try { // try from 00cd8cec to 00cd8d13 has its CatchHandler @ 00cd8d18 */
    ...
    __cxa_throw(this_00,&InvalidArgument::typeinfo,Exception::~Exception);
                    ...
                    /* try { // try from 00cd8bf8 to 00cd8c2f has its CatchHandler @ 00cd8d88 */
  ...
  *(uint *)(this + 0xcc) = uVar1;
                    /* try { // try from 00cd8c54 to 00cd8c6b has its CatchHandler @ 00cd8d84 */
  MakeParameters<CryptoPP::BlockPaddingSchemeDef::BlockPaddingScheme>
            ((CryptoPP *)"BlockPaddingScheme",(char *)&local_64,(BlockPaddingScheme *)0x1,
             (bool)uVar7);
                    /* try { // try from 00cd8c74 to 00cd8c7f has its CatchHandler @ 00cd8d50 */
  (**(code **)(*(long *)this + 0x58))(this,&local_60);
  local_60 = &PTR__AlgorithmParameters_00feeb08;
  if (local_58 != (long *)0x0) {
                    /* try { // try from 00cd8ca0 to 00cd8ca3 has its CatchHandler @ 00cd8d4c */
    (**(code **)(*local_58 + 8))();
  }
