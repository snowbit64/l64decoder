...
// Function: checkTypedModuleMasks<BitVector,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>
// Entry Point: 008425b8
// Size: 816 bytes
// Signature: bool __cdecl checkTypedModuleMasks<BitVector,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>(TypedModuleWithMasks * param_1, IDensityPixelSource * param_2, uint param_3, uint param_4, HelperSource * param_5, IDensityPixelSource * param_6, uint param_7, uint param_8, uint param_9, uint param_10, uint param_11)
...
bool DensityMapModifier::
     checkTypedModuleMasks<BitVector,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>
  ...
  if (bVar15) {
    if ((*(int *)(param_1 + 0x80) == 2) ||
      ...
      if ((int)uVar16 < *(int *)(param_1 + 0x90)) {
        TVar12 = param_1[0x98];
joined_r0x008426c4:
        if (TVar12 == (TypedModuleWithMasks)0x0) goto LAB_00842894;
      }
      else {
        TVar12 = param_1[0x98];
        if (*(int *)(param_1 + 0x94) < (int)uVar16) goto joined_r0x008426c4;
        if (TVar12 != (TypedModuleWithMasks)0x0) goto LAB_00842894;
      }
      if ((*(uint *)(param_1 + 0x9c) != 0) &&
         (uVar16 = *(uint *)(param_1 + 0x9c) & uVar16, uVar16 == 0)) goto LAB_008428c4;
      if (*(IDensityPixelSource **)(param_1 + 0xa8) != param_2) goto LAB_008425f4;
      if (pIVar19 != param_2) goto LAB_008426f8;
      goto LAB_008428c0;
    }
LAB_00842894:
    uVar16 = 0;
...
joined_r0x008426ac:
        ...
        TVar12 = param_1[200];
        if (*(int *)(param_1 + 0xc4) < (int)uVar16) goto joined_r0x008426ac;
        if (TVar12 != (TypedModuleWithMasks)0x0) goto LAB_00842894;
      }
      uVar20 = (uint)(*(uint *)(param_1 + 0xcc) != 0 && (*(uint *)(param_1 + 0xcc) & uVar16) == 0);
      uVar16 = uVar20 ^ 1;
      if ((uVar20 != 0) || (pIVar19 == param_2)) goto LAB_008428c4;
    }
LAB_008426f8:
    uVar16 = param_11;
    if (param_11 != 0) {
            ...
            *(uint *)(param_5 + 0x20) = uVar16;
            ...
            if ((iVar5 == 2) || ((iVar5 == 0) != (uVar8 != (uVar16 & param_7)))) {
              ...
              if (((int)uVar2 < iVar6) || (iVar9 < (int)uVar2)) {
                if (TVar12 != (TypedModuleWithMasks)0x0) goto LAB_00842854;
              }
              else if (TVar12 == (TypedModuleWithMasks)0x0) {
LAB_00842854:
                uVar16 = 1;
                if ((uVar11 == 0) || ((uVar11 & uVar2) != 0)) goto LAB_008428c4;
              }
            }
            bVar15 = false;
            uVar13 = uVar13 - 1;
