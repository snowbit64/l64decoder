...
// Function: applyTypedModulesToShapeWithMask2<ChunkedBitSquare,ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
// Entry Point: 0082686c
// Size: 4140 bytes
...
bool DensityMapModifier::
     applyTypedModulesToShapeWithMask2<ChunkedBitSquare,ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
    ...
    if (((uVar11 < uVar9) || (uVar12 < uVar10)) || ((uVar13 < uVar9 || (uVar14 < uVar10)))) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar17 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar17 != 0
                    ...
                    /* try { // try from 0082785c to 00827867 has its CatchHandler @ 00827898 */
      ...
      do {
        ...
        if (uVar13 < *(uint *)(param_7 + 0x5c)) {
          do {
            ...
            lVar28 = *plVar29;
            uVar27 = (plVar29[1] - lVar28 >> 3) * 0x684bda13;
            local_78 = uVar16;
            if ((int)uVar27 != 0) {
              lVar19 = 0;
              while( true ) {
                this = (TypedModuleWithMasks *)(lVar28 + lVar19);
                bVar5 = checkTypedModuleMasks2<ChunkedBitSquare,ProceduralDensityPixelSource_const,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
            ...
            if (uVar14 != local_78) {
              ...
              lVar28 = *(long *)(*(long *)(local_88 + 10) + lVar19);
              uVar32 = (**(code **)(lVar28 + 8))(lVar28,uVar14,0,local_88[0xf],local_78);
              *(undefined8 *)(*(long *)(puVar4 + 10) + lVar19) = uVar32;
              if (1 < puVar4[0xd]) {
                ...
                do {
                  ...
                  lVar28 = *(long *)(*(long *)(puVar4 + 10) + lVar19);
                  uVar32 = (**(code **)(lVar28 + 8))
                                     (lVar28,uVar14,0,*puVar26,uVar21 >> (ulong)(puVar26[-1] & 0x1f)
                                     );
                  uVar27 = uVar27 + 1;
                  puVar26 = puVar26 + 2;
                  *(undefined8 *)(*(long *)(puVar4 + 10) + lVar19) = uVar32;
      ...
      do {
        ...
        if (uVar10 < *(uint *)(param_7 + 0x5c)) {
          ...
          do {
            ...
            uVar13 = (int)((ulong)(plVar29[1] - *plVar29) >> 3) * 0x684bda13;
            local_78 = uVar14;
            if (uVar13 != 0) {
              local_a8 = uVar10 >> (ulong)(local_14c & 0x1f);
              uVar25 = (((uVar11 >> 5) << (ulong)(*local_b0 & 0x1f)) + (local_a8 >> 5)) *
                       local_b0[0xd];
              ppcVar18 = *(code ***)(*(long *)(local_b0 + 10) + (ulong)uVar25 * 8);
              uVar21 = local_a8 & 0x1f | (uVar11 & 0x1f) << 5;
              uStack_a4 = uVar11;
              uVar16 = (**ppcVar18)(ppcVar18,uVar21,0,local_b0[0xf]);
              if (1 < puVar4[0xd]) {
                puVar26 = puVar4 + 0x11;
                uVar27 = 1;
                do {
              ...
              uStack_cc = uVar9 >> (ulong)(local_158 & 0x1f);
              local_a0 = uVar16;
              ...
              do {
                ...
                pIVar22 = *(IDensityPixelSource **)
                           ((SetOrAddDensityProcessor<ChunkedBitSquare,false> *)(lVar19 + lVar28) +
                           0x78);
...
LAB_008271e4:
                  ...
                  if (pIVar22 == param_1) {
                    ...
                    if ((*(int *)(lVar23 + 0x80) == 2) ||
                      ...
                      if ((int)uVar25 < *(int *)(lVar23 + 0x90)) goto LAB_008270ac;
LAB_0082703c:
                      cVar2 = *(char *)(lVar19 + lVar28 + 0x98);
                      goto joined_r0x008270b0;
                    }
                  }
                  else {
                    if (pIVar22 == param_3) {
                      iVar17 = *(int *)(lVar19 + lVar28 + 0x80);
                      uVar25 = uVar7;
                      uVar21 = local_a0;
                    }
                    else {
                    ...
                    if ((iVar17 == 2) ||
                       ((iVar17 == 0) != (*(uint *)(lVar19 + lVar28 + 0x84) != (uVar21 & uVar25))))
                    {
                      lVar23 = lVar19 + lVar28;
                      uVar25 = uVar21 >> (ulong)(*(uint *)(lVar23 + 0x88) & 0x1f) &
                               (-1 << (ulong)(*(uint *)(lVar23 + 0x8c) & 0x1f) ^ 0xffffffffU);
                      if (*(int *)(lVar23 + 0x90) <= (int)uVar25) goto LAB_0082703c;
LAB_008270ac:
                      cVar2 = *(char *)(lVar19 + lVar28 + 0x98);
joined_r0x008270b0:
                      if ((cVar2 != '\0') &&
                         ((uVar21 = *(uint *)(lVar19 + lVar28 + 0x9c), uVar21 == 0 ||
                          ((uVar21 & uVar25) != 0)))) {
                        pIVar22 = *(IDensityPixelSource **)(lVar19 + lVar28 + 0xa8);
                        if (pIVar22 == (IDensityPixelSource *)0x0) goto LAB_008271e4;
                        if (pIVar22 == param_1) {
                          lVar23 = lVar19 + lVar28;
                          if ((*(int *)(lVar23 + 0xb0) == 2) ||
                            ...
                            if ((int)uVar25 < *(int *)(lVar23 + 0xc0)) goto LAB_008271c0;
LAB_00827150:
                            cVar2 = *(char *)(lVar19 + lVar28 + 200);
                            goto joined_r0x008271c4;
                          }
                        }
                        else {
                          if (pIVar22 == param_3) {
                            iVar17 = *(int *)(lVar19 + lVar28 + 0xb0);
                            uVar25 = uVar7;
                            uVar21 = local_a0;
                          }
                          else {
                          ...
                          if ((iVar17 == 2) ||
                             ((iVar17 == 0) !=
                              (*(uint *)(lVar19 + lVar28 + 0xb4) != (uVar21 & uVar25)))) {
                            lVar23 = lVar19 + lVar28;
                            uVar25 = uVar21 >> (ulong)(*(uint *)(lVar23 + 0xb8) & 0x1f) &
                                     (-1 << (ulong)(*(uint *)(lVar23 + 0xbc) & 0x1f) ^ 0xffffffffU);
                            if (*(int *)(lVar23 + 0xc0) <= (int)uVar25) goto LAB_00827150;
LAB_008271c0:
                            cVar2 = *(char *)(lVar19 + lVar28 + 200);
joined_r0x008271c4:
                            if ((cVar2 != '\0') &&
                               ((uVar21 = *(uint *)(lVar19 + lVar28 + 0xcc), uVar21 == 0 ||
                                ((uVar21 & uVar25) != 0)))) goto LAB_008271e4;
                          }
                        }
                      }
                    }
                  }
                  *(int *)(lVar19 + lVar28 + 4) = *(int *)(lVar19 + lVar28 + 4) + 1;
                }
                uVar25 = local_78;
                puVar4 = local_88;
                lVar28 = lVar28 + 0xd8;
              } while ((ulong)uVar13 * 0xd8 - lVar28 != 0);
              if (uVar14 != local_78) {
                ...
                lVar28 = *(long *)(*(long *)(local_88 + 10) + lVar19);
                uVar32 = (**(code **)(lVar28 + 8))(lVar28,uVar12,0,local_88[0xf],local_78);
                *(undefined8 *)(*(long *)(puVar4 + 10) + lVar19) = uVar32;
                if (1 < puVar4[0xd]) {
                  puVar26 = puVar4 + 0x11;
                  uVar27 = 1;
  ...
  if (param_8 != 0) {
    uVar27 = 0;
    do {
      plVar29 = (long *)(param_9 + uVar27 * 0x18);
      lVar28 = *plVar29;
      lVar19 = plVar29[1];
      if (lVar19 != lVar28) {
        uVar30 = 0;
        do {
          if (*(char *)(lVar28 + uVar30 * 0xd8 + 0x6c) != '\0') {
            lVar28 = lVar28 + uVar30 * 0xd8;
            DensityMap::markDensityRegionDirty
                      (*(DensityMap **)(lVar28 + 0x58),*(uint *)(param_7 + 0x50),
                       *(uint *)(param_7 + 0x48),*(uint *)(param_7 + 0x54),*(uint *)(param_7 + 0x4c)
                       ,*(uint *)(lVar28 + 0x24),*(uint *)(lVar28 + 0x28),*(uint *)(lVar28 + 0x70),
                       *(bool *)(lVar28 + 0x6d),true,true);
            lVar19 = plVar29[1];
            lVar28 = *plVar29;
          }
          uVar30 = (ulong)((int)uVar30 + 1);
          uVar24 = (lVar19 - lVar28 >> 3) * -0x7b425ed097b425ed;
