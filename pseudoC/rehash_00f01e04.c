...
/* Luau::detail::DenseHashTable<Luau::AstLocal*, std::__ndk1::pair<Luau::AstLocal*,
   Luau::Compile::Variable>, std::__ndk1::pair<Luau::AstLocal* const, Luau::Compile::Variable>,
   Luau::detail::ItemInterfaceMap<Luau::AstLocal*, Luau::Compile::Variable>, Luau::DenseHashPointer,
...
LAB_00f01f2c:
  ...
  pvVar12 = *ppvVar11;
  ppvVar13 = ppvVar11;
  if (pvVar12 == pvVar8) goto LAB_00f01f00;
  do {
    uVar7 = 0;
    ...
    do {
      ...
      if (*ppvVar10 == pvVar14) {
        *ppvVar10 = pvVar12;
        pvVar12 = *ppvVar13;
        goto code_r0x00f01ee4;
      }
      if (*ppvVar10 == pvVar12) goto code_r0x00f01ee4;
      uVar7 = uVar7 + 1;
      uVar9 = uVar7 + uVar9;
...
code_r0x00f01ee4:
    ...
    *(undefined2 *)(ppvVar10 + 2) = *(undefined2 *)(ppvVar11 + (long)pvVar5 * 3 + 2);
    ppvVar10[1] = pvVar6;
    pvVar6 = pvVar2;
LAB_00f01f00:
    do {
      pvVar5 = (void *)((long)pvVar5 + 1);
      if (pvVar6 <= pvVar5) goto LAB_00f01f2c;
      ppvVar11 = (void **)*in_x0;
