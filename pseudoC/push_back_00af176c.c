...
// Function: push_back
// Entry Point: 00af176c
// Size: 440 bytes
// Signature: undefined __thiscall push_back(__split_buffer<SubAllocator::Range,std::__ndk1::allocator<SubAllocator::Range>&> * this, Range * param_1)


/* std::__ndk1::__split_buffer<SubAllocator::Range,
   std::__ndk1::allocator<SubAllocator::Range>&>::push_back(SubAllocator::Range&&) */

void __thiscall
std::__ndk1::__split_buffer<SubAllocator::Range,std::__ndk1::allocator<SubAllocator::Range>&>::
push_back(__split_buffer<SubAllocator::Range,std::__ndk1::allocator<SubAllocator::Range>&> *this,
         Range *param_1)

{
  ...
  if (puVar12 != *(undefined8 **)(this + 0x18)) goto LAB_00af18ec;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00af18d4;
      }
    }
    do {
      puVar11 = puVar8 + 1;
