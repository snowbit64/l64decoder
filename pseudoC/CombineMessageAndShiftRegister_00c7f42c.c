...
// Entry Point: 00c7f42c
// Size: 72 bytes
// Signature: undefined __thiscall CombineMessageAndShiftRegister(CFB_EncryptionTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::CFB_CipherAbstractPolicy,CryptoPP::CFB_ModePolicy>> * this, uchar * param_1, uchar * param_2, uchar * param_3, ulong param_4)
