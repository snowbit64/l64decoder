...
// Function: applyTypedStateColors
// Entry Point: 00871fac
// Size: 464 bytes
// Signature: undefined __thiscall applyTypedStateColors(DensityMapVisualizationOverlay * this, int param_1, int param_2, int param_3, int param_4, DensityMapModifier * param_5, uint param_6, uint param_7, uint param_8, uint * param_9)


/* DensityMapVisualizationOverlay::applyTypedStateColors(int, int, int, int, DensityMapModifier&,
   unsigned int, unsigned int, unsigned int, unsigned int*) */

void __thiscall
DensityMapVisualizationOverlay::applyTypedStateColors
    ...
    do {
      ...
      if (0 < param_3) {
        do {
          ...
          uVar4 = uVar3 & param_7;
          if (((uVar4 - 1 < 0x3f) &&
              (lVar5 = (ulong)uVar4 * 0x88 + (ulong)param_8 * 0x2208,
              uVar3 = uVar3 >> ((ulong)*(uint *)(this + lVar5 + 0x4b0) & 0x3f) &
                      *(uint *)(this + lVar5 + 0x4b4), uVar3 < 0x20)) &&
             (*(uint *)(this + (ulong)uVar3 * 4 + (ulong)uVar4 * 0x88 + (ulong)param_8 * 0x2208 +
                               0x4b8) != 0)) {
            *param_9 = *(uint *)(this + (ulong)uVar3 * 4 +
                                        (ulong)uVar4 * 0x88 + (ulong)param_8 * 0x2208 + 0x4b8);
            return;
          }
          uVar8 = uVar8 + 1;
