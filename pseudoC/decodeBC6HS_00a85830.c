...
// Function: decodeBC6HS
// Entry Point: 00a85830
// Size: 864 bytes
// Signature: undefined __cdecl decodeBC6HS(uchar * param_1, uint param_2, uint param_3, ushort * param_4)


/* BC6BC7Util::decodeBC6HS(unsigned char*, unsigned int, unsigned int, unsigned short*) */

void BC6BC7Util::decodeBC6HS(uchar *param_1,uint param_2,uint param_3,ushort *param_4)
  ...
  if (3 < param_3) {
    ...
    do {
      if (3 < param_2) {
        ...
        iVar15 = iVar14;
        do {
          D3DX_BC6H::Decode((D3DX_BC6H *)param_1,true,local_170);
          lVar7 = 0;
          puVar8 = local_168;
          iVar9 = iVar15;
          do {
...
LAB_00a85a7c:
                ...
                if (0x8e < uVar4) goto LAB_00a85a7c;
...
LAB_00a85b04:
                ...
                if (0x8e < uVar4) goto LAB_00a85b04;
                uVar13 = uVar13 | (ushort)(uVar1 >> 0xd) | (short)iVar3 * 0x400;
              }
              uVar1 = puVar11[1];
              uVar4 = uVar1 >> 0x17 & 0xff;
...
LAB_00a85b78:
                ...
                if (0x8e < uVar4) goto LAB_00a85b78;
                uVar12 = uVar12 | (ushort)(uVar1 >> 0xd) | (short)iVar3 * 0x400;
              }
              lVar10 = lVar10 + 4;
              puVar11 = puVar11 + 4;
