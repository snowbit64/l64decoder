...
// Function: rehash
// Entry Point: 00a0ba18
// Size: 220 bytes
// Signature: undefined __thiscall rehash(__hash_table<std::__ndk1::__hash_value_type<unsigned_int,ITextureObject*>,std::__ndk1::__unordered_map_hasher<unsigned_int,std::__ndk1::__hash_value_type<unsigned_int,ITextureObject*>,std::__ndk1::hash<unsigned_int>,true>,std::__ndk1::__unordered_map_equal<unsigned_int,std::__ndk1::__hash_value_type<unsigned_int,ITextureObject*>,std::__ndk1::equal_to<unsigned_int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned_int,ITextureObject*>>> * this, ulong param_1)
...

{
  ...
  uVar2 = *(ulong *)(this + 8);
  uVar1 = param_1;
  if (uVar2 < param_1) goto LAB_00a0bacc;
  if (uVar2 <= param_1) {
    return;
  }
...
LAB_00a0bab8:
    ...
    if (1 < (uint)CONCAT62((int6)((ulong)uVar4 >> 0x10),uVar3)) goto LAB_00a0bab8;
    if (1 < uVar1) {
