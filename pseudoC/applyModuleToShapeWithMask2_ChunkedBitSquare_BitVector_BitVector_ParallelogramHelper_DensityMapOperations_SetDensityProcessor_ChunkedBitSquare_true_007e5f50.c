...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,BitVector,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 007e5f50
// Size: 4308 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,BitVector,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
    ...
    if (((uVar21 < local_98) || (uVar26 < local_94)) || ((uVar22 < local_94 || (uVar25 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar33 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar33 != 0
                    ...
                    /* try { // try from 007e6fe8 to 007e6ff3 has its CatchHandler @ 007e7024 */
              ...
              do {
                ...
                if ((iVar33 == 2) || ((iVar33 == 0) != ((uVar39 & uVar14) != uVar5))) {
                  ...
                  if (((int)uVar39 < iVar6) || (iVar30 < (int)uVar39)) {
                    if (DVar10 != (DensityMapFilter)0x0) goto LAB_007e6cb0;
                  }
...
LAB_007e6d1c:
  uVar31 = uVar31 + 1;
  uVar3 = uVar3 + uVar27;
  if (uVar31 == uVar17) goto LAB_007e6ce4;
  goto LAB_007e6d2c;
LAB_007e6ce4:
  uVar37 = uVar37 + 1;
  uVar38 = uVar38 + uVar25 * uVar27;
  if (uVar37 == uVar35) goto LAB_007e6b64;
  goto LAB_007e6cfc;
}
