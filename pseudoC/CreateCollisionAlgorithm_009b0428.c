...
/* Bt2WheelConvexCollisionAlgorithm::SwappedCreateFunc::CreateCollisionAlgorithm(btCollisionAlgorithmConstructionInfo&,
   btCollisionObjectWrapper const*, btCollisionObjectWrapper const*) */

undefined8 * __thiscall
Bt2WheelConvexCollisionAlgorithm::SwappedCreateFunc::CreateCollisionAlgorithm
