...
// Function: __sort4<RenderQueueItemAllocator::GeometryBucket::SortByDepth&,RenderQueueItemAllocator::GeometryBucket*>
// Entry Point: 00a35284
// Size: 364 bytes
// Signature: uint __cdecl __sort4<RenderQueueItemAllocator::GeometryBucket::SortByDepth&,RenderQueueItemAllocator::GeometryBucket*>(GeometryBucket * param_1, GeometryBucket * param_2, GeometryBucket * param_3, GeometryBucket * param_4, SortByDepth * param_5)


/* unsigned int std::__ndk1::__sort4<RenderQueueItemAllocator::GeometryBucket::SortByDepth&,
...
uint std::__ndk1::
     __sort4<RenderQueueItemAllocator::GeometryBucket::SortByDepth&,RenderQueueItemAllocator::GeometryBucket*>
               (GeometryBucket *param_1,GeometryBucket *param_2,GeometryBucket *param_3,
               GeometryBucket *param_4,SortByDepth *param_5)
...
LAB_00a35350:
    ...
    if (dVar4 <= *(double *)(param_3 + 0x18)) {
      ...
      *(undefined8 *)(param_2 + 0x18) = uVar11;
      *(undefined8 *)(param_2 + 0x10) = uVar10;
      if (*(double *)(param_2 + 0x18) <= *(double *)(param_3 + 0x18)) goto LAB_00a35350;
      uVar5 = *(undefined8 *)param_3;
      uVar7 = *(undefined8 *)(param_3 + 0x18);
      uVar6 = *(undefined8 *)(param_3 + 0x10);
      uVar2 = 2;
