...
// Function: checkTypedModuleMasks2<ProceduralDensityPixelSource_const,ChunkedBitSquare,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
// Entry Point: 00832640
// Size: 1292 bytes
// Signature: bool __cdecl checkTypedModuleMasks2<ProceduralDensityPixelSource_const,ChunkedBitSquare,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>(TypedModuleWithMasks * param_1, IDensityPixelSource * param_2, uint param_3, uint param_4, HelperSource * param_5, IDensityPixelSource * param_6, uint param_7, uint param_8, uint param_9, uint param_10, uint param_11, HelperSource * param_12, IDensityPixelSource * param_13, uint param_14, uint param_15, uint param_16, uint param_17, uint param_18)


/* bool DensityMapModifier::checkTypedModuleMasks2<ProceduralDensityPixelSource const,
   ChunkedBitSquare, DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare, false>
...
bool DensityMapModifier::
     checkTypedModuleMasks2<ProceduralDensityPixelSource_const,ChunkedBitSquare,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
...
joined_r0x00832764:
      ...
      TVar3 = param_1[0x98];
      if (*(int *)(param_1 + 0x94) < (int)uVar18) goto joined_r0x00832764;
      if (TVar3 != (TypedModuleWithMasks)0x0) {
        return false;
      }
    }
    ...
    pIVar13 = *(IDensityPixelSource **)(param_1 + 0xa8);
    if (pIVar13 == param_2) goto LAB_00832798;
  }
...
joined_r0x0083274c:
    ...
    TVar3 = param_1[200];
    if (*(int *)(param_1 + 0xc4) < (int)uVar18) goto joined_r0x0083274c;
    if (TVar3 != (TypedModuleWithMasks)0x0) {
      return false;
    }
  }
          ...
          *(uint *)(param_5 + 0x20) = uVar9;
          ...
          if ((*(IDensityPixelSource **)(param_1 + 0x78) == param_6) &&
            ...
            if ((int)uVar9 < *(int *)(param_1 + 0x90)) {
              TVar3 = param_1[0x98];
joined_r0x00832ad0:
              if (TVar3 == (TypedModuleWithMasks)0x0) goto LAB_00832a28;
            }
            else {
              TVar3 = param_1[0x98];
              if (*(int *)(param_1 + 0x94) < (int)uVar9) goto joined_r0x00832ad0;
              if (TVar3 != (TypedModuleWithMasks)0x0) goto LAB_00832a28;
            }
...
LAB_008329d4:
        ...
        if ((*(IDensityPixelSource **)(param_1 + 0x78) == param_13) &&
          ...
          if ((int)uVar9 < *(int *)(param_1 + 0x90)) {
            TVar3 = param_1[0x98];
joined_r0x008329c0:
            if (TVar3 == (TypedModuleWithMasks)0x0) goto LAB_00832854;
          }
          else {
            TVar3 = param_1[0x98];
            if (*(int *)(param_1 + 0x94) < (int)uVar9) goto joined_r0x008329c0;
            if (TVar3 != (TypedModuleWithMasks)0x0) goto LAB_00832854;
          }
