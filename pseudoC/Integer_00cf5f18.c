...
// Function: Integer
// Entry Point: 00cf5f18
// Size: 276 bytes
// Signature: undefined __thiscall Integer(Integer * this, RandomNumberGenerator * param_1, ulong param_2)


/* CryptoPP::Integer::Integer(CryptoPP::RandomNumberGenerator&, unsigned long) */

void __thiscall
CryptoPP::Integer::Integer(Integer *this,RandomNumberGenerator *param_1,ulong param_2)

{
  ...
  *(undefined ***)this = &PTR__Integer_0100c890;
                    /* try { // try from 00cf6018 to 00cf601f has its CatchHandler @ 00cf602c */
  Randomize(this,param_1,param_2);
  return;
}
