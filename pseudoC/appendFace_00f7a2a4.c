...
// Function: appendFace
// Entry Point: 00f7a2a4
// Size: 480 bytes
// Signature: undefined __thiscall appendFace(btSoftBody * this, int param_1, Material * param_2)


/* btSoftBody::appendFace(int, btSoftBody::Material*) */

void __thiscall btSoftBody::appendFace(btSoftBody *this,int param_1,Material *param_2)

{
  ...
  if (param_1 < 0) {
    ...
    puVar7 = (undefined8 *)(*(long *)(this + 0x3c0) + (ulong)(uint)param_1 * 0x48);
    uStack_78 = puVar7[3];
    local_80 = puVar7[2];
    uStack_68 = puVar7[5];
    local_70 = puVar7[4];
    ...
    if ((int)uVar5 < iVar2) {
      ...
      if (0 < (int)uVar5) {
        ...
        do {
          ...
          puVar1 = (undefined8 *)(*(long *)(this + 0x3c0) + lVar8);
          lVar8 = lVar8 + 0x48;
          uVar9 = *puVar1;
          puVar7[1] = puVar1[1];
          *puVar7 = uVar9;
      ...
      uVar5 = *(uint *)(this + 0x3b4);
      *(long *)(this + 0x3c0) = lVar4;
      *(int *)(this + 0x3b8) = iVar2;
      this[0x3c8] = (btSoftBody)0x1;
    }
  }
  puVar7 = (undefined8 *)(*(long *)(this + 0x3c0) + (long)(int)uVar5 * 0x48);
  puVar7[3] = uStack_78;
  puVar7[2] = local_80;
  puVar7[5] = uStack_68;
  puVar7[4] = local_70;
