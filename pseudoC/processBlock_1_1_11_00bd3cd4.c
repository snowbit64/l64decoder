...
// Function: processBlock_1_1_11
// Entry Point: 00bd3cd4
// Size: 2740 bytes
// Signature: undefined __cdecl processBlock_1_1_11(CustomCipher * param_1, uchar * param_2)


/* CustomCipher::processBlock_1_1_11(CustomCipher&, unsigned char*) */

void CustomCipher::processBlock_1_1_11(CustomCipher *param_1,uchar *param_2)

{
  ...
  uVar2 = ((uint)(byte)CVar8 << 0x10 |
          ...
          uVar2;
  uVar15 = *(uint *)(s_wO_L4 + (ulong)(uVar1 & 0xf) * 4) |
  ...
  param_2[3] = (uchar)uVar15;
  param_2[2] = (uchar)(uVar15 >> 8);
  *(uint *)(param_2 + 4) = uVar1 >> 0x10 | uVar1 << 0x10;
  param_2[1] = (uchar)(uVar15 >> 0x10);
  *param_2 = (uchar)(uVar15 >> 0x18);
  return;
}
