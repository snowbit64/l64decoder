...
// Function: writeBits
// Entry Point: 0085538c
// Size: 200 bytes
// Signature: undefined __cdecl writeBits(BitVector * param_1, uint param_2, uint param_3, uint param_4, uint param_5, uint param_6, uint param_7, uint param_8)


/* DensityMapAccessUtil::writeBits(BitVector*, unsigned int, unsigned int, unsigned int, unsigned
   int, unsigned int, unsigned int, unsigned int) */

void DensityMapAccessUtil::writeBits
...

{
  ...
  lVar7 = *(long *)param_1;
  uVar3 = param_6 + (param_4 + param_5 * param_3) * param_2;
  uVar4 = ~(-1 << (ulong)(param_7 & 0x1f));
  uVar2 = uVar3 & 7;
  ...
  if (0xfffc < (uint)uVar6) {
    ...
    uVar2 = (uint)CONCAT12(*(undefined *)(*(long *)(lVar7 + lVar11) + uVar8),
            ...
            (uVar4 << (ulong)uVar2 ^ 0xffffffff) | param_8 << (ulong)uVar2;
  ...
  *(uint *)(lVar5 + uVar6) =
       *(uint *)(lVar5 + uVar6) & (uVar4 << (ulong)uVar2 ^ 0xffffffff) | param_8 << (ulong)uVar2;
  return;
}
