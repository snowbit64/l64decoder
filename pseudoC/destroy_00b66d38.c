...
// Function: destroy
// Entry Point: 00b66d38
// Size: 64 bytes
// Signature: undefined __thiscall destroy(__tree<std::__ndk1::__value_type<std::__ndk1::pair<unsigned_short,unsigned_short>,unsigned_int>,std::__ndk1::__map_value_compare<std::__ndk1::pair<unsigned_short,unsigned_short>,std::__ndk1::__value_type<std::__ndk1::pair<unsigned_short,unsigned_short>,unsigned_int>,std::__ndk1::less<std::__ndk1::pair<unsigned_short,unsigned_short>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::pair<unsigned_short,unsigned_short>,unsigned_int>>> * this, __tree_node * param_1)


/* std::__ndk1::__tree<std::__ndk1::__value_type<std::__ndk1::pair<unsigned short, unsigned short>,
   unsigned int>, std::__ndk1::__map_value_compare<std::__ndk1::pair<unsigned short, unsigned
   short>, std::__ndk1::__value_type<std::__ndk1::pair<unsigned short, unsigned short>, unsigned
   int>, std::__ndk1::less<std::__ndk1::pair<unsigned short, unsigned short> >, true>,
