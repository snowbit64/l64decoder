...
// Function: __append
// Entry Point: 00ab84ac
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<VulkanRenderQuery*,std::__ndk1::allocator<VulkanRenderQuery*>> * this, ulong param_1)


/* std::__ndk1::vector<VulkanRenderQuery*, std::__ndk1::allocator<VulkanRenderQuery*>
   >::__append(unsigned long) */

void __thiscall
std::__ndk1::vector<VulkanRenderQuery*,std::__ndk1::allocator<VulkanRenderQuery*>>::__append
          (vector<VulkanRenderQuery*,std::__ndk1::allocator<VulkanRenderQuery*>> *this,ulong param_1
          )
