...
/* std::__ndk1::__split_buffer<std::__ndk1::pair<unsigned short, unsigned short>*,
   ...
   short>*>&>::push_back(std::__ndk1::pair<unsigned short, unsigned short>*&&) */
...

{
  ...
  if (pppVar12 != *(pair ***)(this + 0x18)) goto LAB_00730554;
  pppVar3 = *(pair ***)this;
  __src = *(pair ***)(this + 8);
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_0073053c;
      }
    }
    do {
      pppVar11 = pppVar8 + 1;
