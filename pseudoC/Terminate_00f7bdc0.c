...
// Function: Terminate
// Entry Point: 00f7bdc0
// Size: 140 bytes
// Signature: undefined __cdecl Terminate(float param_1)


/* btSoftBody::LJoint::Terminate(float) */

void btSoftBody::LJoint::Terminate(float param_1)

{
  ...
  if (0.0 < *(float *)(in_x0 + 0x60)) {
    ...
    Body::applyDImpulse((Body *)(in_x0 + 8),(btVector3 *)&local_38,(btVector3 *)(in_x0 + 0xb8));
