...
// Function: _decode<BitVector,unsigned_char,CompressedIoUtil::CompressedFileInput<unsigned_char,File>>
// Entry Point: 00b98474
// Size: 768 bytes
// Signature: void __cdecl _decode<BitVector,unsigned_char,CompressedIoUtil::CompressedFileInput<unsigned_char,File>>(CompressedFileInput * param_1, uint param_2, uint param_3, BitVector * param_4)


/* void RLEUtil::_decode<BitVector, unsigned char, CompressedIoUtil::CompressedFileInput<unsigned
   char, File> >(CompressedIoUtil::CompressedFileInput<unsigned char, File>*, unsigned int, unsigned
   int, BitVector*) */
...

{
  ...
  if (*(uint *)(param_1 + 0xc) < *(uint *)(param_1 + 8)) {
    ...
    bVar18 = 0;
    do {
      iVar6 = (**(code **)(**(long **)param_1 + 0x28))(*(long **)param_1,local_6c,1);
      if (iVar6 != 1) break;
      ...
      *(int *)(param_1 + 0xc) = *(int *)(param_1 + 0xc) + 1;
      ...
      if ((((local_6c[0] == bVar18) && (((uVar16 ^ 1) & 1) == 0)) &&
         ...
         (iVar6 = (**(code **)(**(long **)param_1 + 0x28))(*(long **)param_1,local_70,1), iVar6 == 1
         )) {
        ...
        *(uint *)(param_1 + 0xc) = uVar16;
        ...
        while (((uVar8 == 0xff && (uVar16 < *(uint *)(param_1 + 8))) &&
               (iVar6 = (**(code **)(**(long **)param_1 + 0x28))(*(long **)param_1,local_70,1),
               iVar6 == 1))) {
          uVar16 = *(int *)(param_1 + 0xc) + 1;
