...
// Function: setMargin
// Entry Point: 00f579bc
// Size: 216 bytes
// Signature: undefined __thiscall setMargin(btBoxShape * this, float param_1)


/* btBoxShape::setMargin(float) */

void __thiscall btBoxShape::setMargin(btBoxShape *this,float param_1)
