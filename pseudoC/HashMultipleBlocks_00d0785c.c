...
// Entry Point: 00d0785c
// Size: 652 bytes
// Signature: undefined __thiscall HashMultipleBlocks(IteratedHashBase<unsigned_long,CryptoPP::MessageAuthenticationCode> * this, ulong * param_1, ulong param_2)


/* CryptoPP::IteratedHashBase<unsigned long,
   CryptoPP::MessageAuthenticationCode>::HashMultipleBlocks(unsigned long const*, unsigned long) */

ulong __thiscall
CryptoPP::IteratedHashBase<unsigned_long,CryptoPP::MessageAuthenticationCode>::HashMultipleBlocks
          (IteratedHashBase<unsigned_long,CryptoPP::MessageAuthenticationCode> *this,ulong *param_1,
          ulong param_2)

{
  ...
  uVar5 = (**(code **)(*(long *)(this + 8) + 0x50))();
  __n = uVar5 & 0xffffffff;
  iVar4 = (**(code **)(*(long *)this + 0xc0))(this);
  __dest = (ulong *)(**(code **)(*(long *)this + 0xd8))(this);
  uVar13 = __n >> 3;
  if (iVar4 == 0) {
    lVar12 = 0;
    do {
      ...
      (**(code **)(*(long *)this + 200))(this,puVar6);
      param_2 = param_2 - __n;
    ...
    if (uVar11 < 8) {
      ...
      do {
        ...
        (**(code **)(*(long *)this + 200))(this,__dest);
        param_2 = param_2 - __n;
        lVar12 = lVar12 + (uVar5 & 0xfffffff8);
      } while (__n <= param_2);
    }
      ...
      do {
        if (((ulong)puVar6 & 7) == 0) {
          if (uVar11 < 0x20) {
            ...
            uVar8 = uVar14;
            if (uVar13 == uVar14) goto LAB_00d0799c;
          }
          do {
            uVar1 = uVar8 + 1;
