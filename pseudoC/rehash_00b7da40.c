...
// Function: rehash
// Entry Point: 00b7da40
// Size: 220 bytes
// Signature: undefined __thiscall rehash(__hash_table<unsigned_int,std::__ndk1::hash<unsigned_int>,std::__ndk1::equal_to<unsigned_int>,std::__ndk1::allocator<unsigned_int>> * this, ulong param_1)


/* std::__ndk1::__hash_table<unsigned int, std::__ndk1::hash<unsigned int>,
   std::__ndk1::equal_to<unsigned int>, std::__ndk1::allocator<unsigned int> >::rehash(unsigned
   long) */
...

{
  ...
  uVar2 = *(ulong *)(this + 8);
  uVar1 = param_1;
  if (uVar2 < param_1) goto LAB_00b7daf4;
  if (uVar2 <= param_1) {
    return;
  }
...
LAB_00b7dae0:
    ...
    if (1 < (uint)CONCAT62((int6)((ulong)uVar4 >> 0x10),uVar3)) goto LAB_00b7dae0;
    if (1 < uVar1) {
