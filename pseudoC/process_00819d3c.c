...
// Function: process
// Entry Point: 00819d3c
// Size: 240 bytes
// Signature: undefined __thiscall process(SetTypeProcessor<ChunkedBitSquare> * this, HelperSource * param_1)


/* DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>::process(DensityMapAccessUtil::HelperSource<ChunkedBitSquare>&)
    */

void __thiscall
DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>::process
          (SetTypeProcessor<ChunkedBitSquare> *this,HelperSource *param_1)

{
  ...
  uint uVar3;
  uint uVar4;
  SetTypeProcessor<ChunkedBitSquare> SVar5;
  ...
  *(uint *)(this + 0x44) = uVar1;
  ...
  if ((int)uVar2 < *(int *)(this + 0x2c)) {
    ...
    if ((int)uVar2 <= *(int *)(this + 0x30)) {
      if (SVar5 != (SetTypeProcessor<ChunkedBitSquare>)0x0) {
        return;
      }
      goto LAB_00819dc0;
    }
