...
// Entry Point: 00c877a0
// Size: 188 bytes
// Signature: undefined GetCofactor(void)


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* CryptoPP::DL_GroupParameters<CryptoPP::Integer>::GetCofactor() const */

void CryptoPP::DL_GroupParameters<CryptoPP::Integer>::GetCofactor(void)

{
  ...
  (**(code **)(*in_x0 + 0xb0))(local_68);
                    /* try { // try from 00c877e0 to 00c877f7 has its CatchHandler @ 00c87860 */
  (**(code **)(*in_x0 + 0xa0))();
  ...
  for (; local_58 != 0; local_58 = local_58 - 1) {
    *(undefined4 *)((long)local_48 + local_58 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00c87830 to 00c87833 has its CatchHandler @ 00c8785c */
