...
// Function: checkTypedModuleMasks2<ChunkedBitSquare,BitVector,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>
// Entry Point: 0083fa6c
// Size: 1424 bytes
// Signature: bool __cdecl checkTypedModuleMasks2<ChunkedBitSquare,BitVector,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>(TypedModuleWithMasks * param_1, IDensityPixelSource * param_2, uint param_3, uint param_4, HelperSource * param_5, IDensityPixelSource * param_6, uint param_7, uint param_8, uint param_9, uint param_10, uint param_11, HelperSource * param_12, IDensityPixelSource * param_13, uint param_14, uint param_15, uint param_16, uint param_17, uint param_18)
...
bool DensityMapModifier::
     checkTypedModuleMasks2<ChunkedBitSquare,BitVector,DensityMapOperations::SetOrAddDensityProcessor<BitVector,false>>
...
joined_r0x0083fb8c:
      ...
      TVar8 = param_1[0x98];
      if (*(int *)(param_1 + 0x94) < (int)uVar21) goto joined_r0x0083fb8c;
      if (TVar8 != (TypedModuleWithMasks)0x0) {
        return false;
      }
    }
    ...
    pIVar22 = *(IDensityPixelSource **)(param_1 + 0xa8);
    if (pIVar22 == param_2) goto LAB_0083fbc0;
  }
...
joined_r0x0083fb74:
    ...
    TVar8 = param_1[200];
    if (*(int *)(param_1 + 0xc4) < (int)uVar21) goto joined_r0x0083fb74;
    if (TVar8 != (TypedModuleWithMasks)0x0) {
      return false;
    }
  }
...
LAB_0083fc00:
          ...
          if ((*(IDensityPixelSource **)(param_1 + 0x78) == param_6) &&
            ...
            if ((int)uVar3 < *(int *)(param_1 + 0x90)) {
              TVar8 = param_1[0x98];
joined_r0x0083fdb8:
              if (TVar8 == (TypedModuleWithMasks)0x0) goto LAB_0083fc50;
            }
            else {
              TVar8 = param_1[0x98];
              if (*(int *)(param_1 + 0x94) < (int)uVar3) goto joined_r0x0083fdb8;
              if (TVar8 != (TypedModuleWithMasks)0x0) goto LAB_0083fc50;
            }
        ...
        *(uint *)(param_12 + 0x20) = uVar16;
        if ((bool)(bVar12 | pIVar19 != param_13)) {
          ...
          if (((int)uVar16 < iVar15) || (iVar5 < (int)uVar16)) {
            if (TVar8 != (TypedModuleWithMasks)0x0) goto LAB_0083ff8c;
          }
