...
// Function: push_back
// Entry Point: 00862778
// Size: 440 bytes
// Signature: undefined __thiscall push_back(__split_buffer<std::__ndk1::pair<short,short>*,std::__ndk1::allocator<std::__ndk1::pair<short,short>*>> * this, pair * * param_1)


/* std::__ndk1::__split_buffer<std::__ndk1::pair<short, short>*,
   std::__ndk1::allocator<std::__ndk1::pair<short, short>*> >::push_back(std::__ndk1::pair<short,
   short>*&&) */
...

{
  ...
  if (pppVar12 != *(pair ***)(this + 0x18)) goto LAB_008628f8;
  pppVar3 = *(pair ***)this;
  __src = *(pair ***)(this + 8);
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_008628e0;
      }
    }
    do {
      pppVar11 = pppVar8 + 1;
