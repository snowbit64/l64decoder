...
// Function: __sort4<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>
// Entry Point: 00a32c5c
// Size: 364 bytes
// Signature: uint __cdecl __sort4<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>(RasterizerBucket * param_1, RasterizerBucket * param_2, RasterizerBucket * param_3, RasterizerBucket * param_4, SortByDepth * param_5)


/* unsigned int std::__ndk1::__sort4<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,
...
uint std::__ndk1::
     __sort4<RenderQueueItemAllocator::RasterizerBucket::SortByDepth&,RenderQueueItemAllocator::RasterizerBucket*>
               (RasterizerBucket *param_1,RasterizerBucket *param_2,RasterizerBucket *param_3,
               RasterizerBucket *param_4,SortByDepth *param_5)
...
LAB_00a32d28:
    ...
    if (dVar4 <= *(double *)(param_3 + 0x18)) {
      ...
      *(undefined8 *)(param_2 + 0x18) = uVar11;
      *(undefined8 *)(param_2 + 0x10) = uVar10;
      if (*(double *)(param_2 + 0x18) <= *(double *)(param_3 + 0x18)) goto LAB_00a32d28;
      uVar5 = *(undefined8 *)param_3;
      uVar7 = *(undefined8 *)(param_3 + 0x18);
      uVar6 = *(undefined8 *)(param_3 + 0x10);
      uVar2 = 2;
