...
/* Luau::detail::DenseHashTable<Luau::AstLocal*, std::__ndk1::pair<Luau::AstLocal*,
   Luau::AstExprTable*>, std::__ndk1::pair<Luau::AstLocal* const, Luau::AstExprTable*>,
   Luau::detail::ItemInterfaceMap<Luau::AstLocal*, Luau::AstExprTable*>, Luau::DenseHashPointer,
...
LAB_00f00fec:
    ...
    if (((((void *)((long)pvVar3 + lVar4) < pvVar3) || (bVar2)) ||
        ((long)pvVar3 + 8U + lVar4 < (long)pvVar3 + 8U)) || (bVar2)) goto LAB_00f00fec;
    ...
    if (pvVar1 != pvVar6) goto LAB_00f00fec;
  }
  ppvVar5 = (void **)*in_x0;
  pvVar6 = in_x0[1];
joined_r0x00f00f60:
...
joined_r0x00f00f68:
  ...
  pvVar11 = *ppvVar5;
  ppvVar12 = ppvVar5;
  if (pvVar11 == pvVar8) goto LAB_00f01094;
  do {
...
LAB_00f01078:
      *ppvVar13 = pvVar11;
      ...
      do {
        ...
        ppvVar13 = (void **)((long)pvVar3 + uVar9 * 0x10);
        if (*ppvVar13 == pvVar14) goto LAB_00f01078;
        lVar4 = lVar4 + 1;
