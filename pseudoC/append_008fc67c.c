...
// Function: __append
// Entry Point: 008fc67c
// Size: 312 bytes
// Signature: undefined __thiscall __append(vector<IndexedTriangleSet*,std::__ndk1::allocator<IndexedTriangleSet*>> * this, ulong param_1)


/* std::__ndk1::vector<IndexedTriangleSet*, std::__ndk1::allocator<IndexedTriangleSet*>
   >::__append(unsigned long) */

void __thiscall
std::__ndk1::vector<IndexedTriangleSet*,std::__ndk1::allocator<IndexedTriangleSet*>>::__append
          (vector<IndexedTriangleSet*,std::__ndk1::allocator<IndexedTriangleSet*>> *this,
          ulong param_1)
