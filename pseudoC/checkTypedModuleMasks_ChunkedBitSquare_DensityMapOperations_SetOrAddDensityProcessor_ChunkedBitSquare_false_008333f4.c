...
// Function: checkTypedModuleMasks<ChunkedBitSquare,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
// Entry Point: 008333f4
// Size: 912 bytes
// Signature: bool __cdecl checkTypedModuleMasks<ChunkedBitSquare,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>(TypedModuleWithMasks * param_1, IDensityPixelSource * param_2, uint param_3, uint param_4, HelperSource * param_5, IDensityPixelSource * param_6, uint param_7, uint param_8, uint param_9, uint param_10, uint param_11)
...
bool DensityMapModifier::
     checkTypedModuleMasks<ChunkedBitSquare,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
...
joined_r0x00833510:
      ...
      TVar5 = param_1[0x98];
      if (*(int *)(param_1 + 0x94) < (int)uVar15) goto joined_r0x00833510;
      if (TVar5 != (TypedModuleWithMasks)0x0) {
        return false;
      }
    }
  ...
  else if (*(IDensityPixelSource **)(param_1 + 0xa8) == param_2) goto LAB_00833544;
...
joined_r0x008334f8:
    ...
    TVar5 = param_1[200];
    if (*(int *)(param_1 + 0xc4) < (int)uVar15) goto joined_r0x008334f8;
    if (TVar5 != (TypedModuleWithMasks)0x0) {
      return false;
    }
  }
...
LAB_00833724:
             ...
             ((*(int *)(param_1 + 0x80) == 0) != (*(uint *)(param_1 + 0x84) != (uVar10 & param_7))))
          {
            ...
            if ((int)uVar3 < *(int *)(param_1 + 0x90)) {
              TVar5 = param_1[0x98];
joined_r0x00833710:
              if (TVar5 == (TypedModuleWithMasks)0x0) goto LAB_008335bc;
            }
            else {
              TVar5 = param_1[0x98];
              if (*(int *)(param_1 + 0x94) < (int)uVar3) goto joined_r0x00833710;
              if (TVar5 != (TypedModuleWithMasks)0x0) goto LAB_008335bc;
            }
