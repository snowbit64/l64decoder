...
// Function: FUN_00f2b504
// Entry Point: 00f2b504
// Size: 424 bytes
// Signature: undefined FUN_00f2b504(void)


void FUN_00f2b504(long param_1,long param_2,undefined4 *param_3)

{
  ...
  fVar5 = (float)*(undefined8 *)(param_3 + 4);
  fVar6 = (float)((ulong)*(undefined8 *)(param_3 + 4) >> 0x20);
  lVar1 = *(long *)(param_1 + 0xf0);
  uVar2 = NEON_fmadd(*(undefined4 *)(param_1 + 0x48),param_3[6],
                     *(float *)(param_1 + 0x40) * fVar5 + *(float *)(param_1 + 0x44) * fVar6);
  fVar3 = (float)NEON_fmadd(*(undefined4 *)(param_1 + 0x50),*param_3,uVar2);
  fVar9 = (float)param_3[0x19];
  ...
  fVar4 = (float)NEON_fmadd(fVar3 + (float)*(undefined8 *)(param_2 + 0x54) *
                            ...
                            param_3[0x1b],(float)param_3[0x1d] * fVar9);
  fVar7 = ((float)param_3[0x1c] - fVar4) + fVar9;
  fVar3 = fVar7;
  if (fVar7 <= fVar8) {
    fVar3 = fVar8;
  }
  fVar9 = fVar8 - fVar9;
  if (fVar8 <= fVar7) {
    fVar9 = (float)param_3[0x1c] - fVar4;
  }
  param_3[0x19] = fVar3;
  if (lVar1 != 0) {
    uVar2 = NEON_fmadd(fVar9 * (float)param_3[6] * *(float *)(param_1 + 0x88),
    ...
    *(ulong *)(param_1 + 0x40) =
         CONCAT44((float)((ulong)*(undefined8 *)(param_1 + 0x40) >> 0x20) +
                  ...
                  fVar6 * fVar9 * (float)((ulong)*(undefined8 *)(param_1 + 0x80) >> 0x20),
                  (float)*(undefined8 *)(param_1 + 0x40) +
                  (float)*(undefined8 *)(param_1 + 0x70) *
                  fVar5 * fVar9 * (float)*(undefined8 *)(param_1 + 0x80));
    *(undefined4 *)(param_1 + 0x48) = uVar2;
    uVar2 = NEON_fmadd(*(float *)(param_1 + 0x68) * fVar9,param_3[0x12],
  ...
  if (*(long *)(param_2 + 0xf0) != 0) {
    uVar2 = NEON_fmadd(*(float *)(param_2 + 0x88) * fVar9 * (float)param_3[0xe],
    ...
    *(undefined4 *)(param_2 + 0x48) = uVar2;
    uVar2 = NEON_fmadd(*(float *)(param_2 + 0x68) * fVar9,param_3[0x16],
