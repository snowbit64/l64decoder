...
/* std::__ndk1::__split_buffer<TextureStreamingManager::DowngradePipeline::ReallocateRequest*,
   ...
   >::push_back(TextureStreamingManager::DowngradePipeline::ReallocateRequest*&&) */
...

{
  ...
  if (ppRVar12 != *(ReallocateRequest ***)(this + 0x18)) goto LAB_00970edc;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00970ec4;
      }
    }
    do {
      ppRVar11 = ppRVar8 + 1;
