...
// Function: reserve
// Entry Point: 00a18f74
// Size: 208 bytes
// Signature: undefined __thiscall reserve(vector<RenderList::ShapeViewInfo,std::__ndk1::allocator<RenderList::ShapeViewInfo>> * this, ulong param_1)
...
void __thiscall
std::__ndk1::vector<RenderList::ShapeViewInfo,std::__ndk1::allocator<RenderList::ShapeViewInfo>>::
reserve(vector<RenderList::ShapeViewInfo,std::__ndk1::allocator<RenderList::ShapeViewInfo>> *this,
       ulong param_1)
