...
/* non-virtual thunk to
   ...
   CryptoPP::CFB_ModePolicy> >, CryptoPP::CFB_CipherAbstractPolicy> >::AlgorithmProvider() const */
...
::AlgorithmProvider(CipherModeFinalTemplate_CipherHolder<CryptoPP::BlockCipherFinal<(CryptoPP::CipherDir)0,CryptoPP::MDC<CryptoPP::SHA1>::Enc>,CryptoPP::ConcretePolicyHolder<CryptoPP::Empty,CryptoPP::CFB_EncryptionTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::CFB_CipherAbstractPolicy,CryptoPP::CFB_ModePolicy>>,CryptoPP::CFB_CipherAbstractPolicy>>
                    *this)

{
                    /* WARNING: Could not recover jumptable at 0x00d20cf8. Too many branches */
