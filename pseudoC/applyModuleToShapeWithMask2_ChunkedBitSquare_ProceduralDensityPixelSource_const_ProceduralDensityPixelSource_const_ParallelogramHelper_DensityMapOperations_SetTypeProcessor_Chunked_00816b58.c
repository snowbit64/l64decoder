...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
// Entry Point: 00816b58
// Size: 3708 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
    ...
    if (((uVar18 < local_98) || (uVar22 < local_94)) || ((uVar19 < local_94 || (uVar21 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar28 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar28 != 0
                    ...
                    /* try { // try from 00817998 to 008179a3 has its CatchHandler @ 008179d4 */
              ...
              do {
                ...
                if ((iVar28 == 2) || ((iVar28 == 0) != ((uVar26 & uVar12) != uVar4))) {
                  ...
                  if (((int)uVar26 < iVar3) || (iVar25 < (int)uVar26)) {
                    if (DVar8 != (DensityMapFilter)0x0) goto LAB_008176a8;
                  }
...
LAB_008175cc:
  ...
  if (param_6[0x5c] != (SetTypeProcessor)0x0) {
    DensityMap::markDensityRegionDirty
               ...
               *(uint *)(param_5 + 0x54),uVar31,*(uint *)(param_6 + 0x14),*(uint *)(param_6 + 0x18),
...
LAB_008176f8:
  uVar33 = uVar33 + 1;
  if (uVar33 == uVar19) goto LAB_008176d0;
  goto LAB_00817704;
LAB_008176d0:
  uVar32 = uVar32 + 1;
  if (uVar32 == uVar21) goto LAB_008175c0;
  goto LAB_008176e0;
}
