...
// Function: applyModuleToShapeWithMask2<BitVector,BitVector,BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
// Entry Point: 008075c0
// Size: 3764 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask2<BitVector,BitVector,BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, BitVector * param_3, BitVector * param_4, ParallelogramHelper * param_5, AddDensityProcessor * param_6, DensityMapFilter * param_7, DensityMapFilter * param_8)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<BitVector,BitVector,BitVector,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<BitVector,true>>
    ...
    if (((uVar21 < local_98) || (uVar26 < local_94)) || ((uVar22 < local_94 || (uVar25 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar29 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar29 != 0
                    ...
                    /* try { // try from 00808438 to 00808443 has its CatchHandler @ 00808474 */
            ...
            do {
              ...
              if ((iVar29 == 2) || ((iVar29 == 0) != ((uVar37 & uVar15) != uVar4))) {
                ...
                if (((int)uVar37 < iVar5) || (iVar6 < (int)uVar37)) {
                  if (DVar12 != (DensityMapFilter)0x0) goto LAB_008081c8;
                }
    ...
    do {
      ...
      if ((iVar8 == 2) || ((iVar8 == 0) != ((uVar37 & uVar17) != uVar10))) {
        ...
        if (((int)uVar37 < iVar11) || (iVar9 < (int)uVar37)) {
          if (DVar13 != (DensityMapFilter)0x0) goto LAB_008082e8;
        }
...
LAB_008080a4:
  uVar34 = uVar34 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar34) goto LAB_0080803c;
  goto LAB_008080b8;
}
