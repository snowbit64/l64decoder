...
/* CryptoPP::DL_SignatureMessageEncodingMethod_NR::ComputeMessageRepresentative(CryptoPP::RandomNumberGenerator&,
...
void CryptoPP::DL_SignatureMessageEncodingMethod_NR::ComputeMessageRepresentative
...

{
  ...
  if (in_stack_00000008 <= (uVar2 & 0xffffffff) * 8) {
    Integer::Integer((Integer *)local_98,param_9,uVar5,0,1);
                    /* try { // try from 00ceade4 to 00ceadff has its CatchHandler @ 00ceae74 */
    Integer::operator>>=
              ((Integer *)local_98,
               ((in_stack_00000008 + 7 & 0xfffffffffffffff8) - in_stack_00000008) + 1);
    ...
    for (; local_88 != 0; local_88 = local_88 - 1) {
      *(undefined4 *)((long)local_78 + local_88 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00ceae38 to 00ceae3b has its CatchHandler @ 00ceae70 */
