...
// Entry Point: 009e48e0
// Size: 588 bytes
// Signature: undefined __thiscall addTerrainTextureObject(ProceduralPlacementRule * this, uint param_1, basic_string * param_2, basic_string * param_3, uint param_4, uint param_5, uint param_6, uint param_7, int param_8)


/* ProceduralPlacementRule::addTerrainTextureObject(unsigned int, std::__ndk1::basic_string<char,
...

{
  ...
  int iVar3;
  ulong uVar4;
  ProceduralPlacementTextureObjectDesc *this_00;
  ProceduralPlacementManager *this_01;
  void *__dest;
  ProceduralPlacementTextureObjectDesc **ppPVar5;
  long lVar6;
  ulong uVar7;
  ulong uVar8;
  ulong uVar9;
  ...
  this_00 = (ProceduralPlacementTextureObjectDesc *)operator_new(0x78);
                    /* try { // try from 009e4930 to 009e4953 has its CatchHandler @ 009e4b2c */
  ...
  ppPVar5 = *(ProceduralPlacementTextureObjectDesc ***)(this + 0x70);
  if (*(int *)(this_00 + 0x28) != -1) goto LAB_009e49c4;
...
LAB_009e4998:
      ...
      uVar9 = 0;
      if (((int)(uVar8 - 1) == -1) || (uVar8 - 1 >> 0x20 != 0)) goto LAB_009e4998;
      ...
      if (uVar4 != uVar9) goto LAB_009e4998;
    }
    iVar10 = iVar10 + 1;
  }
  *(int *)(this_00 + 0x28) = iVar10;
LAB_009e49c4:
  if (ppPVar5 < *(ProceduralPlacementTextureObjectDesc ***)(this + 0x78)) {
    *ppPVar5 = this_00;
    *(ProceduralPlacementTextureObjectDesc ***)(this + 0x70) = ppPVar5 + 1;
  }
  else {
    ...
    uVar7 = (long)*(ProceduralPlacementTextureObjectDesc ***)(this + 0x78) - (long)__src;
    uVar8 = (long)uVar7 >> 2;
    if (uVar4 <= uVar8) {
      uVar4 = uVar8;
    }
    ...
    ppPVar5 = (ProceduralPlacementTextureObjectDesc **)((long)__dest + ((long)__n >> 3) * 8);
    *ppPVar5 = this_00;
    if (0 < (long)__n) {
