...
// Function: insert
// Entry Point: 00f54258
// Size: 872 bytes
// Signature: undefined __thiscall insert(btHashMap<btHashInt,btTriangleInfo> * this, btHashInt * param_1, btTriangleInfo * param_2)


/* btHashMap<btHashInt, btTriangleInfo>::insert(btHashInt const&, btTriangleInfo const&) */

void __thiscall
btHashMap<btHashInt,btTriangleInfo>::insert
          (btHashMap<btHashInt,btTriangleInfo> *this,btHashInt *param_1,btTriangleInfo *param_2)

{
  ...
  if (uVar4 == uVar3) {
    ...
    if ((int)uVar3 < (int)uVar5) {
      ...
      if ((*(long *)(this + 0x50) != 0) && (this[0x58] != (btHashMap<btHashInt,btTriangleInfo>)0x0))
      {
      ...
      *(uint *)(this + 0x48) = uVar5;
      this[0x58] = (btHashMap<btHashInt,btTriangleInfo>)0x1;
      uVar10 = *(uint *)(this + 0x44);
    }
  }
  uVar20 = *(undefined8 *)param_2;
  ...
  *(int *)(this + 0x44) = *(int *)(this + 0x44) + 1;
  if (uVar10 != *(uint *)(this + 0x68)) goto LAB_00f54528;
  uVar5 = uVar10 << 1;
  if (uVar10 == 0) {
    uVar5 = 1;
  }
  if ((int)uVar5 <= (int)uVar10) goto LAB_00f54528;
  if (uVar5 == 0) {
    uVar8 = 0;
  }
  else {
  ...
  if ((int)uVar10 < 1) {
    ...
    if ((uVar10 < 8) || ((uVar8 < uVar9 + uVar12 * 4 && (uVar9 < uVar8 + uVar12 * 4)))) {
      ...
      if (uVar14 == uVar12) goto LAB_00f544ec;
    }
    lVar7 = uVar12 - uVar14;
...
LAB_00f544ec:
    if (this[0x78] != (btHashMap<btHashInt,btTriangleInfo>)0x0) {
      gNumAlignedFree = gNumAlignedFree + 1;
      (*(code *)PTR_FUN_01048e40)();
    }
  }
