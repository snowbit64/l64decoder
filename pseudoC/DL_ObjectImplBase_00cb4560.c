...
/* CryptoPP::DL_ObjectImplBase<CryptoPP::DL_SignerBase<CryptoPP::Integer>,
  ...
  *(undefined8 *)(this + 0x28) = 0xff8b30;
  ...
  for (; uVar1 != 0; uVar1 = uVar1 - 1) {
    *(undefined4 *)((long)pvVar2 + uVar1 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00cb45e4 to 00cb45e7 has its CatchHandler @ 00cb4604 */
