...
// Function: vector
// Entry Point: 008eca00
// Size: 136 bytes
// Signature: undefined __thiscall vector(vector<float,std::__ndk1::allocator<float>> * this, vector * param_1)


/* std::__ndk1::vector<float, std::__ndk1::allocator<float> >::vector(std::__ndk1::vector<float,
...

{
  ...
  *(undefined8 *)(this + 0x10) = 0;
  ...
  if (uVar1 != 0) {
    if ((long)uVar1 < 0) {
                    /* try { // try from 008eca80 to 008eca87 has its CatchHandler @ 008eca88 */
                    /* WARNING: Subroutine does not return */
      std::__ndk1::__vector_base_common<true>::__throw_length_error();
    }
                    /* try { // try from 008eca30 to 008eca37 has its CatchHandler @ 008eca88 */
