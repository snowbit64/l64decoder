...
// Function: FUN_00cde88c
// Entry Point: 00cde88c
// Size: 440 bytes
// Signature: undefined FUN_00cde88c(void)


void FUN_00cde88c(void **param_1,undefined8 *param_2)

{
  ...
  if (puVar12 != (undefined8 *)param_1[3]) goto LAB_00cdea0c;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00cde9f4;
      }
    }
    do {
      puVar11 = puVar8 + 1;
