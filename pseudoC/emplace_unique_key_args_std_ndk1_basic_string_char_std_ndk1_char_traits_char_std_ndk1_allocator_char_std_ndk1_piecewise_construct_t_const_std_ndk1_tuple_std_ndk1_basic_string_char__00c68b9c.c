...

{
  ...
  ppVar1 = *(piecewise_construct_t **)(param_2 + 0x10);
  if (((byte)*param_2 & 1) == 0) {
    ppVar1 = param_2 + 1;
    uVar11 = (ulong)((byte)*param_2 >> 1);
  }
                    /* try { // try from 00c68bec to 00c68bf3 has its CatchHandler @ 00c68ee0 */
  plVar6 = (long *)__murmur2_or_cityhash<unsigned_long,64ul>::operator()
                             ((__murmur2_or_cityhash<unsigned_long,64ul> *)&local_80,ppVar1,uVar11);
        ...
        do {
          ...
          if (plVar8 == plVar4) {
            ...
            if ((bVar2 & 1) == 0) {
              if (plVar4 != (long *)0x0) {
                plVar10 = (long *)0x0;
                while (*(piecewise_construct_t *)((long)pplVar7 + (long)plVar10 + 0x11) ==
                       ppVar1[(long)plVar10]) {
                  plVar10 = (long *)((long)plVar10 + 1);
                  if ((long *)(ulong)(bVar2 >> 1) == plVar10) goto LAB_00c68d28;
                }
                goto LAB_00c68c78;
              }
            }
            else if (plVar4 != (long *)0x0) {
              uVar5 = memcmp(plVar8,ppVar1,(size_t)plVar4);
              plVar8 = (long *)(ulong)uVar5;
              if (uVar5 != 0) goto LAB_00c68c78;
            }
LAB_00c68d28:
            uVar17 = 0;
            goto LAB_00c68e84;
...
LAB_00c68c78:
  ...
  pplVar7 = (long **)operator_new(0x78);
  local_70 = 0;
  local_80 = pplVar7;
  plStack_78 = plVar4;
                    /* try { // try from 00c68d50 to 00c68d53 has its CatchHandler @ 00c68ec0 */
  ...
  if ((plVar15 == (long *)0x0) || (fVar18 * (float)ZEXT89(plVar15) < (float)(unkuint9)(lVar9 + 1)))
  {
    ...
    if (uVar14 <= uVar11) {
      uVar14 = uVar11;
                    ...
                    /* try { // try from 00c68dd0 to 00c68dd7 has its CatchHandler @ 00c68ebc */
