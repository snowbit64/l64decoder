...
// Function: push_back
// Entry Point: 00ba5724
// Size: 440 bytes
// Signature: undefined __thiscall push_back(__split_buffer<ThreadPool::Task**,std::__ndk1::allocator<ThreadPool::Task**>&> * this, Task * * * param_1)


/* std::__ndk1::__split_buffer<ThreadPool::Task**,
   std::__ndk1::allocator<ThreadPool::Task**>&>::push_back(ThreadPool::Task**&&) */

void __thiscall
std::__ndk1::__split_buffer<ThreadPool::Task**,std::__ndk1::allocator<ThreadPool::Task**>&>::
push_back(__split_buffer<ThreadPool::Task**,std::__ndk1::allocator<ThreadPool::Task**>&> *this,
         Task ***param_1)

{
  ...
  if (puVar12 != *(undefined8 **)(this + 0x18)) goto LAB_00ba58a4;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00ba588c;
      }
    }
    do {
      puVar11 = puVar8 + 1;
