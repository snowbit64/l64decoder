...
/* CryptoPP::DL_SignatureSchemeBase<CryptoPP::PK_Verifier,
   CryptoPP::DL_PublicKey<CryptoPP::ECPPoint> >::MaxRecoverableLength() const */
...

{
  ...
  uVar2 = (**(code **)(*in_x0 + 0xb0))();
                    /* WARNING: Could not recover jumptable at 0x00cbbbdc. Too many branches */
