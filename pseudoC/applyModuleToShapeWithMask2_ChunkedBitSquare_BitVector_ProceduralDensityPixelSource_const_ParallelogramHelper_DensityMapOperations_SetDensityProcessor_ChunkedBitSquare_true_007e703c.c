...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 007e703c
// Size: 3964 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,BitVector,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
    ...
    if (((uVar20 < local_98) || (uVar25 < local_94)) || ((uVar21 < local_94 || (uVar24 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar31 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar31 != 0
                    ...
                    /* try { // try from 007e7f7c to 007e7f87 has its CatchHandler @ 007e7fb8 */
              ...
              do {
                ...
                if ((iVar31 == 2) || ((iVar31 == 0) != ((uVar38 & uVar14) != uVar6))) {
                  ...
                  if (((int)uVar38 < iVar5) || (iVar28 < (int)uVar38)) {
                    if (DVar10 != (DensityMapFilter)0x0) goto LAB_007e7c90;
                  }
...
LAB_007e7cdc:
  uVar37 = uVar37 + 1;
  if (uVar37 == uVar27) goto LAB_007e7cb0;
  goto LAB_007e7ce8;
LAB_007e7cb0:
  uVar36 = uVar36 + 1;
  if (uVar36 == uVar24) goto LAB_007e7b44;
  goto LAB_007e7cc0;
}
