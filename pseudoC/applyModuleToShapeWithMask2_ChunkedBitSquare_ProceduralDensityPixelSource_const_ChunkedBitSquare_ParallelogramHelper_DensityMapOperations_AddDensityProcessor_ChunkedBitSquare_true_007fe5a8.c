...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 007fe5a8
// Size: 4080 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
    ...
    if (((uVar20 < local_98) || (uVar24 < local_94)) || ((uVar21 < local_94 || (uVar23 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar33 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar33 != 0
                    ...
                    /* try { // try from 007ff55c to 007ff567 has its CatchHandler @ 007ff598 */
            ...
            do {
              ...
              if ((iVar33 == 2) || ((iVar33 == 0) != ((uVar29 & uVar15) != uVar7))) {
                ...
                if (((int)uVar29 < iVar27) || (iVar28 < (int)uVar29)) {
                  if (DVar11 != (DensityMapFilter)0x0) goto LAB_007ff1a4;
                }
...
LAB_007ff310:
      ...
      if (iVar9 == 2) goto LAB_007ff310;
LAB_007ff2f0:
      if ((iVar9 == 0) != ((uVar30 & uVar17) != uVar10)) goto LAB_007ff310;
LAB_007ff218:
      uVar29 = uVar29 + 1;
      uVar3 = uVar3 + 1;
    } while (uVar29 != uVar21);
...
LAB_007ff0c4:
  uVar26 = uVar26 + 1;
  if (*(uint *)(param_5 + 0x5c) <= uVar26) goto LAB_007ff05c;
  goto LAB_007ff0e8;
}
