...
/* CryptoPP::DH_Domain<CryptoPP::DL_GroupParameters_GFP_DefaultSafePrime,
   CryptoPP::EnumToType<CryptoPP::CofactorMultiplicationOption, 0> >::StaticAlgorithmName() */
...

{
  ...
  local_40[0] = 0;
                    /* try { // try from 00c8f27c to 00c8f28b has its CatchHandler @ 00c8f2d8 */
  puVar2 = (undefined8 *)
           std::__ndk1::
