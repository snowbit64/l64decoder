...
// Function: applyModuleToShapeWithMask<BitVector,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
// Entry Point: 007f5f98
// Size: 2416 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask<BitVector,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>(IDensityPixelSource * param_1, BitVector * param_2, BitVector * param_3, ParallelogramHelper * param_4, SetDensityProcessor * param_5, DensityMapFilter * param_6)
...
/* bool DensityMapModifier::applyModuleToShapeWithMask<BitVector, BitVector, ParallelogramHelper,
   ...
   BitVector*, ParallelogramHelper&, DensityMapOperations::SetDensityProcessor<BitVector, true>&,
   DensityMapFilter const&) */

bool DensityMapModifier::
     applyModuleToShapeWithMask<BitVector,BitVector,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<BitVector,true>>
    ...
    if ((uVar15 < uVar13) || (uVar16 < uVar14)) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar19 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar19 != 0
                    ...
                    /* try { // try from 007f68bc to 007f68c7 has its CatchHandler @ 007f6918 */
        this = (Logger *)operator_new(0x38);
                    /* try { // try from 007f68cc to 007f68cf has its CatchHandler @ 007f6908 */
        Logger::Logger(this);
              ...
              do {
                ...
                if ((iVar4 == 2) || ((iVar4 == 0) != ((uVar26 & uVar18) != uVar6))) {
                  ...
                  if (((int)uVar26 < iVar19) || (iVar5 < (int)uVar26)) {
                    if (DVar8 != (DensityMapFilter)0x0) goto LAB_007f676c;
                  }
        ...
        if (uVar16 < *(uint *)(param_4 + 0x5c)) {
          do {
            ...
            if ((((iVar4 == 2) || ((iVar4 == 0) != ((uVar10 & uVar18) != uVar6))) &&
              ...
              local_70 = uVar10;
              DensityMapOperations::SetDensityProcessor<BitVector,true>::process
                        ((SetDensityProcessor<BitVector,true> *)param_5,(HelperSource *)&local_90);
              if (uVar10 != local_70) {
                DensityMapAccessUtil::writeValue
