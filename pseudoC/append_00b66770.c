...
// Function: __append
// Entry Point: 00b66770
// Size: 420 bytes
// Signature: undefined __thiscall __append(vector<Brep::SharedWedge,std::__ndk1::allocator<Brep::SharedWedge>> * this, ulong param_1)
...
std::__ndk1::vector<Brep::SharedWedge,std::__ndk1::allocator<Brep::SharedWedge>>::__append
          (vector<Brep::SharedWedge,std::__ndk1::allocator<Brep::SharedWedge>> *this,ulong param_1)
