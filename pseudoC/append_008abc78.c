...
// Function: __append
// Entry Point: 008abc78
// Size: 420 bytes
// Signature: undefined __thiscall __append(vector<BiquadResonantFilter::Settings,std::__ndk1::allocator<BiquadResonantFilter::Settings>> * this, ulong param_1)


/* std::__ndk1::vector<BiquadResonantFilter::Settings,
   std::__ndk1::allocator<BiquadResonantFilter::Settings> >::__append(unsigned long) */
