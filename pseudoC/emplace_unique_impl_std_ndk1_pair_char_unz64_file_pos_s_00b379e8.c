...
// Function: __emplace_unique_impl<std::__ndk1::pair<char*,unz64_file_pos_s>>
// Entry Point: 00b379e8
// Size: 232 bytes
// Signature: pair __cdecl __emplace_unique_impl<std::__ndk1::pair<char*,unz64_file_pos_s>>(pair * param_1)
...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, unz64_file_pos_s> >
   >::__emplace_unique_impl<std::__ndk1::pair<char*, unz64_file_pos_s> >(std::__ndk1::pair<char*,
   unz64_file_pos_s>&&) */
...
pair std::__ndk1::
     ...
     ::__emplace_unique_impl<std::__ndk1::pair<char*,unz64_file_pos_s>>(pair *param_1)

{
  ...
  __construct_node<std::__ndk1::pair<char*,unz64_file_pos_s>>(param_1);
                    /* try { // try from 00b37a1c to 00b37a27 has its CatchHandler @ 00b37ad0 */
  pp_Var2 = __find_equal<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,unz64_file_pos_s>>
                      ((__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,unz64_file_pos_s>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,unz64_file_pos_s>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,unz64_file_pos_s>>>
