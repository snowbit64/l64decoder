...
// Entry Point: 00bef40c
// Size: 204 bytes
// Signature: undefined __thiscall ~__deque_base(__deque_base<ShaderManager::AsyncCompileRequest*,std::__ndk1::allocator<ShaderManager::AsyncCompileRequest*>> * this)


/* std::__ndk1::__deque_base<ShaderManager::AsyncCompileRequest*,
   std::__ndk1::allocator<ShaderManager::AsyncCompileRequest*> >::~__deque_base() */
...

{
  ...
  *(undefined8 *)(this + 0x28) = 0;
  ...
  if (uVar3 >> 3 == 1) {
    ...
    if (uVar3 >> 3 != 2) goto LAB_00bef478;
    uVar4 = 0x200;
  }
