...
// Function: push_front
// Entry Point: 00ba58dc
// Size: 448 bytes
// Signature: undefined __thiscall push_front(__split_buffer<ThreadPool::Task**,std::__ndk1::allocator<ThreadPool::Task**>&> * this, Task * * * param_1)


/* std::__ndk1::__split_buffer<ThreadPool::Task**,
   std::__ndk1::allocator<ThreadPool::Task**>&>::push_front(ThreadPool::Task** const&) */

void __thiscall
std::__ndk1::__split_buffer<ThreadPool::Task**,std::__ndk1::allocator<ThreadPool::Task**>&>::
push_front(__split_buffer<ThreadPool::Task**,std::__ndk1::allocator<ThreadPool::Task**>&> *this,
          Task ***param_1)

{
  ...
  __dest = __src;
  if (__src != *(undefined8 **)this) goto LAB_00ba5a64;
  ...
  if (uVar11 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        puVar6 = __dest + uVar9;
        puVar8 = __src + uVar9;
        if (uVar11 == uVar9) goto LAB_00ba5a4c;
      }
    }
    do {
      puVar7 = puVar6 + 1;
