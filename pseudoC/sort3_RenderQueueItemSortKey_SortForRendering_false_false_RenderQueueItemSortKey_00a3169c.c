...
// Function: __sort3<RenderQueueItemSortKey::SortForRendering<false,false>&,RenderQueueItemSortKey*>
// Entry Point: 00a3169c
// Size: 848 bytes
// Signature: uint __cdecl __sort3<RenderQueueItemSortKey::SortForRendering<false,false>&,RenderQueueItemSortKey*>(RenderQueueItemSortKey * param_1, RenderQueueItemSortKey * param_2, RenderQueueItemSortKey * param_3, SortForRendering * param_4)


/* unsigned int std::__ndk1::__sort3<RenderQueueItemSortKey::SortForRendering<false, false>&,
   RenderQueueItemSortKey*>(RenderQueueItemSortKey*, RenderQueueItemSortKey*,
   RenderQueueItemSortKey*, RenderQueueItemSortKey::SortForRendering<false, false>&) */
...
LAB_00a31990:
    ...
    if (*(float *)(param_3 + 0x20) < fVar9) goto LAB_00a31950;
LAB_00a31810:
...
LAB_00a31974:
    ...
    else if (!bVar3) goto LAB_00a31974;
    goto LAB_00a319c8;
  }
  if (fVar9 < *(float *)(param_1 + 0x20)) goto LAB_00a317a4;
LAB_00a3172c:
  uVar7 = *(uint *)(param_3 + 0x24) >> 0x1e & 1;
  bVar3 = uVar1 <= uVar7;
  if (((((uVar7 == uVar1) &&
...
LAB_00a319a0:
      ...
      else if (!bVar3) goto LAB_00a319a0;
LAB_00a319c8:
      uVar4 = 1;
      goto LAB_00a319cc;
    }
  }
  else if (!bVar3) goto LAB_00a318b0;
  uVar4 = 0;
LAB_00a319cc:
