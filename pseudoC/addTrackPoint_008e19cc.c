...
/* TyreTrackSystem::addTrackPoint(unsigned int, float, float, float, float, float, float, float,
   float, float, float, float, float, bool) */

void TyreTrackSystem::addTrackPoint
...

{
  ...
  pTVar1 = *(Track **)((ulong)param_1 + 0x28);
  if ((param_14 - 1 < *(uint *)(pTVar1 + 0x60)) &&
     (lVar2 = *(long *)(*(long *)(pTVar1 + 0x68) + (ulong)(param_14 - 1) * 8), lVar2 != 0)) {
    TyreTrackGeometry::addTrackPoint
              (pTVar1,param_2,param_3,param_4,param_5,param_6,param_7,param_8,param_9,param_10,
