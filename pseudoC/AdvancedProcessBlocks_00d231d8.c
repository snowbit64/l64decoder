...
/* CryptoPP::Rijndael::Dec::AdvancedProcessBlocks(unsigned char const*, unsigned char const*,
...

{
  BlockTransformation::AdvancedProcessBlocks
            ((BlockTransformation *)(this + 8),param_1,param_2,param_3,param_4,param_5);
  return;
}
