...
// Entry Point: 00a2da54
// Size: 272 bytes
// Signature: void emplace_back<>(void)


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void std::__ndk1::vector<RenderQueueItemAllocator::GeometryBucket,
   std::__ndk1::allocator<RenderQueueItemAllocator::GeometryBucket> >::emplace_back<>() */
