...
// Function: operator()
// Entry Point: 00ccb95c
// Size: 428 bytes
// Signature: AssignFromHelperClass * __cdecl operator()(char * param_1, _func_void_Integer_ptr * param_2)


/* CryptoPP::AssignFromHelperClass<CryptoPP::DL_PrivateKey<CryptoPP::Integer>,
   CryptoPP::DL_PrivateKey<CryptoPP::Integer> >&
   CryptoPP::AssignFromHelperClass<CryptoPP::DL_PrivateKey<CryptoPP::Integer>,
   CryptoPP::DL_PrivateKey<CryptoPP::Integer> >::TEMPNAMEPLACEHOLDERVALUE(char const*, void
   (CryptoPP::DL_PrivateKey<CryptoPP::Integer>::*)(CryptoPP::Integer const&)) */
...

{
  ...
  if (param_1[0x10] == '\0') {
    Integer::Integer((Integer *)local_78);
                    /* try { // try from 00ccb9ac to 00ccb9df has its CatchHandler @ 00ccbbc8 */
    ...
    if ((uVar3 & 1) == 0) {
      this = (InvalidArgument *)__cxa_allocate_exception(0x28);
                    /* try { // try from 00ccba54 to 00ccba63 has its CatchHandler @ 00ccbbb4 */
      std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
      basic_string<decltype(nullptr)>(abStack_e8,"N8CryptoPP13DL_PrivateKeyINS_7IntegerEEE");
                    /* try { // try from 00ccba64 to 00ccba73 has its CatchHandler @ 00ccbb9c */
      puVar4 = (undefined8 *)
               std::__ndk1::
      ...
      puVar4[2] = 0;
      *puVar4 = 0;
                    /* try { // try from 00ccba8c to 00ccba97 has its CatchHandler @ 00ccbb6c */
      puVar4 = (undefined8 *)
               std::__ndk1::
               basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
      ...
      puVar4[2] = 0;
      *puVar4 = 0;
                    /* try { // try from 00ccbab0 to 00ccbabf has its CatchHandler @ 00ccbb48 */
      puVar4 = (undefined8 *)
               std::__ndk1::
               basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
      ...
      puVar4[2] = 0;
      *puVar4 = 0;
                    /* try { // try from 00ccbadc to 00ccbb03 has its CatchHandler @ 00ccbb08 */
    ...
    for (; local_68 != 0; local_68 = local_68 - 1) {
      *(undefined4 *)((long)local_58 + local_68 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00ccba18 to 00ccba1b has its CatchHandler @ 00ccbbc4 */
