...
// Function: getCreateMaskSignature
// Entry Point: 009d8adc
// Size: 516 bytes
// Signature: undefined __thiscall getCreateMaskSignature(ProceduralPlacementMask * this, ProceduralPlacementMask * param_1, basic_string * param_2, ProceduralPlacementMask * param_3)


/* ProceduralPlacementMask::getCreateMaskSignature(ProceduralPlacementMask*,
...

{
  ...
  ShaHash::ShaHash(aSStack_178,0xa0);
                    /* try { // try from 009d8b24 to 009d8b33 has its CatchHandler @ 009d8cf4 */
  ...
  if (bVar4) {
    uVar1 = local_188;
                    ...
                    /* try { // try from 009d8b54 to 009d8b5b has its CatchHandler @ 009d8cec */
  ShaHash::add(aSStack_178,puVar2,uVar1);
                    /* try { // try from 009d8b64 to 009d8b73 has its CatchHandler @ 009d8ce4 */
  ...
  if (bVar4) {
    uVar1 = local_1a0;
                    ...
                    /* try { // try from 009d8b94 to 009d8b9b has its CatchHandler @ 009d8ce0 */
  ShaHash::add(aSStack_178,puVar2,uVar1);
  uStack_78 = 0;
  local_80 = 0;
  uStack_68 = 0;
  ...
  uStack_148 = 0;
  uStack_150 = 0;
  FUN_009d8ecc(&local_160);
                    /* try { // try from 009d8be0 to 009d8bfb has its CatchHandler @ 009d8cfc */
  ShaHash::add(aSStack_178,(uchar *)&local_160,0x100);
  ShaHash::getSHA1Hash((uchar *)aSStack_178);
  local_1b0 = (char *)0x0;
                    /* try { // try from 009d8c00 to 009d8c53 has its CatchHandler @ 009d8d00 */
  StringUtil::base64Encode(auStack_5c,0x14,true,&local_1b0);
  __src = local_1b0;
  __n = strlen(local_1b0);
  if (0xffffffffffffffef < __n) {
                    /* try { // try from 009d8cd4 to 009d8cdb has its CatchHandler @ 009d8d00 */
