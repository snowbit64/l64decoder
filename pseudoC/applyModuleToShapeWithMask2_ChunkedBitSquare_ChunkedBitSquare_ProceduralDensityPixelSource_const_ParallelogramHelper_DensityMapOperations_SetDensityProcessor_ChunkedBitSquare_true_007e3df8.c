...
// Function: applyModuleToShapeWithMask2<ChunkedBitSquare,ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 007e3df8
// Size: 4092 bytes
...
bool DensityMapModifier::
     applyModuleToShapeWithMask2<ChunkedBitSquare,ChunkedBitSquare,ProceduralDensityPixelSource_const,ParallelogramHelper,DensityMapOperations::SetDensityProcessor<ChunkedBitSquare,true>>
    ...
    if (((uVar20 < local_98) || (uVar24 < local_94)) || ((uVar21 < local_94 || (uVar23 < local_98)))
      ...
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar34 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar34 != 0
                    ...
                    /* try { // try from 007e4da0 to 007e4db7 has its CatchHandler @ 007e4df4 */
            ...
            do {
              ...
              do {
                ...
                if (*(uint *)(param_3 + 0x34) < 2) {
                  uVar43 = (ulong)*(uint *)(param_3 + 0x34);
                  if (iVar34 != 2) goto LAB_007e4a64;
LAB_007e4a84:
                  uVar5 = uVar30 >> (ulong)(uVar6 & 0x1f) & uVar14;
                  if (((int)uVar5 < iVar27) || (iVar29 < (int)uVar5)) {
                    if (DVar11 != (DensityMapFilter)0x0) goto LAB_007e4ab0;
                  }
...
LAB_007e4ab0:
                  ...
                  if (iVar34 == 2) goto LAB_007e4a84;
LAB_007e4a64:
                  if ((iVar34 == 0) != ((uVar30 & uVar15) != uVar7)) goto LAB_007e4a84;
                }
                uVar32 = uVar32 + 1;
                uVar3 = uVar3 + 1;
              } while (uVar32 != uVar28);
...
LAB_007e4b0c:
  uVar38 = uVar38 + 1;
  if (uVar38 == uVar21) goto LAB_007e4ad8;
  goto LAB_007e4b1c;
LAB_007e4ad8:
  uVar26 = uVar26 + 1;
  if (uVar26 == uVar23) goto LAB_007e4900;
  goto LAB_007e4ae8;
}
