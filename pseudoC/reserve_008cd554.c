...
// Function: reserve
// Entry Point: 008cd554
// Size: 176 bytes
// Signature: undefined __thiscall reserve(vector<unsigned_int,std::__ndk1::allocator<unsigned_int>> * this, ulong param_1)


/* std::__ndk1::vector<unsigned int, std::__ndk1::allocator<unsigned int> >::reserve(unsigned long)
    */
