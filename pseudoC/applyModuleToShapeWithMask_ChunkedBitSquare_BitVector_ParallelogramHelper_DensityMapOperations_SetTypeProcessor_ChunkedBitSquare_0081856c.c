...
// Function: applyModuleToShapeWithMask<ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
// Entry Point: 0081856c
// Size: 2752 bytes
// Signature: bool __cdecl applyModuleToShapeWithMask<ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>(IDensityPixelSource * param_1, ChunkedBitSquare * param_2, BitVector * param_3, ParallelogramHelper * param_4, SetTypeProcessor * param_5, DensityMapFilter * param_6)
...
bool DensityMapModifier::
     applyModuleToShapeWithMask<ChunkedBitSquare,BitVector,ParallelogramHelper,DensityMapOperations::SetTypeProcessor<ChunkedBitSquare>>
    ...
    if ((uVar15 < uVar13) || (uVar16 < uVar14)) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar22 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar22 != 0
                    ...
                    /* try { // try from 00818fe8 to 00818fef has its CatchHandler @ 0081903c */
        this = (Logger *)operator_new(0x38);
                    /* try { // try from 00818ff4 to 00818ff7 has its CatchHandler @ 0081902c */
        Logger::Logger(this);
...
LAB_00818d34:
  uVar21 = uVar21 + 1;
  uVar3 = uVar3 + uVar17;
  if (uVar21 == uVar14) goto LAB_00818d14;
  goto LAB_00818d44;
LAB_00818d14:
  uVar19 = uVar19 + 1;
  uVar27 = uVar27 + uVar15 * uVar17;
  if (uVar19 == uVar25) goto LAB_00818ca0;
  goto LAB_00818d24;
LAB_00818ca0:
  *(int *)param_5 = *(int *)param_5 + 1;
LAB_00818cb0:
  uVar16 = uVar16 + 1;
  if (*(uint *)(param_4 + 0x5c) <= uVar16) goto LAB_00818c58;
  goto LAB_00818cd8;
}
