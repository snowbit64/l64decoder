...
// Function: __insertion_sort_3<RenderQueueItemSortKey::SortForRendering<false,true>&,RenderQueueItemSortKey*>
// Entry Point: 00a2f10c
// Size: 476 bytes
// Signature: void __cdecl __insertion_sort_3<RenderQueueItemSortKey::SortForRendering<false,true>&,RenderQueueItemSortKey*>(RenderQueueItemSortKey * param_1, RenderQueueItemSortKey * param_2, SortForRendering * param_3)


/* void std::__ndk1::__insertion_sort_3<RenderQueueItemSortKey::SortForRendering<false, true>&,
                ...
                if ((uVar4 == uVar5) &&
                  ...
                  if ((uVar11 != *(ulong *)(param_1 + lVar13 + 0x28)) ||
                     (((bVar6 = *(ulong *)(param_1 + lVar13 + 0x38) <= uVar1,
                      ...
                      bVar6 = uVar5 <= uVar3 >> 0x1f, uVar3 >> 0x1f != uVar5)))) goto LAB_00a2f298;
...
LAB_00a2f298:
        ...
        else if (!bVar6) goto LAB_00a2f204;
      }
      else if (uVar4 < uVar5) {
        uVar9 = puVar8[1];
        goto LAB_00a2f204;
