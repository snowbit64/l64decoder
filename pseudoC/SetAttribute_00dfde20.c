...
// Entry Point: 00dfde20
// Size: 204 bytes
// Signature: undefined __thiscall SetAttribute(XMLAttribute * this, uint param_1)


/* tinyxml2::XMLAttribute::SetAttribute(unsigned int) */

void __thiscall tinyxml2::XMLAttribute::SetAttribute(XMLAttribute *this,uint param_1)

{
  ...
  FUN_00dfa4ec(auStack_110,200,200,&DAT_004cf2ba,param_1);
