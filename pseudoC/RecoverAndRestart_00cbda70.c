...
// Entry Point: 00cbda70
// Size: 1032 bytes
// Signature: undefined __thiscall RecoverAndRestart(DL_VerifierBase<CryptoPP::EC2NPoint> * this, uchar * param_1, PK_MessageAccumulator * param_2)


/* CryptoPP::DL_VerifierBase<CryptoPP::EC2NPoint>::RecoverAndRestart(unsigned char*,
   CryptoPP::PK_MessageAccumulator&) const */

undefined  [16] __thiscall
CryptoPP::DL_VerifierBase<CryptoPP::EC2NPoint>::RecoverAndRestart
          (DL_VerifierBase<CryptoPP::EC2NPoint> *this,uchar *param_1,PK_MessageAccumulator *param_2)

{
  ...
  if (uVar6 == 0) {
    ...
    puVar12 = (uchar *)UnalignedAllocate(uVar17);
                    ...
                    /* try { // try from 00cbdb84 to 00cbdc2f has its CatchHandler @ 00cbdec8 */
  ...
  param_2[0xe8] = (PK_MessageAccumulator)0x1;
                    /* try { // try from 00cbdc38 to 00cbdc4f has its CatchHandler @ 00cbdea4 */
  Integer::Integer((Integer *)local_a0,puVar12,uVar17,0,1);
                    /* try { // try from 00cbdc5c to 00cbdca3 has its CatchHandler @ 00cbdea8 */
  ...
  *(undefined8 *)(param_2 + 0x50) = 0xffffffffffffffff;
                    /* try { // try from 00cbdcbc to 00cbdccb has its CatchHandler @ 00cbde9c */
  Integer::Integer((Integer *)local_d0,*(uchar **)(param_2 + 0x80),*(ulong *)(param_2 + 0x78),0,1);
                    /* try { // try from 00cbdcdc to 00cbdceb has its CatchHandler @ 00cbde98 */
  (**(code **)(*plVar8 + 0x20))(local_100,plVar8,plVar10,uVar9,local_d0,param_2 + 0xb8);
                    /* try { // try from 00cbdcf0 to 00cbdcfb has its CatchHandler @ 00cbde88 */
  ...
  for (; local_f0 != 0; local_f0 = local_f0 - 1) {
    *(undefined4 *)((long)local_e0 + local_f0 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00cbdd34 to 00cbdd37 has its CatchHandler @ 00cbde84 */
  UnalignedDeallocate(local_e0);
                    /* try { // try from 00cbdd40 to 00cbdd9b has its CatchHandler @ 00cbdeb0 */
  ...
  for (; local_c0 != 0; local_c0 = local_c0 - 1) {
    *(undefined4 *)((long)local_b0 + local_c0 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00cbddd4 to 00cbddd7 has its CatchHandler @ 00cbde80 */
  ...
  for (; local_90 != 0; local_90 = local_90 - 1) {
    *(undefined4 *)((long)local_80 + local_90 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00cbde08 to 00cbde0b has its CatchHandler @ 00cbde7c */
  UnalignedDeallocate(local_80);
  for (; uVar17 != 0; uVar17 = uVar17 - 1) {
    puVar12[uVar17 - 1] = '\0';
  }
                    /* try { // try from 00cbde34 to 00cbde37 has its CatchHandler @ 00cbde78 */
