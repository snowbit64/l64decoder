...

{
  ...
  this_00 = (long *)(this + 8);
  HashTransformation::ThrowIfInvalidTruncatedSize((HashTransformation *)this_00,param_2);
  lVar9 = (**(code **)(*(long *)this + 0xd8))(this);
  __src = (uchar *)(**(code **)(*(long *)this + 0xe0))(this);
  uVar4 = (**(code **)(*(long *)(this + 8) + 0x50))(this_00);
  uVar5 = (**(code **)(*(long *)this + 0xc0))(this);
  uVar17 = uVar4 - 0x10;
  iVar6 = (**(code **)(*(long *)(this + 8) + 0x50))(this_00);
  uVar8 = 0;
  if (iVar6 != 0) {
    uVar8 = iVar6 - 1;
  }
  uVar8 = uVar8 & *(uint *)(this + 0x10);
  ...
  *(undefined *)((long)__s + (ulong)uVar8) = 0x80;
  if (uVar8 < uVar17) {
    ...
    uVar7 = (**(code **)(*(long *)(this + 8) + 0x50))(this_00);
    (**(code **)(*(long *)this + 0xd0))(this,__s,uVar7);
  }
  ...
  *(ulong *)(lVar9 + ((ulong)(uVar4 >> 3) + (ulong)uVar5) * 8 + -0x10) = uVar10;
  uVar10 = *(long *)(this + 0x18) << 3;
  uVar12 = (uVar10 & 0xff00ff00ff00ff00) >> 8 |
           (*(ulong *)(this + 0x10) >> 0x3d | uVar10 & 0xff00ff00ff00ff) << 8;
  uVar12 = (uVar12 & 0xffff0000ffff0000) >> 0x10 | (uVar12 & 0xffff0000ffff) << 0x10;
  uVar10 = *(ulong *)(this + 0x10) >> 0x3d | uVar10;
  if (uVar5 != 0) {
    uVar10 = uVar12 >> 0x20 | uVar12 << 0x20;
  }
  *(ulong *)(lVar9 + (~(ulong)uVar5 + (ulong)(uVar4 >> 3)) * 8) = uVar10;
  uVar7 = (**(code **)(lVar3 + 0x50))(this_00);
  (**(code **)(*(long *)this + 0xd0))(this,lVar9,uVar7);
  if ((((uint)param_1 | (uint)param_2) & 7) == 0) {
    if (uVar5 != 0) {
      if (7 < param_2) {
        ...
        if ((param_2 < 0x20) ||
          ...
          if (uVar10 == uVar12) goto LAB_00d076d0;
        }
        lVar9 = uVar10 - uVar12;
    ...
    if (__src == param_1) goto LAB_00d076d0;
  }
  else {
    uVar8 = (**(code **)(*this_00 + 0x48))(this_00);
    if ((uVar5 != 0) && (7 < uVar8)) {
      ...
      if (uVar8 < 0x20) {
        ...
        if (uVar11 == uVar10) goto LAB_00d076c4;
      }
      lVar9 = uVar10 - uVar11;
...
LAB_00d076d0:
                    /* WARNING: Could not recover jumptable at 0x00d076f8. Too many branches */
