...
// Entry Point: 00f9448c
// Size: 288 bytes
// Signature: undefined __thiscall getAllContactManifolds(btSphereSphereCollisionAlgorithm * this, btAlignedObjectArray * param_1)


/* btSphereSphereCollisionAlgorithm::getAllContactManifolds(btAlignedObjectArray<btPersistentManifold*>&)
    */

void __thiscall
btSphereSphereCollisionAlgorithm::getAllContactManifolds
          (btSphereSphereCollisionAlgorithm *this,btAlignedObjectArray *param_1)

{
  ...
  if ((lVar3 != 0) && (this[0x10] != (btSphereSphereCollisionAlgorithm)0x0)) {
