...
// Entry Point: 009ddec4
// Size: 76 bytes
// Signature: undefined __thiscall getNodeFromId(ProceduralPlacementRaycastObjectsMask * this, uint param_1, TransformGroup * param_2)


/* ProceduralPlacementRaycastObjectsMask::getNodeFromId(unsigned int, TransformGroup*) */

TransformGroup * __thiscall
ProceduralPlacementRaycastObjectsMask::getNodeFromId
          (ProceduralPlacementRaycastObjectsMask *this,uint param_1,TransformGroup *param_2)
