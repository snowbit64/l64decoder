...
// Function: applyTypedModulesToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
// Entry Point: 0082ba48
// Size: 4076 bytes
// Signature: bool __cdecl applyTypedModulesToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>(IDensityPixelSource * param_1, ChunkedBitSquare * param_2, IDensityPixelSource * param_3, ProceduralDensityPixelSource * param_4, IDensityPixelSource * param_5, BitVector * param_6, ParallelogramHelper * param_7, uint param_8, TypedModules * param_9)
...
bool DensityMapModifier::
     applyTypedModulesToShapeWithMask2<ChunkedBitSquare,ProceduralDensityPixelSource_const,BitVector,ParallelogramHelper,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
    ...
    if (((uVar11 < uVar9) || (uVar12 < uVar10)) || ((uVar13 < uVar9 || (uVar14 < uVar10)))) {
      if (((LogManager::getInstance()::singletonLogManager & 1) == 0) &&
         (iVar17 = __cxa_guard_acquire(&LogManager::getInstance()::singletonLogManager), iVar17 != 0
                    ...
                    /* try { // try from 0082c9f8 to 0082ca03 has its CatchHandler @ 0082ca34 */
          ...
          do {
            ...
            if ((int)uVar30 != 0) {
              ...
              while( true ) {
                ...
                bVar5 = checkTypedModuleMasks2<ProceduralDensityPixelSource_const,BitVector,DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,false>>
    ...
    if (uVar9 < *(uint *)(param_7 + 0x4c)) {
      do {
        ...
        if (uVar10 < *(uint *)(param_7 + 0x5c)) {
          uVar11 = uVar9 >> (ulong)(local_148 & 0x1f);
          do {
            puVar4 = local_88;
            uVar12 = local_88[0xd];
            ...
            if ((int)uVar30 != 0) {
              ...
              lVar27 = *local_d8;
              uVar13 = (local_d0 + local_e8 * uVar11) * local_e0;
              ...
              lVar21 = 0xcc;
              local_c8 = uVar25 >> (ulong)(uVar13 & 7) &
...
LAB_0082c380:
                  ...
                  if (pIVar22 == param_1) {
                    ...
                    if ((*(int *)(lVar23 + -0x4c) == 2) ||
                      ...
                      if ((int)uVar13 < *(int *)(lVar23 + -0x3c)) goto LAB_0082c24c;
LAB_0082c1dc:
                      cVar2 = *(char *)(lVar27 + lVar21 + -0x34);
                      goto joined_r0x0082c250;
                    }
                  }
                  else {
                    if (pIVar22 == param_3) {
                       ...
                       ((iVar17 == 0) != (*(uint *)(lVar27 + lVar21 + -0x48) != (uVar25 & uVar13))))
                    {
                      ...
                      uVar13 = uVar25 >> (ulong)(*(uint *)(lVar23 + -0x44) & 0x1f) &
                               (-1 << (ulong)(*(uint *)(lVar23 + -0x40) & 0x1f) ^ 0xffffffffU);
                      if (*(int *)(lVar23 + -0x3c) <= (int)uVar13) goto LAB_0082c1dc;
LAB_0082c24c:
                      cVar2 = *(char *)(lVar27 + lVar21 + -0x34);
joined_r0x0082c250:
                      if ((cVar2 != '\0') &&
                        ...
                        if (pIVar22 == (IDensityPixelSource *)0x0) goto LAB_0082c380;
                        if (pIVar22 == param_1) {
                          lVar23 = lVar27 + lVar21;
                          if ((*(int *)(lVar23 + -0x1c) == 2) ||
                            ...
                            ;
                            if ((int)uVar13 < *(int *)(lVar23 + -0xc)) goto LAB_0082c360;
LAB_0082c2f0:
                            cVar2 = *(char *)(lVar27 + lVar21 + -4);
                            goto joined_r0x0082c364;
                          }
                        }
                        else {
                          if (pIVar22 == param_3) {
                          ...
                          if ((iVar17 == 2) ||
                            ...
                            uVar13 = uVar25 >> (ulong)(*(uint *)(lVar23 + -0x14) & 0x1f) &
                                     (-1 << (ulong)(*(uint *)(lVar23 + -0x10) & 0x1f) ^ 0xffffffffU)
                            ;
                            if (*(int *)(lVar23 + -0xc) <= (int)uVar13) goto LAB_0082c2f0;
LAB_0082c360:
                            cVar2 = *(char *)(lVar27 + lVar21 + -4);
joined_r0x0082c364:
                            if ((cVar2 != '\0') &&
                               ((*(uint *)(lVar27 + lVar21) == 0 ||
                                ((*(uint *)(lVar27 + lVar21) & uVar13) != 0)))) goto LAB_0082c380;
                          }
                        }
                      }
                    }
