...
// Function: FUN_00754c20
// Entry Point: 00754c20
// Size: 292 bytes
// Signature: undefined FUN_00754c20(void)


long FUN_00754c20(long *param_1,long **param_2)

{
  ...
  param_2[1] = plVar2;
  plVar2 = (long *)FUN_00754e18(param_1,plVar2,param_2 + 2);
  ...
  if (plVar2 == (long *)0x0) {
    ...
    *(long ***)(*param_1 + (long)plVar4 * 8) = pplVar5;
    if (*param_2 == (long *)0x0) goto LAB_00754d24;
    ...
    *plVar2 = (long)param_2;
    ...
    if (plVar2 == plVar4) goto LAB_00754d24;
  }
