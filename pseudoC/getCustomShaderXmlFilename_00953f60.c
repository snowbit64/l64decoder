...
// Function: getCustomShaderXmlFilename
// Entry Point: 00953f60
// Size: 164 bytes
// Signature: undefined __thiscall getCustomShaderXmlFilename(MaterialShaderManager * this, uint param_1)


/* MaterialShaderManager::getCustomShaderXmlFilename(unsigned int) */

MaterialShaderManager * __thiscall
MaterialShaderManager::getCustomShaderXmlFilename(MaterialShaderManager *this,uint param_1)

{
  ...
  if (ppMVar3 != (MaterialShaderManager **)0x0) {
    ...
    if ((ppMVar1 != ppMVar5) && (*(uint *)(ppMVar1 + 4) <= param_1)) {
      pMVar2 = ppMVar1[5];
      pMVar4 = pMVar2 + 0x69;
      if (((byte)pMVar2[0x68] & 1) != 0) {
        pMVar4 = *(MaterialShaderManager **)(pMVar2 + 0x78);
      }
      goto LAB_00953fc4;
    }
  }
