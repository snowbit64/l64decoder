...
// Function: applyModuleToShapeWithoutMask<ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
// Entry Point: 00803468
// Size: 708 bytes
// Signature: bool __cdecl applyModuleToShapeWithoutMask<ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>(IDensityPixelSource * param_1, ChunkedBitSquare * param_2, ParallelogramHelper * param_3, AddDensityProcessor * param_4)
...
/* bool DensityMapModifier::applyModuleToShapeWithoutMask<ChunkedBitSquare, ParallelogramHelper,
   ...
   DensityMapOperations::AddDensityProcessor<ChunkedBitSquare, true>&) */

bool DensityMapModifier::
     applyModuleToShapeWithoutMask<ChunkedBitSquare,ParallelogramHelper,DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>>
               (IDensityPixelSource *param_1,ChunkedBitSquare *param_2,ParallelogramHelper *param_3,
               AddDensityProcessor *param_4)

{
      ...
      if (uVar12 < *(uint *)(param_3 + 0x5c)) {
        do {
          ...
          DensityMapOperations::AddDensityProcessor<ChunkedBitSquare,true>::process
                    ((AddDensityProcessor<ChunkedBitSquare,true> *)param_4,(HelperSource *)&local_90
                    );
          uVar3 = local_70;
          puVar6 = local_80;
          if (uVar7 != local_70) {
  ...
  if (param_4[0x6c] != (AddDensityProcessor)0x0) {
    DensityMap::markDensityRegionDirty
              (*(DensityMap **)(param_4 + 0x58),*(uint *)(param_3 + 0x50),*(uint *)(param_3 + 0x48),
               *(uint *)(param_3 + 0x54),uVar12,*(uint *)(param_4 + 0x24),*(uint *)(param_4 + 0x28),
               *(uint *)(param_4 + 0x70),(bool)param_4[0x6d],true,true);
  }
