...
/* CryptoPP::GetValueHelperClass<CryptoPP::DL_PrivateKey_ECGDSA<CryptoPP::ECP>,
   CryptoPP::DL_PrivateKey_ECGDSA<CryptoPP::ECP> >::Assignable() */
...

{
  ...
  if (*(char *)(in_x0 + 4) == '\0') {
    ...
    if ((iVar2 == 0) &&
       (iVar2 = strcmp(pcVar3 + 0xb,"N8CryptoPP20DL_PrivateKey_ECGDSAINS_3ECPEEE"), iVar2 == 0)) {
      NameValuePairs::ThrowIfTypeMismatch
                (pcVar3,(type_info *)&DL_PrivateKey_ECGDSA<CryptoPP::ECP>::typeinfo,
                 (type_info *)in_x0[2]);
      lVar4 = *in_x0;
      lVar5 = in_x0[3];
