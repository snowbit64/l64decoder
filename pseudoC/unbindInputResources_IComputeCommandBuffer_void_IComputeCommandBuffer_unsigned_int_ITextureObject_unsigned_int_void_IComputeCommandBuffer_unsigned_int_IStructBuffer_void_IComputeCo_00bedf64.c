...
// Function: unbindInputResources<IComputeCommandBuffer,void(IComputeCommandBuffer::*)(unsigned_int,ITextureObject*,unsigned_int),void(IComputeCommandBuffer::*)(unsigned_int,IStructBuffer*),void(IComputeCommandBuffer::*)(unsigned_int,IConstantBuffer*),void(IComputeCommandBuffer::*)(unsigned_int,ISamplerObject*)>
// Entry Point: 00bedf64
// Size: 860 bytes
// Signature: void __cdecl unbindInputResources<IComputeCommandBuffer,void(IComputeCommandBuffer::*)(unsigned_int,ITextureObject*,unsigned_int),void(IComputeCommandBuffer::*)(unsigned_int,IStructBuffer*),void(IComputeCommandBuffer::*)(unsigned_int,IConstantBuffer*),void(IComputeCommandBuffer::*)(unsigned_int,ISamplerObject*)>(IComputeCommandBuffer * param_1, ShaderTexture * param_2, uint param_3, ShaderStructBuffer * param_4, uint param_5, ShaderConstantBuffer * param_6, uint param_7, ShaderSampler * param_8, uint param_9, SHADER_STAGE param_10, _func_void_uint_ITextureObject_ptr_uint * param_11, _func_void_uint_IStructBuffer_ptr * param_12, _func_void_uint_IConstantBuffer_ptr * param_13, _func_void_uint_ISamplerObject_ptr * param_14)


/* void AdhocShader::unbindInputResources<IComputeCommandBuffer, void
   ...
   unsigned int, IProgramObject::SHADER_STAGE, void (IComputeCommandBuffer::*)(unsigned int,
   ITextureObject*, unsigned int), void (IComputeCommandBuffer::*)(unsigned int, IStructBuffer*),
   void (IComputeCommandBuffer::*)(unsigned int, IConstantBuffer*), void
...
void AdhocShader::
     unbindInputResources<IComputeCommandBuffer,void(IComputeCommandBuffer::*)(unsigned_int,ITextureObject*,unsigned_int),void(IComputeCommandBuffer::*)(unsigned_int,IStructBuffer*),void(IComputeCommandBuffer::*)(unsigned_int,IConstantBuffer*),void(IComputeCommandBuffer::*)(unsigned_int,ISamplerObject*)>
               ...
               _func_void_uint_ITextureObject_ptr_uint *param_11,
...

{
  ...
  if (lVar11 != lVar12) {
    ...
    do {
      if ((int)param_4 != 0) {
        pcVar13 = *(char **)(lVar12 + uVar9 * 0x10 + 8);
        uVar8 = (ulong)param_4 & 0xffffffff;
        lVar14 = (ulong)param_3 + 0x10;
        do {
          iVar1 = strcmp(pcVar13,*(char **)(lVar14 + -0x10));
          if (iVar1 == 0) {
            p_Var4 = param_12;
            ...
            (*p_Var4)((uint)(param_2 + ((long)param_13 >> 1)),
                      (IStructBuffer *)*(undefined4 *)(lVar12 + uVar9 * 0x10));
            lVar11 = *plVar3;
            lVar12 = *plVar2;
            break;
          }
    ...
    } while (uVar9 < (ulong)(lVar11 - lVar12 >> 4));
    if (lVar11 != lVar12) {
      uVar9 = 0;
      do {
        if ((int)param_6 != 0) {
          ...
          do {
            ...
            if (iVar1 == 0) {
              ...
              (*p_Var5)((uint)(param_2 + ((long)in_stack_00000030 >> 1)),
                        (ISamplerObject *)*(undefined4 *)(lVar12 + uVar9 * 0x10));
              lVar11 = *plVar3;
              lVar12 = *plVar2;
              break;
            }
  ...
  if (lVar12 != lVar11) {
    ...
    do {
      if ((int)param_8 != 0) {
        pcVar13 = *(char **)(lVar11 + uVar9 * 0x10 + 8);
        ...
        do {
          ...
          if (iVar1 == 0) {
            ...
            (*pcVar6)(param_2 + ((long)in_stack_00000040 >> 1),
                      *(undefined4 *)(lVar11 + uVar9 * 0x10),0);
            lVar11 = *(long *)(param_1 + 0xa0);
            lVar12 = *(long *)(param_1 + 0xa8);
            break;
          }
      ...
      uVar9 = (ulong)((int)uVar9 + 1);
    } while (uVar9 < (ulong)(lVar12 - lVar11 >> 4));
  }
  lVar12 = *(long *)(param_1 + uVar7 * 0x18 + 0xb8);
  lVar11 = *(long *)(param_1 + uVar7 * 0x18 + 0xc0);
  if (lVar11 != lVar12) {
    uVar9 = 0;
    do {
      if (param_10 != 0) {
        ...
        do {
          ...
          if (iVar1 == 0) {
            ...
            (*pcVar6)(param_2 + ((long)in_stack_00000050 >> 1),
                      *(undefined4 *)(lVar12 + uVar9 * 0x10),0);
            lVar11 = *(long *)(param_1 + uVar7 * 0x18 + 0xc0);
            lVar12 = *(long *)(param_1 + uVar7 * 0x18 + 0xb8);
            break;
          }
