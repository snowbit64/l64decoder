...
// Function: createModules<ChunkedBitSquare>
// Entry Point: 00769488
// Size: 1552 bytes
// Signature: TypedModules * __thiscall createModules<ChunkedBitSquare>(DensityMapMultiModifierLua * this, DensityMapExecute * param_1)


/* DensityMapModifier::TypedModules<DensityMapOperations::SetOrAddDensityProcessor<ChunkedBitSquare,
   false> >*
   DensityMapMultiModifierLua::createModules<ChunkedBitSquare>(DensityMapMultiModifierLua::DensityMapExecute&)
    */

TypedModules * __thiscall
DensityMapMultiModifierLua::createModules<ChunkedBitSquare>
...
LAB_0076950c:
    ...
    if ((int)(uVar14 - 1) == -1 || uVar14 - 1 >> 0x20 != 0) goto LAB_0076950c;
    ...
    if (uVar21 == uVar14) goto LAB_0076955c;
  }
  ...
  if (lVar4 != lVar13) {
    ...
    do {
      ...
      if (*(int *)(puVar17 + 3) == 0) {
        ...
        uStack_12c = uVar11;
        local_100 = uVar22;
        FUN_00823fac(__s + (ulong)uVar6 * 3,&local_158);
      }
        ...
        if (uVar18 != 0) {
          ...
          do {
            if (uVar14 != *(uint *)(lVar13 + 0x1c)) {
              ...
              uStack_12c = uVar6;
              local_100 = uVar22;
              FUN_00823fac(puVar12,&local_158);
            }
            uVar14 = uVar14 + 1;
            puVar12 = puVar12 + 3;
          } while (uVar21 != uVar14);
