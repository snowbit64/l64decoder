...
// Entry Point: 00c7e758
// Size: 224 bytes
// Signature: undefined __thiscall UncheckedSetKey(CFB_CipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::CFB_CipherAbstractPolicy,CryptoPP::SymmetricCipher>> * this, uchar * param_1, uint param_2, NameValuePairs * param_3)
...
::UncheckedSetKey(CFB_CipherTemplate<CryptoPP::AbstractPolicyHolder<CryptoPP::CFB_CipherAbstractPolicy,CryptoPP::SymmetricCipher>>
...

{
  ...
  plVar3 = (long *)(**(code **)(*(long *)this + 0x88))(this,param_1,param_2);
  ...
  *(ulong *)(this + 0x10) = uVar5 & 0xffffffff;
