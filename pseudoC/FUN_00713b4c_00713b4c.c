...
// Function: FUN_00713b4c
// Entry Point: 00713b4c
// Size: 440 bytes
// Signature: undefined FUN_00713b4c(void)


void FUN_00713b4c(void **param_1,undefined8 *param_2)

{
  ...
  if (puVar12 != (undefined8 *)param_1[3]) goto LAB_00713ccc;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00713cb4;
      }
    }
    do {
      puVar11 = puVar8 + 1;
