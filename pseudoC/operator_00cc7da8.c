...
// Function: operator()
// Entry Point: 00cc7da8
// Size: 428 bytes
// Signature: AssignFromHelperClass * __cdecl operator()(char * param_1, _func_void_Integer_ptr * param_2)


/* CryptoPP::AssignFromHelperClass<CryptoPP::DL_PrivateKey<CryptoPP::ECPPoint>,
   CryptoPP::DL_PrivateKey<CryptoPP::ECPPoint> >&
   CryptoPP::AssignFromHelperClass<CryptoPP::DL_PrivateKey<CryptoPP::ECPPoint>,
   CryptoPP::DL_PrivateKey<CryptoPP::ECPPoint> >::TEMPNAMEPLACEHOLDERVALUE(char const*, void
   (CryptoPP::DL_PrivateKey<CryptoPP::ECPPoint>::*)(CryptoPP::Integer const&)) */
...

{
  ...
  if (param_1[0x10] == '\0') {
    Integer::Integer((Integer *)local_78);
                    /* try { // try from 00cc7df8 to 00cc7e2b has its CatchHandler @ 00cc8014 */
    ...
    if ((uVar3 & 1) == 0) {
      this = (InvalidArgument *)__cxa_allocate_exception(0x28);
                    /* try { // try from 00cc7ea0 to 00cc7eaf has its CatchHandler @ 00cc8000 */
      std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
      basic_string<decltype(nullptr)>(abStack_e8,"N8CryptoPP13DL_PrivateKeyINS_8ECPPointEEE");
                    /* try { // try from 00cc7eb0 to 00cc7ebf has its CatchHandler @ 00cc7fe8 */
      puVar4 = (undefined8 *)
               std::__ndk1::
      ...
      puVar4[2] = 0;
      *puVar4 = 0;
                    /* try { // try from 00cc7ed8 to 00cc7ee3 has its CatchHandler @ 00cc7fb8 */
      puVar4 = (undefined8 *)
               std::__ndk1::
               basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
      ...
      puVar4[2] = 0;
      *puVar4 = 0;
                    /* try { // try from 00cc7efc to 00cc7f0b has its CatchHandler @ 00cc7f94 */
      puVar4 = (undefined8 *)
               std::__ndk1::
               basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
      ...
      puVar4[2] = 0;
      *puVar4 = 0;
                    /* try { // try from 00cc7f28 to 00cc7f4f has its CatchHandler @ 00cc7f54 */
    ...
    for (; local_68 != 0; local_68 = local_68 - 1) {
      *(undefined4 *)((long)local_58 + local_68 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00cc7e64 to 00cc7e67 has its CatchHandler @ 00cc8010 */
