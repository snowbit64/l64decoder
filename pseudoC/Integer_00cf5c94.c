...
// Function: Integer
// Entry Point: 00cf5c94
// Size: 276 bytes
// Signature: undefined __thiscall Integer(Integer * this, BufferedTransformation * param_1)


/* CryptoPP::Integer::Integer(CryptoPP::BufferedTransformation&) */

void __thiscall CryptoPP::Integer::Integer(Integer *this,BufferedTransformation *param_1)

{
  ...
  *(undefined ***)this = &PTR__Integer_0100c890;
                    /* try { // try from 00cf5d94 to 00cf5d9b has its CatchHandler @ 00cf5da8 */
