...
// Entry Point: 00ca8604
// Size: 64 bytes
// Signature: undefined __thiscall SavePrecomputation(DL_PrivateKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::ECP>> * this, BufferedTransformation * param_1)
...
void __thiscall
CryptoPP::DL_PrivateKeyImpl<CryptoPP::DL_GroupParameters_EC<CryptoPP::ECP>>::SavePrecomputation
...

{
  ...
  plVar1 = (long *)(**(code **)(*(long *)(this + *(long *)(*(long *)this + -0x68)) + 0x10))();
                    /* WARNING: Could not recover jumptable at 0x00ca8640. Too many branches */
