...
// Function: __append
// Entry Point: 00ac3734
// Size: 420 bytes
// Signature: undefined __thiscall __append(vector<VulkanResourceAllocator::ReleasedBuffer,std::__ndk1::allocator<VulkanResourceAllocator::ReleasedBuffer>> * this, ulong param_1)


/* std::__ndk1::vector<VulkanResourceAllocator::ReleasedBuffer,
   std::__ndk1::allocator<VulkanResourceAllocator::ReleasedBuffer> >::__append(unsigned long) */
