...
// Entry Point: 00bb4ce4
// Size: 44 bytes
// Signature: undefined __thiscall MethodDeclaration(MethodDeclaration * this, Type param_1, Type param_2, Type param_3, Type param_4, Type param_5, Type param_6, void * param_7)
...

{
  ...
  *(undefined8 *)(this + 0x60) = 0x600000000;
