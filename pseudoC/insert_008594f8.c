...
// Function: insert
// Entry Point: 008594f8
// Size: 556 bytes
// Signature: undefined __thiscall insert(vector<std::__ndk1::pair<unsigned_int,DensityMapSyncer::ConnectionData*>,std::__ndk1::allocator<std::__ndk1::pair<unsigned_int,DensityMapSyncer::ConnectionData*>>> * this, __wrap_iter param_1, pair * param_2)


/* std::__ndk1::vector<std::__ndk1::pair<unsigned int, DensityMapSyncer::ConnectionData*>,
   ...
   DensityMapSyncer::ConnectionData*> const*>, std::__ndk1::pair<unsigned int,
   DensityMapSyncer::ConnectionData*>&&) */
...

{
  ...
  *local_50;
  ...
  if (puVar7 < *(undefined8 **)(this + 0x10)) {
    ...
    local_60 = local_68;
                    /* try { // try from 00859638 to 00859643 has its CatchHandler @ 00859724 */
