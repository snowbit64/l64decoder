...
// Function: push_back
// Entry Point: 007462e4
// Size: 440 bytes
// Signature: undefined __thiscall push_back(__split_buffer<VehicleNavigationAgent**,std::__ndk1::allocator<VehicleNavigationAgent**>> * this, VehicleNavigationAgent * * * param_1)


/* std::__ndk1::__split_buffer<VehicleNavigationAgent**,
   std::__ndk1::allocator<VehicleNavigationAgent**> >::push_back(VehicleNavigationAgent**&&) */

void __thiscall
std::__ndk1::
__split_buffer<VehicleNavigationAgent**,std::__ndk1::allocator<VehicleNavigationAgent**>>::push_back
          (__split_buffer<VehicleNavigationAgent**,std::__ndk1::allocator<VehicleNavigationAgent**>>
           *this,VehicleNavigationAgent ***param_1)

{
  ...
  if (puVar12 != *(undefined8 **)(this + 0x18)) goto LAB_00746464;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_0074644c;
      }
    }
    do {
      puVar11 = puVar8 + 1;
