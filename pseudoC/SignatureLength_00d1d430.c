...
/* CryptoPP::TF_SignatureSchemeBase<CryptoPP::PK_Signer,
   ...
   CryptoPP::PK_SignatureMessageEncodingMethod> >::SignatureLength() const */
...

{
  ...
  (**(code **)(*plVar3 + 0x20))(local_58);
                    /* try { // try from 00d1d468 to 00d1d46f has its CatchHandler @ 00d1d4dc */
  ...
  for (; local_48 != 0; local_48 = local_48 - 1) {
    *(undefined4 *)((long)local_38 + local_48 * 4 + -4) = 0;
                    ...
                    /* try { // try from 00d1d4ac to 00d1d4af has its CatchHandler @ 00d1d4d8 */
