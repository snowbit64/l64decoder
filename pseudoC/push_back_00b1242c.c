...
// Function: push_back
// Entry Point: 00b1242c
// Size: 440 bytes
// Signature: undefined __thiscall push_back(__split_buffer<float**,std::__ndk1::allocator<float**>&> * this, float * * * param_1)


/* std::__ndk1::__split_buffer<float**, std::__ndk1::allocator<float**>&>::push_back(float**&&) */

void __thiscall
std::__ndk1::__split_buffer<float**,std::__ndk1::allocator<float**>&>::push_back
...

{
  ...
  if (puVar12 != *(undefined8 **)(this + 0x18)) goto LAB_00b125ac;
  ...
  if (uVar9 != 0) {
    ...
    if (0x17 < uVar9) {
      if (((void *)((long)__src + (uVar9 & 0xfffffffffffffff8) + 8) <=
        ...
        if (uVar9 == uVar10) goto LAB_00b12594;
      }
    }
    do {
      puVar11 = puVar8 + 1;
