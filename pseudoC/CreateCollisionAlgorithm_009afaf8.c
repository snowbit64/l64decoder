...
/* Bt2ConvexHeightfieldCollisionAlgorithm::SwappedCreateFunc::CreateCollisionAlgorithm(btCollisionAlgorithmConstructionInfo&,
   btCollisionObjectWrapper const*, btCollisionObjectWrapper const*) */

Bt2ConvexHeightfieldCollisionAlgorithm * __thiscall
Bt2ConvexHeightfieldCollisionAlgorithm::SwappedCreateFunc::CreateCollisionAlgorithm
...

{
  ...
  Bt2ConvexHeightfieldCollisionAlgorithm
            (this_00,param_1,param_2,param_3,true,*(btVoronoiSimplexSolver **)(this + 0x10),
