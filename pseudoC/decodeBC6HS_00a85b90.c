...
// Entry Point: 00a85b90
// Size: 436 bytes
// Signature: undefined __cdecl decodeBC6HS(uchar * param_1, uint param_2, uint param_3, float * param_4)


/* BC6BC7Util::decodeBC6HS(unsigned char*, unsigned int, unsigned int, float*) */

void BC6BC7Util::decodeBC6HS(uchar *param_1,uint param_2,uint param_3,float *param_4)
  ...
  if (3 < param_3) {
    ...
    do {
      if (3 < param_2) {
        ...
        iVar1 = iVar11;
        do {
          D3DX_BC6H::Decode((D3DX_BC6H *)param_1,true,(HDRColorA *)local_170);
          lVar8 = 0;
          iVar3 = iVar1;
          do {
            lVar2 = lVar8 + 0x40;
