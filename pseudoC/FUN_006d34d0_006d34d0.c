...
// Function: FUN_006d34d0
// Entry Point: 006d34d0
// Size: 904 bytes
// Signature: undefined FUN_006d34d0(void)


int FUN_006d34d0(undefined8 *param_1,undefined8 *param_2,undefined8 *param_3,undefined8 *param_4)

{
  ...
  if (sVar3 == 0) {
LAB_006d3578:
    if (uVar1 <= uVar2) goto LAB_006d381c;
    ...
    if (iVar10 == 0) goto LAB_006d3578;
    if (-1 < iVar10) goto LAB_006d381c;
  }
  ...
  *(undefined *)((long)param_4 + 1) = uVar7;
  iVar16 = iVar9 + 1;
  *(ulong *)((long)param_4 + 2) = CONCAT26(uStack_72,local_78);
  param_4[1] = uVar13;
  param_4[2] = pvVar17;
  param_4[4] = uVar19;
  param_4[3] = uVar18;
