...
/* ProceduralPlacementManager::ClearAndScatterCallClearTexture::apply() */

void ProceduralPlacementManager::ClearAndScatterCallClearTexture::apply(void)

{
  ...
  *(undefined8 *)((long)local_40 + 0xc) = 0x2323232323232323;
                    /* try { // try from 009ce318 to 009ce32b has its CatchHandler @ 009ce710 */
  ...
  local_67._6_1_ = 't';
  local_67._7_1_ = 'e';
                    /* try { // try from 009ce378 to 009ce383 has its CatchHandler @ 009ce6fc */
  ...
  if (((byte)local_80[0] & 1) != 0) {
    pvVar2 = local_70;
                    ...
                    /* try { // try from 009ce3a0 to 009ce3a7 has its CatchHandler @ 009ce6dc */
  ...
  puVar4[2] = 0;
  *puVar4 = 0;
                    /* try { // try from 009ce3c0 to 009ce3d3 has its CatchHandler @ 009ce6a8 */
  logPerformance((ProceduralPlacementManager *)&DAT_02111c18,(basic_string *)&local_50);
  if ((local_50 & 1) != 0) {
    operator_delete(local_40);
  }
  ...
  clearTextureInMask((ProceduralPlacementManager *)&DAT_02111c18,*(PPMask **)(in_x0 + 8),
                     (basic_string *)(in_x0 + 0x10));
