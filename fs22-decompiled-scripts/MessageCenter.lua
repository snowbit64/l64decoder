...
MessageType.LOADING_STATIONS_CHANGED = nextMessageTypeId()
...
MessageType.TREE_SHAPE_MOUNTED = nextMessageTypeId()
MessageType.SLEEPING = nextMessageTypeId()
MessageType.SLOT_USAGE_CHANGED = nextMessageTypeId()
