...
function ConstructionBrushSculpt:shift(x, y, z, direction)
	...
	local requestLandscaping = LandscapingSculptEvent.new(validateOnly, operation, x, y, z, nil, , , , , , currentRadius, self.brushStrength, self.brushShape, Landscaping.TERRAIN_UNIT)
...
function ConstructionBrushSculpt:flatten(x, y, z)
	...
	local request = LandscapingSculptEvent.new(validateOnly, operation, x, self.flattenHeight, z, nil, , , , , , self.brushRadius, self.brushStrength, self.brushShape, Landscaping.TERRAIN_UNIT)
...
function ConstructionBrushSculpt:smooth(x, y, z)
	...
	local requestLandscaping = LandscapingSculptEvent.new(validateOnly, operation, x, y, z, nil, , , , , , self.brushRadius, self.brushStrength * 2, self.brushShape, Landscaping.TERRAIN_UNIT)
