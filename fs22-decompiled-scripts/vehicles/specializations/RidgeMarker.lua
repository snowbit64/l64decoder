...
function RidgeMarker.initSpecialization()
	g_configurationManager:addConfigurationType("ridgeMarker", g_i18n:getText("configuration_ridgeMarker"), "ridgeMarker", nil, , , ConfigurationUtil.SELECTOR_MULTIOPTION)
