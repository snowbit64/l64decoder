...
EventIds.EVENT_PLACEABLE_OBJECT_STORAGE_UNLOAD = nextEventId()
EventIds.EVENT_PLACEABLE_OBJECT_STORAGE_ERROR = nextEventId()
...
EventIds.EVENT_WOODHARVESTER_DROP_TREE = nextEventId()
